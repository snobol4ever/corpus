...
n0_make_list_α:         mov              r11, 1
                        ...
                        mov              qword ptr [rsp + 408], rdx;          jmp   n1_assign_α
#-----------------------------------------------------------------------------------------------------------------------
...
n2_var_α:               mov              r11, 3
                        ...
                        mov              qword ptr [rsp + 360], rax;          jmp   n3_lit_integer_α
#-----------------------------------------------------------------------------------------------------------------------
...
n5_var_α:               mov              r11, 6
                        ...
                        mov              rax, qword ptr [rsp + 424]
                        mov              qword ptr [rsp + 264], rax;          jmp   n6_lit_integer_α
#-----------------------------------------------------------------------------------------------------------------------
n6_lit_integer_α:       mov              r11, 7
                        mov              qword ptr [rsp + 272], 3             # result
                        mov              rax, qword ptr [rip + .Lx24_0]
                        mov              qword ptr [rsp + 280], rax;          jmp   n7_call_builtin_icon_α
.Lx24_0:                .quad            5
#-----------------------------------------------------------------------------------------------------------------------
...
n8_var_α:               mov              r11, 9
                        ...
                        mov              rax, qword ptr [rsp + 424]
                        mov              qword ptr [rsp + 168], rax;          jmp   n9_lit_integer_α
#-----------------------------------------------------------------------------------------------------------------------
n9_lit_integer_α:       mov              r11, 10
                        mov              qword ptr [rsp + 176], 3             # result
                        mov              rax, qword ptr [rip + .Lx29_0]
                        mov              qword ptr [rsp + 184], rax;          jmp   n10_call_builtin_icon_α
.Lx29_0:                .quad            6
#-----------------------------------------------------------------------------------------------------------------------
...
n11_var_α:              mov              r11, 12
                        ...
                        mov              rax, qword ptr [rsp + 424]
                        mov              qword ptr [rsp + 88], rax;           jmp   n12_iterate_α
#-----------------------------------------------------------------------------------------------------------------------
n12_iterate_α:          mov              r11, 13
                        mov              qword ptr [rsp + 64], 0
.Lx35_0:                mov              rdi, qword ptr [rsp + 80]
...
n12_iterate_β:          mov              r11, 13
                        inc              qword ptr [rsp + 64];                jmp   .Lx35_0
#-----------------------------------------------------------------------------------------------------------------------
...
.Lrkfn37:               .string          "write"
                        ...
                        cmp              al, 104;                             je    n12_iterate_β
                        mov              r8,  qword ptr [rip + rtccb+40]
                        mov              r9,  qword ptr [rip + rtccb+48]
                        mov              r10, qword ptr [rip + rtccb+56]
                        mov              r11, qword ptr [rip + rtccb+64];     jmp   n12_iterate_β
n13_call_builtin_icon_β:
                        mov              r11, 14;                             jmp   n12_iterate_β
#-----------------------------------------------------------------------------------------------------------------------
main_β:
                                                                              jmp   main_ω
#-----------------------------------------------------------------------------------------------------------------------
