...
n6_iterate_β:           mov              r11, 7
                        inc              qword ptr [rsp + 6256];              jmp   .Lx289_0
#-----------------------------------------------------------------------------------------------------------------------
...
n10_iterate_β:          mov              r11, 11
                        inc              qword ptr [rsp + 6128];              jmp   .Lx296_0
#-----------------------------------------------------------------------------------------------------------------------
...
.Lrkfn298:              .string          "write"
                        ...
                        cmp              al, 104;                             je    n10_iterate_β
                        mov              r8,  qword ptr [rip + rtccb+40]
                        mov              r9,  qword ptr [rip + rtccb+48]
                        mov              r10, qword ptr [rip + rtccb+56]
                        mov              r11, qword ptr [rip + rtccb+64];     jmp   n10_iterate_β
n11_call_builtin_icon_β:
                        mov              r11, 12;                             jmp   n10_iterate_β
#-----------------------------------------------------------------------------------------------------------------------
...
n14_to_β:               mov              r11, 15
                        inc              qword ptr [rsp + 5680];              jmp   .Lx302_0
#-----------------------------------------------------------------------------------------------------------------------
...
n16_bound_α:            mov              r11, 17
                        mov              qword ptr [rsp + 5728], rsp;         jmp   n17_lit_string_α
#-----------------------------------------------------------------------------------------------------------------------
...
n20_disjunction_af:     mov              r11, 21
                        add              dword ptr [rsp + 5936], 1
                        mov              eax, dword ptr [rsp + 5936]
                        cmp              eax, 1;                              je    n22_lit_string_α
                        add              rsp, 16;                             jmp   n27_unmark_α
#-----------------------------------------------------------------------------------------------------------------------
...
.Lrkfn313:              .string          "write"
                        ...
                        mov              r9,  qword ptr [rip + rtccb+48]
                        mov              r10, qword ptr [rip + rtccb+56]
                        mov              r11, qword ptr [rip + rtccb+64];     jmp   n27_unmark_α
...
n22_lit_string_β:       mov              r11, 23;                             jmp   n20_disjunction_af
...
n23_var_ref_β:          mov              r11, 24;                             jmp   n20_disjunction_af
#-----------------------------------------------------------------------------------------------------------------------
...
n26_deref_β:            mov              r11, 27;                             jmp   n20_disjunction_af
#-----------------------------------------------------------------------------------------------------------------------
n27_unmark_α:           mov              r11, 28
                        mov              rsp, qword ptr [rsp + 5728];         jmp   n14_to_β
#-----------------------------------------------------------------------------------------------------------------------
...
#-----------------------------------------------------------------------------------------------------------------------
n31_to_by_α:            mov              r11, 32
                        mov              rdi, qword ptr [rsp + 5312]
...
#-----------------------------------------------------------------------------------------------------------------------
n33_bound_α:            mov              r11, 34
                        mov              qword ptr [rsp + 5360], rsp;         jmp   n34_lit_string_α
#-----------------------------------------------------------------------------------------------------------------------
...
.Lrkfn338:              .string          "write"
                        ...
                        mov              r9,  qword ptr [rip + rtccb+48]
                        mov              r10, qword ptr [rip + rtccb+56]
                        mov              r11, qword ptr [rip + rtccb+64];     jmp   n44_unmark_α
...
n40_var_ref_β:          mov              r11, 41;                             jmp   n37_disjunction_af
#-----------------------------------------------------------------------------------------------------------------------
...
n43_deref_β:            mov              r11, 44;                             jmp   n37_disjunction_af
#-----------------------------------------------------------------------------------------------------------------------
n44_unmark_α:           mov              r11, 45
                        mov              rsp, qword ptr [rsp + 5360];         jmp   n31_to_by_β
#-----------------------------------------------------------------------------------------------------------------------
...
n47_to_β:               mov              r11, 48
                        inc              qword ptr [rsp + 4928];              jmp   .Lx351_0
#-----------------------------------------------------------------------------------------------------------------------
...
#-----------------------------------------------------------------------------------------------------------------------
n49_bound_α:            mov              r11, 50
                        mov              qword ptr [rsp + 4976], rsp;         jmp   n50_lit_string_α
#-----------------------------------------------------------------------------------------------------------------------
...
n53_disjunction_af:     mov              r11, 54
                        add              dword ptr [rsp + 5184], 1
                        mov              eax, dword ptr [rsp + 5184]
                        cmp              eax, 1;                              je    n55_lit_string_α
                        add              rsp, 16;                             jmp   n60_unmark_α
#-----------------------------------------------------------------------------------------------------------------------
...
.Lrkfn362:              .string          "write"
                        ...
                        mov              r9,  qword ptr [rip + rtccb+48]
                        mov              r10, qword ptr [rip + rtccb+56]
                        mov              r11, qword ptr [rip + rtccb+64];     jmp   n60_unmark_α
...
n56_var_β:              mov              r11, 57;                             jmp   n53_disjunction_af
#-----------------------------------------------------------------------------------------------------------------------
...
n59_subscript_β:        mov              r11, 60;                             jmp   n53_disjunction_af
#-----------------------------------------------------------------------------------------------------------------------
n60_unmark_α:           mov              r11, 61
                        mov              rsp, qword ptr [rsp + 4976];         jmp   n47_to_β
#-----------------------------------------------------------------------------------------------------------------------
...
n63_to_β:               mov              r11, 64
                        inc              qword ptr [rsp + 4544];              jmp   .Lx375_0
#-----------------------------------------------------------------------------------------------------------------------
...
#-----------------------------------------------------------------------------------------------------------------------
n65_bound_α:            mov              r11, 66
                        mov              qword ptr [rsp + 4592], rsp;         jmp   n66_lit_string_α
#-----------------------------------------------------------------------------------------------------------------------
...
n69_disjunction_β:      mov              r11, 70
                        mov              eax, dword ptr [rsp + 4800]
                        cmp              eax, 0;                              je    n69_disjunction_af
                                                                              jmp   n69_disjunction_af
n69_disjunction_af:     mov              r11, 70
                        add              dword ptr [rsp + 4800], 1
                        mov              eax, dword ptr [rsp + 4800]
                        cmp              eax, 1;                              je    n71_lit_string_α
                        add              rsp, 16;                             jmp   n77_unmark_α
#-----------------------------------------------------------------------------------------------------------------------
...
.Lrkfn386:              .string          "write"
                        ...
                        cmp              al, 104;                             je    n69_disjunction_β
                        mov              r8,  qword ptr [rip + rtccb+40]
                        mov              r9,  qword ptr [rip + rtccb+48]
                        mov              r10, qword ptr [rip + rtccb+56]
                        mov              r11, qword ptr [rip + rtccb+64];     jmp   n77_unmark_α
n70_call_builtin_icon_β:
                        mov              r11, 71;                             jmp   n69_disjunction_β
#-----------------------------------------------------------------------------------------------------------------------
...
n71_lit_string_β:       mov              r11, 72;                             jmp   n69_disjunction_af
.Lx387_0:               .quad            .Lx387_0_s
.Lx387_0_s:             .string          "--"
#-----------------------------------------------------------------------------------------------------------------------
n72_var_α:              mov              r11, 73
                        mov              rax, qword ptr [rsp + 6320]
                        mov              qword ptr [rsp + 4832], rax
                        mov              rax, qword ptr [rsp + 6328]
                        mov              qword ptr [rsp + 4840], rax;         jmp   n73_lit_integer_α
n72_var_β:              mov              r11, 73;                             jmp   n69_disjunction_af
#-----------------------------------------------------------------------------------------------------------------------
n73_lit_integer_α:      mov              r11, 74
                        mov              qword ptr [rsp + 4848], 3            # result
...
.Lx393_0:               mov              rdi, qword ptr [rsp + 4848]
                        ...
                        mov              qword ptr [rip + rtccb+64], r11
                        call             rt_add@PLT
                        cmp              al, 104;                             je    n69_disjunction_af
...
n76_subscript_β:        mov              r11, 77;                             jmp   n69_disjunction_af
#-----------------------------------------------------------------------------------------------------------------------
n77_unmark_α:           mov              r11, 78
                        mov              rsp, qword ptr [rsp + 4592];         jmp   n63_to_β
#-----------------------------------------------------------------------------------------------------------------------
...
n80_to_β:               mov              r11, 81
                        inc              qword ptr [rsp + 4160];              jmp   .Lx400_0
#-----------------------------------------------------------------------------------------------------------------------
...
#-----------------------------------------------------------------------------------------------------------------------
n82_bound_α:            mov              r11, 83
                        mov              qword ptr [rsp + 4208], rsp;         jmp   n83_lit_string_α
#-----------------------------------------------------------------------------------------------------------------------
...
n86_disjunction_β:      mov              r11, 87
                        mov              eax, dword ptr [rsp + 4416]
                        cmp              eax, 0;                              je    n86_disjunction_af
                                                                              jmp   n86_disjunction_af
n86_disjunction_af:     mov              r11, 87
                        add              dword ptr [rsp + 4416], 1
                        mov              eax, dword ptr [rsp + 4416]
                        cmp              eax, 1;                              je    n88_lit_string_α
                        add              rsp, 16;                             jmp   n94_unmark_α
#-----------------------------------------------------------------------------------------------------------------------
...
.Lrkfn411:              .string          "write"
                        ...
                        cmp              al, 104;                             je    n86_disjunction_β
                        mov              r8,  qword ptr [rip + rtccb+40]
                        mov              r9,  qword ptr [rip + rtccb+48]
                        mov              r10, qword ptr [rip + rtccb+56]
                        mov              r11, qword ptr [rip + rtccb+64];     jmp   n94_unmark_α
n87_call_builtin_icon_β:
                        mov              r11, 88;                             jmp   n86_disjunction_β
#-----------------------------------------------------------------------------------------------------------------------
...
n88_lit_string_β:       mov              r11, 89;                             jmp   n86_disjunction_af
...
n89_var_β:              mov              r11, 90;                             jmp   n86_disjunction_af
#-----------------------------------------------------------------------------------------------------------------------
...
#-----------------------------------------------------------------------------------------------------------------------
n92_binop_α:            mov              r11, 93
                        mov              eax, 3
                        mov              ecx, dword ptr [rsp + 6336]
                        mov              edx, eax
                        and              edx, ecx
                        cmp              dl, 3;                               jne   .Lx418_2
                        mov              rax, 3
                        mov              rdx, qword ptr [rsp + 6344]
                        sub              rax, rdx
...
.Lx418_0:               mov              rdi, qword ptr [rsp + 4464]
                        ...
                        mov              qword ptr [rip + rtccb+64], r11
                        call             rt_sub@PLT
                        cmp              al, 104;                             je    n86_disjunction_af
                        mov              qword ptr [rsp + 4496], rax
                        mov              qword ptr [rsp + 4504], rdx
                        mov              r8,  qword ptr [rip + rtccb+40]
                        mov              r9,  qword ptr [rip + rtccb+48]
                        mov              r10, qword ptr [rip + rtccb+56]
                        mov              r11, qword ptr [rip + rtccb+64];     jmp   n93_subscript_α
#-----------------------------------------------------------------------------------------------------------------------
...
n93_subscript_β:        mov              r11, 94;                             jmp   n86_disjunction_af
#-----------------------------------------------------------------------------------------------------------------------
n94_unmark_α:           mov              r11, 95
                        mov              rsp, qword ptr [rsp + 4208];         jmp   n80_to_β
#-----------------------------------------------------------------------------------------------------------------------
...
n96_iterate_β:          mov              r11, 97
                        inc              qword ptr [rsp + 4080];              jmp   .Lx425_0
#-----------------------------------------------------------------------------------------------------------------------
...
n103_iterate_β:         mov              r11, 104
                        inc              qword ptr [rsp + 3904];              jmp   .Lx436_0
#-----------------------------------------------------------------------------------------------------------------------
...
n105_assign_var_α:      mov              r11, 106
                        ...
                        mov              r10, qword ptr [rip + rtccb+56]
                        mov              r11, qword ptr [rip + rtccb+64]
                        cmp              al, 104;                             je    n106_lit_string_α
...
.Lrkfn443:              .string          "write"
                        ...
                        cmp              al, 104;                             je    n109_lit_integer_α
                        mov              r8,  qword ptr [rip + rtccb+40]
                        mov              r9,  qword ptr [rip + rtccb+48]
                        mov              r10, qword ptr [rip + rtccb+56]
                        mov              r11, qword ptr [rip + rtccb+64];     jmp   n109_lit_integer_α
n108_call_builtin_icon_β:
                        mov              r11, 109;                            jmp   n109_lit_integer_α
#-----------------------------------------------------------------------------------------------------------------------
...
n111_to_β:              mov              r11, 112
                        inc              qword ptr [rsp + 3216];              jmp   .Lx447_0
#-----------------------------------------------------------------------------------------------------------------------
...
#-----------------------------------------------------------------------------------------------------------------------
n113_bound_α:           mov              r11, 114
                        mov              qword ptr [rsp + 3264], rsp;         jmp   n114_lit_string_α
#-----------------------------------------------------------------------------------------------------------------------
...
n116_disjunction_β:     mov              r11, 117
                        mov              eax, dword ptr [rsp + 3344]
                        cmp              eax, 0;                              je    n135_unmark_α
                                                                              jmp   n135_unmark_α
n116_disjunction_af:    mov              r11, 117
                        add              dword ptr [rsp + 3344], 1
                        mov              eax, dword ptr [rsp + 3344]
                        cmp              eax, 1;                              je    n118_lit_string_α
                        add              rsp, 16;                             jmp   n135_unmark_α
#-----------------------------------------------------------------------------------------------------------------------
n117_conjunction_α:     mov              r11, 118
...
n117_conjunction_β:     mov              r11, 118;                            jmp   n135_unmark_α
#-----------------------------------------------------------------------------------------------------------------------
...
n118_lit_string_β:      mov              r11, 119;                            jmp   n135_unmark_α
.Lx456_0:               .quad            .Lx456_0_s
.Lx456_0_s:             .string          "J "
#-----------------------------------------------------------------------------------------------------------------------
n119_var_α:             mov              r11, 120
                        mov              rax, qword ptr [rsp + 6336]
...
.Lrkfn461:              .string          "write"
                        ...
                        cmp              al, 104;                             je    n135_unmark_α
                        mov              r8,  qword ptr [rip + rtccb+40]
                        mov              r9,  qword ptr [rip + rtccb+48]
                        mov              r10, qword ptr [rip + rtccb+56]
                        mov              r11, qword ptr [rip + rtccb+64];     jmp   n116_disjunction_as
n121_call_builtin_icon_β:
                        mov              r11, 122;                            jmp   n135_unmark_α
#-----------------------------------------------------------------------------------------------------------------------
...
n122_var_ref_β:         mov              r11, 123;                            jmp   n116_disjunction_af
#-----------------------------------------------------------------------------------------------------------------------
...
n124_subscript_α:       mov              r11, 125
                        ...
                        mov              r10, qword ptr [rip + rtccb+56]
                        mov              r11, qword ptr [rip + rtccb+64]
                        cmp              al, 104;                             je    n116_disjunction_af
...
n134_call_builtin_icon_β:
                        mov              r11, 135;                            jmp   n135_unmark_α
#-----------------------------------------------------------------------------------------------------------------------
n135_unmark_α:          mov              r11, 136
                        mov              rsp, qword ptr [rsp + 3264];         jmp   n111_to_β
#-----------------------------------------------------------------------------------------------------------------------
...
n138_to_β:              mov              r11, 139
                        inc              qword ptr [rsp + 2480];              jmp   .Lx487_0
#-----------------------------------------------------------------------------------------------------------------------
...
#-----------------------------------------------------------------------------------------------------------------------
n140_bound_α:           mov              r11, 141
                        mov              qword ptr [rsp + 2528], rsp;         jmp   n141_lit_integer_α
#-----------------------------------------------------------------------------------------------------------------------
...
n143_to_β:              mov              r11, 144
                        inc              qword ptr [rsp + 2592];              jmp   .Lx494_0
#-----------------------------------------------------------------------------------------------------------------------
...
#-----------------------------------------------------------------------------------------------------------------------
n145_bound_α:           mov              r11, 146
                        mov              qword ptr [rsp + 2640], rsp;         jmp   n146_lit_string_α
#-----------------------------------------------------------------------------------------------------------------------
...
.Lrkfn508:              .string          "writes"
                        ...
                        mov              r9,  qword ptr [rip + rtccb+48]
                        mov              r10, qword ptr [rip + rtccb+56]
                        mov              r11, qword ptr [rip + rtccb+64];     jmp   n154_disjunction_α
n153_call_builtin_icon_β:
                        mov              r11, 154;                            jmp   n154_disjunction_α
#-----------------------------------------------------------------------------------------------------------------------
...
n154_disjunction_as:    mov              r11, 155
...
n154_disjunction_β:     mov              r11, 155
                        mov              eax, dword ptr [rsp + 2720]
                        cmp              eax, 0;                              je    n167_unmark_α
                                                                              jmp   n167_unmark_α
n154_disjunction_af:    mov              r11, 155
                        add              dword ptr [rsp + 2720], 1
                        mov              eax, dword ptr [rsp + 2720]
                        cmp              eax, 1;                              je    n156_var_α
                        add              rsp, 16;                             jmp   n167_unmark_α
#-----------------------------------------------------------------------------------------------------------------------
n155_conjunction_α:     mov              r11, 156
                        mov              rax, qword ptr [rsp + 2704]
                        mov              qword ptr [rsp + 2688], rax
                        mov              rax, qword ptr [rsp + 2712]
                        mov              qword ptr [rsp + 2696], rax;         jmp   n167_unmark_α
n155_conjunction_β:     mov              r11, 156;                            jmp   n167_unmark_α
#-----------------------------------------------------------------------------------------------------------------------
n156_var_α:             mov              r11, 157
                        mov              rax, qword ptr [rsp + 6320]
                        mov              qword ptr [rsp + 2960], rax
                        mov              rax, qword ptr [rsp + 6328]
                        mov              qword ptr [rsp + 2968], rax;         jmp   n157_lit_string_α
n156_var_β:             mov              r11, 157;                            jmp   n167_unmark_α
#-----------------------------------------------------------------------------------------------------------------------
...
.Lrkfn516:              .string          "write"
                        ...
                        mov              r9,  qword ptr [rip + rtccb+48]
                        mov              r10, qword ptr [rip + rtccb+56]
                        mov              r11, qword ptr [rip + rtccb+64];     jmp   n154_disjunction_as
n158_call_builtin_icon_β:
                        mov              r11, 159;                            jmp   n167_unmark_α
#-----------------------------------------------------------------------------------------------------------------------
...
n159_var_ref_β:         mov              r11, 160;                            jmp   n154_disjunction_af
#-----------------------------------------------------------------------------------------------------------------------
n160_var_α:             mov              r11, 161
                        mov              rax, qword ptr [rsp + 6336]
...
n166_call_builtin_icon_β:
                        mov              r11, 167;                            jmp   n167_unmark_α
#-----------------------------------------------------------------------------------------------------------------------
n167_unmark_α:          mov              r11, 168
                        mov              rsp, qword ptr [rsp + 2640];         jmp   n143_to_β
#-----------------------------------------------------------------------------------------------------------------------
n168_unmark_α:          mov              r11, 169
                        mov              rsp, qword ptr [rsp + 2528];         jmp   n138_to_β
#-----------------------------------------------------------------------------------------------------------------------
...
n171_to_β:              mov              r11, 172
                        inc              qword ptr [rsp + 1520];              jmp   .Lx537_0
#-----------------------------------------------------------------------------------------------------------------------
...
n176_to_β:              mov              r11, 177
                        inc              qword ptr [rsp + 1632];              jmp   .Lx544_0
#-----------------------------------------------------------------------------------------------------------------------
...
#-----------------------------------------------------------------------------------------------------------------------
n178_bound_α:           mov              r11, 179
                        mov              qword ptr [rsp + 1680], rsp;         jmp   n179_lit_integer_α
#-----------------------------------------------------------------------------------------------------------------------
...
n181_to_β:              mov              r11, 182
                        inc              qword ptr [rsp + 1744];              jmp   .Lx551_0
#-----------------------------------------------------------------------------------------------------------------------
...
#-----------------------------------------------------------------------------------------------------------------------
n183_bound_α:           mov              r11, 184
                        mov              qword ptr [rsp + 1792], rsp;         jmp   n184_lit_string_α
#-----------------------------------------------------------------------------------------------------------------------
...
.Lrkfn568:              .string          "writes"
                        ...
                        cmp              al, 104;                             je    n194_disjunction_α
                        mov              r8,  qword ptr [rip + rtccb+40]
                        mov              r9,  qword ptr [rip + rtccb+48]
                        mov              r10, qword ptr [rip + rtccb+56]
                        mov              r11, qword ptr [rip + rtccb+64];     jmp   n194_disjunction_α
n193_call_builtin_icon_β:
                        mov              r11, 194;                            jmp   n194_disjunction_α
#-----------------------------------------------------------------------------------------------------------------------
n194_disjunction_α:     sub              rsp, 16
                        mov              r11, 195
                        mov              qword ptr [rsp + 0], 0
                        mov              qword ptr [rsp + 8], 0
                        mov              dword ptr [rsp + 1872], 0;           jmp   n199_var_ref_α
n194_disjunction_as:    mov              r11, 195
                        mov              eax, dword ptr [rsp + 1872]
                        cmp              eax, 0;                              jne   .Lx570_0
                        mov              rax, qword ptr [rsp + 1888]
                        mov              qword ptr [rsp + 0], rax
                        mov              rax, qword ptr [rsp + 1896]
                        mov              qword ptr [rsp + 8], rax;            jmp   n195_conjunction_α
...
n194_disjunction_β:     mov              r11, 195
                        mov              eax, dword ptr [rsp + 1872]
                        cmp              eax, 0;                              je    n210_unmark_α
                                                                              jmp   n210_unmark_α
n194_disjunction_af:    mov              r11, 195
                        add              dword ptr [rsp + 1872], 1
                        mov              eax, dword ptr [rsp + 1872]
                        cmp              eax, 1;                              je    n196_var_α
                        add              rsp, 16;                             jmp   n210_unmark_α
#-----------------------------------------------------------------------------------------------------------------------
n195_conjunction_α:     mov              r11, 196
                        mov              rax, qword ptr [rsp + 1856]
                        mov              qword ptr [rsp + 1840], rax
                        mov              rax, qword ptr [rsp + 1864]
                        mov              qword ptr [rsp + 1848], rax;         jmp   n210_unmark_α
n195_conjunction_β:     mov              r11, 196;                            jmp   n210_unmark_α
#-----------------------------------------------------------------------------------------------------------------------
n196_var_α:             mov              r11, 197
                        mov              rax, qword ptr [rsp + 6320]
                        mov              qword ptr [rsp + 2160], rax
                        mov              rax, qword ptr [rsp + 6328]
                        mov              qword ptr [rsp + 2168], rax;         jmp   n197_lit_string_α
n196_var_β:             mov              r11, 197;                            jmp   n210_unmark_α
#-----------------------------------------------------------------------------------------------------------------------
...
.Lrkfn576:              .string          "write"
                        ...
                        cmp              al, 104;                             je    n210_unmark_α
                        mov              r8,  qword ptr [rip + rtccb+40]
                        mov              r9,  qword ptr [rip + rtccb+48]
                        mov              r10, qword ptr [rip + rtccb+56]
                        mov              r11, qword ptr [rip + rtccb+64];     jmp   n194_disjunction_as
n198_call_builtin_icon_β:
                        mov              r11, 199;                            jmp   n210_unmark_α
#-----------------------------------------------------------------------------------------------------------------------
...
n199_var_ref_β:         mov              r11, 200;                            jmp   n194_disjunction_af
#-----------------------------------------------------------------------------------------------------------------------
n200_var_α:             mov              r11, 201
                        mov              rax, qword ptr [rsp + 6336]
                        mov              qword ptr [rsp + 2000], rax
                        mov              rax, qword ptr [rsp + 6344]
                        mov              qword ptr [rsp + 2008], rax;         jmp   n201_var_α
#-----------------------------------------------------------------------------------------------------------------------
n201_var_α:             mov              r11, 202
                        mov              rax, qword ptr [rsp + 6352]
                        mov              qword ptr [rsp + 2016], rax
                        mov              rax, qword ptr [rsp + 6360]
                        mov              qword ptr [rsp + 2024], rax;         jmp   n202_subscript_α
#-----------------------------------------------------------------------------------------------------------------------
n202_subscript_α:       mov              r11, 203
...
n209_call_builtin_icon_β:
                        mov              r11, 210;                            jmp   n210_unmark_α
#-----------------------------------------------------------------------------------------------------------------------
n210_unmark_α:          mov              r11, 211
                        mov              rsp, qword ptr [rsp + 1792];         jmp   n181_to_β
#-----------------------------------------------------------------------------------------------------------------------
n211_unmark_α:          mov              r11, 212
                        mov              rsp, qword ptr [rsp + 1680];         jmp   n176_to_β
#-----------------------------------------------------------------------------------------------------------------------
n212_unmark_α:          mov              r11, 213
                        mov              rsp, qword ptr [rsp + 1568];         jmp   n171_to_β
#-----------------------------------------------------------------------------------------------------------------------
...
n216_iterate_β:         mov              r11, 217
                        inc              qword ptr [rsp + 1264];              jmp   .Lx605_0
#-----------------------------------------------------------------------------------------------------------------------
...
.Lx606_0_s:             .string          "-"
#-----------------------------------------------------------------------------------------------------------------------
n218_rev_assign_var_α:  mov              r11, 219
                        ...
                        mov              r10, qword ptr [rip + rtccb+56]
                        mov              r11, qword ptr [rip + rtccb+64]
                        cmp              al, 104;                             je    n216_iterate_β
                        mov              qword ptr [rsp + 1296], rax
                        mov              qword ptr [rsp + 1304], rdx;         jmp   n219_bound_α
n218_rev_assign_var_β:  mov              r11, 219
                        mov              rdi, qword ptr [rsp + 1248]
                        mov              rsi, qword ptr [rsp + 1256]
                        ...
                        mov              r9,  qword ptr [rip + rtccb+48]
                        mov              r10, qword ptr [rip + rtccb+56]
                        mov              r11, qword ptr [rip + rtccb+64];     jmp   n216_iterate_β
#-----------------------------------------------------------------------------------------------------------------------
n219_bound_α:           mov              r11, 220
                        mov              qword ptr [rsp + 1344], rsp;         jmp   n220_lit_string_α
#-----------------------------------------------------------------------------------------------------------------------
n220_lit_string_α:      mov              r11, 221
...
n222_call_builtin_icon_β:
                        mov              r11, 223;                            jmp   n223_unmark_α
#-----------------------------------------------------------------------------------------------------------------------
n223_unmark_α:          mov              r11, 224
                        mov              rsp, qword ptr [rsp + 1344];         jmp   n218_rev_assign_var_β
#-----------------------------------------------------------------------------------------------------------------------
...
n227_to_β:              mov              r11, 228
                        inc              qword ptr [rsp + 992];               jmp   .Lx622_0
#-----------------------------------------------------------------------------------------------------------------------
n228_subscript_α:       mov              r11, 229
...
.Lx624_0_s:             .string          "-"
#-----------------------------------------------------------------------------------------------------------------------
n230_rev_assign_var_α:  mov              r11, 231
...
n230_rev_assign_var_β:  mov              r11, 231
                        mov              rdi, qword ptr [rsp + 1040]
                        mov              rsi, qword ptr [rsp + 1048]
                        ...
                        mov              r9,  qword ptr [rip + rtccb+48]
                        mov              r10, qword ptr [rip + rtccb+56]
                        mov              r11, qword ptr [rip + rtccb+64];     jmp   n227_to_β
#-----------------------------------------------------------------------------------------------------------------------
n231_bound_α:           mov              r11, 232
                        mov              qword ptr [rsp + 1104], rsp;         jmp   n232_lit_string_α
#-----------------------------------------------------------------------------------------------------------------------
n232_lit_string_α:      mov              r11, 233
...
.Lrkfn632:              .string          "write"
                        ...
                        mov              r9,  qword ptr [rip + rtccb+48]
                        mov              r10, qword ptr [rip + rtccb+56]
                        mov              r11, qword ptr [rip + rtccb+64];     jmp   n235_unmark_α
n234_call_builtin_icon_β:
                        mov              r11, 235;                            jmp   n235_unmark_α
#-----------------------------------------------------------------------------------------------------------------------
n235_unmark_α:          mov              r11, 236
                        mov              rsp, qword ptr [rsp + 1104];         jmp   n230_rev_assign_var_β
#-----------------------------------------------------------------------------------------------------------------------
n236_var_ref_α:         mov              r11, 237
                        mov              rax, 4294967336
                        lea              rdx, [rsp + 6320]
...
n239_to_β:              mov              r11, 240
                        inc              qword ptr [rsp + 688];               jmp   .Lx640_0
#-----------------------------------------------------------------------------------------------------------------------
...
.Lx642_0:               mov              rdi, qword ptr [rsp + 672]
                        ...
                        mov              qword ptr [rip + rtccb+64], r11
                        call             rt_add@PLT
                        cmp              al, 104;                             je    n239_to_β
                        mov              qword ptr [rsp + 752], rax
                        mov              qword ptr [rsp + 760], rdx
                        mov              r8,  qword ptr [rip + rtccb+40]
                        mov              r9,  qword ptr [rip + rtccb+48]
                        mov              r10, qword ptr [rip + rtccb+56]
                        mov              r11, qword ptr [rip + rtccb+64];     jmp   n242_subscript_α
#-----------------------------------------------------------------------------------------------------------------------
n242_subscript_α:       mov              r11, 243
...
.Lx644_0_s:             .string          "--"
#-----------------------------------------------------------------------------------------------------------------------
n244_rev_assign_var_α:  mov              r11, 245
...
n244_rev_assign_var_β:  mov              r11, 245
                        mov              rdi, qword ptr [rsp + 640]
                        mov              rsi, qword ptr [rsp + 648]
                        ...
                        mov              r9,  qword ptr [rip + rtccb+48]
                        mov              r10, qword ptr [rip + rtccb+56]
                        mov              r11, qword ptr [rip + rtccb+64];     jmp   n239_to_β
#-----------------------------------------------------------------------------------------------------------------------
n245_bound_α:           mov              r11, 246
                        mov              qword ptr [rsp + 816], rsp;          jmp   n246_lit_string_α
#-----------------------------------------------------------------------------------------------------------------------
n246_lit_string_α:      mov              r11, 247
...
.Lrkfn652:              .string          "write"
                        ...
                        cmp              al, 104;                             je    n249_unmark_α
                        mov              r8,  qword ptr [rip + rtccb+40]
                        mov              r9,  qword ptr [rip + rtccb+48]
                        mov              r10, qword ptr [rip + rtccb+56]
                        mov              r11, qword ptr [rip + rtccb+64];     jmp   n249_unmark_α
n248_call_builtin_icon_β:
                        mov              r11, 249;                            jmp   n249_unmark_α
#-----------------------------------------------------------------------------------------------------------------------
n249_unmark_α:          mov              r11, 250
                        mov              rsp, qword ptr [rsp + 816];          jmp   n244_rev_assign_var_β
#-----------------------------------------------------------------------------------------------------------------------
n250_lit_string_α:      mov              r11, 251
...
#-----------------------------------------------------------------------------------------------------------------------
n252_var_ref_α:         mov              r11, 253
                        mov              rax, 4294967336
                        lea              rdx, [rsp + 6320]
                        mov              qword ptr [rsp + 368], rax
                        mov              qword ptr [rsp + 376], rdx;          jmp   n253_lit_integer_α
#-----------------------------------------------------------------------------------------------------------------------
n253_lit_integer_α:     mov              r11, 254
...
n255_subscript_α:       mov              r11, 256
                        ...
                        mov              r10, qword ptr [rip + rtccb+56]
                        mov              r11, qword ptr [rip + rtccb+64]
                        cmp              al, 104;                             je    n264_lit_string_α
                        mov              qword ptr [rsp + 352], rax
                        mov              qword ptr [rsp + 360], rdx;          jmp   n256_lit_string_α
#-----------------------------------------------------------------------------------------------------------------------
n256_lit_string_α:      mov              r11, 257
...
n257_iterate_β:         mov              r11, 258
                        inc              qword ptr [rsp + 448];               jmp   .Lx664_0
#-----------------------------------------------------------------------------------------------------------------------
n258_assign_var_α:      mov              r11, 259
...
#-----------------------------------------------------------------------------------------------------------------------
n259_bound_α:           mov              r11, 260
                        mov              qword ptr [rsp + 480], rsp;          jmp   n260_lit_string_α
#-----------------------------------------------------------------------------------------------------------------------
...
.Lrkfn672:              .string          "write"
                        ...
                        cmp              al, 104;                             je    n263_unmark_α
                        mov              r8,  qword ptr [rip + rtccb+40]
                        mov              r9,  qword ptr [rip + rtccb+48]
                        mov              r10, qword ptr [rip + rtccb+56]
                        mov              r11, qword ptr [rip + rtccb+64];     jmp   n263_unmark_α
n262_call_builtin_icon_β:
                        mov              r11, 263;                            jmp   n263_unmark_α
#-----------------------------------------------------------------------------------------------------------------------
n263_unmark_α:          mov              r11, 264
                        mov              rsp, qword ptr [rsp + 480];          jmp   n257_iterate_β
#-----------------------------------------------------------------------------------------------------------------------
n264_lit_string_α:      mov              r11, 265
...
n271_iterate_β:         mov              r11, 272
                        inc              qword ptr [rsp + 96];                jmp   .Lx684_0
#-----------------------------------------------------------------------------------------------------------------------
n272_assign_var_α:      mov              r11, 273
...
#-----------------------------------------------------------------------------------------------------------------------
n273_bound_α:           mov              r11, 274
                        mov              qword ptr [rsp + 128], rsp;          jmp   n274_lit_string_α
#-----------------------------------------------------------------------------------------------------------------------
n274_lit_string_α:      mov              r11, 275
...
n276_call_builtin_icon_β:
                        mov              r11, 277;                            jmp   n277_lit_string_α
#-----------------------------------------------------------------------------------------------------------------------
n277_lit_string_α:      mov              r11, 278
...
#-----------------------------------------------------------------------------------------------------------------------
n279_conjunction_α:     mov              r11, 280
                        mov              rax, qword ptr [rsp + 192]
                        mov              qword ptr [rsp + 176], rax
                        mov              rax, qword ptr [rsp + 200]
                        mov              qword ptr [rsp + 184], rax;          jmp   n280_unmark_α
n279_conjunction_β:     mov              r11, 280;                            jmp   n280_unmark_α
#-----------------------------------------------------------------------------------------------------------------------
n280_unmark_α:          mov              r11, 281
                        mov              rsp, qword ptr [rsp + 128];          jmp   n271_iterate_β
#-----------------------------------------------------------------------------------------------------------------------
main_β:
                                                                              jmp   main_ω
#-----------------------------------------------------------------------------------------------------------------------
