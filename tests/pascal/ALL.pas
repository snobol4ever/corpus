...
{-------------------------------------- 10 ladder__rung05_proc_func_multi_param}
...
{------------------------------------------- 13 ladder__rung01_var_assign_widen}
...
{------------------------------------------- 14 ladder__rung02_arithmetic_unary}
...
{------------------------------------- 17 ladder__rung01_var_assign_multi_group}
...
{------------------------------------- 19 ladder__rung01_var_assign_multi_ident}
...
{---------------------------------------- 20 ladder__rung03_if_while_if_no_else}
...
{------------------------------------- 21 ladder__rung03_if_while_dangling_else}
...
{--------------------------------------- 22 ladder__rung03_if_while_if_compound}
...
{----------------------------------------- 32 ladder__rung02_arithmetic_mod_neg}
...
{---------------------------------------- 33 ladder__rung04_for_repeat_for_zero}
...
{------------------------------------- 34 ladder__rung04_for_repeat_repeat_once}
...
{---------------------------------------- 38 ladder__rung03_if_while_while_zero}
...
{------------------------------------ 39 ladder__rung04_for_repeat_for_compound}
...
{---------------------------------------------- 40 program_procedure_writeln_10}
program varparam;
var k : integer;
...
{----------------------------------------------- 41 program_procedure_writeln_4}
program varparam;
var k : integer;
  procedure bump(var n : integer);
  begin
...
{----------------------------------------------- 42 program_procedure_writeln_6}
program flat;
var x : integer;
  procedure p;
  begin
...
{------------------------------------------ 44 ladder__rung05_proc_func_forward}
...
{----------------------------------------------- 47 program_procedure_writeln_1}
program aliastest;
var a : integer;
...
{----------------------------------------------- 48 program_procedure_writeln_2}
program swaptest;
var a, b : integer;
...
{----------------------------------------------- 49 program_procedure_writeln_3}
program varmix;
var g : integer;
...
{----------------------------------------------- 50 program_procedure_writeln_7}
program aliastest;
var a : integer;
  procedure addto(var x, y : integer);
  begin
...
{----------------------------------------------- 51 program_procedure_writeln_8}
program swaptest;
var a, b : integer;
  procedure swap(var x, y : integer);
  var t : integer;
...
{----------------------------------------------- 52 program_procedure_writeln_9}
program varmix;
var g : integer;
  procedure inc2(var r : integer; d : integer);
  begin
...
{--------------------------------------- 55 program_procedure_writeln_replace_1}
program boolarg;
var i, j: integer;
...
{--------------------------------------- 56 program_procedure_writeln_replace_2}
program boolarg;
var i, j: integer;
procedure show(b: boolean);
begin
...
{----------------------------------------------- 60 program_procedure_writeln_5}
...
{-------------------------------------- 61 ladder__rung04_for_repeat_for_downto}
...
{--------------------------------------------- 66 program_for_writeln_replace_1}
...
{----------------------------------------------- 70 program_procedure_nested_19}
program t;
var glob : integer;
...
{----------------------------------------------------- 75 program_for_writeln_4}
program readnumber(input, output);
{ ISO 7185 6.9.1: read skips spaces and end-of-lines, then takes a signed-integer for an integer variable and a signed-number for a
  real one, and stops at the first character that cannot continue it. }
...
{----------------------------------------------- 76 program_procedure_nested_13}
program t(output);
var x: integer;
...
{----------------------------------------------- 85 program_procedure_nested_22}
program nestvar;
var x: integer;
...
{---------------------------------------- 88 ladder__rung05_proc_func_no_params}
...
{----------------------------------------------- 89 program_procedure_nested_11}
program varframe;
var g : integer;
  procedure bump(var n : integer);
  begin
...
{----------------------------------------------- 90 program_procedure_nested_12}
program vartrans;
var g : integer;
...
{----------------------------------------------- 91 program_procedure_nested_18}
program nestedtest;
var g : integer;
  procedure outer;
  var x : integer;
...
{----------------------------------------------- 92 program_procedure_nested_25}
program varframe;
var g : integer;
  procedure bump(var n : integer);
  begin
...
{----------------------------------------------- 93 program_procedure_nested_26}
program vartrans;
var g : integer;
  procedure inner(var z : integer);
  begin
...
{----------------------------------------------- 96 program_procedure_nested_20}
program nestrec;
var g : integer;
...
{----------------------------------------------- 98 program_procedure_nested_17}
program nestcount;
var g : integer;
  procedure counter;
  var c : integer;
...
{---------------------------------------------- 101 program_procedure_nested_23}
program nestvar2;
var x: integer;
procedure outer(var a: integer);
  procedure middle;
...
{----------------------------------------------- 102 program_procedure_nested_9}
program nestvar2;
var x: integer;
procedure outer(var a: integer);
  procedure middle;
...
{---------------------------------------------- 103 program_procedure_nested_10}
program nestvar3;
var x, y: integer;
...
{---------------------------------------------- 104 program_procedure_nested_24}
program nestvar3;
var x, y: integer;
procedure swapvals(var a, b: integer);
  procedure doswap;
...
{---------------------------------------------- 105 program_procedure_nested_21}
program nestshadow;
var g : integer;
  procedure outer;
  var x : integer;
...
{----------------------------------------------- 106 program_procedure_nested_7}
program nestshadow;
var g : integer;
  procedure outer;
  var x : integer;
...
{---------------------------------------------- 107 program_procedure_nested_16}
program nest2;
var g : integer;
  procedure a;
  var x : integer;
...
{----------------------------------------------- 108 program_procedure_nested_2}
program nest2;
var g : integer;
  procedure a;
  var x : integer;
...
{----------------------------------------------- 109 program_procedure_nested_1}
program deep5;
var g: integer;
procedure p1;
var a: integer;
...
{---------------------------------------------- 110 program_procedure_nested_15}
program deep5;
var g: integer;
procedure p1;
var a: integer;
...
{---------------------------------------------- 111 program_procedure_nested_14}
...
{---------------------------------------------- 112 program_procedure_record_11}
program t;
...
{----------------------------------------------- 113 program_procedure_record_4}
program t;
type r = record a, b: integer end;
var g: r;
procedure c(var f: r);
...
{-------------------------------------------- 115 program_record_case_replace_2}
program vrec1;
...
{----------------------------------------------- 117 program_procedure_record_7}
program recparam;
...
{---------------------------------------------- 119 program_procedure_record_10}
program t;
type r = record a, b: integer end;
var g: r;
procedure c(var f: r);
...
{----------------------------------------------- 120 program_procedure_record_3}
program t;
type r = record a, b: integer end;
var g: r;
procedure c(var f: r);
...
{-------------------------------------------- 123 program_record_case_replace_4}
program vrec4;
...
{---------------------------------------------- 125 program_procedure_forward_1}
program forward1;
var x: integer;
...
{---------------------------------------------- 126 program_procedure_forward_2}
program forward1;
var x: integer;
procedure second; forward;
procedure first;
...
{----------------------------------------------- 127 program_procedure_record_1}
...
{----------------------------------------------- 128 program_procedure_record_8}
program aggloc2(output);
type rec = record typtr: integer; kind: integer end;
var gattr: rec; depth: integer;
  procedure selector;
...
{-------------------------------------------- 130 program_record_case_replace_3}
program vrec2;
type valu = record case b: boolean of
      true: (ival: integer);
      false: (valp: integer)
...
{-------------------------------------------- 131 program_record_case_replace_1}
...
begin p1 end.
{--------------------------------------------- 134 program_while_goto_replace_1}
program goto2;
label 1, 5;
...
{--------------------------------------------- 135 program_while_goto_replace_2}
program goto2;
label 1, 5;
var i, n, total: integer;
begin
...
{------------------------------------------- 139 program_function_for_replace_1}
(*$c+,d+,l-,t-*)
...
{------------------------------------------- 140 program_function_for_replace_2}
(*$c+,d+,l-,t-*)
(* recursion on the p-machine: fact and fib *)
program recursion(output);
var
...
{----------------------------------------------- 153 program_procedure_record_2}
...
{----------------------------------------------- 154 program_procedure_record_9}
program rec_local_collision;
type rec = record f: integer end;
var g: integer;
procedure inner;
...
{-------------------------------------------- 158 program_case_repeat_replace_1}
...
{-------------------------------------------- 159 program_case_repeat_replace_2}
(* pb40: KNOWN FAIL (session 40) - no .ref on purpose; gate skips it.
   Lowering bug: inside a case arm, an if/else whose ELSE contains a loop,
   followed by a for-loop, wires the for's exit edge to the preceding IR_IF
   marker whose gamma points back at the for-init -> infinite re-init cycle
...
{------------------------------------- 161 program_function_procedure_replace_1}
...
{------------------------------------------- 172 program_array_packed_replace_3}
...
{------------------------------------------- 177 program_array_packed_replace_2}
...
{--------------------------------------------- 182 program_function_procedure_5}
program goto3;
var r: integer;
...
{---------------------------------------------- 183 program_procedure_record_12}
...
{----------------------------------------------- 184 program_procedure_record_5}
program vpfld(output);
type rec = record fld: integer; other: integer end; pr = ^rec;
var p: pr;
  procedure genlabel(var nxtlab: integer); begin nxtlab := 42 end;
...
{------------------------------------------- 190 program_array_packed_replace_1}
...
{--------------------------------------------- 195 program_function_procedure_3}
program char3;
var c : char;
...
{--------------------------------------------- 196 program_function_procedure_8}
program char3;
var c : char;
procedure printc(x : char);
begin
...
{------------------------------------- 226 program_function_procedure_replace_3}
program exits(output);
{ exit leaves the routine it names, or the one it is in: a procedure from inside nested loops, a function with the result it holds or
  the value exit passes, a recursion, and the main program's own statement-part. }
var calls, k: integer;
...
{------------------------------------------- 227 program_record_array_replace_1}
program t;
type dt = (ci, cc);
     r = record case dt of
       ci: (vi: integer);
...
{--------------------------------------------- 228 program_function_procedure_1}
program arr2dtype;
...
{--------------------------------------------- 229 program_function_procedure_6}
program arr2dtype;
type mat = array[0..1, 0..1] of integer;
var m: mat; x: integer;
procedure setmat(var a: mat);
...
{----------------------------------------------- 231 program_procedure_record_6}
program ptr8(output);
type link = ^node; node = record val : integer; next : link end;
var head : link;
...
{------------------------------------- 232 program_function_procedure_replace_2}
...
{--------------------------------------- 233 program_procedure_record_replace_1}
program w1;
type valu = record case b: boolean of
        true: (ival: integer);
        false: (valp: integer)
...
{--------------------------------------- 234 program_procedure_record_replace_2}
program w1;
type valu = record case b: boolean of
        true: (ival: integer);
        false: (valp: integer)
...
{---------------------------------------- 237 program_procedure_array_replace_1}
...
{---------------------------------------- 238 program_procedure_array_replace_6}
{ Regression probe for the in-process binary emitter's forward-reference
  patch table (BB_PATCH_MAX). A single procedure with many statements leaves
  one pending forward-ref patch per statement (the chain jumps to the proc's
  gamma/omega ports, which resolve only at proc end). With the old cap of 512
...
{------------------------------------------ 239 program_record_packed_replace_1}
program mir3(output);
type
...
{---------------------------------------- 242 program_procedure_array_replace_3}
...
{---------------------------------------- 243 program_procedure_array_replace_8}
(* PB-32: minimal programme->block->body chain, no decls
   mirrors pcom token flow for "program x; begin end." 
   token stream: period(progsy-done)->beginsy->endsy->period *)
program pb32(output);
...
{--------------------------------------- 244 program_procedure_array_replace_10}
...
{---------------------------------------- 245 program_procedure_array_replace_5}
(* PB-34: Test complex repeat-until with eof()-like sentinel
   Simulates block()'s outer repeat: until (sy in statbegsys) or done
   where "done" is an integer boolean flag (like eof check)
   AND block's body repeat: until (sy=fsy) or (sy in blockbegsys) or done *)
...
{---------------------------------------- 246 program_procedure_array_replace_4}
...
{---------------------------------------- 247 program_procedure_array_replace_9}
(* PB-33: exact "program x; begin end." chain
   When block_sim is called: sy=beginsy(31)
   insymbol -> sy=endsy(39)
   body: statement_sim(sy=39): 39 not in statbegsys, 39<>ident(0) -> NO-OP
...
{---------------------------------------- 248 program_procedure_array_replace_2}
...
{---------------------------------------- 249 program_procedure_array_replace_7}
(* PB-31: full programme->block->body->statement chain simulation
   mirrors pcom token flow for "program hello; begin writeln(...) end." *)
program pb31(output);
var
...
{--------------------------------------------- 251 program_array_case_replace_1}
