...
OUTPUT = 'world';
OUTPUT = 42;
/*------------------------------------------------------ 101 simple_output_25 */
// A04_concat_assign.sc — concat on right side of assignment
x = 'foo'   'bar';
OUTPUT = x;
/*------------------------------------------------------ 102 simple_output_29 */
// A04_concat_var.sc — concatenate variable with string literal
x = 'hello';
OUTPUT = x   ' world';
/*------------------------------------------------------ 103 simple_output_52 */
// 009 - Assign string to variable, output it
x = 'hello';
OUTPUT = x;
/*------------------------------------------------------ 104 simple_output_53 */
// 010 - Assign integer to variable, output it
n = 42;
OUTPUT = n;
/*------------------------------------------------------ 105 simple_output_57 */
// 014 - Indirect assignment via dollar
$'x' = 'hello';
OUTPUT = x;
/*------------------------------------------------------ 106 simple_output_58 */
// 016 - Direct assignment to OUTPUT special variable
OUTPUT = 'alpha';
OUTPUT = 'beta';
/*------------------------------------------------------ 107 simple_output_91 */
N = 42;
OUTPUT = "value="   N;
OUTPUT = N   " things";
/*------------------------------------------------------ 108 simple_program_5 */
while (EQ(x, 1)) {
    break;
}
/*------------------------------------------------------ 109 simple_program_7 */
while (EQ(x, 1)) {
    continue;
}
/*------------------------------------------------------ 110 simple_assign_38 */
switch (x) {
case 1: y = 10; break;
case 2: y = 20;
}
/*------------------------------------------------------ 111 simple_assign_39 */
switch (x) {
case 1: y = 10;
default: y = 99;
}
/*------------------------------------------------------ 112 simple_assign_41 */
switch (x) {
case 1: y = 10;
case 2: y = 20;
}
...
OUTPUT = 'on='  && wc['on'];
OUTPUT = 'mat=' && wc['mat'];
/*--------------------------------------------------- 249 break_rem_capture_1 */
s = 'key=value';
s ? BREAK('=') . k '=' REM . v;
OUTPUT = k;
OUTPUT = v;
/*------------------------------------ 250 datatype_replace_keyword_replace_1 */
...
/*------------------------------------------- 251 break_len_capture_replace_1 */
...
/*-------------------------------------------- 253 rpos_len_capture_replace_1 */
...
/*------------------------------------------- 255 trim_size_keyword_replace_1 */
...
/*---------------------------------------- 256 trim_replace_keyword_replace_1 */
...
r = setter('d', 'val');
OUTPUT = "[" r "]";
/*------------------------------------------ 281 trim_keyword_replace_1 XFAIL */
...
OUTPUT = gcd(100, 75);
OUTPUT = lcm(4, 6);
/*----------------------------------------- 282 break_len_rem_replace_2 XFAIL */
...
/*----------------------------------------- 283 break_any_pos_replace_1 XFAIL */
