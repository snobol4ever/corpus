...
s ? LEN(2) . t;
OUTPUT = t;
/*----------------------------------------------------- 266 len_imm_capture_1 */
s = 'abc';
s ? LEN(1) $ t LEN(1);
OUTPUT = t;
/*------------------------------------------------------ 267 notany_capture_1 */
s = 'xyz';
s ? NOTANY('y') . t;
OUTPUT = t;
/*--------------------------------------------- 268 replace_keyword_replace_1 */
...
OUTPUT = 'on='  && wc['on'];
OUTPUT = 'mat=' && wc['mat'];
/*----------------------------------------------------- 289 len_rem_capture_1 */
s = 'abcd';
s ? LEN(2) REM . t;
OUTPUT = t;
/*----------------------------------------------------- 290 pos_len_capture_1 */
s = 'hello';
s ? POS(0) LEN(2) . t;
OUTPUT = t;
/*---------------------------------------------------- 291 rpos_len_capture_1 */
s = 'hello';
s ? LEN(3) . t RPOS(2);
OUTPUT = t;
/*--------------------------------------------------- 292 break_rem_capture_1 */
s = 'key=value';
s ? BREAK('=') . k '=' REM . v;
OUTPUT = k;
OUTPUT = v;
/*------------------------------------ 293 datatype_replace_keyword_replace_1 */
...
/*------------------------------------------------- 294 eval_datatype_defer_1 */
x = 1;
d = *x;
OUTPUT = DATATYPE(d);
x = 99;
OUTPUT = EVAL(d);
/*------------------------------------------- 295 break_len_capture_replace_1 */
...
/*-------------------------------------------- 297 rpos_len_capture_replace_1 */
...
/*------------------------------------------- 299 trim_size_keyword_replace_1 */
...
/*---------------------------------------- 300 trim_replace_keyword_replace_1 */
...
/*----------------------------------------- 320 break_any_pos_replace_1 XFAIL */
