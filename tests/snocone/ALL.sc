...
OUTPUT = 'on='  && wc['on'];
OUTPUT = 'mat=' && wc['mat'];
/*--------------------------------------------------- 272 break_rem_capture_1 */
s = 'key=value';
s ? BREAK('=') . k '=' REM . v;
OUTPUT = k;
OUTPUT = v;
/*------------------------------------ 273 datatype_replace_keyword_replace_1 */
...
/*------------------------------------------------- 274 eval_datatype_defer_1 */
x = 1;
d = *x;
OUTPUT = DATATYPE(d);
x = 99;
OUTPUT = EVAL(d);
/*------------------------------------------- 275 break_len_capture_replace_1 */
...
/*-------------------------------------------- 277 rpos_len_capture_replace_1 */
...
/*------------------------------------------- 279 trim_size_keyword_replace_1 */
...
/*---------------------------------------- 280 trim_replace_keyword_replace_1 */
...
/*------------------------------------------ 299 trim_keyword_replace_1 XFAIL */
...
OUTPUT = gcd(100, 75);
OUTPUT = lcm(4, 6);
/*----------------------------------------- 300 break_len_rem_replace_2 XFAIL */
...
/*----------------------------------------- 301 break_any_pos_replace_1 XFAIL */
