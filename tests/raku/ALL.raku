...
#-------------------------------------------------------------------- 107 say_88
 say("  hi   there  ".words); 
#--------------------------------------------------------- 108 simple_program_14
if 7 %% 3 { say "yes" } else { say "no" }
#--------------------------------------------------------- 109 simple_program_15
if 1 + 2 %% 3 { say "yes" } else { say "no" }
#--------------------------------------------------------- 110 simple_program_16
if 6 %% 3 { say "yes" } else { say "no" }
#--------------------------------------------------------- 111 simple_program_17
unless 10 %% 3 { say "notdiv" }
#---------------------------------------------------------- 112 simple_program_2
if 1 < 2 < 9 < 4 { say "bad" } else { say "out" }
#--------------------------------------------------------- 113 simple_program_21
if 0 %% 5 { say "yes" } else { say "no" }
#---------------------------------------------------------- 114 simple_program_3
if 1 < 2 < 3 < 4 { say "yes" }
#--------------------------------------------------------- 115 simple_program_35
print(1,2,3);
#---------------------------------------------------------- 116 simple_program_4
say chr(72) ~ chr(105);
#--------------------------------------------------------- 117 simple_program_42
say [~] (1, 2, 3, 4);
#--------------------------------------------------------- 118 simple_program_51
say sprintf("%08b", 5);
#--------------------------------------------------------- 119 simple_program_52
say sprintf("%.2f", 3.14159);
#--------------------------------------------------------- 120 simple_program_53
say sprintf("%-5d|", 42);
#--------------------------------------------------------- 121 simple_program_54
say sprintf("100%%");
#--------------------------------------------------------- 122 simple_program_55
say sprintf("%03d", 7);
#--------------------------------------------------------- 123 simple_program_68
say 1 ~ "x" x 3 ~ 2;
#--------------------------------------------------------- 124 simple_program_71
say "[" ~ ("q" x -2) ~ "]";
#--------------------------------------------------------- 125 simple_program_73
say 1 ~ "x" x 3 ~ 2;
#--------------------------------------------------------- 126 simple_program_74
say "a" ~ "b" x 2;
#--------------------------------------------------------- 127 simple_program_76
say "[" ~ ("z" x 0) ~ "]";
#---------------------------------------------------------- 128 test_assign_bare
$x = 5;
#----------------------------------------------------------- 129 test_atom_array
@a;
#------------------------------------------------------------ 130 test_atom_hash
%h;
#---------------------------------------------------------- 131 test_atom_scalar
$x;
#------------------------------------------------------- 132 test_bare_ident_arg
say(x);
#------------------------------------------------------------ 133 test_call_expr
say(add(1, 2));
#--------------------------------------------------------- 134 test_print_stderr
print($*STDERR, "error");
#----------------------------------------------------------- 135 test_say_stdout
say($*STDOUT, "hello");
#-------------------------------------------------------------- 136 test_say_var
say $x;
#--------------------------------------------------- 137 test_stmt_ctrl_loop_inf
loop { say "tick"; }
#------------------------------------------------------- 138 test_stmt_pfx_BEGIN
BEGIN { say("setup"); }
#------------------------------------------------------- 139 test_stmt_pfx_CHECK
CHECK { say("check"); }
#--------------------------------------------------------- 140 test_stmt_pfx_END
END { say("teardown"); }
#-------------------------------------------------------- 141 test_stmt_pfx_INIT
INIT { say("init"); }
#------------------------------------------------------- 142 test_stmt_pfx_eager
eager @a;
#------------------------------------------------------- 143 test_stmt_pfx_hyper
hyper @a;
#-------------------------------------------------------- 144 test_stmt_pfx_lazy
lazy @a;
#-------------------------------------------------------- 145 test_stmt_pfx_once
once { say("once"); }
#----------------------------------------------------- 146 test_stmt_pfx_quietly
quietly { say("quiet"); }
#-------------------------------------------------------- 147 test_stmt_pfx_race
race @a;
#------------------------------------------------------- 148 test_stmt_pfx_react
react { say("react"); }
#------------------------------------------------------------ 149 test_try_basic
try { say "safe"; }
#------------------------------------------------------------ 150 test_try_catch
try { die "oops"; } CATCH { say "caught"; }
#------------------------------------------------------ 151 test_try_catch_lower
try { die "boom"; } catch { say "handled"; }
#-------------------------------------------------------------------- 152 say_90
say("hello");
say(42);
#---------------------------------------------------------- 153 simple_assign_46
my constant GREETING = "hello";
say GREETING;
#---------------------------------------------------------- 154 simple_assign_47
my constant K = 3;
say K * K;
#---------------------------------------------------------- 155 simple_assign_48
constant $E = 2;
say $E;
#-------------------------------------------------------------------- 156 sub_26
sub t() { 42 }
...
sub greet() { "hi" }
say greet();
#---------------------------------------------------------- 158 simple_assign_49
constant A = "a";
constant B = "b";
say A ~ B;
#---------------------------------------- 159 ladder__rung12_exceptions_no_catch
try {
    die "swallowed";
}
say "after";
...
say 2.5+1.5;
say -3.0;
#----------------------------------------- 161 ladder__rung11_junctions_operator
if 1|2|3 == 2 {
    say "yes";
} else {
    say "no";
}
#------------------------------------------------- 162 ladder__rung12_exceptions
try {
    die "boom";
    CATCH {
        default { say "caught"; }
...
#------------------------------------- 163 ladder__rung12_exceptions_die_message
try {
    die "custom message";
    CATCH {
        default { say .message; }
...
#--------------------------------------------------------- 191 simple_assign_100
my $i = 7; say $i++;
#--------------------------------------------------------- 192 simple_assign_102
my $i = 5; my $j = --$i; say $j;
#--------------------------------------------------------- 193 simple_assign_105
my $i = 5; my $j = ++$i; say $j;
#--------------------------------------------------------- 194 simple_assign_106
my $i = 5; my $j = ++$i; say $i;
#--------------------------------------------------------- 195 simple_assign_110
my $x = 5; say "x is ", $x;
#--------------------------------------------------------- 196 simple_assign_111
my $x = 6; my $y = 7; say $x * $y;
#--------------------------------------------------------- 197 simple_assign_114
my $a = "zebra"; my $b = "apple"; say $a gt $b ?? "y" !! "n";
#--------------------------------------------------------- 198 simple_assign_115
my $x = 0 ?? 5 !! 9; say $x;
#--------------------------------------------------------- 199 simple_assign_116
my $g = "C"; say $g eq "A" ?? 1 !! $g eq "B" ?? 2 !! 3;
#--------------------------------------------------------- 200 simple_assign_117
my $n = 10; say $n > 3 ?? "big" !! "small";
#--------------------------------------------------------- 201 simple_assign_118
my $x = 1 ?? 5 !! 9; say $x;
#--------------------------------------------------------- 202 simple_assign_124
my $s; $s = "ab" x 3; say $s;
#--------------------------------------------------------- 203 simple_assign_125
my $s = "ab" x 3; say $s;
#--------------------------------------------------------- 204 simple_assign_126
my $n = 3; my $s = "ab" x $n; say $s;
#--------------------------------------------------------- 205 simple_assign_128
my $s = "yo"; my $n = 4; say $s x $n;
#----------------------------------------------------------- 206 simple_assign_2
my $r = 10 div $n;
#---------------------------------------------------------- 207 simple_assign_20
my $x = -5;
#---------------------------------------------------------- 208 simple_assign_21
my $y = -$x;
#---------------------------------------------------------- 209 simple_assign_26
 my $b = { say 9; }; $b(); $b(); 
#---------------------------------------------------------- 210 simple_assign_28
 my $b = { say 5; }; $b(); 
#---------------------------------------------------------- 211 simple_assign_29
 my $a = { say 1; }; my $b = { say 2; }; $b(); $a(); 
#----------------------------------------------------------- 212 simple_assign_3
my $r = $x div 3;
#---------------------------------------------------------- 213 simple_assign_67
my $x = 7; say $x.fmt("%03d");
#---------------------------------------------------------- 214 simple_assign_68
my $s = "hi"; say $s.fmt("[%5s]");
#---------------------------------------------------------- 215 simple_assign_69
my $i = 3; $i++; $i++; say $i;
#----------------------------------------------------------- 216 simple_assign_7
my $r = $x % 3;
#----------------------------------------------------------- 217 simple_assign_8
my $r = $x % $y % 2;
#---------------------------------------------------------- 218 simple_assign_89
my $i = 5; say $i--;
#---------------------------------------------------------- 219 simple_assign_98
my $i = 5; my $j = $i++; say $j;
#---------------------------------------------------------- 220 simple_assign_99
my $i = 5; my $j = $i++; say $i;
#--------------------------------------------------------------- 221 split_say_1
 say("a,b,c".split(",")); 
#------------------------------------------------------------ 222 test_arith_add
my $x = 1 + 2;
#---------------------------------------------------------- 223 test_arith_chain
my $x = 1 + 2 + 3;
#------------------------------------------------------------ 224 test_arith_mul
my $x = 6 * 7;
#----------------------------------------------------------- 225 test_arith_prec
...
#------------------------------------------------------------ 228 test_decl_hash
my %h = 9;
#------------------------------------------------------ 229 test_decl_scalar_int
my $x = 5;
#------------------------------------------------------ 230 test_decl_scalar_str
my $s = "hello";
#---------------------------------------------------------- 231 test_kebab_ident
my $s-address = 5; say $s-address;
#------------------------------------------------------------- 232 test_our_decl
our $a = 1; say $a;
#------------------------------------------------------- 233 test_qualified_term
...
my %h = a => 1, b => 2, c => 3;
say %h.kv.elems;
#--------------------------------- 264 ladder__rung01_variables_type_constrained
my Int $x = 5;
say $x;
#-------------------------------------- 265 ladder__rung04_arrays_negative_index
my @a = (1, 2, 3);
say @a[*-1];
#--------------------------------------- 266 ladder__rung04_arrays_out_of_bounds
my @a = (1, 2, 3);
say @a[10].raku;
#----------------------------------------- 267 ladder__rung05_hashes_missing_key
my %h = (a => 1);
say %h{'z'}.raku;
#-------------------------------------------- 268 ladder__rung06_control_ternary
my $x = 5;
say $x > 3 ?? "big" !! "small";
#---------------------------------------------- 269 ladder__rung06_control_until
my $i = 0;
until ($i >= 3) { say $i; $i = $i + 1; }
#--------------------------------------- 270 ladder__rung07_subs_implicit_return
sub double($x) { $x * 2 }
say double(5);
#------------------------------------------------------------------- 271 multi_3
multi bar($x) { $x + 1 }
...
#----------------------------------------------------------------- 272 say_try_1
    ...
    say('after');
#--------------------------------------------------------- 273 simple_assign_101
my $b = 5;
say $b ** 2;
#--------------------------------------------------------- 274 simple_assign_112
my $x = 10; my $y = 3;
say $x % $y;
#--------------------------------------------------------- 275 simple_assign_113
my $x = 10; my $y = 3;
say $x * $y;
#--------------------------------------------------------- 276 simple_assign_123
my $d = 42;
{ say "def" with $d }
#---------------------------------------------------------- 277 simple_assign_14
my $s = "hello";
say $s.chars();
#---------------------------------------------------------- 278 simple_assign_15
my $s = "HELLO";
say $s.lc();
#---------------------------------------------------------- 279 simple_assign_16
my $s = "hello world";
say $s.substr(6, 5);
#---------------------------------------------------------- 280 simple_assign_17
my $s = "  hi  ";
say $s.trim();
#---------------------------------------------------------- 281 simple_assign_18
my $s = "hello";
say $s.uc();
#---------------------------------------------------------- 282 simple_assign_38
my $n = 66;
say chr($n);
#----------------------------------------------------------- 283 simple_assign_4
my $obj = Foo.new(x => 1);
...
my $x = 3.14;
say $x;
#---------------------------------------------------------- 285 simple_assign_51
my $x = 0;
say $x // "oops";
#---------------------------------------------------------- 286 simple_assign_54
my ($a, $b) = (10, 20);
say $a + $b;
#---------------------------------------------------------- 287 simple_assign_55
my ($x, $y) = "foo", "bar";
say $y;
#---------------------------------------------------------- 288 simple_assign_56
my ($a, $b, $c) = 1, 2, 3;
say $c;
#----------------------------------------------------------- 289 simple_assign_6
my $q = $x div $y;
my $r = $x % $y;
#---------------------------------------------------------- 290 simple_assign_73
my $s = "hello";
say $s.chars;
#---------------------------------------------------------- 291 simple_assign_74
my $x = 5;
say "yes" with $x;
#---------------------------------------------------------- 292 simple_assign_76
my $x = 42;
say $_ with $x;
#---------------------------------------------------------- 293 simple_assign_77
my $x = 0;
say "z" with $x;
#---------------------------------------------------------- 294 simple_assign_85
my $i = 0;
until $i >= 3 { say $i; $i = $i + 1 }
#---------------------------------------------------------- 295 simple_assign_87
my $c = "z";
say $c.ord;
#--------------------------------------------------------- 296 simple_program_26
my $y;
say "gone" without $y;
#---------------------------------------------------------- 297 simple_program_9
my $x;
say $x // "default";
#-------------------------------------------------------------------- 298 sub_12
...
sub f(*%h) { say %h{'z'}; }
f(z => 4, w => 5);
#--------------------------------------------------- 314 test_interp_leading_var
my $x = "world";
say "$x there";
#------------------------------------------------------ 315 test_interp_only_var
my $x = "hi";
say "$x";
#-------------------------------------------------------- 316 test_interp_simple
my $name = "world";
say "hello $name";
#-------------------------------------------------- 317 test_interp_trailing_lit
my $a = "foo";
say "val=$a!";
#---------------------------------------------------------- 318 test_print_basic
my $x = "hello";
print "$x\n";
#------------------------------------------------------------------ 319 array_14
my @n = (1,2,3,4);
...
%h<foo> = "bar";
say %h<foo>;
#----------------------------- 326 ladder__rung01_variables_multiple_declaration
my ($a, $b) = (1, 2);
say $a;
say $b;
#----------------------------------- 327 ladder__rung01_variables_no_initializer
my $x;
$x = 5;
say $x;
#----------------------------------------------------- 328 ladder__rung05_hashes
my %h = a => 1, b => 2;
say %h{'a'};
say %h{'b'};
#----------------------------------------- 329 ladder__rung05_hashes_keys_values
my %h = (a => 1, b => 2);
say %h.keys.sort;
say %h.values.sort;
#--------------------------------------------- 330 ladder__rung09_string_methods
my $s = "Raku";
say $s.uc;
say $s.chars;
#------------------------------------- 331 ladder__rung10_given_when_basic_match
given 5 {
    when 5 { say "matched"; }
}
#--------------------------------------------------------- 332 simple_assign_103
my $n = 5;
--$n;
say $n;
#--------------------------------------------------------- 333 simple_assign_104
my $n = 5;
++$n;
say $n;
#---------------------------------------------------------- 334 simple_assign_19
my Int $x = 5;
my Str $s;
say $x;
#---------------------------------------------------------- 335 simple_assign_25
my $s = 1;
$s = 2;
say $s;
#---------------------------------------------------------- 336 simple_assign_39
my $x = 5;
$x += 3;
say $x;
#---------------------------------------------------------- 337 simple_assign_41
my $x = 24;
$x /= 6;
say $x;
#---------------------------------------------------------- 338 simple_assign_42
my $x = 6;
$x *= 4;
say $x;
#---------------------------------------------------------- 339 simple_assign_43
my $x = 7;
$x -= 4;
say $x;
#---------------------------------------------------------- 340 simple_assign_52
my ($a, $b) = 1, 2, 3;
say $a;
say $b;
#---------------------------------------------------------- 341 simple_assign_53
my ($a, $b, $c) = 1, 2;
say $a;
say $b;
#---------------------------------------------------------- 342 simple_assign_57
my ($a, $b) = 3, 7;
say $a;
say $b;
#---------------------------------------------------------- 343 simple_assign_58
my $h = 7/2;
say $h*2 == 7 ?? 7 !! 0;
say $h*2;
#---------------------------------------------------------- 344 simple_assign_78
my $x = 3;
say "nope" without $x;
say "end";
#---------------------------------------------------------- 345 simple_assign_97
my $i = 0;
$i = $i + 1 until $i >= 3;
say $i;
#--------------------------------------------------------- 346 simple_program_25
my $y;
say "nope" with $y;
say "end";
#----------------------------------------------------------------- 347 sub_say_3
...
say "after";
#--------------------------------------------------------- 357 simple_assign_109
my $n = 7;
repeat {
    say $n;
} until $n > 0;
#---------------------------------------------------------- 358 simple_assign_50
my $a = "ok";
my $b;
say $a // "nope";
say $b // "fallback";
#---------------------------------------------------------- 359 simple_assign_59
my $a = 5; my $b = 2;
say $a/$b;
my $c = 8; my $d = 2;
say $c/$d;
#---------------------------------------------------------- 360 simple_assign_75
my $x = 7;
my $r = 0;
$r = $_ with $x;
say $r;
#---------------------------------------------------------- 361 simple_assign_79
my $y;
my $r = 0;
$r = 9 without $y;
say $r;
#---------------------------------------------------------- 362 simple_assign_86
my ($a, $b, $c) = 3, 7;
say $a;
say $b;
say "end";
#-------------------------------------------- 363 ladder__rung04_arrays_push_pop
my @a = (1, 2);
@a.push(3);
say @a;
@a.pop;
say @a;
#----------------------------------- 364 ladder__rung10_given_when_multiple_when
given 2 {
    when 1 { say "one"; }
    when 2 { say "two"; }
    when 3 { say "three"; }
}
#-------------------------------------------------- 365 ladder__rung11_junctions
if any(1,2,3) == 2 {
    say "yes";
} else {
    say "no";
}
#---------------------------------------------- 366 ladder__rung11_junctions_all
if all(1,2,3) > 0 {
    say "yes";
} else {
    say "no";
}
#--------------------------------------------- 367 ladder__rung11_junctions_none
if none(1,2,3) == 5 {
    say "yes";
} else {
    say "no";
}
#---------------------------------------------- 368 ladder__rung11_junctions_one
if one(1,2,3) == 2 {
    say "yes";
} else {
    say "no";
}
#--------------------------------------------------------- 369 simple_assign_108
my $j = 10;
repeat {
    $j = $j + 1;
    say $j;
} until $j >= 12;
#---------------------------------------------------------- 370 simple_assign_90
my $i = 3;
$i--;
say $i;
$i--;
say $i;
#---------------------------------------------------------- 371 simple_assign_94
my $i = 0;
$i++;
say $i;
$i++;
say $i;
#------------------------------------------------- 372 ladder__rung02_arithmetic
my $a = 7;
my $b = 3;
say $a + $b;
say $a - $b;
...
#---------------------------------------------------------- 418 simple_assign_10
my $s = $a ~ $b;
#---------------------------------------------------------- 419 simple_assign_11
my $s = $a ~ $b ~ $c;
#---------------------------------------------------------- 420 simple_assign_12
my $s = 'hello' ~ ' ' ~ 'world';
#--------------------------------------------------------- 421 simple_assign_127
my $s = "ab" x 0; say "[" ~ $s ~ "]";
#---------------------------------------------------------- 422 simple_assign_13
my $s = $a ~ 'x' ~ $b;
#--------------------------------------------------------------------- 423 sub_6
 my $s = sub { say 8; }; $s(); 
#--------------------------------------------------------------- 424 test_seq_op
...
#----------------------------------------------- 448 ladder__rung04_arrays_slice
my @a = (1, 2, 3, 4, 5);
say @a[1..3];
#--------------------------------------------- 449 ladder__rung06_control_unless
my $x = 5;
...
my $x = 0;
if ($x == 0) { die "zero"; }
#--------------------------------------------------------- 471 simple_assign_120
my $x = 5;
{ say "big" if $x > 3 }
#--------------------------------------------------------- 472 simple_assign_121
my $x = 1;
{ say "hi" unless $x }
#--------------------------------------------------------- 473 simple_assign_122
my $x = 0;
{ say "hi" unless $x }
#---------------------------------------------------------- 474 simple_assign_30
my $x = 5;
if ($x > 3) { say "big" }
#---------------------------------------------------------- 475 simple_assign_31
my $x = 5;
if 10 > $x > 1 { say "gt" }
#---------------------------------------------------------- 476 simple_assign_32
my $x = 5;
if 1 < $x < 10 { say "in" }
#---------------------------------------------------------- 477 simple_assign_33
my $x = 1;
if 1 <= $x < 10 { say "in" }
#---------------------------------------------------------- 478 simple_assign_34
my $a = 5;
if 1 < $a == 5 { say "m" }
#---------------------------------------------------------- 479 simple_assign_35
my $x = 50;
if 1 < $x < 10 { say "bad" } else { say "out" }
#---------------------------------------------------------- 480 simple_assign_36
my $x = 1;
if 1 < $x < 10 { say "bad" } else { say "out" }
#---------------------------------------------------------- 481 simple_assign_37
my $x = 5;
unless 1 < $x < 3 { say "fires" }
#---------------------------------------------------------- 482 simple_assign_60
my $n = 8;
if $n %% 2 { say "even" } else { say "odd" }
#---------------------------------------------------------- 483 simple_assign_61
my $n = 7;
if $n %% 2 { say "even" } else { say "odd" }
#---------------------------------------------------------- 484 simple_assign_72
my $i = 0;
until $i >= 10 { last if $i >= 2; say $i; $i = $i + 1 }
#---------------------------------------------------------- 485 simple_assign_81
my $x = 2;
if $x == 1 { say "one" } else { if $x == 2 { say "two" } else { say "other" } }
#---------------------------------------------------------- 486 simple_assign_82
my $x = 5;
if $x > 3 { say "big" }
#---------------------------------------------------------- 487 simple_assign_83
my $x = 2;
if $x > 3 { say "big" } else { say "small" }
#---------------------------------------------------------- 488 simple_assign_84
my $x = 2;
unless $x > 5 { say "not big" }
#---------------------------------------------------------- 489 simple_assign_88
my $x = 5;
if ($x > 3) { say "big"; }
#---------------------------------------------------------- 490 simple_assign_91
my $x = 1;
say "big" if $x > 3;
#---------------------------------------------------------- 491 simple_assign_93
my $x = 5;
say "big" if $x > 3;
#---------------------------------------------------------- 492 simple_assign_95
my $ok = 1;
print "hi" if $ok == 1;
#---------------------------------------------------------- 493 simple_assign_96
my $x = 2;
...
sub f(Str $s) { say($s); }
 f("hi"); 
#------------------------------------------------------ 512 test_bare_ident_expr
my $r = foo + 1;
say($r);
#-------------------------------------------------------- 513 test_handle_stderr
my $e = $*STDERR;
say($e);
#--------------------------------------------------------- 514 test_handle_stdin
my $line = $*STDIN;
say($line);
#-------------------------------------------------------- 515 test_handle_stdout
my $x = $*STDOUT;
say($x);
#----------------------------------------------------------- 516 test_lines_file
my @lines = lines("/tmp/test.txt");
say(@lines);
#---------------------------------------------------- 517 test_nested_call_arith
my $x = add(foo(), bar()) + 1;
say($x);
#--------------------------------------------------------- 518 test_nested_calls
my $n = length(trim($s));
say($n);
#----------------------------------------------------------- 519 test_slurp_file
my $content = slurp("/tmp/test.txt");
say($content);
#------------------------------------------------- 520 test_stmt_ctrl_loop_three
my $i = 0;
loop ($i = 0; $i < 3; $i = $i + 1) { say $i; }
#---------------------------------------------------------- 521 test_stmt_pfx_do
my $x = 1;
do { say($x); };
#--------------------------------------------------- 522 test_triple_nested_call
my $r = abs(int(sqrt($x)));
say($r);
#---------------------------------------------------------- 523 test_try_die_msg
my $msg = "bad";
...
#------------------------------------------------------------- 537 say_try_die_3
    ...
    say('unreached');
#--------------------------------------------------------- 538 simple_assign_107
my $x = 4; my $y = 9;
if ($x < $y) { say "ct" } else { say "cf" }
if (4 < 9) { say "lt" } else { say "lf" }
#--------------------------------------------------------- 539 simple_assign_119
my $x = 10;
{ $x = $x + 1 if $x > 5 }
say $x;
#---------------------------------------------------------- 540 simple_assign_40
my $s = "hello";
$s ~= " world";
say $s;
#---------------------------------------------------------- 541 simple_assign_80
my $a = 1;
my $b = 0;
...
my @a = (1,2,3);
f(@a);
#------------------------------------------------------- 544 test_stmt_pfx_ENTER
my $x = 1;
ENTER { say("enter"); }
say($x);
#-------------------------------------------------------- 545 test_stmt_pfx_KEEP
my $x = 1;
KEEP { say("keep"); }
say($x);
#------------------------------------------------------- 546 test_stmt_pfx_LEAVE
my $x = 1;
LEAVE { say("leave"); }
say($x);
#-------------------------------------------------------- 547 test_stmt_pfx_POST
my $x = 5;
POST { say("post"); }
say($x);
#--------------------------------------------------------- 548 test_stmt_pfx_PRE
my $x = 5;
PRE { say("pre"); }
say($x);
#-------------------------------------------------------- 549 test_stmt_pfx_TEMP
my $x = 1;
TEMP { say("temp"); }
say($x);
#-------------------------------------------------------- 550 test_stmt_pfx_UNDO
my $x = 1;
UNDO { say("undo"); }
say($x);
#------------------------------------------------------------------- 551 while_5
...
#--------------------------------------------------------------- 557 array_say_5
    ...
    say(@r[1]);
    say(@r[2]);
#--------------------------------- 558 ladder__rung10_given_when_when_with_range
given 5 {
    when 1..3 { say "low"; }
    when 4..6 { say "mid"; }
    default { say "high"; }
}
#-------------------------------------------- 559 ladder__rung12_exceptions_fail
sub f {
    fail "oops";
}
my $r = f();
...
#---------------------------------------------- 561 benchmark_rc-man-or-boy-test
...
say A(10, {1}, {-1}, {-1}, {1}, {0});
#----------------------------------- 562 ladder__rung12_exceptions_specific_type
try {
...
#----------------------------------------------------------------- 580 for_say_8
for <a b c> -> $x { say($x); }
#---------------------------------------------------------- 581 join_array_say_1
 my @a = (1, 2, 3); say(@a.join("-")); 
#--------------------------------------------------- 582 ladder__rung08_for_loop
for 1..3 -> $i { say $i; }
#---------------------------------------- 583 ladder__rung08_for_loop_nested_for
for 1..2 -> $i { for 1..2 -> $j { say "$i,$j"; } }
#------------------------------------------------------------ 584 loop_replace_3
loop (my $i = 0; $i < 10; $i++) { last if $i == 3; say $i; }
#------------------------------------------------------------ 585 loop_replace_4
loop (my $i = 0; $i < 4; $i++) { next if $i == 1; say $i; }
#---------------------------------------------------------- 586 smartmatch_say_2
 if ('abc' ~~ /^\d+$/) { say("match"); } else { say("nomatch"); } 
#---------------------------------------------------------- 587 smartmatch_say_3
 if ('abc123' ~~ /\d+/) { say("match"); } else { say("nomatch"); } 
#--------------------------------------------------------- 588 split_array_say_1
...
my $v = %h{"x"};
say($v);
#-------------------------------------------------------- 598 join_range_array_2
my @r = 1..5;
say @r[0,2,4].join(",");
#-------------------------------------------------------- 599 join_range_array_3
my @a = 10,20,30,40,50;
say @a[1..2].join(",");
#-------------------------------------------------------- 600 join_range_array_4
my @a = 1..4;
say @a.join(",");
#-------------------------------------------------------- 601 join_range_array_5
my @r = 10..20;
say @r[2..5].join(",");
#-------------------------------------------------------- 602 join_range_array_6
my @a = 1,2,3,4,5;
say @a[1..^4].join(",");
#-------------------------------------------------------- 603 join_range_array_7
my @a = 1,2,3,4,5;
say @a[0..2].join(",");
#-------------------------------------------------------- 604 join_range_array_8
my @a = 1,2,3,4,5;
say @a[1..3].join(",");
#-------------------------------------------------------- 605 join_range_array_9
my @a = 1,2,3,4,5;
say @a[2..2].join(",");
#---------------------------------------- 606 ladder__rung06_control_elsif_chain
my $x = 2;
if ($x == 1) { say "one"; } elsif ($x == 2) { say "two"; } else { say "other"; }
#------------------------------------------------------- 607 ladder__rung07_subs
...
#--------------------------------------------------- 659 class_method_replace_10
class C { method sq($n) { $n * $n } }
my $o = C.new;
say $o.sq(6);
#--------------------------------------------------- 660 class_method_replace_11
class C { method calc($n) { my $t = $n + 1; $t * 2 } }
my $o = C.new;
say $o.calc(4);
#--------------------------------------------------- 661 class_method_replace_14
class C { method answer { 42 } }
my $o = C.new;
say $o.answer();
#---------------------------------------------------- 662 class_method_replace_6
class C { method go() { 7 } }
my $x = C.new.go();
say $x;
#----------------------------------------------------------- 663 class_replace_1
...
my $i = 1;
say @a[$i,3].join(",");
#-------------------------------------------------------- 668 join_range_array_1
my @a = 9;
@a = 1..4;
say @a.join(",");
#--------------------------------------- 669 ladder__rung07_subs_optional_params
...
#----------------------------------- 694 ladder__rung13_classes_public_attribute
class Point {
    has $.x is rw;
    has $.y is rw;
}
...
$p.x = 10;
say $p.x;
#----------------------------------------- 695 benchmark_pi-sequential-iteration
...
#------------------------------------------ 724 ladder__rung07_subs_named_params
sub greet(:$name) { return "hi " ~ $name; }
say greet(name => "Bob");
#------------------------------------ 725 ladder__rung08_for_loop_for_over_array
my @a = (10, 20, 30);
for @a -> $x { say $x; }
#------------------------------------ 726 ladder__rung08_for_loop_for_with_index
my @a = ("a", "b");
for @a.kv -> $i, $v { say "$i:$v"; }
#------------------------------------------------------ 727 method_say_replace_1
role Speaks { method talk() { return "hello"; } }
 my $s = Speaks.new(); say($s.talk()); 
#--------------------------------------------------------- 728 multi_sub_array_3
multi sub f($a, **@r) { say "L:" ~ @r.elems; }
f(1,2,3,4);
#--------------------------------------------------------- 729 multi_sub_array_4
...
#--------------------------------------------------- 732 class_method_replace_12
class Point { has $.x; has $.y; method sum { $!x + $!y } }
my $p = Point.new(x => 3, y => 4);
say $p.sum;
#--------------------------------------------------- 733 class_method_replace_13
class C { method greet { return "hi"; } }
my $o = C.new;
say $o.greet();
#--------------------------------------------------- 734 class_method_replace_15
...
#------------------------------------------------------ 745 class_say_replace_26
class Animal { has $.name; }
class Dog is Animal { }
 my $d = Dog.new(name => "Rex"); say($d.name); 
#------------------------------------------------------ 746 class_say_replace_27
role HasId { has $.id; }
...
#--------------------------------------------------- 759 class_method_replace_16
class C { method m($v = 42) { return $v } }
my $o = C.new;
say $o.m();
say $o.m(8);
#----------------------------------------------- 760 class_method_say_replace_35
class A { method TWEAK() { say("A"); } }
class B is A { method TWEAK() { say("B"); } }
class C is B { method TWEAK() { say("C"); } }
 my $c = C.new(); 
#------------------------------------------------------- 761 join_range_array_10
my @a = 1,2,3,4,5;
my $lo = 1;
my $hi = 3;
say @a[$lo..$hi].join(",");
#---------------------------------------- 762 ladder__rung07_subs_multi_dispatch
...
sub boomer() { die('deep'); say('sub-after'); };
    ...
    say('after');
#------------------------------------------------------- 766 test_stmt_pfx_FIRST
for 1..3 -> $i {
    FIRST { say("first"); }
    say($i);
}
#-------------------------------------------------------- 767 test_stmt_pfx_LAST
for 1..3 -> $i {
    LAST { say("last"); }
    say($i);
}
#-------------------------------------------------------- 768 test_stmt_pfx_NEXT
for 1..3 -> $i {
    NEXT { say("next"); }
    say($i);
}
#------------------------------------------------------------- 769 say_try_die_5
    ...
    say('after');
#------------------------------------------------------ 770 test_nested_if_while
my $i = 0;
if ($i == 0) {
    while ($i < 3) { $i = $i + 1; }
}
say($i);
#------------------------------------------------------- 771 token_say_replace_1
grammar G {
    token TOP { \d+ }
}
...
my $g = Greeter.new;
say $g.greet;
#------------------------------ 773 ladder__rung13_classes_named_arg_constructor
class Sum {
    has $.a;
    has $.b;
    method total { $!a + $!b }
...
say $s.total;
#------------------------------------------- 774 ladder__rung14_roles_smartmatch
role Flyer { }
...
my $w = Widget.new;
say $w.greet;
#--------------------------------------------- 777 ladder__rung14_roles_override
role Greeter {
...
my $s = Special.new;
say $s.greet;
#------------------------------------------- 778 ladder__rung14_roles_attributes
role Counter {
    has $.count is rw = 0;
    method inc { $!count++ }
}
...
$t.inc;
say $t.count;
#------------------------------------------ 779 ladder__rung14_roles_composition
role Flyer {
...
say $d.fly;
say $d.swim;
#---------------------------------- 780 ladder__rung13_classes_private_attribute
class Counter {
    has $!count;
    method init { $!count = 0 }
    method inc { $!count++ }
...
my @a = 7,8,9;
for @a { say($_); }
#-------------------------------------------------- 796 smartmatch_say_replace_1
my $s = "hello";
if ($s ~~ /e(l+)(o)/) { say($1); }
#-------------------------------------------------- 797 smartmatch_say_replace_2
my $s = "hello";
if ($s ~~ /(?<word>\w+)/) { say($<word>); }
#-------------------------------------------------- 798 smartmatch_say_replace_3
my $s = "hello";
if ($s ~~ /e(l+)/) { say($0); }
#-------------------------------------------------- 799 smartmatch_say_replace_4
my $s = "x";
if ($s ~~ /^x$/) { say("anchor"); }
#-------------------------------------------------- 800 smartmatch_say_replace_5
my $s = "hello world";
if ($s ~~ /\s+/) { say("space"); }
#-------------------------------------------------- 801 smartmatch_say_replace_6
my $s = "anything";
if ($s ~~ /.*/) { say("match"); }
#-------------------------------------------------- 802 smartmatch_say_replace_7
my $s = "hello";
if ($s ~~ /ell/) { say("match"); }
#------------------------------------------------- 803 class_array_say_replace_2
class Base { has @.log; }
class Derived is Base { has $.id; }
 my $d = Derived.new(id => 7); my @l = $d.log; say(@l.elems); 
#----------------------------------------------- 804 class_method_grep_replace_1
class C { method grep() { return 8 } }
my $o = C.new;
say $o.grep();
#------------------------------------------------ 805 class_method_map_replace_1
class C { method map($x) { return $x + 1 } }
my $o = C.new;
say $o.map(4);
#--------------------------------------------------- 806 class_method_replace_18
class Sayer { has $.t; method go() { say $!t } }
my $s = Sayer.new(t => "done");
if True { $s.go() }
#--------------------------------------------------- 807 class_method_replace_19
class C { has $.x; method greet() { return 3; } }
my $o = C.new;
say $o.greet();
#----------------------------------------------- 808 class_method_say_replace_51
role R { method who() { return "role"; } }
class C does R { method who() { return "class"; } }
 my $c = C.new(); say($c.who()); 
#----------------------------------------------- 809 class_method_sort_replace_2
class C { method sort() { return 99 } }
my $o = C.new;
say $o.sort;
#--------------------------------------------------------- 810 for_range_array_1
my @a = 0 xx 3;
for 0..2 -> $i { @a[$i] = $i * 10 }
say @a[0]; say @a[1]; say @a[2];
#---------------------------------------------------------- 811 for_range_hash_1
my %h;
for 1..2 -> $i { %h{$i} = $i * 100 }
say %h{1}; say %h{2};
#----------------------------------------------------------- 812 multi_sub_say_2
...
#----------------------------------------------- 816 class_method_say_replace_31
...
my $r = double(3);
say($r);
#----------------------------------------------- 829 class_method_sort_replace_1
class Widget {
...
say $w.sort;
say $w.reverse;
#---------------------------------------------- 830 benchmark_divide-and-conquer
my \SCALE = 10;
my \FANOUT = 2;
...
#------------------------------------------------ 833 sub_junction_say_replace_1
...
#----------------------------------------------- 861 class_method_say_replace_25
...
#----------------------------------------------------------- 865 while_say_try_1
    ...
    say('after');
#---------------------------------------------- 866 class_method_multi_replace_4
class Animal { }
class Dog is Animal { }
class Handler {
...
#---------------------------------------- 867 ladder__rung13_classes_inheritance
class Animal {
    method speak { return "..." }
...
#---------------------------------------- 871 benchmark_rc-forest-fire-stringify
...
say $d.name;
say $d.greet();
#---------------------------------------------- 873 sub_smartmatch_say_replace_1
...
#---------------------------------------------- 875 sub_smartmatch_say_replace_2
...
#------------------------------------------------ 876 benchmark_point_class_add2
...
print $a.x, ' ', $a.y;
#-------------------------------------------- 877 multi_sub_smartmatch_replace_1
...
#------------------------------------------- 878 benchmark_send-more-money-loops
# ⛔⭐ SELF-TIMED ON THE TWO-NUMBER BASIS (Lon 2026-08-30, RULES.md § THE TWO-NUMBER BENCHMARK BASIS).
...
#----------------------------------------------- 894 class_method_say_replace_15
class Point {
    has $.x;
    has $.y;
    method sum() { return $!x + $!y; }
...
class Dog {
    ...
    say($d.name);
    say($d.greet());
#------------------------------------------- 895 scrip_test_rk_seq_consumers_arr
...
main();
#---------------------------------------------- 896 benchmark_rc-9-billion-names
my @todo = $[1];
my @sums = 0;
sub nextrow($n) {
    for +@todo .. $n -> $l {
...
#---------------------------------------------- 903 benchmark_rc-perfect-shuffle
use v6;
...
#----------------------------------------------- 904 scrip_test_rk_array_literal
...
main();
#-------------------------------------------- 905 sub_regex_smartmatch_replace_1
...
#---------------------------------------------- 906 class_method_multi_replace_3
...
#-------------------------------------- 907 benchmark_rc-self-describing-numbers
sub is_selfdesc($n) {
    my $s = $n.Str;
    my $chars = $s.chars;
    my @a = +«$s.comb;
...
#----------------------------------------------- 908 sub_when_junction_replace_1
...
merge-sort @a;
say @a[0];
#------------------------------------------------ 913 benchmark_point_class_add1
# Point Class Benchmarks
...
main();
#--------------------------------------------------- 915 simple_program_18 XFAIL
say 7 %% 3;
#--------------------------------------------------- 916 simple_program_19 XFAIL
say 6 %% 3;
#--------------------------------------------------- 917 simple_program_20 XFAIL
say 0 %% 5;
#-------------------------------------------------------------- 918 say_62 XFAIL
 say(3 < 9); say(5 < 9); 
#-------------------------------------------------------------- 919 say_64 XFAIL
...
#-------------------------------------------------------------- 921 say_80 XFAIL
    say(reverse('abc'));
#------------------------------------------------------ 922 say_replace_19 XFAIL
say (6 == 6);
#------------------------------------------------------ 923 say_replace_20 XFAIL
say (9 <= 9);
#------------------------------------------------------ 924 say_replace_22 XFAIL
say (3 != 4);
#-------------------------------------------------------------- 925 say_29 XFAIL
grammar G { rule TOP { "a" | "b" } }
 say(G.parse("a")); 
...
my @b = 3, 1, 2, 1;
say @b.unique;
#--------------------------------------------------------- 950 class_say_2 XFAIL
class Cat { }
 say(Cat.WHAT()); 
#---------------------------------------------------- 951 simple_assign_23 XFAIL
my $d = Dog.new(name => "Rex");
say $d.name;
#---------------------------------------------------- 952 simple_assign_70 XFAIL
my $x = (42,);
say $x;
#---------------------------------------------------- 953 simple_assign_71 XFAIL
my $x = (1,2,3);
say $x;
#--------------------------------------------------------- 954 token_say_1 XFAIL
grammar G { token w { \w+ } rule TOP { "[" <w> "]" } }
 say(G.parse("[abc]")); 
#----------------------------------------------------- 955 array_replace_3 XFAIL
my @a = (1,2,3);
say "A";
say @a[99];
say "B";
#----------------------------------------------------- 956 array_replace_4 XFAIL
my @a = (10,20,30);
say "before";
say @a[3];
say "after";
...
#--------------------------------------------------------- 958 token_say_4 XFAIL
grammar G {
    token TOP { \d+ }
}

    say(G.parse("12345"));
#--------------------------------------------------------- 959 token_say_3 XFAIL
grammar G {
    token word { \w+ }
    rule TOP { <word> }
}
...
grammar G {
    ...
    say(G.parse("12abc"));
#---------------------------------------------------- 961 simple_assign_27 XFAIL
 my $b = { return 3; }; say $b() + $b(); 
#------------------------------------------------------------ 962 array_11 XFAIL
my $x = 5;
my @r = gather { take $x; };
#--------------------------------------------------------- 963 join_hash_2 XFAIL
my %h = a => 1, b => 2, c => 3;
say %h.pairs.sort.join(" ");
#------------------------------------------------------ 964 say_replace_21 XFAIL
my $x = 4; my $y = 9;
say ($x < $y);
#------------------------------------------------------- 965 say_try_die_1 XFAIL
...
my @r = gather { take $n; };
say @r;
#--------------------------------------------------------- 968 array_say_3 XFAIL
    my @a = (10, 20, 30);
    say(elems(@a));
    my @e = '';
    say(elems(@e));
#---------------------------------------------------------- 969 hash_say_5 XFAIL
    my %h = 0;
    %h<lang> = 'Raku';
    %h<vers> = '6';
    say(%h<lang>);
...
#--------------------------------------------------------- 983 array_say_4 XFAIL
    ...
    say($p);
    say(elems(@nums));
#----------------------------------------------------- 984 for_range_say_2 XFAIL
for 1..^5 -> $i { say($i); }
#------------------------------------------------ 985 class_say_replace_18 XFAIL
class Q { has $.x; }
 my $q = Q.new(x => 1); $q.x = 5; say("unreached"); 
#------------------------------------------------ 986 class_say_replace_21 XFAIL
class Empty { has $.x; }
 my $e = Empty.new(x => 1); say($e); 
#------------------------------------------------ 987 class_say_replace_28 XFAIL
class Point { has $.x; }
 my $p = Point.new(x => 1); say($p.WHAT); 
#------------------------------------------------- 988 class_say_replace_5 XFAIL
class Config { has %.opts; }
 my $c = Config.new(); my $h = $c.opts; say(hash_exists($h, 'x')); 
#------------------------------------------------- 989 class_say_replace_6 XFAIL
class Point { has $.x is required; has $.y; }
 my $p = Point.new(y => 9); say("unreached"); 
#------------------------------------------------ 990 class_say_replace_29 XFAIL
class Animal { has $.name; }
class Dog is Animal { }
 my $d = Dog.new(name => "Rex"); say($d.WHAT); 
#----------------------------------------------------- 991 for_range_say_6 XFAIL
    for grep { $_ > 2 } 1..5 -> $v {
        say($v);
    }
    say('done');
#----------------------------------------------------- 992 for_range_say_7 XFAIL
    for map { $_ * 2 } 1..3 -> $v {
        say($v);
    }
    say('done');
#-------------------------------------------------- 993 class_method_say_2 XFAIL
class Greeter {
    has $.name;
    method greet($msg) {
        say($msg);
...
#---------------------------------------- 1003 class_method_say_replace_49 XFAIL
role A { method m() { return "a"; } }
role B { method m() { return "b"; } }
class C does A does B { }
 my $c = C.new(); say($c.m()); 
#------------------------------------------ 1004 for_range_array_replace_1 XFAIL
my @a = (1,2,3);
for 0..4 -> $i {
    say @a[$i];
}
say "done";
#----------------------------------------- 1005 class_method_say_replace_1 XFAIL
class Dog {
    has $.name;
    method speak() {
        say("woof");
