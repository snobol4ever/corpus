...
#----------------------------------------------------------- 10 simple_program_1
die "fatal error";
#---------------------------------------------------------- 11 simple_program_27
say ord("A");
#---------------------------------------------------------- 12 simple_program_28
say "Z".ord;
#---------------------------------------------------------- 13 simple_program_29
say 2 ** 10;
#---------------------------------------------------------- 14 simple_program_30
say 2 ** 3 ** 2;
#---------------------------------------------------------- 15 simple_program_31
say 3 + 2 ** 3;
#---------------------------------------------------------- 16 simple_program_32
say 2 * 3 ** 2;
#---------------------------------------------------------- 17 simple_program_33
say -2 ** 2;
#---------------------------------------------------------- 18 simple_program_34
print "a", "b"; say "";
#---------------------------------------------------------- 19 simple_program_37
say sqrt(2);
#---------------------------------------------------------- 20 simple_program_39
say [+] ();
#---------------------------------------------------------- 21 simple_program_40
say [+] (1, 2, 3, 4);
#---------------------------------------------------------- 22 simple_program_41
say [+] 5;
#---------------------------------------------------------- 23 simple_program_43
say [max] (3, 1, 4, 2);
#---------------------------------------------------------- 24 simple_program_44
say [min] (3, 1, 4, 2);
#---------------------------------------------------------- 25 simple_program_45
say [*] ();
#---------------------------------------------------------- 26 simple_program_46
say [*] (1, 2, 3, 4);
#---------------------------------------------------------- 27 simple_program_47
say [*] 7;
#---------------------------------------------------------- 28 simple_program_48
say [-] (1, 2, 3, 4);
#---------------------------------------------------------- 29 simple_program_49
say 1, 2, 3;
#----------------------------------------------------------- 30 simple_program_5
say chr(97);
#---------------------------------------------------------- 31 simple_program_50
say "a", "b", "c";
#---------------------------------------------------------- 32 simple_program_56
 say "b" ge "a" ?? "y" !! "n"; 
#---------------------------------------------------------- 33 simple_program_57
 say "b" gt "a" ?? "y" !! "n"; 
#---------------------------------------------------------- 34 simple_program_58
 say "abc" le "abc" ?? "y" !! "n"; 
#---------------------------------------------------------- 35 simple_program_59
 say "abc" lt "abd" ?? "y" !! "n"; 
#----------------------------------------------------------- 36 simple_program_6
say chr(65);
#---------------------------------------------------------- 37 simple_program_60
 say "10" lt "9" ?? "y" !! "n"; 
#---------------------------------------------------------- 38 simple_program_63
say "hello".subst("l","L");
#---------------------------------------------------------- 39 simple_program_64
say "aaa".subst("a","bb");
#---------------------------------------------------------- 40 simple_program_65
say "hello".subst("xy","Z");
#---------------------------------------------------------- 41 simple_program_66
say <x y z>.elems;
#---------------------------------------------------------- 42 simple_program_67
say "ab" x 3;
#---------------------------------------------------------- 43 simple_program_69
say "-" x 5;
#----------------------------------------------------------- 44 simple_program_7
say 65.chr;
#---------------------------------------------------------- 45 simple_program_70
say 2 + 3 x 2;
#---------------------------------------------------------- 46 simple_program_72
say 7 x 2;
#---------------------------------------------------------- 47 simple_program_75
say "ab" x 3;
#----------------------------------------------------------- 48 simple_program_8
say chr(ord("Q"));
#-------------------------------------- 49 ladder__rung00_hello_print_no_newline
print "no newline";
say "end";
#-------------------------------- 50 ladder__rung02_arithmetic_negative_operands
say -7 % 2;
say -7 div 2;
#----------------------------------------------------------- 51 simple_assign_44
constant PI = 3;
...
constant N = 10;
say N + 5;
#---------------------------------------------------------- 53 simple_program_12
say 3 + 7/2;
say 7/2 - 2;
#---------------------------------------------------------- 54 simple_program_22
say 1;;
say 2;
#---------------------------------------------------------- 55 simple_program_38
print 4.0;
say "";
#---------------------------------------------------------- 56 simple_program_13
say 7/2;
say 10/4;
say -7/2;
#---------------------------------------------------------- 57 simple_program_36
say 3.5;
say 10/4;
say -7/2;
#---------------------------------------------------------- 58 simple_program_11
say 8/2;
say 6/3;
say 9/3;
say 10/2;
...
#--------------------------------------------------------------------- 62 hash_3
say 255.fmt("%x");
#---------------------------------------- 63 ladder__rung03_strings_multi_concat
say "a" ~ "b" ~ "c";
#--------------------------------- 64 ladder__rung09_string_methods_split_method
say "a,b,c".split(",");
#--------------------------------------------------------------------- 65 say_15
{ say(42); }
#--------------------------------------------------------------------- 66 say_17
...
#---------------------------------------------------------- 86 simple_program_14
if 7 %% 3 { say "yes" } else { say "no" }
#---------------------------------------------------------- 87 simple_program_15
if 1 + 2 %% 3 { say "yes" } else { say "no" }
#---------------------------------------------------------- 88 simple_program_16
if 6 %% 3 { say "yes" } else { say "no" }
#---------------------------------------------------------- 89 simple_program_17
unless 10 %% 3 { say "notdiv" }
#----------------------------------------------------------- 90 simple_program_2
if 1 < 2 < 9 < 4 { say "bad" } else { say "out" }
#---------------------------------------------------------- 91 simple_program_21
if 0 %% 5 { say "yes" } else { say "no" }
#----------------------------------------------------------- 92 simple_program_3
if 1 < 2 < 3 < 4 { say "yes" }
#---------------------------------------------------------- 93 simple_program_35
print(1,2,3);
#----------------------------------------------------------- 94 simple_program_4
say chr(72) ~ chr(105);
#---------------------------------------------------------- 95 simple_program_42
say [~] (1, 2, 3, 4);
#---------------------------------------------------------- 96 simple_program_51
say sprintf("%08b", 5);
#---------------------------------------------------------- 97 simple_program_52
say sprintf("%.2f", 3.14159);
#---------------------------------------------------------- 98 simple_program_53
say sprintf("%-5d|", 42);
#---------------------------------------------------------- 99 simple_program_54
say sprintf("100%%");
#--------------------------------------------------------- 100 simple_program_55
say sprintf("%03d", 7);
#--------------------------------------------------------- 101 simple_program_68
say 1 ~ "x" x 3 ~ 2;
#--------------------------------------------------------- 102 simple_program_71
say "[" ~ ("q" x -2) ~ "]";
#--------------------------------------------------------- 103 simple_program_73
say 1 ~ "x" x 3 ~ 2;
#--------------------------------------------------------- 104 simple_program_74
say "a" ~ "b" x 2;
#--------------------------------------------------------- 105 simple_program_76
say "[" ~ ("z" x 0) ~ "]";
#-------------------------------------------------------------------- 106 say_90
say("hello");
say(42);
#---------------------------------------------------------- 107 simple_assign_46
my constant GREETING = "hello";
say GREETING;
#---------------------------------------------------------- 108 simple_assign_47
my constant K = 3;
say K * K;
#---------------------------------------------------------- 109 simple_assign_48
constant $E = 2;
say $E;
#-------------------------------------------------------------------- 110 sub_26
sub t() { 42 }
...
sub greet() { "hi" }
say greet();
#---------------------------------------------------------- 112 simple_assign_49
constant A = "a";
constant B = "b";
say A ~ B;
#---------------------------------------- 113 ladder__rung12_exceptions_no_catch
try {
    die "swallowed";
}
say "after";
...
say 2.5+1.5;
say -3.0;
#----------------------------------------- 115 ladder__rung11_junctions_operator
if 1|2|3 == 2 {
    say "yes";
} else {
    say "no";
}
#------------------------------------------------- 116 ladder__rung12_exceptions
try {
    die "boom";
    CATCH {
        default { say "caught"; }
...
#------------------------------------- 117 ladder__rung12_exceptions_die_message
try {
    die "custom message";
    CATCH {
        default { say .message; }
...
#-------------------------------------------------------------------- 139 say_12
until ($x > 5) { say($x); }
#--------------------------------------------------------- 140 simple_assign_100
my $i = 7; say $i++;
#--------------------------------------------------------- 141 simple_assign_102
my $i = 5; my $j = --$i; say $j;
#--------------------------------------------------------- 142 simple_assign_105
my $i = 5; my $j = ++$i; say $j;
#--------------------------------------------------------- 143 simple_assign_106
my $i = 5; my $j = ++$i; say $i;
#--------------------------------------------------------- 144 simple_assign_110
my $x = 5; say "x is ", $x;
#--------------------------------------------------------- 145 simple_assign_111
my $x = 6; my $y = 7; say $x * $y;
#--------------------------------------------------------- 146 simple_assign_114
my $a = "zebra"; my $b = "apple"; say $a gt $b ?? "y" !! "n";
#--------------------------------------------------------- 147 simple_assign_115
my $x = 0 ?? 5 !! 9; say $x;
#--------------------------------------------------------- 148 simple_assign_116
my $g = "C"; say $g eq "A" ?? 1 !! $g eq "B" ?? 2 !! 3;
#--------------------------------------------------------- 149 simple_assign_117
my $n = 10; say $n > 3 ?? "big" !! "small";
#--------------------------------------------------------- 150 simple_assign_118
my $x = 1 ?? 5 !! 9; say $x;
#--------------------------------------------------------- 151 simple_assign_124
my $s; $s = "ab" x 3; say $s;
#--------------------------------------------------------- 152 simple_assign_125
my $s = "ab" x 3; say $s;
#--------------------------------------------------------- 153 simple_assign_126
my $n = 3; my $s = "ab" x $n; say $s;
#--------------------------------------------------------- 154 simple_assign_128
my $s = "yo"; my $n = 4; say $s x $n;
#----------------------------------------------------------- 155 simple_assign_2
my $r = 10 div $n;
#---------------------------------------------------------- 156 simple_assign_20
my $x = -5;
#---------------------------------------------------------- 157 simple_assign_21
my $y = -$x;
#---------------------------------------------------------- 158 simple_assign_26
 my $b = { say 9; }; $b(); $b(); 
#---------------------------------------------------------- 159 simple_assign_28
 my $b = { say 5; }; $b(); 
#---------------------------------------------------------- 160 simple_assign_29
 my $a = { say 1; }; my $b = { say 2; }; $b(); $a(); 
#----------------------------------------------------------- 161 simple_assign_3
my $r = $x div 3;
#---------------------------------------------------------- 162 simple_assign_67
my $x = 7; say $x.fmt("%03d");
#---------------------------------------------------------- 163 simple_assign_68
my $s = "hi"; say $s.fmt("[%5s]");
#---------------------------------------------------------- 164 simple_assign_69
my $i = 3; $i++; $i++; say $i;
#----------------------------------------------------------- 165 simple_assign_7
my $r = $x % 3;
#----------------------------------------------------------- 166 simple_assign_8
my $r = $x % $y % 2;
#---------------------------------------------------------- 167 simple_assign_89
my $i = 5; say $i--;
#---------------------------------------------------------- 168 simple_assign_98
my $i = 5; my $j = $i++; say $j;
#---------------------------------------------------------- 169 simple_assign_99
my $i = 5; my $j = $i++; say $i;
#------------------------------------------------------------------ 170 array_12
my @a = (10,20,30);
say @a[*].elems;
...
my %h = a => 1, b => 2, c => 3;
say %h.kv.elems;
#--------------------------------- 197 ladder__rung01_variables_type_constrained
my Int $x = 5;
say $x;
#-------------------------------------- 198 ladder__rung04_arrays_negative_index
my @a = (1, 2, 3);
say @a[*-1];
#--------------------------------------- 199 ladder__rung04_arrays_out_of_bounds
my @a = (1, 2, 3);
say @a[10].raku;
#----------------------------------------- 200 ladder__rung05_hashes_missing_key
my %h = (a => 1);
say %h{'z'}.raku;
#-------------------------------------------- 201 ladder__rung06_control_ternary
my $x = 5;
say $x > 3 ?? "big" !! "small";
#---------------------------------------------- 202 ladder__rung06_control_until
my $i = 0;
until ($i >= 3) { say $i; $i = $i + 1; }
#--------------------------------------- 203 ladder__rung07_subs_implicit_return
sub double($x) { $x * 2 }
say double(5);
#------------------------------------------------------------------- 204 multi_3
multi bar($x) { $x + 1 }
say bar(7);
#--------------------------------------------------------- 205 simple_assign_101
my $b = 5;
say $b ** 2;
#--------------------------------------------------------- 206 simple_assign_112
my $x = 10; my $y = 3;
say $x % $y;
#--------------------------------------------------------- 207 simple_assign_113
my $x = 10; my $y = 3;
say $x * $y;
#--------------------------------------------------------- 208 simple_assign_123
my $d = 42;
{ say "def" with $d }
#---------------------------------------------------------- 209 simple_assign_14
my $s = "hello";
say $s.chars();
#---------------------------------------------------------- 210 simple_assign_15
my $s = "HELLO";
say $s.lc();
#---------------------------------------------------------- 211 simple_assign_16
my $s = "hello world";
say $s.substr(6, 5);
#---------------------------------------------------------- 212 simple_assign_17
my $s = "  hi  ";
say $s.trim();
#---------------------------------------------------------- 213 simple_assign_18
my $s = "hello";
say $s.uc();
#---------------------------------------------------------- 214 simple_assign_38
my $n = 66;
say chr($n);
#----------------------------------------------------------- 215 simple_assign_4
my $obj = Foo.new(x => 1);
...
my $x = 3.14;
say $x;
#---------------------------------------------------------- 217 simple_assign_51
my $x = 0;
say $x // "oops";
#---------------------------------------------------------- 218 simple_assign_54
my ($a, $b) = (10, 20);
say $a + $b;
#---------------------------------------------------------- 219 simple_assign_55
my ($x, $y) = "foo", "bar";
say $y;
#---------------------------------------------------------- 220 simple_assign_56
my ($a, $b, $c) = 1, 2, 3;
say $c;
#----------------------------------------------------------- 221 simple_assign_6
my $q = $x div $y;
my $r = $x % $y;
#---------------------------------------------------------- 222 simple_assign_73
my $s = "hello";
say $s.chars;
#---------------------------------------------------------- 223 simple_assign_74
my $x = 5;
say "yes" with $x;
#---------------------------------------------------------- 224 simple_assign_76
my $x = 42;
say $_ with $x;
#---------------------------------------------------------- 225 simple_assign_77
my $x = 0;
say "z" with $x;
#---------------------------------------------------------- 226 simple_assign_85
my $i = 0;
until $i >= 3 { say $i; $i = $i + 1 }
#---------------------------------------------------------- 227 simple_assign_87
my $c = "z";
say $c.ord;
#--------------------------------------------------------- 228 simple_program_26
my $y;
say "gone" without $y;
#---------------------------------------------------------- 229 simple_program_9
my $x;
say $x // "default";
#-------------------------------------------------------------------- 230 sub_13
sub f(:$x = 5) { say $x; }
...
%h<foo> = "bar";
say %h<foo>;
#----------------------------- 251 ladder__rung01_variables_multiple_declaration
my ($a, $b) = (1, 2);
say $a;
say $b;
#----------------------------------- 252 ladder__rung01_variables_no_initializer
my $x;
$x = 5;
say $x;
#----------------------------------------------------- 253 ladder__rung05_hashes
my %h = a => 1, b => 2;
say %h{'a'};
say %h{'b'};
#----------------------------------------- 254 ladder__rung05_hashes_keys_values
my %h = (a => 1, b => 2);
say %h.keys.sort;
say %h.values.sort;
#--------------------------------------------- 255 ladder__rung09_string_methods
my $s = "Raku";
say $s.uc;
say $s.chars;
#------------------------------------- 256 ladder__rung10_given_when_basic_match
given 5 {
    when 5 { say "matched"; }
}
#--------------------------------------------------------- 257 simple_assign_103
my $n = 5;
--$n;
say $n;
#--------------------------------------------------------- 258 simple_assign_104
my $n = 5;
++$n;
say $n;
#---------------------------------------------------------- 259 simple_assign_19
my Int $x = 5;
my Str $s;
say $x;
#---------------------------------------------------------- 260 simple_assign_25
my $s = 1;
$s = 2;
say $s;
#---------------------------------------------------------- 261 simple_assign_39
my $x = 5;
$x += 3;
say $x;
#---------------------------------------------------------- 262 simple_assign_41
my $x = 24;
$x /= 6;
say $x;
#---------------------------------------------------------- 263 simple_assign_42
my $x = 6;
$x *= 4;
say $x;
#---------------------------------------------------------- 264 simple_assign_43
my $x = 7;
$x -= 4;
say $x;
#---------------------------------------------------------- 265 simple_assign_52
my ($a, $b) = 1, 2, 3;
say $a;
say $b;
#---------------------------------------------------------- 266 simple_assign_53
my ($a, $b, $c) = 1, 2;
say $a;
say $b;
#---------------------------------------------------------- 267 simple_assign_57
my ($a, $b) = 3, 7;
say $a;
say $b;
#---------------------------------------------------------- 268 simple_assign_58
my $h = 7/2;
say $h*2 == 7 ?? 7 !! 0;
say $h*2;
#---------------------------------------------------------- 269 simple_assign_78
my $x = 3;
say "nope" without $x;
say "end";
#---------------------------------------------------------- 270 simple_assign_97
my $i = 0;
$i = $i + 1 until $i >= 3;
say $i;
#--------------------------------------------------------- 271 simple_program_25
my $y;
say "nope" with $y;
say "end";
#----------------------------------------------------------------- 272 sub_say_3
...
#------------------------------------------------------------ 274 junction_say_6
    ...
    say(none(10, 20));
    say(one('x', 'y'));
#-------------------------------------------------- 275 ladder__rung01_variables
my $name = "Raku";
my $n = 42;
say $name;
say $n;
#----------------------------------------------------- 276 ladder__rung04_arrays
my @arr = (1, 2, 3);
say @arr[0];
say @arr[2];
say @arr.elems;
#--------------------------------------- 277 ladder__rung05_hashes_exists_delete
my %h = (a => 1);
say %h{'a'}:exists;
%h{'a'}:delete;
say %h{'a'}:exists;
#------------------------------------ 278 ladder__rung10_given_when_default_case
given 99 {
    when 1 { say "one"; }
    default { say "other"; }
}
#-------------------------- 279 ladder__rung10_given_when_no_match_falls_through
given 99 {
    when 1 { say "one"; }
}
say "after";
#--------------------------------------------------------- 280 simple_assign_109
my $n = 7;
repeat {
    say $n;
} until $n > 0;
#---------------------------------------------------------- 281 simple_assign_50
my $a = "ok";
my $b;
say $a // "nope";
say $b // "fallback";
#---------------------------------------------------------- 282 simple_assign_59
my $a = 5; my $b = 2;
say $a/$b;
my $c = 8; my $d = 2;
say $c/$d;
#---------------------------------------------------------- 283 simple_assign_75
my $x = 7;
my $r = 0;
$r = $_ with $x;
say $r;
#---------------------------------------------------------- 284 simple_assign_79
my $y;
my $r = 0;
$r = 9 without $y;
say $r;
#---------------------------------------------------------- 285 simple_assign_86
my ($a, $b, $c) = 3, 7;
say $a;
say $b;
say "end";
#-------------------------------------------- 286 ladder__rung04_arrays_push_pop
my @a = (1, 2);
@a.push(3);
say @a;
@a.pop;
say @a;
#----------------------------------- 287 ladder__rung10_given_when_multiple_when
given 2 {
    when 1 { say "one"; }
    when 2 { say "two"; }
    when 3 { say "three"; }
}
#-------------------------------------------------- 288 ladder__rung11_junctions
if any(1,2,3) == 2 {
    say "yes";
} else {
    say "no";
}
#---------------------------------------------- 289 ladder__rung11_junctions_all
if all(1,2,3) > 0 {
    say "yes";
} else {
    say "no";
}
#--------------------------------------------- 290 ladder__rung11_junctions_none
if none(1,2,3) == 5 {
    say "yes";
} else {
    say "no";
}
#---------------------------------------------- 291 ladder__rung11_junctions_one
if one(1,2,3) == 2 {
    say "yes";
} else {
    say "no";
}
#--------------------------------------------------------- 292 simple_assign_108
my $j = 10;
repeat {
    $j = $j + 1;
    say $j;
} until $j >= 12;
#---------------------------------------------------------- 293 simple_assign_90
my $i = 3;
$i--;
say $i;
$i--;
say $i;
#---------------------------------------------------------- 294 simple_assign_94
my $i = 0;
$i++;
say $i;
$i++;
say $i;
#------------------------------------------------- 295 ladder__rung02_arithmetic
my $a = 7;
my $b = 3;
say $a + $b;
say $a - $b;
...
#---------------------------------------------------------- 338 simple_assign_10
my $s = $a ~ $b;
#---------------------------------------------------------- 339 simple_assign_11
my $s = $a ~ $b ~ $c;
#---------------------------------------------------------- 340 simple_assign_12
my $s = 'hello' ~ ' ' ~ 'world';
#--------------------------------------------------------- 341 simple_assign_127
my $s = "ab" x 0; say "[" ~ $s ~ "]";
#---------------------------------------------------------- 342 simple_assign_13
my $s = $a ~ 'x' ~ $b;
#--------------------------------------------------------------------- 343 sub_6
 my $s = sub { say 8; }; $s(); 
#------------------------------------------------------------------ 344 array_37
...
#----------------------------------------------- 366 ladder__rung04_arrays_slice
my @a = (1, 2, 3, 4, 5);
say @a[1..3];
#--------------------------------------------- 367 ladder__rung06_control_unless
my $x = 5;
...
my $x = 0;
if ($x == 0) { die "zero"; }
#--------------------------------------------------------- 389 simple_assign_120
my $x = 5;
{ say "big" if $x > 3 }
#--------------------------------------------------------- 390 simple_assign_121
my $x = 1;
{ say "hi" unless $x }
#--------------------------------------------------------- 391 simple_assign_122
my $x = 0;
{ say "hi" unless $x }
#---------------------------------------------------------- 392 simple_assign_30
my $x = 5;
if ($x > 3) { say "big" }
#---------------------------------------------------------- 393 simple_assign_31
my $x = 5;
if 10 > $x > 1 { say "gt" }
#---------------------------------------------------------- 394 simple_assign_32
my $x = 5;
if 1 < $x < 10 { say "in" }
#---------------------------------------------------------- 395 simple_assign_33
my $x = 1;
if 1 <= $x < 10 { say "in" }
#---------------------------------------------------------- 396 simple_assign_34
my $a = 5;
if 1 < $a == 5 { say "m" }
#---------------------------------------------------------- 397 simple_assign_35
my $x = 50;
if 1 < $x < 10 { say "bad" } else { say "out" }
#---------------------------------------------------------- 398 simple_assign_36
my $x = 1;
if 1 < $x < 10 { say "bad" } else { say "out" }
#---------------------------------------------------------- 399 simple_assign_37
my $x = 5;
unless 1 < $x < 3 { say "fires" }
#---------------------------------------------------------- 400 simple_assign_60
my $n = 8;
if $n %% 2 { say "even" } else { say "odd" }
#---------------------------------------------------------- 401 simple_assign_61
my $n = 7;
if $n %% 2 { say "even" } else { say "odd" }
#---------------------------------------------------------- 402 simple_assign_72
my $i = 0;
until $i >= 10 { last if $i >= 2; say $i; $i = $i + 1 }
#---------------------------------------------------------- 403 simple_assign_81
my $x = 2;
if $x == 1 { say "one" } else { if $x == 2 { say "two" } else { say "other" } }
#---------------------------------------------------------- 404 simple_assign_82
my $x = 5;
if $x > 3 { say "big" }
#---------------------------------------------------------- 405 simple_assign_83
my $x = 2;
if $x > 3 { say "big" } else { say "small" }
#---------------------------------------------------------- 406 simple_assign_84
my $x = 2;
unless $x > 5 { say "not big" }
#---------------------------------------------------------- 407 simple_assign_88
my $x = 5;
if ($x > 3) { say "big"; }
#---------------------------------------------------------- 408 simple_assign_91
my $x = 1;
say "big" if $x > 3;
#---------------------------------------------------------- 409 simple_assign_93
my $x = 5;
say "big" if $x > 3;
#---------------------------------------------------------- 410 simple_assign_95
my $ok = 1;
print "hi" if $ok == 1;
#---------------------------------------------------------- 411 simple_assign_96
my $x = 2;
...
say('A');
say('B');
#--------------------------------------------------------- 441 simple_assign_107
my $x = 4; my $y = 9;
if ($x < $y) { say "ct" } else { say "cf" }
if (4 < 9) { say "lt" } else { say "lf" }
#--------------------------------------------------------- 442 simple_assign_119
my $x = 10;
{ $x = $x + 1 if $x > 5 }
say $x;
#---------------------------------------------------------- 443 simple_assign_40
my $s = "hello";
$s ~= " world";
say $s;
#---------------------------------------------------------- 444 simple_assign_80
my $a = 1;
my $b = 0;
...
#--------------------------------- 453 ladder__rung10_given_when_when_with_range
given 5 {
    when 1..3 { say "low"; }
    when 4..6 { say "mid"; }
    default { say "high"; }
}
#-------------------------------------------- 454 ladder__rung12_exceptions_fail
sub f {
    fail "oops";
}
my $r = f();
...
#----------------------------------- 456 ladder__rung12_exceptions_specific_type
try {
...
#----------------------------------------------------------------- 472 for_say_8
for <a b c> -> $x { say($x); }
#---------------------------------------------------------- 473 join_array_say_1
 my @a = (1, 2, 3); say(@a.join("-")); 
#--------------------------------------------------- 474 ladder__rung08_for_loop
for 1..3 -> $i { say $i; }
#---------------------------------------- 475 ladder__rung08_for_loop_nested_for
for 1..2 -> $i { for 1..2 -> $j { say "$i,$j"; } }
#------------------------------------------------------------ 476 loop_replace_3
loop (my $i = 0; $i < 10; $i++) { last if $i == 3; say $i; }
#------------------------------------------------------------ 477 loop_replace_4
loop (my $i = 0; $i < 4; $i++) { next if $i == 1; say $i; }
#---------------------------------------------------------- 478 smartmatch_say_2
 if ('abc' ~~ /^\d+$/) { say("match"); } else { say("nomatch"); } 
#---------------------------------------------------------- 479 smartmatch_say_3
 if ('abc123' ~~ /\d+/) { say("match"); } else { say("nomatch"); } 
#--------------------------------------------------------- 480 split_array_say_1
...
my $v = %h{"x"};
say($v);
#-------------------------------------------------------- 490 join_range_array_2
my @r = 1..5;
say @r[0,2,4].join(",");
#-------------------------------------------------------- 491 join_range_array_3
my @a = 10,20,30,40,50;
say @a[1..2].join(",");
#-------------------------------------------------------- 492 join_range_array_4
my @a = 1..4;
say @a.join(",");
#-------------------------------------------------------- 493 join_range_array_5
my @r = 10..20;
say @r[2..5].join(",");
#-------------------------------------------------------- 494 join_range_array_6
my @a = 1,2,3,4,5;
say @a[1..^4].join(",");
#-------------------------------------------------------- 495 join_range_array_7
my @a = 1,2,3,4,5;
say @a[0..2].join(",");
#-------------------------------------------------------- 496 join_range_array_8
my @a = 1,2,3,4,5;
say @a[1..3].join(",");
#-------------------------------------------------------- 497 join_range_array_9
my @a = 1,2,3,4,5;
say @a[2..2].join(",");
#---------------------------------------- 498 ladder__rung06_control_elsif_chain
my $x = 2;
if ($x == 1) { say "one"; } elsif ($x == 2) { say "two"; } else { say "other"; }
#------------------------------------------------------- 499 ladder__rung07_subs
...
#--------------------------------------------------- 544 class_method_replace_10
class C { method sq($n) { $n * $n } }
my $o = C.new;
say $o.sq(6);
#--------------------------------------------------- 545 class_method_replace_11
class C { method calc($n) { my $t = $n + 1; $t * 2 } }
my $o = C.new;
say $o.calc(4);
#--------------------------------------------------- 546 class_method_replace_14
class C { method answer { 42 } }
my $o = C.new;
say $o.answer();
#---------------------------------------------------- 547 class_method_replace_6
class C { method go() { 7 } }
my $x = C.new.go();
say $x;
#----------------------------------------------------------- 548 class_replace_1
...
my $i = 1;
say @a[$i,3].join(",");
#-------------------------------------------------------- 552 join_range_array_1
my @a = 9;
@a = 1..4;
say @a.join(",");
#--------------------------------------- 553 ladder__rung07_subs_optional_params
...
#----------------------------------- 576 ladder__rung13_classes_public_attribute
class Point {
    has $.x is rw;
    has $.y is rw;
}
...
#------------------------------------------------------ 623 class_say_replace_26
class Animal { has $.name; }
class Dog is Animal { }
 my $d = Dog.new(name => "Rex"); say($d.name); 
#------------------------------------------------------ 624 class_say_replace_27
role HasId { has $.id; }
...
#--------------------------------------------------- 637 class_method_replace_16
class C { method m($v = 42) { return $v } }
my $o = C.new;
say $o.m();
say $o.m(8);
#----------------------------------------------- 638 class_method_say_replace_35
class A { method TWEAK() { say("A"); } }
class B is A { method TWEAK() { say("B"); } }
class C is B { method TWEAK() { say("C"); } }
 my $c = C.new(); 
#------------------------------------------------------- 639 join_range_array_10
my @a = 1,2,3,4,5;
my $lo = 1;
my $hi = 3;
say @a[$lo..$hi].join(",");
#---------------------------------------- 640 ladder__rung07_subs_multi_dispatch
...
my $g = Greeter.new;
say $g.greet;
#------------------------------ 645 ladder__rung13_classes_named_arg_constructor
class Sum {
    has $.a;
    has $.b;
    method total { $!a + $!b }
...
say $s.total;
#------------------------------------------- 646 ladder__rung14_roles_smartmatch
role Flyer { }
...
my $w = Widget.new;
say $w.greet;
#--------------------------------------------- 649 ladder__rung14_roles_override
role Greeter {
...
my $s = Special.new;
say $s.greet;
#------------------------------------------- 650 ladder__rung14_roles_attributes
role Counter {
    has $.count is rw = 0;
    method inc { $!count++ }
}
...
$t.inc;
say $t.count;
#------------------------------------------ 651 ladder__rung14_roles_composition
role Flyer {
...
say $d.fly;
say $d.swim;
#---------------------------------- 652 ladder__rung13_classes_private_attribute
class Counter {
    has $!count;
    method init { $!count = 0 }
    method inc { $!count++ }
...
my @a = 7,8,9;
for @a { say($_); }
#-------------------------------------------------- 665 smartmatch_say_replace_1
my $s = "hello";
if ($s ~~ /e(l+)(o)/) { say($1); }
#-------------------------------------------------- 666 smartmatch_say_replace_2
my $s = "hello";
if ($s ~~ /(?<word>\w+)/) { say($<word>); }
#-------------------------------------------------- 667 smartmatch_say_replace_3
my $s = "hello";
if ($s ~~ /e(l+)/) { say($0); }
#-------------------------------------------------- 668 smartmatch_say_replace_4
my $s = "x";
if ($s ~~ /^x$/) { say("anchor"); }
#-------------------------------------------------- 669 smartmatch_say_replace_5
my $s = "hello world";
if ($s ~~ /\s+/) { say("space"); }
#-------------------------------------------------- 670 smartmatch_say_replace_6
my $s = "anything";
if ($s ~~ /.*/) { say("match"); }
#-------------------------------------------------- 671 smartmatch_say_replace_7
my $s = "hello";
if ($s ~~ /ell/) { say("match"); }
#------------------------------------------------- 672 class_array_say_replace_2
class Base { has @.log; }
class Derived is Base { has $.id; }
 my $d = Derived.new(id => 7); my @l = $d.log; say(@l.elems); 
#----------------------------------------------- 673 class_method_grep_replace_1
class C { method grep() { return 8 } }
my $o = C.new;
say $o.grep();
#------------------------------------------------ 674 class_method_map_replace_1
class C { method map($x) { return $x + 1 } }
my $o = C.new;
say $o.map(4);
#--------------------------------------------------- 675 class_method_replace_18
class Sayer { has $.t; method go() { say $!t } }
my $s = Sayer.new(t => "done");
if True { $s.go() }
#--------------------------------------------------- 676 class_method_replace_19
class C { has $.x; method greet() { return 3; } }
my $o = C.new;
say $o.greet();
#----------------------------------------------- 677 class_method_say_replace_51
role R { method who() { return "role"; } }
class C does R { method who() { return "class"; } }
 my $c = C.new(); say($c.who()); 
#----------------------------------------------- 678 class_method_sort_replace_2
class C { method sort() { return 99 } }
my $o = C.new;
say $o.sort;
#--------------------------------------------------------- 679 for_range_array_1
my @a = 0 xx 3;
for 0..2 -> $i { @a[$i] = $i * 10 }
say @a[0]; say @a[1]; say @a[2];
#---------------------------------------------------------- 680 for_range_hash_1
my %h;
for 1..2 -> $i { %h{$i} = $i * 100 }
say %h{1}; say %h{2};
#----------------------------------------------------------- 681 multi_sub_say_2
...
#----------------------------------------------- 684 class_method_say_replace_31
...
my $r = double(3);
say($r);
#----------------------------------------------- 697 class_method_sort_replace_1
class Widget {
...
#------------------------------------------------ 700 sub_junction_say_replace_1
...
#----------------------------------------------- 725 class_method_say_replace_25
...
#---------------------------------------- 730 ladder__rung13_classes_inheritance
class Animal {
    method speak { return "..." }
...
say $d.name;
say $d.greet();
#---------------------------------------------- 734 sub_smartmatch_say_replace_1
...
#---------------------------------------------- 736 sub_smartmatch_say_replace_2
...
#-------------------------------------------- 737 multi_sub_smartmatch_replace_1
...
#----------------------------------------------- 753 class_method_say_replace_15
class Point {
    has $.x;
    has $.y;
    method sum() { return $!x + $!y; }
...
#-------------------------------------------- 759 sub_regex_smartmatch_replace_1
...
#---------------------------------------------- 760 class_method_multi_replace_3
...
#----------------------------------------------- 761 sub_when_junction_replace_1
...
#--------------------------------------------------- 762 simple_program_18 XFAIL
say 7 %% 3;
#--------------------------------------------------- 763 simple_program_19 XFAIL
say 6 %% 3;
#--------------------------------------------------- 764 simple_program_20 XFAIL
say 0 %% 5;
#--------------------------------------------------- 765 simple_program_23 XFAIL
say "hello".ends-with("xy");
#--------------------------------------------------- 766 simple_program_24 XFAIL
say "hello".ends-with("lo");
#--------------------------------------------------- 767 simple_program_61 XFAIL
say "hello".starts-with("xy");
#--------------------------------------------------- 768 simple_program_62 XFAIL
say "hello".starts-with("he");
#--------------------------------------------------- 769 simple_program_10 XFAIL
say "before";
say 1/0;
say "after";
#-------------------------------------------------------------- 770 say_16 XFAIL
...
#-------------------------------------------------------------- 780 say_88 XFAIL
 say("  hi   there  ".words); 
#------------------------------------------------------ 781 say_replace_19 XFAIL
say (6 == 6);
#------------------------------------------------------ 782 say_replace_20 XFAIL
say (9 <= 9);
#------------------------------------------------------ 783 say_replace_22 XFAIL
say (3 != 4);
#-------------------------------------------------------------- 784 say_29 XFAIL
grammar G { rule TOP { "a" | "b" } }
 say(G.parse("a")); 
...
my @b = 3, 1, 2, 1;
say @b.unique;
#--------------------------------------------------------- 818 class_say_2 XFAIL
class Cat { }
 say(Cat.WHAT()); 
#----------------------------------------------------------- 819 say_try_1 XFAIL
    try { say('ok'); } CATCH { say('never'); }
    say('after');
#---------------------------------------------------- 820 simple_assign_23 XFAIL
my $d = Dog.new(name => "Rex");
say $d.name;
#---------------------------------------------------- 821 simple_assign_70 XFAIL
my $x = (42,);
say $x;
#---------------------------------------------------- 822 simple_assign_71 XFAIL
my $x = (1,2,3);
say $x;
#-------------------------------------------------------------- 823 sub_12 XFAIL
sub f(:$x) { say $x.defined; }
f();
#-------------------------------------------------------- 824 sub_array_17 XFAIL
sub f(*@r) { say @r; }
f("x","y","z");
#--------------------------------------------------------- 825 token_say_1 XFAIL
grammar G { token w { \w+ } rule TOP { "[" <w> "]" } }
 say(G.parse("[abc]")); 
#----------------------------------------------------- 826 array_replace_3 XFAIL
my @a = (1,2,3);
say "A";
say @a[99];
say "B";
#----------------------------------------------------- 827 array_replace_4 XFAIL
my @a = (10,20,30);
say "before";
say @a[3];
say "after";
...
#--------------------------------------------------------- 829 token_say_4 XFAIL
grammar G {
    token TOP { \d+ }
}

    say(G.parse("12345"));
#--------------------------------------------------------- 830 token_say_3 XFAIL
grammar G {
    token word { \w+ }
    rule TOP { <word> }
}
...
#---------------------------------------------------- 835 simple_assign_27 XFAIL
 my $b = { return 3; }; say $b() + $b(); 
#------------------------------------------------------------ 836 array_11 XFAIL
my $x = 5;
my @r = gather { take $x; };
#--------------------------------------------------------- 837 array_say_9 XFAIL
    my @a = (1, 2, 3);
    say(@a);
#--------------------------------------------------------- 838 join_hash_2 XFAIL
my %h = a => 1, b => 2, c => 3;
say %h.pairs.sort.join(" ");
#------------------------------------------------------ 839 say_replace_21 XFAIL
my $x = 4; my $y = 9;
say ($x < $y);
#------------------------------------------------------- 840 say_try_die_1 XFAIL
    try { die('boom'); CATCH { say('caught'); } }
    say('after');
#-------------------------------------------------------- 841 sub_array_16 XFAIL
sub f($a, *@r) { say @r; }
f(1,2,3);
#--------------------------------------------------------- 842 sub_array_8 XFAIL
sub f($a, **@r) { say @r; }
f(1,2,3);
#----------------------------------------------------------- 843 sub_say_9 XFAIL
sub f(Int $x) { say($x); }
...
my @r = gather { take $n; };
say @r;
#------------------------------------------------------- 845 say_try_die_3 XFAIL
    say('pre');
    try { die('a'); } CATCH { die('fatal-in-handler'); }
    say('unreached');
#--------------------------------------------------------- 846 array_say_3 XFAIL
    my @a = (10, 20, 30);
    say(elems(@a));
    my @e = '';
    say(elems(@e));
#--------------------------------------------------------- 847 array_say_5 XFAIL
    my @a = (1, 2, 3);
    my @r = reverse(@a);
    say(@r[0]);
    say(@r[1]);
    say(@r[2]);
#---------------------------------------------------------- 848 hash_say_5 XFAIL
    my %h = 0;
    %h<lang> = 'Raku';
    %h<vers> = '6';
    say(%h<lang>);
...
#------------------------------------------------------- 891 say_try_die_6 XFAIL
    my $n = 2;
    try { if ($n > 1) { die('cond'); } say('no'); } CATCH { say($_); }
    say('after');
#----------------------------------------- 892 class_method_say_replace_49 XFAIL
role A { method m() { return "a"; } }
role B { method m() { return "b"; } }
class C does A does B { }
 my $c = C.new(); say($c.m()); 
#------------------------------------------- 893 for_range_array_replace_1 XFAIL
my @a = (1,2,3);
for 0..4 -> $i {
    say @a[$i];
}
say "done";
#------------------------------------------ 894 class_method_say_replace_1 XFAIL
class Dog {
    has $.name;
    method speak() {
        say("woof");
...
#---------------------------------------- 914 class_method_range_replace_2 XFAIL
class Animal { has $.name; method speak() { return "..."; } }
class Dog is Animal { has $.breed; }
 my $d = Dog.new(name => "Rex", breed => "Lab"); say($d.^attributes); 
#---------------------------------------- 915 class_method_range_replace_3 XFAIL
