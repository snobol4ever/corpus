...
#----------------------------------------------------------- 10 simple_program_1
die "fatal error";
#---------------------------------------------------------- 11 simple_program_23
say "hello".ends-with("xy");
#---------------------------------------------------------- 12 simple_program_24
say "hello".ends-with("lo");
#---------------------------------------------------------- 13 simple_program_27
say ord("A");
#---------------------------------------------------------- 14 simple_program_28
say "Z".ord;
#---------------------------------------------------------- 15 simple_program_29
say 2 ** 10;
#---------------------------------------------------------- 16 simple_program_30
say 2 ** 3 ** 2;
#---------------------------------------------------------- 17 simple_program_31
say 3 + 2 ** 3;
#---------------------------------------------------------- 18 simple_program_32
say 2 * 3 ** 2;
#---------------------------------------------------------- 19 simple_program_33
say -2 ** 2;
#---------------------------------------------------------- 20 simple_program_34
print "a", "b"; say "";
#---------------------------------------------------------- 21 simple_program_37
say sqrt(2);
#---------------------------------------------------------- 22 simple_program_39
say [+] ();
#---------------------------------------------------------- 23 simple_program_40
say [+] (1, 2, 3, 4);
#---------------------------------------------------------- 24 simple_program_41
say [+] 5;
#---------------------------------------------------------- 25 simple_program_43
say [max] (3, 1, 4, 2);
#---------------------------------------------------------- 26 simple_program_44
say [min] (3, 1, 4, 2);
#---------------------------------------------------------- 27 simple_program_45
say [*] ();
#---------------------------------------------------------- 28 simple_program_46
say [*] (1, 2, 3, 4);
#---------------------------------------------------------- 29 simple_program_47
say [*] 7;
#---------------------------------------------------------- 30 simple_program_48
say [-] (1, 2, 3, 4);
#---------------------------------------------------------- 31 simple_program_49
say 1, 2, 3;
#----------------------------------------------------------- 32 simple_program_5
say chr(97);
#---------------------------------------------------------- 33 simple_program_50
say "a", "b", "c";
#---------------------------------------------------------- 34 simple_program_56
 say "b" ge "a" ?? "y" !! "n"; 
#---------------------------------------------------------- 35 simple_program_57
 say "b" gt "a" ?? "y" !! "n"; 
#---------------------------------------------------------- 36 simple_program_58
 say "abc" le "abc" ?? "y" !! "n"; 
#---------------------------------------------------------- 37 simple_program_59
 say "abc" lt "abd" ?? "y" !! "n"; 
#----------------------------------------------------------- 38 simple_program_6
say chr(65);
#---------------------------------------------------------- 39 simple_program_60
 say "10" lt "9" ?? "y" !! "n"; 
#---------------------------------------------------------- 40 simple_program_61
say "hello".starts-with("xy");
#---------------------------------------------------------- 41 simple_program_62
say "hello".starts-with("he");
#---------------------------------------------------------- 42 simple_program_63
say "hello".subst("l","L");
#---------------------------------------------------------- 43 simple_program_64
say "aaa".subst("a","bb");
#---------------------------------------------------------- 44 simple_program_65
say "hello".subst("xy","Z");
#---------------------------------------------------------- 45 simple_program_66
say <x y z>.elems;
#---------------------------------------------------------- 46 simple_program_67
say "ab" x 3;
#---------------------------------------------------------- 47 simple_program_69
say "-" x 5;
#----------------------------------------------------------- 48 simple_program_7
say 65.chr;
#---------------------------------------------------------- 49 simple_program_70
say 2 + 3 x 2;
#---------------------------------------------------------- 50 simple_program_72
say 7 x 2;
#---------------------------------------------------------- 51 simple_program_75
say "ab" x 3;
#----------------------------------------------------------- 52 simple_program_8
say chr(ord("Q"));
#-------------------------------------------------------------- 53 test_atom_int
...
#-------------------------------------------------- 60 test_stmt_ctrl_CATCH_free
CATCH { say "caught"; }
#--------------------------------------------------------- 61 test_stmt_ctrl_use
use v6;
#---------------------------------------------------------- 62 test_use_revision
use v6.e.PREVIEW; say "hi";
#-------------------------------------- 63 ladder__rung00_hello_print_no_newline
print "no newline";
say "end";
#-------------------------------- 64 ladder__rung02_arithmetic_negative_operands
say -7 % 2;
say -7 div 2;
#----------------------------------------------------------- 65 simple_assign_44
constant PI = 3;
...
constant N = 10;
say N + 5;
#---------------------------------------------------------- 67 simple_program_12
say 3 + 7/2;
say 7/2 - 2;
#---------------------------------------------------------- 68 simple_program_22
say 1;;
say 2;
#---------------------------------------------------------- 69 simple_program_38
print 4.0;
say "";
#---------------------------------------------------------- 70 simple_program_10
say "before";
say 1/0;
say "after";
#---------------------------------------------------------- 71 simple_program_13
say 7/2;
say 10/4;
say -7/2;
#---------------------------------------------------------- 72 simple_program_36
say 3.5;
say 10/4;
say -7/2;
#---------------------------------------------------------- 73 simple_program_11
say 8/2;
say 6/3;
say 9/3;
say 10/2;
...
#--------------------------------------------------------------------- 77 hash_3
say 255.fmt("%x");
#---------------------------------------- 78 ladder__rung03_strings_multi_concat
say "a" ~ "b" ~ "c";
#--------------------------------- 79 ladder__rung09_string_methods_split_method
say "a,b,c".split(",");
#--------------------------------------------------------------------- 80 say_15
{ say(42); }
#--------------------------------------------------------------------- 81 say_17
...
#-------------------------------------------------------------------- 106 say_88
 say("  hi   there  ".words); 
#--------------------------------------------------------- 107 simple_program_14
if 7 %% 3 { say "yes" } else { say "no" }
#--------------------------------------------------------- 108 simple_program_15
if 1 + 2 %% 3 { say "yes" } else { say "no" }
#--------------------------------------------------------- 109 simple_program_16
if 6 %% 3 { say "yes" } else { say "no" }
#--------------------------------------------------------- 110 simple_program_17
unless 10 %% 3 { say "notdiv" }
#---------------------------------------------------------- 111 simple_program_2
if 1 < 2 < 9 < 4 { say "bad" } else { say "out" }
#--------------------------------------------------------- 112 simple_program_21
if 0 %% 5 { say "yes" } else { say "no" }
#---------------------------------------------------------- 113 simple_program_3
if 1 < 2 < 3 < 4 { say "yes" }
#--------------------------------------------------------- 114 simple_program_35
print(1,2,3);
#---------------------------------------------------------- 115 simple_program_4
say chr(72) ~ chr(105);
#--------------------------------------------------------- 116 simple_program_42
say [~] (1, 2, 3, 4);
#--------------------------------------------------------- 117 simple_program_51
say sprintf("%08b", 5);
#--------------------------------------------------------- 118 simple_program_52
say sprintf("%.2f", 3.14159);
#--------------------------------------------------------- 119 simple_program_53
say sprintf("%-5d|", 42);
#--------------------------------------------------------- 120 simple_program_54
say sprintf("100%%");
#--------------------------------------------------------- 121 simple_program_55
say sprintf("%03d", 7);
#--------------------------------------------------------- 122 simple_program_68
say 1 ~ "x" x 3 ~ 2;
#--------------------------------------------------------- 123 simple_program_71
say "[" ~ ("q" x -2) ~ "]";
#--------------------------------------------------------- 124 simple_program_73
say 1 ~ "x" x 3 ~ 2;
#--------------------------------------------------------- 125 simple_program_74
say "a" ~ "b" x 2;
#--------------------------------------------------------- 126 simple_program_76
say "[" ~ ("z" x 0) ~ "]";
#---------------------------------------------------------- 127 test_assign_bare
$x = 5;
#----------------------------------------------------------- 128 test_atom_array
@a;
#------------------------------------------------------------ 129 test_atom_hash
%h;
#---------------------------------------------------------- 130 test_atom_scalar
$x;
#------------------------------------------------------- 131 test_bare_ident_arg
say(x);
#------------------------------------------------------------ 132 test_call_expr
say(add(1, 2));
#--------------------------------------------------------- 133 test_print_stderr
print($*STDERR, "error");
#----------------------------------------------------------- 134 test_say_stdout
say($*STDOUT, "hello");
#-------------------------------------------------------------- 135 test_say_var
say $x;
#--------------------------------------------------- 136 test_stmt_ctrl_loop_inf
loop { say "tick"; }
#------------------------------------------------------- 137 test_stmt_pfx_BEGIN
BEGIN { say("setup"); }
#------------------------------------------------------- 138 test_stmt_pfx_CHECK
CHECK { say("check"); }
#--------------------------------------------------------- 139 test_stmt_pfx_END
END { say("teardown"); }
#-------------------------------------------------------- 140 test_stmt_pfx_INIT
INIT { say("init"); }
#------------------------------------------------------- 141 test_stmt_pfx_eager
eager @a;
#------------------------------------------------------- 142 test_stmt_pfx_hyper
hyper @a;
#-------------------------------------------------------- 143 test_stmt_pfx_lazy
lazy @a;
#-------------------------------------------------------- 144 test_stmt_pfx_once
once { say("once"); }
#----------------------------------------------------- 145 test_stmt_pfx_quietly
quietly { say("quiet"); }
#-------------------------------------------------------- 146 test_stmt_pfx_race
race @a;
#------------------------------------------------------- 147 test_stmt_pfx_react
react { say("react"); }
#------------------------------------------------------------ 148 test_try_basic
try { say "safe"; }
#------------------------------------------------------------ 149 test_try_catch
try { die "oops"; } CATCH { say "caught"; }
#------------------------------------------------------ 150 test_try_catch_lower
try { die "boom"; } catch { say "handled"; }
#-------------------------------------------------------------------- 151 say_90
say("hello");
say(42);
#---------------------------------------------------------- 152 simple_assign_46
my constant GREETING = "hello";
say GREETING;
#---------------------------------------------------------- 153 simple_assign_47
my constant K = 3;
say K * K;
#---------------------------------------------------------- 154 simple_assign_48
constant $E = 2;
say $E;
#-------------------------------------------------------------------- 155 sub_26
sub t() { 42 }
...
sub greet() { "hi" }
say greet();
#---------------------------------------------------------- 157 simple_assign_49
constant A = "a";
constant B = "b";
say A ~ B;
#---------------------------------------- 158 ladder__rung12_exceptions_no_catch
try {
    die "swallowed";
}
say "after";
...
say 2.5+1.5;
say -3.0;
#----------------------------------------- 160 ladder__rung11_junctions_operator
if 1|2|3 == 2 {
    say "yes";
} else {
    say "no";
}
#------------------------------------------------- 161 ladder__rung12_exceptions
try {
    die "boom";
    CATCH {
        default { say "caught"; }
...
#------------------------------------- 162 ladder__rung12_exceptions_die_message
try {
    die "custom message";
    CATCH {
        default { say .message; }
...
#--------------------------------------------------------- 190 simple_assign_100
my $i = 7; say $i++;
#--------------------------------------------------------- 191 simple_assign_102
my $i = 5; my $j = --$i; say $j;
#--------------------------------------------------------- 192 simple_assign_105
my $i = 5; my $j = ++$i; say $j;
#--------------------------------------------------------- 193 simple_assign_106
my $i = 5; my $j = ++$i; say $i;
#--------------------------------------------------------- 194 simple_assign_110
my $x = 5; say "x is ", $x;
#--------------------------------------------------------- 195 simple_assign_111
my $x = 6; my $y = 7; say $x * $y;
#--------------------------------------------------------- 196 simple_assign_114
my $a = "zebra"; my $b = "apple"; say $a gt $b ?? "y" !! "n";
#--------------------------------------------------------- 197 simple_assign_115
my $x = 0 ?? 5 !! 9; say $x;
#--------------------------------------------------------- 198 simple_assign_116
my $g = "C"; say $g eq "A" ?? 1 !! $g eq "B" ?? 2 !! 3;
#--------------------------------------------------------- 199 simple_assign_117
my $n = 10; say $n > 3 ?? "big" !! "small";
#--------------------------------------------------------- 200 simple_assign_118
my $x = 1 ?? 5 !! 9; say $x;
#--------------------------------------------------------- 201 simple_assign_124
my $s; $s = "ab" x 3; say $s;
#--------------------------------------------------------- 202 simple_assign_125
my $s = "ab" x 3; say $s;
#--------------------------------------------------------- 203 simple_assign_126
my $n = 3; my $s = "ab" x $n; say $s;
#--------------------------------------------------------- 204 simple_assign_128
my $s = "yo"; my $n = 4; say $s x $n;
#----------------------------------------------------------- 205 simple_assign_2
my $r = 10 div $n;
#---------------------------------------------------------- 206 simple_assign_20
my $x = -5;
#---------------------------------------------------------- 207 simple_assign_21
my $y = -$x;
#---------------------------------------------------------- 208 simple_assign_26
 my $b = { say 9; }; $b(); $b(); 
#---------------------------------------------------------- 209 simple_assign_28
 my $b = { say 5; }; $b(); 
#---------------------------------------------------------- 210 simple_assign_29
 my $a = { say 1; }; my $b = { say 2; }; $b(); $a(); 
#----------------------------------------------------------- 211 simple_assign_3
my $r = $x div 3;
#---------------------------------------------------------- 212 simple_assign_67
my $x = 7; say $x.fmt("%03d");
#---------------------------------------------------------- 213 simple_assign_68
my $s = "hi"; say $s.fmt("[%5s]");
#---------------------------------------------------------- 214 simple_assign_69
my $i = 3; $i++; $i++; say $i;
#----------------------------------------------------------- 215 simple_assign_7
my $r = $x % 3;
#----------------------------------------------------------- 216 simple_assign_8
my $r = $x % $y % 2;
#---------------------------------------------------------- 217 simple_assign_89
my $i = 5; say $i--;
#---------------------------------------------------------- 218 simple_assign_98
my $i = 5; my $j = $i++; say $j;
#---------------------------------------------------------- 219 simple_assign_99
my $i = 5; my $j = $i++; say $i;
#--------------------------------------------------------------- 220 split_say_1
 say("a,b,c".split(",")); 
#------------------------------------------------------------ 221 test_arith_add
my $x = 1 + 2;
#---------------------------------------------------------- 222 test_arith_chain
my $x = 1 + 2 + 3;
#------------------------------------------------------------ 223 test_arith_mul
my $x = 6 * 7;
#----------------------------------------------------------- 224 test_arith_prec
...
#------------------------------------------------------------ 227 test_decl_hash
my %h = 9;
#------------------------------------------------------ 228 test_decl_scalar_int
my $x = 5;
#------------------------------------------------------ 229 test_decl_scalar_str
my $s = "hello";
#---------------------------------------------------------- 230 test_kebab_ident
my $s-address = 5; say $s-address;
#------------------------------------------------------------- 231 test_our_decl
our $a = 1; say $a;
#------------------------------------------------------- 232 test_qualified_term
...
my %h = a => 1, b => 2, c => 3;
say %h.kv.elems;
#--------------------------------- 263 ladder__rung01_variables_type_constrained
my Int $x = 5;
say $x;
#-------------------------------------- 264 ladder__rung04_arrays_negative_index
my @a = (1, 2, 3);
say @a[*-1];
#--------------------------------------- 265 ladder__rung04_arrays_out_of_bounds
my @a = (1, 2, 3);
say @a[10].raku;
#----------------------------------------- 266 ladder__rung05_hashes_missing_key
my %h = (a => 1);
say %h{'z'}.raku;
#-------------------------------------------- 267 ladder__rung06_control_ternary
my $x = 5;
say $x > 3 ?? "big" !! "small";
#---------------------------------------------- 268 ladder__rung06_control_until
my $i = 0;
until ($i >= 3) { say $i; $i = $i + 1; }
#--------------------------------------- 269 ladder__rung07_subs_implicit_return
sub double($x) { $x * 2 }
say double(5);
#------------------------------------------------------------------- 270 multi_3
multi bar($x) { $x + 1 }
say bar(7);
#--------------------------------------------------------- 271 simple_assign_101
my $b = 5;
say $b ** 2;
#--------------------------------------------------------- 272 simple_assign_112
my $x = 10; my $y = 3;
say $x % $y;
#--------------------------------------------------------- 273 simple_assign_113
my $x = 10; my $y = 3;
say $x * $y;
#--------------------------------------------------------- 274 simple_assign_123
my $d = 42;
{ say "def" with $d }
#---------------------------------------------------------- 275 simple_assign_14
my $s = "hello";
say $s.chars();
#---------------------------------------------------------- 276 simple_assign_15
my $s = "HELLO";
say $s.lc();
#---------------------------------------------------------- 277 simple_assign_16
my $s = "hello world";
say $s.substr(6, 5);
#---------------------------------------------------------- 278 simple_assign_17
my $s = "  hi  ";
say $s.trim();
#---------------------------------------------------------- 279 simple_assign_18
my $s = "hello";
say $s.uc();
#---------------------------------------------------------- 280 simple_assign_38
my $n = 66;
say chr($n);
#----------------------------------------------------------- 281 simple_assign_4
my $obj = Foo.new(x => 1);
...
my $x = 3.14;
say $x;
#---------------------------------------------------------- 283 simple_assign_51
my $x = 0;
say $x // "oops";
#---------------------------------------------------------- 284 simple_assign_54
my ($a, $b) = (10, 20);
say $a + $b;
#---------------------------------------------------------- 285 simple_assign_55
my ($x, $y) = "foo", "bar";
say $y;
#---------------------------------------------------------- 286 simple_assign_56
my ($a, $b, $c) = 1, 2, 3;
say $c;
#----------------------------------------------------------- 287 simple_assign_6
my $q = $x div $y;
my $r = $x % $y;
#---------------------------------------------------------- 288 simple_assign_73
my $s = "hello";
say $s.chars;
#---------------------------------------------------------- 289 simple_assign_74
my $x = 5;
say "yes" with $x;
#---------------------------------------------------------- 290 simple_assign_76
my $x = 42;
say $_ with $x;
#---------------------------------------------------------- 291 simple_assign_77
my $x = 0;
say "z" with $x;
#---------------------------------------------------------- 292 simple_assign_85
my $i = 0;
until $i >= 3 { say $i; $i = $i + 1 }
#---------------------------------------------------------- 293 simple_assign_87
my $c = "z";
say $c.ord;
#--------------------------------------------------------- 294 simple_program_26
my $y;
say "gone" without $y;
#---------------------------------------------------------- 295 simple_program_9
my $x;
say $x // "default";
#-------------------------------------------------------------------- 296 sub_12
...
sub f(*%h) { say %h{'z'}; }
f(z => 4, w => 5);
#--------------------------------------------------- 312 test_interp_leading_var
my $x = "world";
say "$x there";
#------------------------------------------------------ 313 test_interp_only_var
my $x = "hi";
say "$x";
#-------------------------------------------------------- 314 test_interp_simple
my $name = "world";
say "hello $name";
#-------------------------------------------------- 315 test_interp_trailing_lit
my $a = "foo";
say "val=$a!";
#---------------------------------------------------------- 316 test_print_basic
my $x = "hello";
print "$x\n";
#------------------------------------------------------------------ 317 array_14
my @n = (1,2,3,4);
...
%h<foo> = "bar";
say %h<foo>;
#----------------------------- 324 ladder__rung01_variables_multiple_declaration
my ($a, $b) = (1, 2);
say $a;
say $b;
#----------------------------------- 325 ladder__rung01_variables_no_initializer
my $x;
$x = 5;
say $x;
#----------------------------------------------------- 326 ladder__rung05_hashes
my %h = a => 1, b => 2;
say %h{'a'};
say %h{'b'};
#----------------------------------------- 327 ladder__rung05_hashes_keys_values
my %h = (a => 1, b => 2);
say %h.keys.sort;
say %h.values.sort;
#--------------------------------------------- 328 ladder__rung09_string_methods
my $s = "Raku";
say $s.uc;
say $s.chars;
#------------------------------------- 329 ladder__rung10_given_when_basic_match
given 5 {
    when 5 { say "matched"; }
}
#--------------------------------------------------------- 330 simple_assign_103
my $n = 5;
--$n;
say $n;
#--------------------------------------------------------- 331 simple_assign_104
my $n = 5;
++$n;
say $n;
#---------------------------------------------------------- 332 simple_assign_19
my Int $x = 5;
my Str $s;
say $x;
#---------------------------------------------------------- 333 simple_assign_25
my $s = 1;
$s = 2;
say $s;
#---------------------------------------------------------- 334 simple_assign_39
my $x = 5;
$x += 3;
say $x;
#---------------------------------------------------------- 335 simple_assign_41
my $x = 24;
$x /= 6;
say $x;
#---------------------------------------------------------- 336 simple_assign_42
my $x = 6;
$x *= 4;
say $x;
#---------------------------------------------------------- 337 simple_assign_43
my $x = 7;
$x -= 4;
say $x;
#---------------------------------------------------------- 338 simple_assign_52
my ($a, $b) = 1, 2, 3;
say $a;
say $b;
#---------------------------------------------------------- 339 simple_assign_53
my ($a, $b, $c) = 1, 2;
say $a;
say $b;
#---------------------------------------------------------- 340 simple_assign_57
my ($a, $b) = 3, 7;
say $a;
say $b;
#---------------------------------------------------------- 341 simple_assign_58
my $h = 7/2;
say $h*2 == 7 ?? 7 !! 0;
say $h*2;
#---------------------------------------------------------- 342 simple_assign_78
my $x = 3;
say "nope" without $x;
say "end";
#---------------------------------------------------------- 343 simple_assign_97
my $i = 0;
$i = $i + 1 until $i >= 3;
say $i;
#--------------------------------------------------------- 344 simple_program_25
my $y;
say "nope" with $y;
say "end";
#----------------------------------------------------------------- 345 sub_say_3
...
#------------------------------------------------------------ 349 junction_say_6
    ...
    say(none(10, 20));
    say(one('x', 'y'));
#-------------------------------------------------- 350 ladder__rung01_variables
my $name = "Raku";
my $n = 42;
say $name;
say $n;
#----------------------------------------------------- 351 ladder__rung04_arrays
my @arr = (1, 2, 3);
say @arr[0];
say @arr[2];
say @arr.elems;
#--------------------------------------- 352 ladder__rung05_hashes_exists_delete
my %h = (a => 1);
say %h{'a'}:exists;
%h{'a'}:delete;
say %h{'a'}:exists;
#------------------------------------ 353 ladder__rung10_given_when_default_case
given 99 {
    when 1 { say "one"; }
    default { say "other"; }
}
#-------------------------- 354 ladder__rung10_given_when_no_match_falls_through
given 99 {
    when 1 { say "one"; }
}
say "after";
#--------------------------------------------------------- 355 simple_assign_109
my $n = 7;
repeat {
    say $n;
} until $n > 0;
#---------------------------------------------------------- 356 simple_assign_50
my $a = "ok";
my $b;
say $a // "nope";
say $b // "fallback";
#---------------------------------------------------------- 357 simple_assign_59
my $a = 5; my $b = 2;
say $a/$b;
my $c = 8; my $d = 2;
say $c/$d;
#---------------------------------------------------------- 358 simple_assign_75
my $x = 7;
my $r = 0;
$r = $_ with $x;
say $r;
#---------------------------------------------------------- 359 simple_assign_79
my $y;
my $r = 0;
$r = 9 without $y;
say $r;
#---------------------------------------------------------- 360 simple_assign_86
my ($a, $b, $c) = 3, 7;
say $a;
say $b;
say "end";
#-------------------------------------------- 361 ladder__rung04_arrays_push_pop
my @a = (1, 2);
@a.push(3);
say @a;
@a.pop;
say @a;
#----------------------------------- 362 ladder__rung10_given_when_multiple_when
given 2 {
    when 1 { say "one"; }
    when 2 { say "two"; }
    when 3 { say "three"; }
}
#-------------------------------------------------- 363 ladder__rung11_junctions
if any(1,2,3) == 2 {
    say "yes";
} else {
    say "no";
}
#---------------------------------------------- 364 ladder__rung11_junctions_all
if all(1,2,3) > 0 {
    say "yes";
} else {
    say "no";
}
#--------------------------------------------- 365 ladder__rung11_junctions_none
if none(1,2,3) == 5 {
    say "yes";
} else {
    say "no";
}
#---------------------------------------------- 366 ladder__rung11_junctions_one
if one(1,2,3) == 2 {
    say "yes";
} else {
    say "no";
}
#--------------------------------------------------------- 367 simple_assign_108
my $j = 10;
repeat {
    $j = $j + 1;
    say $j;
} until $j >= 12;
#---------------------------------------------------------- 368 simple_assign_90
my $i = 3;
$i--;
say $i;
$i--;
say $i;
#---------------------------------------------------------- 369 simple_assign_94
my $i = 0;
$i++;
say $i;
$i++;
say $i;
#------------------------------------------------- 370 ladder__rung02_arithmetic
my $a = 7;
my $b = 3;
say $a + $b;
say $a - $b;
...
#---------------------------------------------------------- 415 simple_assign_10
my $s = $a ~ $b;
#---------------------------------------------------------- 416 simple_assign_11
my $s = $a ~ $b ~ $c;
#---------------------------------------------------------- 417 simple_assign_12
my $s = 'hello' ~ ' ' ~ 'world';
#--------------------------------------------------------- 418 simple_assign_127
my $s = "ab" x 0; say "[" ~ $s ~ "]";
#---------------------------------------------------------- 419 simple_assign_13
my $s = $a ~ 'x' ~ $b;
#--------------------------------------------------------------------- 420 sub_6
 my $s = sub { say 8; }; $s(); 
#--------------------------------------------------------------- 421 test_seq_op
...
#----------------------------------------------- 445 ladder__rung04_arrays_slice
my @a = (1, 2, 3, 4, 5);
say @a[1..3];
#--------------------------------------------- 446 ladder__rung06_control_unless
my $x = 5;
...
my $x = 0;
if ($x == 0) { die "zero"; }
#--------------------------------------------------------- 468 simple_assign_120
my $x = 5;
{ say "big" if $x > 3 }
#--------------------------------------------------------- 469 simple_assign_121
my $x = 1;
{ say "hi" unless $x }
#--------------------------------------------------------- 470 simple_assign_122
my $x = 0;
{ say "hi" unless $x }
#---------------------------------------------------------- 471 simple_assign_30
my $x = 5;
if ($x > 3) { say "big" }
#---------------------------------------------------------- 472 simple_assign_31
my $x = 5;
if 10 > $x > 1 { say "gt" }
#---------------------------------------------------------- 473 simple_assign_32
my $x = 5;
if 1 < $x < 10 { say "in" }
#---------------------------------------------------------- 474 simple_assign_33
my $x = 1;
if 1 <= $x < 10 { say "in" }
#---------------------------------------------------------- 475 simple_assign_34
my $a = 5;
if 1 < $a == 5 { say "m" }
#---------------------------------------------------------- 476 simple_assign_35
my $x = 50;
if 1 < $x < 10 { say "bad" } else { say "out" }
#---------------------------------------------------------- 477 simple_assign_36
my $x = 1;
if 1 < $x < 10 { say "bad" } else { say "out" }
#---------------------------------------------------------- 478 simple_assign_37
my $x = 5;
unless 1 < $x < 3 { say "fires" }
#---------------------------------------------------------- 479 simple_assign_60
my $n = 8;
if $n %% 2 { say "even" } else { say "odd" }
#---------------------------------------------------------- 480 simple_assign_61
my $n = 7;
if $n %% 2 { say "even" } else { say "odd" }
#---------------------------------------------------------- 481 simple_assign_72
my $i = 0;
until $i >= 10 { last if $i >= 2; say $i; $i = $i + 1 }
#---------------------------------------------------------- 482 simple_assign_81
my $x = 2;
if $x == 1 { say "one" } else { if $x == 2 { say "two" } else { say "other" } }
#---------------------------------------------------------- 483 simple_assign_82
my $x = 5;
if $x > 3 { say "big" }
#---------------------------------------------------------- 484 simple_assign_83
my $x = 2;
if $x > 3 { say "big" } else { say "small" }
#---------------------------------------------------------- 485 simple_assign_84
my $x = 2;
unless $x > 5 { say "not big" }
#---------------------------------------------------------- 486 simple_assign_88
my $x = 5;
if ($x > 3) { say "big"; }
#---------------------------------------------------------- 487 simple_assign_91
my $x = 1;
say "big" if $x > 3;
#---------------------------------------------------------- 488 simple_assign_93
my $x = 5;
say "big" if $x > 3;
#---------------------------------------------------------- 489 simple_assign_95
my $ok = 1;
print "hi" if $ok == 1;
#---------------------------------------------------------- 490 simple_assign_96
my $x = 2;
...
sub f(Str $s) { say($s); }
 f("hi"); 
#------------------------------------------------------ 509 test_bare_ident_expr
my $r = foo + 1;
say($r);
#-------------------------------------------------------- 510 test_handle_stderr
my $e = $*STDERR;
say($e);
#--------------------------------------------------------- 511 test_handle_stdin
my $line = $*STDIN;
say($line);
#-------------------------------------------------------- 512 test_handle_stdout
my $x = $*STDOUT;
say($x);
#----------------------------------------------------------- 513 test_lines_file
my @lines = lines("/tmp/test.txt");
say(@lines);
#---------------------------------------------------- 514 test_nested_call_arith
my $x = add(foo(), bar()) + 1;
say($x);
#--------------------------------------------------------- 515 test_nested_calls
my $n = length(trim($s));
say($n);
#----------------------------------------------------------- 516 test_slurp_file
my $content = slurp("/tmp/test.txt");
say($content);
#------------------------------------------------- 517 test_stmt_ctrl_loop_three
my $i = 0;
loop ($i = 0; $i < 3; $i = $i + 1) { say $i; }
#---------------------------------------------------------- 518 test_stmt_pfx_do
my $x = 1;
do { say($x); };
#--------------------------------------------------- 519 test_triple_nested_call
my $r = abs(int(sqrt($x)));
say($r);
#---------------------------------------------------------- 520 test_try_die_msg
my $msg = "bad";
...
say('A');
say('B');
#--------------------------------------------------------- 534 simple_assign_107
my $x = 4; my $y = 9;
if ($x < $y) { say "ct" } else { say "cf" }
if (4 < 9) { say "lt" } else { say "lf" }
#--------------------------------------------------------- 535 simple_assign_119
my $x = 10;
{ $x = $x + 1 if $x > 5 }
say $x;
#---------------------------------------------------------- 536 simple_assign_40
my $s = "hello";
$s ~= " world";
say $s;
#---------------------------------------------------------- 537 simple_assign_80
my $a = 1;
my $b = 0;
...
my @a = (1,2,3);
f(@a);
#------------------------------------------------------- 540 test_stmt_pfx_ENTER
my $x = 1;
ENTER { say("enter"); }
say($x);
#-------------------------------------------------------- 541 test_stmt_pfx_KEEP
my $x = 1;
KEEP { say("keep"); }
say($x);
#------------------------------------------------------- 542 test_stmt_pfx_LEAVE
my $x = 1;
LEAVE { say("leave"); }
say($x);
#-------------------------------------------------------- 543 test_stmt_pfx_POST
my $x = 5;
POST { say("post"); }
say($x);
#--------------------------------------------------------- 544 test_stmt_pfx_PRE
my $x = 5;
PRE { say("pre"); }
say($x);
#-------------------------------------------------------- 545 test_stmt_pfx_TEMP
my $x = 1;
TEMP { say("temp"); }
say($x);
#-------------------------------------------------------- 546 test_stmt_pfx_UNDO
my $x = 1;
UNDO { say("undo"); }
say($x);
#------------------------------------------------------------------- 547 while_5
...
#--------------------------------------------------------------- 553 array_say_5
    ...
    say(@r[1]);
    say(@r[2]);
#--------------------------------- 554 ladder__rung10_given_when_when_with_range
given 5 {
    when 1..3 { say "low"; }
    when 4..6 { say "mid"; }
    default { say "high"; }
}
#-------------------------------------------- 555 ladder__rung12_exceptions_fail
sub f {
    fail "oops";
}
my $r = f();
...
#---------------------------------------------- 557 benchmark_rc-man-or-boy-test
...
say A(10, {1}, {-1}, {-1}, {1}, {0});
#----------------------------------- 558 ladder__rung12_exceptions_specific_type
try {
...
#----------------------------------------------------------------- 576 for_say_8
for <a b c> -> $x { say($x); }
#---------------------------------------------------------- 577 join_array_say_1
 my @a = (1, 2, 3); say(@a.join("-")); 
#--------------------------------------------------- 578 ladder__rung08_for_loop
for 1..3 -> $i { say $i; }
#---------------------------------------- 579 ladder__rung08_for_loop_nested_for
for 1..2 -> $i { for 1..2 -> $j { say "$i,$j"; } }
#------------------------------------------------------------ 580 loop_replace_3
loop (my $i = 0; $i < 10; $i++) { last if $i == 3; say $i; }
#------------------------------------------------------------ 581 loop_replace_4
loop (my $i = 0; $i < 4; $i++) { next if $i == 1; say $i; }
#---------------------------------------------------------- 582 smartmatch_say_2
 if ('abc' ~~ /^\d+$/) { say("match"); } else { say("nomatch"); } 
#---------------------------------------------------------- 583 smartmatch_say_3
 if ('abc123' ~~ /\d+/) { say("match"); } else { say("nomatch"); } 
#--------------------------------------------------------- 584 split_array_say_1
...
my $v = %h{"x"};
say($v);
#-------------------------------------------------------- 594 join_range_array_2
my @r = 1..5;
say @r[0,2,4].join(",");
#-------------------------------------------------------- 595 join_range_array_3
my @a = 10,20,30,40,50;
say @a[1..2].join(",");
#-------------------------------------------------------- 596 join_range_array_4
my @a = 1..4;
say @a.join(",");
#-------------------------------------------------------- 597 join_range_array_5
my @r = 10..20;
say @r[2..5].join(",");
#-------------------------------------------------------- 598 join_range_array_6
my @a = 1,2,3,4,5;
say @a[1..^4].join(",");
#-------------------------------------------------------- 599 join_range_array_7
my @a = 1,2,3,4,5;
say @a[0..2].join(",");
#-------------------------------------------------------- 600 join_range_array_8
my @a = 1,2,3,4,5;
say @a[1..3].join(",");
#-------------------------------------------------------- 601 join_range_array_9
my @a = 1,2,3,4,5;
say @a[2..2].join(",");
#---------------------------------------- 602 ladder__rung06_control_elsif_chain
my $x = 2;
if ($x == 1) { say "one"; } elsif ($x == 2) { say "two"; } else { say "other"; }
#------------------------------------------------------- 603 ladder__rung07_subs
...
#--------------------------------------------------- 654 class_method_replace_10
class C { method sq($n) { $n * $n } }
my $o = C.new;
say $o.sq(6);
#--------------------------------------------------- 655 class_method_replace_11
class C { method calc($n) { my $t = $n + 1; $t * 2 } }
my $o = C.new;
say $o.calc(4);
#--------------------------------------------------- 656 class_method_replace_14
class C { method answer { 42 } }
my $o = C.new;
say $o.answer();
#---------------------------------------------------- 657 class_method_replace_6
class C { method go() { 7 } }
my $x = C.new.go();
say $x;
#----------------------------------------------------------- 658 class_replace_1
...
my $i = 1;
say @a[$i,3].join(",");
#-------------------------------------------------------- 663 join_range_array_1
my @a = 9;
@a = 1..4;
say @a.join(",");
#--------------------------------------- 664 ladder__rung07_subs_optional_params
...
#----------------------------------- 689 ladder__rung13_classes_public_attribute
class Point {
    has $.x is rw;
    has $.y is rw;
}
...
$p.x = 10;
say $p.x;
#----------------------------------------- 690 benchmark_pi-sequential-iteration
...
#------------------------------------------ 718 ladder__rung07_subs_named_params
sub greet(:$name) { return "hi " ~ $name; }
say greet(name => "Bob");
#------------------------------------ 719 ladder__rung08_for_loop_for_over_array
my @a = (10, 20, 30);
for @a -> $x { say $x; }
#------------------------------------ 720 ladder__rung08_for_loop_for_with_index
my @a = ("a", "b");
for @a.kv -> $i, $v { say "$i:$v"; }
#------------------------------------------------------ 721 method_say_replace_1
role Speaks { method talk() { return "hello"; } }
 my $s = Speaks.new(); say($s.talk()); 
#--------------------------------------------------------- 722 multi_sub_array_3
multi sub f($a, **@r) { say "L:" ~ @r.elems; }
f(1,2,3,4);
#--------------------------------------------------------- 723 multi_sub_array_4
...
#------------------------------------------------------ 739 class_say_replace_26
class Animal { has $.name; }
class Dog is Animal { }
 my $d = Dog.new(name => "Rex"); say($d.name); 
#------------------------------------------------------ 740 class_say_replace_27
role HasId { has $.id; }
...
#--------------------------------------------------- 753 class_method_replace_16
class C { method m($v = 42) { return $v } }
my $o = C.new;
say $o.m();
say $o.m(8);
#----------------------------------------------- 754 class_method_say_replace_35
class A { method TWEAK() { say("A"); } }
class B is A { method TWEAK() { say("B"); } }
class C is B { method TWEAK() { say("C"); } }
 my $c = C.new(); 
#------------------------------------------------------- 755 join_range_array_10
my @a = 1,2,3,4,5;
my $lo = 1;
my $hi = 3;
say @a[$lo..$hi].join(",");
#---------------------------------------- 756 ladder__rung07_subs_multi_dispatch
...
#------------------------------------------------------- 759 test_stmt_pfx_FIRST
for 1..3 -> $i {
    FIRST { say("first"); }
    say($i);
}
#-------------------------------------------------------- 760 test_stmt_pfx_LAST
for 1..3 -> $i {
    LAST { say("last"); }
    say($i);
}
#-------------------------------------------------------- 761 test_stmt_pfx_NEXT
for 1..3 -> $i {
    NEXT { say("next"); }
    say($i);
}
#------------------------------------------------------ 762 test_nested_if_while
my $i = 0;
if ($i == 0) {
    while ($i < 3) { $i = $i + 1; }
}
say($i);
#------------------------------------------------------- 763 token_say_replace_1
grammar G {
    token TOP { \d+ }
}
...
my $g = Greeter.new;
say $g.greet;
#------------------------------ 765 ladder__rung13_classes_named_arg_constructor
class Sum {
    has $.a;
    has $.b;
    method total { $!a + $!b }
...
say $s.total;
#------------------------------------------- 766 ladder__rung14_roles_smartmatch
role Flyer { }
...
my $w = Widget.new;
say $w.greet;
#--------------------------------------------- 769 ladder__rung14_roles_override
role Greeter {
...
my $s = Special.new;
say $s.greet;
#------------------------------------------- 770 ladder__rung14_roles_attributes
role Counter {
    has $.count is rw = 0;
    method inc { $!count++ }
}
...
$t.inc;
say $t.count;
#------------------------------------------ 771 ladder__rung14_roles_composition
role Flyer {
...
say $d.fly;
say $d.swim;
#---------------------------------- 772 ladder__rung13_classes_private_attribute
class Counter {
    has $!count;
    method init { $!count = 0 }
    method inc { $!count++ }
...
my @a = 7,8,9;
for @a { say($_); }
#-------------------------------------------------- 788 smartmatch_say_replace_1
my $s = "hello";
if ($s ~~ /e(l+)(o)/) { say($1); }
#-------------------------------------------------- 789 smartmatch_say_replace_2
my $s = "hello";
if ($s ~~ /(?<word>\w+)/) { say($<word>); }
#-------------------------------------------------- 790 smartmatch_say_replace_3
my $s = "hello";
if ($s ~~ /e(l+)/) { say($0); }
#-------------------------------------------------- 791 smartmatch_say_replace_4
my $s = "x";
if ($s ~~ /^x$/) { say("anchor"); }
#-------------------------------------------------- 792 smartmatch_say_replace_5
my $s = "hello world";
if ($s ~~ /\s+/) { say("space"); }
#-------------------------------------------------- 793 smartmatch_say_replace_6
my $s = "anything";
if ($s ~~ /.*/) { say("match"); }
#-------------------------------------------------- 794 smartmatch_say_replace_7
my $s = "hello";
if ($s ~~ /ell/) { say("match"); }
#------------------------------------------------- 795 class_array_say_replace_2
class Base { has @.log; }
class Derived is Base { has $.id; }
 my $d = Derived.new(id => 7); my @l = $d.log; say(@l.elems); 
#----------------------------------------------- 796 class_method_grep_replace_1
class C { method grep() { return 8 } }
my $o = C.new;
say $o.grep();
#------------------------------------------------ 797 class_method_map_replace_1
class C { method map($x) { return $x + 1 } }
my $o = C.new;
say $o.map(4);
#--------------------------------------------------- 798 class_method_replace_18
class Sayer { has $.t; method go() { say $!t } }
my $s = Sayer.new(t => "done");
if True { $s.go() }
#--------------------------------------------------- 799 class_method_replace_19
class C { has $.x; method greet() { return 3; } }
my $o = C.new;
say $o.greet();
#----------------------------------------------- 800 class_method_say_replace_51
role R { method who() { return "role"; } }
class C does R { method who() { return "class"; } }
 my $c = C.new(); say($c.who()); 
#----------------------------------------------- 801 class_method_sort_replace_2
class C { method sort() { return 99 } }
my $o = C.new;
say $o.sort;
#--------------------------------------------------------- 802 for_range_array_1
my @a = 0 xx 3;
for 0..2 -> $i { @a[$i] = $i * 10 }
say @a[0]; say @a[1]; say @a[2];
#---------------------------------------------------------- 803 for_range_hash_1
my %h;
for 1..2 -> $i { %h{$i} = $i * 100 }
say %h{1}; say %h{2};
#----------------------------------------------------------- 804 multi_sub_say_2
...
#----------------------------------------------- 807 class_method_say_replace_31
...
my $r = double(3);
say($r);
#----------------------------------------------- 820 class_method_sort_replace_1
class Widget {
...
say $w.sort;
say $w.reverse;
#---------------------------------------------- 821 benchmark_divide-and-conquer
my \SCALE = 10;
my \FANOUT = 2;
...
#------------------------------------------------ 824 sub_junction_say_replace_1
...
#----------------------------------------------- 850 class_method_say_replace_25
...
#---------------------------------------- 855 ladder__rung13_classes_inheritance
class Animal {
    method speak { return "..." }
...
#---------------------------------------- 859 benchmark_rc-forest-fire-stringify
...
say $d.name;
say $d.greet();
#---------------------------------------------- 861 sub_smartmatch_say_replace_1
...
#---------------------------------------------- 863 sub_smartmatch_say_replace_2
...
#------------------------------------------------ 864 benchmark_point_class_add2
...
print $a.x, ' ', $a.y;
#-------------------------------------------- 865 multi_sub_smartmatch_replace_1
...
#------------------------------------------- 866 benchmark_send-more-money-loops
# ⛔⭐ SELF-TIMED ON THE TWO-NUMBER BASIS (Lon 2026-08-30, RULES.md § THE TWO-NUMBER BENCHMARK BASIS).
...
#----------------------------------------------- 882 class_method_say_replace_15
class Point {
    has $.x;
    has $.y;
    method sum() { return $!x + $!y; }
...
class Dog {
    ...
    say($d.name);
    say($d.greet());
#------------------------------------------- 883 scrip_test_rk_seq_consumers_arr
...
main();
#---------------------------------------------- 884 benchmark_rc-9-billion-names
my @todo = $[1];
my @sums = 0;
sub nextrow($n) {
    for +@todo .. $n -> $l {
...
#---------------------------------------------- 891 benchmark_rc-perfect-shuffle
use v6;
...
#----------------------------------------------- 892 scrip_test_rk_array_literal
...
main();
#-------------------------------------------- 893 sub_regex_smartmatch_replace_1
...
#---------------------------------------------- 894 class_method_multi_replace_3
...
#-------------------------------------- 895 benchmark_rc-self-describing-numbers
sub is_selfdesc($n) {
    my $s = $n.Str;
    my $chars = $s.chars;
    my @a = +«$s.comb;
...
#----------------------------------------------- 896 sub_when_junction_replace_1
...
merge-sort @a;
say @a[0];
#------------------------------------------------ 901 benchmark_point_class_add1
# Point Class Benchmarks
...
main();
#--------------------------------------------------- 903 simple_program_18 XFAIL
say 7 %% 3;
#--------------------------------------------------- 904 simple_program_19 XFAIL
say 6 %% 3;
#--------------------------------------------------- 905 simple_program_20 XFAIL
say 0 %% 5;
#-------------------------------------------------------------- 906 say_16 XFAIL
{ say(1); } say(2);
#-------------------------------------------------------------- 907 say_62 XFAIL
...
#-------------------------------------------------------------- 910 say_80 XFAIL
    say(reverse('abc'));
#------------------------------------------------------ 911 say_replace_19 XFAIL
say (6 == 6);
#------------------------------------------------------ 912 say_replace_20 XFAIL
say (9 <= 9);
#------------------------------------------------------ 913 say_replace_22 XFAIL
say (3 != 4);
#-------------------------------------------------------------- 914 say_29 XFAIL
grammar G { rule TOP { "a" | "b" } }
 say(G.parse("a")); 
...
my @b = 3, 1, 2, 1;
say @b.unique;
#--------------------------------------------------------- 939 class_say_2 XFAIL
class Cat { }
 say(Cat.WHAT()); 
#----------------------------------------------------------- 940 say_try_1 XFAIL
    try { say('ok'); } CATCH { say('never'); }
    say('after');
#---------------------------------------------------- 941 simple_assign_23 XFAIL
my $d = Dog.new(name => "Rex");
say $d.name;
#---------------------------------------------------- 942 simple_assign_70 XFAIL
my $x = (42,);
say $x;
#---------------------------------------------------- 943 simple_assign_71 XFAIL
my $x = (1,2,3);
say $x;
#--------------------------------------------------------- 944 token_say_1 XFAIL
grammar G { token w { \w+ } rule TOP { "[" <w> "]" } }
 say(G.parse("[abc]")); 
#----------------------------------------------------- 945 array_replace_3 XFAIL
my @a = (1,2,3);
say "A";
say @a[99];
say "B";
#----------------------------------------------------- 946 array_replace_4 XFAIL
my @a = (10,20,30);
say "before";
say @a[3];
say "after";
...
#--------------------------------------------------------- 948 token_say_4 XFAIL
grammar G {
    token TOP { \d+ }
}

    say(G.parse("12345"));
#--------------------------------------------------------- 949 token_say_3 XFAIL
grammar G {
    token word { \w+ }
    rule TOP { <word> }
}
...
#---------------------------------------------------- 952 simple_assign_27 XFAIL
 my $b = { return 3; }; say $b() + $b(); 
#------------------------------------------------------------ 953 array_11 XFAIL
my $x = 5;
my @r = gather { take $x; };
#--------------------------------------------------------- 954 join_hash_2 XFAIL
my %h = a => 1, b => 2, c => 3;
say %h.pairs.sort.join(" ");
#------------------------------------------------------ 955 say_replace_21 XFAIL
my $x = 4; my $y = 9;
say ($x < $y);
#------------------------------------------------------- 956 say_try_die_1 XFAIL
...
my @r = gather { take $n; };
say @r;
#------------------------------------------------------- 959 say_try_die_3 XFAIL
    say('pre');
    try { die('a'); } CATCH { die('fatal-in-handler'); }
    say('unreached');
#--------------------------------------------------------- 960 array_say_3 XFAIL
    my @a = (10, 20, 30);
    say(elems(@a));
    my @e = '';
    say(elems(@e));
#---------------------------------------------------------- 961 hash_say_5 XFAIL
    my %h = 0;
    %h<lang> = 'Raku';
    %h<vers> = '6';
    say(%h<lang>);
...
#--------------------------------------------------------- 976 array_say_4 XFAIL
    ...
    say($p);
    say(elems(@nums));
#----------------------------------------------------- 977 for_range_say_2 XFAIL
for 1..^5 -> $i { say($i); }
#----------------------------------------------------- 978 for_range_say_4 XFAIL
 for 1..3 -> $v { say($v); } say('done'); 
#------------------------------------------------ 979 class_say_replace_18 XFAIL
class Q { has $.x; }
 my $q = Q.new(x => 1); $q.x = 5; say("unreached"); 
#------------------------------------------------ 980 class_say_replace_21 XFAIL
class Empty { has $.x; }
 my $e = Empty.new(x => 1); say($e); 
#------------------------------------------------ 981 class_say_replace_28 XFAIL
class Point { has $.x; }
 my $p = Point.new(x => 1); say($p.WHAT); 
#------------------------------------------------- 982 class_say_replace_5 XFAIL
class Config { has %.opts; }
 my $c = Config.new(); my $h = $c.opts; say(hash_exists($h, 'x')); 
#------------------------------------------------- 983 class_say_replace_6 XFAIL
class Point { has $.x is required; has $.y; }
 my $p = Point.new(y => 9); say("unreached"); 
#------------------------------------------------ 984 class_say_replace_29 XFAIL
class Animal { has $.name; }
class Dog is Animal { }
 my $d = Dog.new(name => "Rex"); say($d.WHAT); 
#----------------------------------------------------- 985 for_range_say_6 XFAIL
    for grep { $_ > 2 } 1..5 -> $v {
        say($v);
    }
    say('done');
#----------------------------------------------------- 986 for_range_say_7 XFAIL
    for map { $_ * 2 } 1..3 -> $v {
        say($v);
    }
    say('done');
#------------------------------------------------------- 987 sub_say_try_1 XFAIL
sub boomer() { die('deep'); say('sub-after'); }

    try { boomer(); say('body-after'); } CATCH { say($_); }
    say('after');
#------------------------------------------------------- 988 say_try_die_5 XFAIL
    try {
        try { die('a'); } CATCH { die('b'); }
        say('unreached');
    } CATCH { say('outer:' ~ $_); }
    say('after');
#-------------------------------------------------- 989 class_method_say_2 XFAIL
class Greeter {
    has $.name;
    method greet($msg) {
        say($msg);
...
#------------------------------------------------------- 999 say_try_die_6 XFAIL
    my $n = 2;
    try { if ($n > 1) { die('cond'); } say('no'); } CATCH { say($_); }
    say('after');
#---------------------------------------- 1000 class_method_say_replace_49 XFAIL
role A { method m() { return "a"; } }
role B { method m() { return "b"; } }
class C does A does B { }
 my $c = C.new(); say($c.m()); 
#------------------------------------------ 1001 for_range_array_replace_1 XFAIL
my @a = (1,2,3);
for 0..4 -> $i {
    say @a[$i];
}
say "done";
#----------------------------------------- 1002 class_method_say_replace_1 XFAIL
class Dog {
    has $.name;
    method speak() {
        say("woof");
...
#--------------------------------------- 1022 class_method_range_replace_2 XFAIL
class Animal { has $.name; method speak() { return "..."; } }
class Dog is Animal { has $.breed; }
 my $d = Dog.new(name => "Rex", breed => "Lab"); say($d.^attributes); 
#--------------------------------------- 1023 class_method_range_replace_3 XFAIL
