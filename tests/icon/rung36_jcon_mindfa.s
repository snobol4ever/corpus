...
showdfa_γ:
                        mov              rdi, rax
                        mov              rsi, rdx
                        add              rsp, 1776;                           jmp   qword ptr [rsp]
#-----------------------------------------------------------------------------------------------------------------------
showdfa_ω:
                        add              rsp, 1776;                           jmp   qword ptr [rsp + 8]
#-----------------------------------------------------------------------------------------------------------------------
showdfa_dcα:
                        pop              r12
                        push             r12
...
writeset_γ:
                        mov              rdi, rax
                        mov              rsi, rdx
                        add              rsp, 544;                            jmp   qword ptr [rsp]
#-----------------------------------------------------------------------------------------------------------------------
writeset_ω:
                        add              rsp, 544;                            jmp   qword ptr [rsp + 8]
#-----------------------------------------------------------------------------------------------------------------------
writeset_dcα:
                        pop              r12
                        push             r12
...
.Lx547_0:               mov              rdi, qword ptr [rsp + 2832]
                        ...
                        cmp              al, 104;                             je    n385_disjunction_α
                                                                              jmp   n370_assign_α
...
.Lx752_0:               mov              rdi, qword ptr [rsp + 480]
                        ...
                        mov              qword ptr [rsp + 448], rax
                        mov              qword ptr [rsp + 456], rdx
                        cmp              al, 104;                             je    n385_disjunction_af
                                                                              jmp   n509_assign_α
...
minimize_γ:
                        mov              rdi, rax
                        mov              rsi, rdx
                        add              rsp, 3536;                           jmp   qword ptr [rsp]
#-----------------------------------------------------------------------------------------------------------------------
minimize_ω:
                        add              rsp, 3536;                           jmp   qword ptr [rsp + 8]
#-----------------------------------------------------------------------------------------------------------------------
minimize_dcα:
                        pop              r12
                        push             r12
...
n843_binop_α:           mov              r11, 342
                        ...
                        mov              qword ptr [rsp + 3312], rax
                        mov              qword ptr [rsp + 3320], rdx;         jmp   n844_assign_α
#-----------------------------------------------------------------------------------------------------------------------
...
n869_binop_α:           mov              r11, 368
                        ...
                        mov              qword ptr [rsp + 2784], rax
                        mov              qword ptr [rsp + 2792], rdx;         jmp   n870_assign_α
#-----------------------------------------------------------------------------------------------------------------------
...
makemdfa_γ:
                        mov              rdi, rax
                        mov              rsi, rdx
                        add              rsp, 3808;                           jmp   qword ptr [rsp]
#-----------------------------------------------------------------------------------------------------------------------
makemdfa_ω:
                        add              rsp, 3808;                           jmp   qword ptr [rsp + 8]
#-----------------------------------------------------------------------------------------------------------------------
makemdfa_dcα:
                        pop              r12
                        push             r12
...
n1268_binop_α:          mov              r11, 505
                        ...
                        mov              qword ptr [rsp + 224], rax
                        mov              qword ptr [rsp + 232], rdx;          jmp   n1269_var_α
#-----------------------------------------------------------------------------------------------------------------------
...
equiv_dcα:
                        ...
                        mov              r11, qword ptr [rip + rtccb+64]
                        add              rsp, 16
                        lea              rcx, [rip + .Lx1295_3]
                        push             rcx
                        lea              rcx, [rip + .Lx1295_2]
                        push             rcx;                                 jmp   FN__equiv
.Lx1295_2:              add              rsp, 24
                        pop              r12;                                 jmp   r12
.Lx1295_3:              add              rsp, 24
                        pop              r12
...
equivdelta_dcα:
                        ...
                        mov              r11, qword ptr [rip + rtccb+64]
                        add              rsp, 32
                        lea              rcx, [rip + .Lx1338_3]
                        push             rcx
                        lea              rcx, [rip + .Lx1338_2]
                        push             rcx;                                 jmp   FN__equivdelta
.Lx1338_2:              add              rsp, 24
                        pop              r12;                                 jmp   r12
.Lx1338_3:              add              rsp, 24
                        pop              r12
...
finalstates_dcα:
                        ...
                        mov              r11, qword ptr [rip + rtccb+64]
                        add              rsp, 16
                        lea              rcx, [rip + .Lx1412_3]
                        push             rcx
                        lea              rcx, [rip + .Lx1412_2]
                        push             rcx;                                 jmp   FN__finalstates
.Lx1412_2:              add              rsp, 24
                        pop              r12;                                 jmp   r12
.Lx1412_3:              add              rsp, 24
                        pop              r12
...
n1418_binop_α:          mov              r11, 560
                        ...
                        cmp              al, 104;                             je    n1420_lit_charset_α
                        mov              qword ptr [rsp + 448], rax
                        mov              qword ptr [rsp + 456], rdx;          jmp   n1419_assign_α
#-----------------------------------------------------------------------------------------------------------------------
...
n1425_binop_α:          mov              r11, 567
                        ...
                        cmp              al, 104;                             je    n1427_make_list_α
                        mov              qword ptr [rsp + 352], rax
                        mov              qword ptr [rsp + 360], rdx;          jmp   n1426_assign_α
#-----------------------------------------------------------------------------------------------------------------------
...
n1432_binop_α:          mov              r11, 574
                        ...
                        mov              qword ptr [rsp + 272], rax
                        mov              qword ptr [rsp + 280], rdx;          jmp   n1433_iterate_α
#-----------------------------------------------------------------------------------------------------------------------
...
diff_dcα:
                        ...
                        mov              r11, qword ptr [rip + rtccb+64]
                        add              rsp, 16
                        lea              rcx, [rip + .Lx1486_3]
                        push             rcx
                        lea              rcx, [rip + .Lx1486_2]
                        push             rcx;                                 jmp   FN__diff
.Lx1486_2:              add              rsp, 24
                        pop              r12;                                 jmp   r12
.Lx1486_3:              add              rsp, 24
                        pop              r12
