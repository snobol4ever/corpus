...
`rung36_jcon_collate.icn` `rung36_jcon_geddump.icn`
...
`rung36_jcon_sorting.icn` `rung36_jcon_struct.icn` `rung36_jcon_errkwds.icn`
...
accountable. They are now IN the denominator, which is the honest form of the same fact.
...
which alone is sufficient: the icon master format cannot yet carry a stdin sidecar, and its stored
