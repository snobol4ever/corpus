...
n2_lit_string_α:        mov              r11, 3
                        ...
                        mov              qword ptr [rsp + 344], rax;          jmp   n3_var_ref_α
.Lx15_0:                .quad            .Lx15_0_s
.Lx15_0_s:              .string          "digit"
#-----------------------------------------------------------------------------------------------------------------------
n3_var_ref_α:           mov              r11, 4
                        mov              rax, 4294967336
                        lea              rdx, [rsp + 352]
                        mov              qword ptr [rsp + 256], rax
                        mov              qword ptr [rsp + 264], rdx;          jmp   n4_call_builtin_prolog_α
#-----------------------------------------------------------------------------------------------------------------------
...
n4_call_builtin_prolog_β:
                        mov              r11, 5;                              jmp   n12_call_builtin_prolog_α
#-----------------------------------------------------------------------------------------------------------------------
