...
n2_call_builtin_prolog_β:
                        mov              r11, 3;                              jmp   n16_call_builtin_prolog_α
#-----------------------------------------------------------------------------------------------------------------------
...
n5_call_builtin_prolog_β:
                        mov              r11, 6;                              jmp   n16_call_builtin_prolog_α
#-----------------------------------------------------------------------------------------------------------------------
...
n9_call_builtin_prolog_β:
                        mov              r11, 10;                             jmp   n5_call_builtin_prolog_α
#-----------------------------------------------------------------------------------------------------------------------
...
n11_call_builtin_prolog_β:
                        mov              r11, 12;                             jmp   n5_call_builtin_prolog_α
#-----------------------------------------------------------------------------------------------------------------------
...
n13_call_builtin_prolog_β:
                        mov              r11, 14;                             jmp   n5_call_builtin_prolog_α
#-----------------------------------------------------------------------------------------------------------------------
n14_move_label_α:       mov              r11, 15
...
n15_disjunction_α:      mov              r11, 16
                        ...
                        test             rax, rax;                            je    main_ω
                                                                              jmp   rax
n15_disjunction_β:      mov              r11, 16;                             jmp   main_ω
#-----------------------------------------------------------------------------------------------------------------------
