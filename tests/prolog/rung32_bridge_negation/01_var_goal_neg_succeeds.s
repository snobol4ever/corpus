...
n10_lit_string_α:       mov              r11, 6
                        ...
                        mov              qword ptr [rsp + 392], rax;          jmp   n11_call_builtin_prolog_α
.Lx26_0:                .quad            .Lx26_0_s
.Lx26_0_s:              .string          "fail"
#-----------------------------------------------------------------------------------------------------------------------
...
n12_var_ref_α:          mov              r11, 8
                        ...
                        mov              qword ptr [rsp + 312], rdx;          jmp   n13_call_proc_staged_α
#-----------------------------------------------------------------------------------------------------------------------
n13_call_proc_staged_α: mov              r11, 9
...
.Lx31_29:               mov              qword ptr [rsp + 240], rax
                        mov              qword ptr [rsp + 248], rdx
                        cmp              al, 104;                             je    n16_lit_string_α
                                                                              jmp   n14_lit_string_α
n13_call_proc_staged_β: mov              r11, 9
...
.Lx31_0_s:              .string          "$call/1"
#-----------------------------------------------------------------------------------------------------------------------
n14_lit_string_α:       mov              r11, 10
                        mov              qword ptr [rsp + 224], 2             # result
                        mov              dword ptr [rsp + 228], 6
                        mov              rax, qword ptr [rip + .Lx32_0]
                        mov              qword ptr [rsp + 232], rax;          jmp   n15_call_builtin_prolog_α
.Lx32_0:                .quad            .Lx32_0_s
.Lx32_0_s:              .string          "failed"
#-----------------------------------------------------------------------------------------------------------------------
...
n15_call_builtin_prolog_β:
                        mov              r11, 11;                             jmp   n22_call_builtin_prolog_α
#-----------------------------------------------------------------------------------------------------------------------
n16_lit_string_α:       mov              r11, 12
                        mov              qword ptr [rsp + 176], 2             # result
                        mov              dword ptr [rsp + 180], 9
                        mov              rax, qword ptr [rip + .Lx35_0]
                        mov              qword ptr [rsp + 184], rax;          jmp   n17_call_builtin_prolog_α
.Lx35_0:                .quad            .Lx35_0_s
.Lx35_0_s:              .string          "succeeded"
#-----------------------------------------------------------------------------------------------------------------------
...
n21_disjunction_α:      mov              r11, 17
                        ...
                        test             rax, rax;                            je    main_ω
                                                                              jmp   rax
n21_disjunction_β:      mov              r11, 17;                             jmp   main_ω
#-----------------------------------------------------------------------------------------------------------------------
