...
%----------------------------------------------------------- 9 simple_program_10
foo(X,Y,Z) :- Z is X \/ Y.
%--------------------------------------------------------- 10 simple_program_106
main :-
%---------------------------------------------------------- 11 simple_program_11
foo(X) :- X is 2^32.
%---------------------------------------------------------- 12 simple_program_12
foo(X) :- X is 2^3^4.
%---------------------------------------------------------- 13 simple_program_13
foo(X,Y,Z) :- Z is X // Y.
%---------------------------------------------------------- 14 simple_program_14
foo(X) :- X is 1 + 2.
%---------------------------------------------------------- 15 simple_program_15
foo(X) :- X is 1 + 2 * 3.
%---------------------------------------------------------- 16 simple_program_16
foo(X) :- X is 1.
%---------------------------------------------------------- 17 simple_program_17
foo(X) :- X is (1 + 2) * 3.
%---------------------------------------------------------- 18 simple_program_18
foo(X) :- X is 1 - 2 - 3.
%---------------------------------------------------------- 19 simple_program_19
foo(X, Y) :- Y is X + 1.
%----------------------------------------------------------- 20 simple_program_2
foo(_, X, _, X).
%---------------------------------------------------------- 21 simple_program_20
foo(X,Y,Z) :- Z is X mod Y.
%---------------------------------------------------------- 22 simple_program_21
foo(X) :- X is -1.
%---------------------------------------------------------- 23 simple_program_22
foo(X,Y,Z) :- Z is X ** Y.
%---------------------------------------------------------- 24 simple_program_23
foo(X,Y,Z) :- Z is X rem Y.
%---------------------------------------------------------- 25 simple_program_24
foo(X,Y,Z) :- Z is X << 2.
%---------------------------------------------------------- 26 simple_program_25
foo(X,Y,Z) :- Z is X >> 2.
%---------------------------------------------------------- 27 simple_program_26
foo(X,Y,Z) :- Z is X xor Y.
%---------------------------------------------------------- 28 simple_program_27
foo.
%---------------------------------------------------------- 29 simple_program_28
"hi".
%---------------------------------------------------------- 30 simple_program_29
foo :- X is 0'a + 1.
%----------------------------------------------------------- 31 simple_program_3
foo(_x, _x).
%---------------------------------------------------------- 32 simple_program_30
foo(0'0).
%---------------------------------------------------------- 33 simple_program_31
foo(0'a).
%---------------------------------------------------------- 34 simple_program_32
foo(0' ).
%---------------------------------------------------------- 35 simple_program_33
foo(0'A).
%---------------------------------------------------------- 36 simple_program_34
foo(X,Y) :- X @> Y.
%---------------------------------------------------------- 37 simple_program_35
foo(X,Y) :- X @< Y.
%---------------------------------------------------------- 38 simple_program_36
foo(X,Y) :- X > Y.
%---------------------------------------------------------- 39 simple_program_37
foo(X,Y) :- X < Y.
%---------------------------------------------------------- 40 simple_program_38
foo(bar).
%---------------------------------------------------------- 41 simple_program_39
foo(a, b).
%----------------------------------------------------------- 42 simple_program_4
foo(_x, _y).
%---------------------------------------------------------- 43 simple_program_40
point(a, b, c).
%---------------------------------------------------------- 44 simple_program_41
age(42).
%---------------------------------------------------------- 45 simple_program_42
point(3, X, "name").
%---------------------------------------------------------- 46 simple_program_44
foo(bar(a)).
%---------------------------------------------------------- 47 simple_program_45
foo(bar(a), baz(b, c)).
%---------------------------------------------------------- 48 simple_program_46
foo(X).
%---------------------------------------------------------- 49 simple_program_47
foo :- a, b ; c.
%---------------------------------------------------------- 50 simple_program_48
foo :- a, b, c.
%---------------------------------------------------------- 51 simple_program_49
foo :- a, b.
%----------------------------------------------------------- 52 simple_program_5
foo(_).
%---------------------------------------------------------- 53 simple_program_50
foo(X) :- bar(X) ; baz(X).
%---------------------------------------------------------- 54 simple_program_51
foo :- a ; b ; c.
%---------------------------------------------------------- 55 simple_program_52
foo :- a ; b.
%---------------------------------------------------------- 56 simple_program_53
foo :- X is 1.5 + 2.0.
%---------------------------------------------------------- 57 simple_program_54
foo(1.0).
%---------------------------------------------------------- 58 simple_program_55
foo(-3.14).
%---------------------------------------------------------- 59 simple_program_56
foo(3.14).
%---------------------------------------------------------- 60 simple_program_57
foo(X,Y) :- a -> b, c -> d.
%---------------------------------------------------------- 61 simple_program_58
foo(X) :- X -> a.
%---------------------------------------------------------- 62 simple_program_59
foo([]).
%----------------------------------------------------------- 63 simple_program_6
foo(_, _).
%---------------------------------------------------------- 64 simple_program_60
foo([[a, b], [c, d]]).
%---------------------------------------------------------- 65 simple_program_61
foo([a]).
%---------------------------------------------------------- 66 simple_program_62
foo([member/2, append/3]).
%---------------------------------------------------------- 67 simple_program_63
foo([a, b, c]).
%---------------------------------------------------------- 68 simple_program_64
foo([X, Y]).
%----------------------------------------------------------- 69 simple_program_7
foo(X,Y,Z) :- Z is X /\ Y.
%---------------------------------------------------------- 70 simple_program_70
foo :- lists:member(X, [1,2,3]).
%---------------------------------------------------------- 71 simple_program_71
foo :- not(bar).
%---------------------------------------------------------- 72 simple_program_73
foo(bar(a, baz(b))).
%---------------------------------------------------------- 73 simple_program_74
foo :- (a, b), (c, d).
%---------------------------------------------------------- 74 simple_program_75
foo :- (a ; b), c.
%---------------------------------------------------------- 75 simple_program_76
foo :- (a, b) ; c.
%---------------------------------------------------------- 76 simple_program_77
foo :- a ; (b, c).
%---------------------------------------------------------- 77 simple_program_78
foo :- (a ; (b, c)), d.
%---------------------------------------------------------- 78 simple_program_79
foo('').
%----------------------------------------------------------- 79 simple_program_8
foo(X,Y) :- Z is \X.
%---------------------------------------------------------- 80 simple_program_80
foo(0b1010).
%---------------------------------------------------------- 81 simple_program_81
foo(0xff).
%---------------------------------------------------------- 82 simple_program_82
foo(0o17).
%---------------------------------------------------------- 83 simple_program_83
foo :- bar.
%---------------------------------------------------------- 84 simple_program_85
even(0) :- true.
%---------------------------------------------------------- 85 simple_program_86
record(3, X, "name") :- log(X).
%---------------------------------------------------------- 86 simple_program_87
twice(X, Y) :- plus(X, X).
%---------------------------------------------------------- 87 simple_program_88
foo(X) :- bar(X).
%----------------------------------------------------------- 88 simple_program_9
foo(X,Y) :- X is \ Y.
%---------------------------------------------------------- 89 simple_program_65
foo(X) :- bar(X).
foo(a).
%---------------------------------------------------------- 90 simple_program_66
foo(X) :- bar(X).
foo(X) :- baz(X).
%---------------------------------------------------------- 91 simple_program_68
foo(a).
foo(b).
%---------------------------------------------------------- 92 simple_program_89
foo(X) :- bar(X).
bar(a).
%---------------------------------------------------------- 93 simple_program_43
foo(a).
bar(b, c).
baz.
%---------------------------------------------------------- 94 simple_program_67
foo(a).
foo(b).
foo(c).
%---------------------------------------------------------- 95 simple_program_69
foo(a).
bar(b).
foo(c).
%---------------------------------------------------------------------- 96 cut_1
...
%----------------------------------------------------------- 123 simple_assign_1
foo(X) :- X = 5.
%---------------------------------------------------------- 124 simple_assign_10
foo(X,Y) :- X =\= Y.
%---------------------------------------------------------- 125 simple_assign_12
foo(X) :- X = a:b.
%----------------------------------------------------------- 126 simple_assign_2
foo(X) :- X = 1 + 2.
%----------------------------------------------------------- 127 simple_assign_5
foo(X,Y) :- X =:= Y.
%--------------------------------------------------------- 128 simple_program_72
foo :- arg(1, foo(a,b), X).
%--------------------------------------------------------- 129 simple_program_84
greet :- write(hello).
%-------------------------------------------------------------- 130 directive_10
:- foo.
bar :- baz.
...
%-------------------------------------------------------- 137 format_directive_1
:- initialization(main).
main :- format("hello~n").
%-------------------------------------------------------- 138 format_directive_2
:- initialization(main).
main :- format("hello ~a~n", [world]).
%-------------------------------------------------------- 139 format_directive_3
:- initialization(main).
main :- format("count: ~d~n", [7]).
%-------------------------------------------------------- 140 format_directive_4
:- initialization(main).
...
%-------------------------------------------------------- 179 format_directive_5
:- initialization(main).
main :- format("x = ~w~n", [42]).
%----------------------------------------------- 180 write_canonical_directive_4
:- initialization(main).
main :- write_canonical(1+2), nl.
%-------------------------------------------------------- 181 writeq_directive_3
:- initialization(main).
main :- writeq('hello world'), nl, writeq(foo), nl.
%-------------------------------------------------------- 182 writeq_directive_4
:- initialization(main).
...
%----------------------------------------------- 204 write_canonical_directive_2
:- initialization(main).
main :-
    write_canonical(f(a,b)), nl,
    write_canonical(g(1,2,3)), nl.
%----------------------------------------------- 205 write_canonical_directive_3
:- initialization(main).
main :-
...
%----------------------------------------- 296 copy_term_ite_directive_replace_1
:- initialization(main).
main :-
    copy_term(f(X, X), f(A, B)),
    (A == B -> write(same) ; write(diff)), nl,
    copy_term(hello, C), write(C), nl.
%----------------------------------------- 297 copy_term_ite_directive_replace_2
:- initialization(main).
main :-
    copy_term(f(X, X), f(A, B)),
    (A == B -> write(same) ; write(diff)), nl,
    copy_term(hello, C), write(C), nl.
%------------------------------------------------------ 298 ite_list_directive_1
...
main :-
    ...
    nl.
%----------------------------------------------- 305 asserta_assertz_directive_1
:- assertz(item(b)).
:- assertz(item(c)).
:- asserta(item(a)).
...
main :-
    retract(age(bob, X)),
    write(X), nl.
%------------------------------------------------ 334 op_ite_directive_replace_2
:- op(200, fy, ~).
:- initialization(main).
main :-
    ( ~ ~ a == ~(~(a)) -> write(yes) ; write(no) ), nl,
...
%---------------------------------------------- 335 copy_term_ite_list_replace_1
...
%----------------------------------------------- 336 findall_directive_replace_1
...
main :-
    ...
    call(G, R),
    write(R), nl.
%--------------------------------------------- 338 catch_ite_directive_replace_1
...
main :-
    ...
    write(done), nl.
%---------------------------------------------- 341 call_ite_directive_replace_1
...
%----------------------------------------------- 345 ite_naf_directive_replace_1
...
%----------------------------------------------- 348 ite_naf_directive_replace_2
...
main :-
    ...
    write(done), nl.
%--------------------------------------------- 353 catch_ite_directive_replace_2
:- initialization(main).
...
%-------------------------------------------------------- 356 directive_12 XFAIL
:- initialization(main).
f(a).
main :- f(X), write(X), nl.
%-------------------------------------------------------- 357 directive_13 XFAIL
:- initialization(main).
f(a).
f(b).
main :- f(X), write(X), nl.
%-------------------------------------------------------- 358 directive_14 XFAIL
:- initialization(main).
f(a).
f(b).
f(c).
main :- ( f(X), write(X), nl, fail ) ; true.
%-------------------------------------------------------- 359 directive_15 XFAIL
:- initialization(main).
main :- ( ( X = a ; X = b ), write(X), nl, fail ) ; true.
%----------------------------------------------------- 360 cut_directive_2 XFAIL
:- initialization(main).
count(0) :- !.
count(N) :- N > 0, write(N), nl, N1 is N - 1, count(N1).
main :- count(3).
%----------------------------------------------------- 361 cut_directive_3 XFAIL
:- initialization(main).
f(a) :- !.
f(b).
main :- ( f(X), write(X), nl, fail ) ; true.
%---------------------------------------------------- 362 list_directive_1 XFAIL
:- initialization(main).
mem(X, [X|_]).
mem(X, [_|T]) :- mem(X, T).
main :- ( mem(X, [1,2,3]), write(X), nl, fail ) ; true.
%----------------------------------------------------- 363 cut_directive_4 XFAIL
:- initialization(main).
t(1).
t(2).
t(3).
