...
greet :- write(hi).
main :- greet, nl.
%------------------------------------------------------ 248 sub_atom_directive_1
:- initialization(main).
main :- sub_atom(abc, B, 1, _, S), write(B-S), nl, fail.
main :- write(done), nl.
%----------------------------------------------------- 249 zero_arity_dispatch_1
:- initialization(main).
main(x) :- write(wrong), nl.
main :- write(right), nl.
%-------------------------------- 250 clause_choice_two_clauses_distinct_heads_1
:- initialization(main).
sound(dog, woof).
sound(cat, meow).
...
%------------------------------------------------- 271 ofi_once_first_solution_1
:- initialization(main).
p(1).
p(2).
main :- once(p(X)), write(X), nl.
%---------------------------------------------------- 272 rule_body_calls_fact_1
:- initialization(main).
color(red).
likes_color :- color(X), write(X).
main :- likes_color, nl.
%----------------------------------------------- 273 write_canonical_directive_2
:- initialization(main).
main :-
    write_canonical(f(a,b)), nl,
    write_canonical(g(1,2,3)), nl.
%----------------------------------------------- 274 write_canonical_directive_3
:- initialization(main).
main :-
    write_canonical(1+2), nl,
    write_canonical(a-b), nl.
%--------------------------------------- 275 clause_choice_first_solution_only_1
:- initialization(main).
r(1).
r(2).
r(3).
...
%--------------------------------------------------------- 290 index_directive_1
:- initialization(main).
fact(a, 1).
fact(b, 2).
fact(c, 3).
main :- fact(b, V), write(V), nl.
%----------------------------------- 291 indexing_distinct_constant_first_args_1
color_code(red, 1).
color_code(green, 2).
color_code(blue, 3).
:- initialization(main).
main :- color_code(green, X), write(X), nl.
%---------------------------------------------------------- 292 scrip_test_hello
% SCRIP DEMO1 -- Hello World (Prolog section)
% Idiom: write/1 + nl/0
:- initialization(main, main).
main :-
    write('Hello, World!'), nl.
%--------------------------------------------------------- 293 simple_program_91
:- initialization(main).
main :-
    plus(3, Y, 10), write(Y), nl,
    plus(0, W, 5),  write(W), nl.
main.
%--------------------------------------------------------- 294 simple_program_92
:- initialization(main).
main :-
    plus(X, 4, 10), write(X), nl,
    plus(Y, 3, 3),  write(Y), nl.
main.
%----------------------------------------------- 295 write_canonical_directive_1
:- initialization(main).
main :-
    write_canonical(hello), nl,
    write_canonical('Hello'), nl,
    write_canonical([]), nl.
%-------------------------------------------------------- 296 writeq_directive_1
:- initialization(main).
main :-
    writeq(hello), nl,
    writeq('Hello'), nl,
    writeq([]), nl.
%-------------------------------------------------------- 297 writeq_directive_2
:- initialization(main).
main :-
    writeq(1+2), nl,
    writeq(f(a,b)), nl,
    writeq(a-b), nl.
%----------------------------------- 298 clause_choice_three_clauses_enumerate_1
:- initialization(main).
q(1).
q(2).
q(3).
...
main :- nl.
%---------------------------------------------- 299 declarations_discontiguous_1
:- discontiguous(bar/1).
bar(1).
other(x).
bar(2).
...
%-------------------------------------------- 326 test_rung10_programs_puzzle_10
%-------------------------------------------------------------------------------
...
%------------------------------------------------ 343 ite_bare_if_then_no_else_1
:- initialization(main).
main :- (1 =:= 1 -> write(yes)), nl.
%----------------------------------------------------- 344 ite_condition_fails_1
:- initialization(main).
main :- (fail -> write(then) ; write(else)), nl.
%---------------------------------------------- 345 ofi_ignore_of_failing_goal_1
:- initialization(main).
main :- (ignore(fail) -> write(yes) ; write(no)), nl.
%----------------------------------------------------- 346 ofi_ignore_succeeds_1
:- initialization(main).
main :- ignore(X = bound), write(X), nl.
%------------------------------------------------ 347 ofi_once_of_failing_goal_1
:- initialization(main).
main :- (once(fail) -> write(yes) ; write(no)), nl.
%-------------------------------------------------- 348 repeat_repeat_with_cut_1
:- initialization(main).
main :- repeat, write(x), !, nl.
%--------------------------------------------------- 349 streams_current_input_1
:- initialization(main).
...
%------------------------------------------- 377 clause_choice_redo_after_fail_1
:- initialization(main).
main :- between(1, 3, X), write(X), fail.
main :- nl.
%----------------------------------------------------- 378 copy_term_directive_1
:- initialization(main).
main :-
...
%------------------------------------------------------- 383 dcg_terminal_list_1
nums --> [1,2,3].
:- initialization(main).
main :- phrase(nums, [1,2,3]), write(ok), nl.
%---------------------------------------------------- 384 declarations_dynamic_1
:- dynamic(foo/1).
:- initialization(main).
...
%------------------------------------------------- 386 bagof_setof_bagof_basic_1
likes(mary,wine).
likes(mary,cheese).
:- initialization(main).
main :- bagof(X, likes(mary,X), L), write(L), nl.
%------------------------------------------- 387 clause_choice_no_clause_fails_1
:- initialization(main).
s(1).
s(2).
...
f(b).
main :- ( f(X), write(X), nl, fail ) ; true.
%---------------------------------------------------------- 390 cut_first_goal_1
:- initialization(main).
q :- !, write(first).
q :- write(second).
main :- q, nl.
%------------------------------------------------------- 391 declarations_op_3_1
:- op(700, xfx, ===>).
implies(X ===> Y) :- write(X), write(then), write(Y), nl.
:- initialization(main).
main :- implies(rain ===> wet).
%------------------------------------------------------- 392 findall_directive_2
:- initialization(main).
main :-
    findall(X, fail, Xs),
    write(Xs), nl.
...
%---------------------------------------------- 397 last_call_accumulator_loop_1
...
differ(_, _, _).
%-------------------------------------------------------------------------------
%-------------------------------------------- 464 test_rung10_programs_puzzle_03
%-------------------------------------------------------------------------------
% 3
...
puzzle :-
    ...
    fail.
%-------------------------------------------- 465 test_rung10_programs_puzzle_06
%-------------------------------------------------------------------------------
% 6
...
%-------------------------------------- 511 bagof_setof_free_variable_grouping_1
likes(mary,wine).
likes(mary,cheese).
likes(john,beer).
:- initialization(main).
main :- findall(Y-L, bagof(X,likes(Y,X),L), Groups), write(Groups), nl.
%--------------------------------------------- 512 call_n_call_of_cut_is_local_1
p1(1). p1(2). p1(3).
q1 :- call((p1(X), !)), write(X), fail.
q1 :- write(done).
:- initialization(main).
main :- q1, nl.
%----------------------------------------- 513 copy_term_ite_directive_replace_1
:- initialization(main).
main :-
    copy_term(f(X, X), f(A, B)),
    (A == B -> write(same) ; write(diff)), nl,
    copy_term(hello, C), write(C), nl.
%----------------------------------------- 514 copy_term_ite_directive_replace_2
:- initialization(main).
main :-
    copy_term(f(X, X), f(A, B)),
    (A == B -> write(same) ; write(diff)), nl,
    copy_term(hello, C), write(C), nl.
%------------------------------------------------------ 515 ite_list_directive_1
...
main :-
    ...
    42 =.. L3, write(L3), nl.
%--------------------------------------------- 526 benchmark_witness_depth_nrev8
:- initialization(main).
...
%----------------------------------------------- 537 asserta_assertz_directive_1
:- initialization(main).
:- assertz(item(b)).
:- assertz(item(c)).
:- asserta(item(a)).
...
lefteven(6).
lefteven(8).
%-------------------------------------------- 557 test_rung10_programs_puzzle_02
%-------------------------------------------------------------------------------
% 2
...
%-------------------------------------------- 558 test_rung10_programs_puzzle_14
%-------------------------------------------------------------------------------
% 14
...
differ(_, X, X) :- !, fail.
differ(_, _, _).
%-------------------------------------------- 559 test_rung10_programs_puzzle_04
%-------------------------------------------------------------------------------
% 4
...
differ(_, _, X, X) :- !, fail.
differ(_, _, _, _).
%-------------------------------------------- 560 test_rung10_programs_puzzle_13
%-------------------------------------------------------------------------------
% 13
...
display(Victim, Murderer, Witness, Policeman, Judge, Hangman) :-
    ...
    write('\n').
%-------------------------------------------- 561 test_rung10_programs_puzzle_08
%-------------------------------------------------------------------------------
...
all_diff5(A,B,C,D,E) :-
    ...
    B\=C, B\=D, B\=E,
    C\=D, C\=E, D\=E.
%-------------------------------------------- 562 test_rung10_programs_puzzle_11
%-------------------------------------------------------------------------------
...
all_diff5(A,B,C,D,E) :-
    ...
    B\=C, B\=D, B\=E,
    C\=D, C\=E, D\=E.
%-------------------------------------------- 563 test_rung10_programs_puzzle_12
%-------------------------------------------------------------------------------
% 12
...
display(SAr, SBa, SCo, SDu, SEg, SFu) :-
    ...
    write('\n').
%-------------------------------------------- 564 test_rung10_programs_puzzle_07
%-------------------------------------------------------------------------------
% 7
...
%----------------------- 573 abolish_call_after_abolish_raises_existence_error_1
:- dynamic(bb10a/1).
:- initialization(main).
...
%------------------------------------------- 575 abolish_retractall_vs_abolish_1
:- dynamic(cc10a/1).
:- initialization(main).
...
%------------------------------------------------ 588 last_call_nreverse_large_1
myapp([], L, L).
...
%------------------------------------------------ 589 op_ite_directive_replace_2
:- op(200, fy, ~).
:- initialization(main).
main :-
    ( ~ ~ a == ~(~(a)) -> write(yes) ; write(no) ), nl,
...
%----------------------------------------------- 590 assertz_retract_directive_1
:- initialization(main).
...
main :-
    retract(age(bob, X)),
    write(X), nl.
%----------------------------------------------- 591 findall_directive_replace_1
...
main :-
    ...
    call(G, R),
    write(R), nl.
%--------------------------------------------- 593 catch_ite_directive_replace_1
...
%----------------------------------------------- 595 findall_directive_replace_3
...
main :-
    ...
    findall(Y, G, Ys),
    write(Ys), nl.
%----------------------------------------------- 596 findall_directive_replace_5
...
main :-
    ...
    write(done), nl.
%---------------------------------------------- 599 call_ite_directive_replace_1
...
main :-
    ...
    nl.
%----------------------------------------------- 600 findall_directive_replace_2
...
%----------------------------------------------- 603 findall_directive_replace_4
...
main :-
    ...
    findall(C, G, Cs),
    write(Cs), nl.
%----------------------------------------------- 604 ite_naf_directive_replace_1
...
main :-
    ...
    write(done), nl.
main :- write(main_failed), nl.
%----------------------------------------- 606 catch_functor_directive_replace_1
...
acyc(_, no).
%----------------------------------------------- 611 ite_naf_directive_replace_2
...
%---------------------------------------------- 618 scrip_test_coverage_net_gaps
...
main :-
    ...
    write(X), nl,
    fail ; true.
%-------------------------------------------- 620 test_rung10_programs_puzzle_20
%-------------------------------------------------------------------------------
% 20
...
%-------------------------------------------- 621 test_rung10_programs_puzzle_17
%-------------------------------------------------------------------------------
% 17
...
differ(X, X) :- !, fail.
differ(_, _).
%---------------------------------------------- 622 scrip_test_coverage_pl_nodes
...
:- trail_test.
:- write(done), nl.
%-------------------------------------------- 624 test_rung10_programs_puzzle_16
%-------------------------------------------------------------------------------
% 16
...
display(Brakeman, Conductor, Engineer, Fireman) :-
    ...
    write('\n').
%-------------------------------------------- 625 test_rung10_programs_puzzle_18
%-------------------------------------------------------------------------------
% 18
...
display(Today, SAb, SBr, SCu, SDe) :-
    ...
    write('\n').
%-------------------------------------------- 626 test_rung10_programs_puzzle_15
%-------------------------------------------------------------------------------
% 15
...
%---------------------------------------------- 638 copy_term_ite_list_replace_1
...
%--------------------------------------------- 643 catch_ite_directive_replace_2
:- initialization(main).
...
main :-
    ...
    write(done), nl,
    halt.
%------------------------------------------- 644 catch_throw_directive_replace_1
