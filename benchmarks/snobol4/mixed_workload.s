...
n5_cmp_test_α:
                        ...
                        test             eax, eax
                                                                                        je    .Lx27_240
                        add              rsp, 16
                                                                                        jmp   proc_LBL__RSUM_zw5s4_ω_d64
.Lx27_240:
...
proc_LBL__RSUM_zw5s4_ω_d112:
                        add              rsp, 112
                                                                                        jmp   n10_var_α
proc_LBL__RSUM_zw5s4_ω_d96:
                        add              rsp, 96
                                                                                        jmp   n10_var_α
proc_LBL__RSUM_zw5s4_ω_d80:
                        add              rsp, 80
                                                                                        jmp   n10_var_α
proc_LBL__RSUM_zw5s4_ω_d64:
                        add              rsp, 64
                                                                                        jmp   n10_var_α
proc_LBL__RSUM_zw5s4_ω_d48:
                        add              rsp, 48
                                                                                        jmp   n10_var_α
proc_LBL__RSUM_zw5s4_ω_d32:
                        add              rsp, 32
                                                                                        jmp   n10_var_α
proc_LBL__RSUM_zw5s4_ω_d16:
                        add              rsp, 16
                                                                                        jmp   n10_var_α
#=======================================================================================================================
...
n13_binop_α:
                        ...
                        cmp              eax, 104
                                                                                        jne   .Lx36_240
                        add              rsp, 16
                                                                                        jmp   proc_LBL__RSUM_zw5s5_ω_d48
.Lx36_240:
                        mov              qword ptr [rsp + 0], rax                       # result
                        mov              qword ptr [rsp + 8], rdx
                                                                                        jmp   n14_call_α
...
.Lx38_2:
                        ...
                        cmp              eax, 104
                                                                                        jne   .Lx38_240
                        add              rsp, 16
                                                                                        jmp   proc_LBL__RSUM_zw5s5_ω_d64
.Lx38_240:
                                                                                        jmp   n15_binop_α
n14_call_β:
                                                                                        jmp   proc_LBL__RSUM_zw5s5_ω_d64
...
n15_binop_α:
                        ...
                        cmp              eax, 104
                                                                                        jne   .Lx39_240
                        add              rsp, 16
                                                                                        jmp   proc_LBL__RSUM_zw5s5_ω_d80
.Lx39_240:
                        mov              qword ptr [rsp + 0], rax                       # result
                        mov              qword ptr [rsp + 8], rdx
                                                                                        jmp   n16_assign_α
...
n17_statement_α:
                        add              rsp, 96
                                                                                        jmp   n18_save_restore_α
proc_LBL__RSUM_zw5s5_ω_d96:
                        add              rsp, 96
                                                                                        jmp   n18_save_restore_α
proc_LBL__RSUM_zw5s5_ω_d80:
                        add              rsp, 80
                                                                                        jmp   n18_save_restore_α
proc_LBL__RSUM_zw5s5_ω_d64:
                        add              rsp, 64
                                                                                        jmp   n18_save_restore_α
proc_LBL__RSUM_zw5s5_ω_d48:
                        add              rsp, 48
                                                                                        jmp   n18_save_restore_α
proc_LBL__RSUM_zw5s5_ω_d32:
                        add              rsp, 32
                                                                                        jmp   n18_save_restore_α
proc_LBL__RSUM_zw5s5_ω_d16:
                        add              rsp, 16
                                                                                        jmp   n18_save_restore_α
proc_LBL__RSUM_zw5s5_ω_d112:
                        add              rsp, 112
                                                                                        jmp   n18_save_restore_α
#-----------------------------------------------------------------------------------------------------------------------
n18_save_restore_α:
