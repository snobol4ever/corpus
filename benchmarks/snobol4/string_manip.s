...
.Llit_string_α_44_0_s:  .string          "string_manip.sno"
...
.Llit_string_α_59_0_s:  .string          "The quick brown fox jumps over the lazy dog"
...
n15_statement_begin_β:  mov              r11, 16;                             jmp   n22_stmt_mark_α
...
.Llit_string_α_68_0_s:  .string          "aeiou"
...
n19_call_α:             sub              rsp, 16
                        ...
                        mov              qword ptr [rsp + 40], rax
                        .section         .rodata
.Lcall_α_rkfnzd71:      .string          "REPLACE"
                        .section         .text
                        .intel_syntax    noprefix
...
n21_statement_end_α:    mov              r11, 22
                        add              rsp, 64;                             jmp   n22_stmt_mark_α
...
n22_stmt_mark_α:        mov              r11, 23
                        ...
                        mov              rax, qword ptr [rip + g_line@GOTPCREL]
                        mov              qword ptr [rax + 0], 6;              jmp   n23_statement_begin_α
...
n34_stmt_mark_α:        mov              r11, 35
                        ...
                        mov              rax, qword ptr [rip + g_line@GOTPCREL]
                        mov              qword ptr [rax + 0], 7;              jmp   n35_statement_begin_α
...
.Llit_string_α_97_0_s:  .string          "masked text = "
...
n41_goto_bx:
#-----------------------------------------------------------------------------------------------------------------------
n41_goto_α:             mov              r11, 42;                             jmp   n9_stmt_mark_α
