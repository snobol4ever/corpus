...
.Lcall_α_132_240:       mov              qword ptr [rsp + 0], rax             # result
                        ...
                        mov              r9,  qword ptr [rip + rtccb+48]
                        mov              r10, qword ptr [rip + rtccb+56]
                        mov              r11, qword ptr [rip + rtccb+64];     jmp   n37_stmt_mark_α
...
n50_assign_α:           mov              r11, 29
                        ...
                        .section         .rodata
.Lassign_α_155_1_s:     .string          "string_pattern.sno"
                        .section         .text
                        .intel_syntax    noprefix
...
n56_assign_α:           mov              r11, 35
                        ...
                        .section         .rodata
.Lassign_α_165_1_s:     .string          "string_pattern.sno"
                        .section         .text
                        .intel_syntax    noprefix
...
n65_assign_α:           mov              r11, 44
                        ...
                        .section         .rodata
.Lassign_α_182_1_s:     .string          "string_pattern.sno"
                        .section         .text
                        .intel_syntax    noprefix
...
n71_assign_α:           mov              r11, 50
                        ...
                        .section         .rodata
.Lassign_α_191_1_s:     .string          "string_pattern.sno"
                        .section         .text
                        .intel_syntax    noprefix
                        ...
                        mov              rax, qword ptr [rsp + 0]
                        mov              rdx, qword ptr [rsp + 8]
                        add              rsp, 16;                             jmp   n72_match_begin_α
...
.Lmatch_defer_α_194_52: lea              rdi, [rsp + 0]
                        ...
                        mov              rax, qword ptr [rsp + 24]
                        mov              rdx, qword ptr [rsp + 40]
                        add              rsp, 48;                             jmp   .Lmatch_defer_α_194_2
...
.Lmatch_end_α_196_8:    mov              qword ptr [rip + rtccb+40], r8
                        ...
                        mov              rax, qword ptr [rsp + 16]
                        mov              rdx, qword ptr [rsp + 24]
                        add              rsp, 32;                             jmp   .Lmatch_end_α_196_1
...
n86_assign_α:           mov              r11, 65
                        ...
                        .section         .rodata
.Lassign_α_214_1_s:     .string          "string_pattern.sno"
                        .section         .text
                        .intel_syntax    noprefix
...
n91_assign_α:           mov              r11, 70
                        ...
                        .section         .rodata
.Lassign_α_222_1_s:     .string          "string_pattern.sno"
                        .section         .text
                        .intel_syntax    noprefix
...
.Lassign_α_222_0_s:     .string          "STRING_PATTERN"
...
n100_assign_α:          mov              r11, 79
                        ...
                        .section         .rodata
.Lassign_α_236_1_s:     .string          "string_pattern.sno"
                        .section         .text
                        .intel_syntax    noprefix
...
.Lassign_α_248_1_s:     .string          "string_pattern.sno"
                        ...
                        mov              rax, qword ptr [rsp + 0]
                        mov              rdx, qword ptr [rsp + 8]
                        add              rsp, 16;                             jmp   n109_statement_end_α
...
n110_stmt_mark_α:       mov              r11, 89
                        ...
                        mov              rax, qword ptr [rip + g_stcount@GOTPCREL]
                        inc              qword ptr [rax + 0];                 jmp   n111_statement_begin_α
...
n115_assign_α:          mov              r11, 94
                        ...
                        .section         .rodata
.Lassign_α_258_1_s:     .string          "string_pattern.sno"
                        .section         .text
                        .intel_syntax    noprefix
...
n122_assign_α:          mov              r11, 101
                        ...
                        .section         .rodata
.Lassign_α_268_1_s:     .string          "string_pattern.sno"
                        .section         .text
                        .intel_syntax    noprefix
