...
n2_match_begin_α:
                        ...
                        mov              rdi, qword ptr [rbp + 432]                     # lo
                        mov              rsi, qword ptr [rbp + 440]                     # hi
...
n10_match_replace_α:
                        ...
                        mov              rsi, qword ptr [rbp + 432]                     # sub_lo
                        mov              rdx, qword ptr [rbp + 440]                     # sub_hi
...
n158_match_rpos_α:
                        ...
                        sub              ecx, eax
                        cmp              r14d, ecx
                                                                                        jne   n156_match_begin_β
                                                                                        jmp   n159_match_assign_save_α
n158_match_rpos_β:
...
n161_match_assign_cond_α:
                        ...
                        mov              qword ptr [r12 + 16], rdx
                        add              r12, 24
                                                                                        jmp   n162_match_end_α
n161_match_assign_cond_β:
                        sub              r12, 24
                                                                                        jmp   n160_match_len_β
#-----------------------------------------------------------------------------------------------------------------------
n162_match_end_α:
                        mov              r10, r12
.Lx292_9:
...
n163_lit_string_α:
                        ...
                        mov              qword ptr [rsp + 120], rax
                                                                                        jmp   n164_match_replace_α
.Lx293_0:
                        .quad            .Lx293_0_s
.Lx293_0_s:
                        .string          ""
#-----------------------------------------------------------------------------------------------------------------------
n164_match_replace_α:
