...
# IR_MATCH_HEAD
 ...
 mov r13, rax
 mov r15, rdx
 mov qword ptr [r12 + 408], rbp
 lea rcx, [rip + g_dcap_top]
 mov rbp, qword ptr [rcx + 0]
 mov qword ptr [r12 + 400], rbp
...
# IR_MATCH_HEAD
 ...
 mov qword ptr [r12 + 672], rsp
 mov rdi, qword ptr [r12 + 848]
 mov rsi, qword ptr [r12 + 856]
 call rt_match_enter@PLT
 mov r13, rax
 mov r15, rdx
 mov qword ptr [r12 + 696], rbp
 lea rcx, [rip + g_dcap_top]
 mov rbp, qword ptr [rcx + 0]
 mov qword ptr [r12 + 688], rbp
 mov dword ptr [r12 + 656], 0
.Lx20_0:
 mov r14d, dword ptr [r12 + 656]
 jmp xchain0_n13_α
 xchain0_n12_β:
 add dword ptr [r12 + 656], 1
...
# IR_MATCH_SEQ_NARY
 xchain0_n13_α:
 mov dword ptr [r12 + 720], r14d
 mov dword ptr [r12 + 724], 0
 jmp xchain0_n15_α
xchain0_n13_as:
 mov eax, dword ptr [r12 + 724]
 add eax, 1
 mov dword ptr [r12 + 724], eax
 cmp eax, 1
 je xchain0_n16_α
 jmp xchain0_n14_α
 xchain0_n13_β:
 mov dword ptr [r12 + 724], 2
xchain0_n13_af:
 mov eax, dword ptr [r12 + 724]
 sub eax, 1
 mov dword ptr [r12 + 724], eax
