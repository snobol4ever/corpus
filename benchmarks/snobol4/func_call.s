...
#-----------------------------------------------------------------------------------------------------------------------
n27_statement_end_α:                                                          jmp   RETURN
#-----------------------------------------------------------------------------------------------------------------------
...
.Lx136_0:               lea              rdi, [rsp + 32]
                        ...
                        mov              r9,   qword ptr [r11 + 48]
                        mov              r10,  qword ptr [r11 + 56]
                        mov              r11,  qword ptr [r11 + 64];          jmp   n46_coerce_numeric_α
...
.Lx138_0:               lea              rdi, [rsp + 32]
                        ...
                        mov              r9,   qword ptr [r11 + 48]
                        mov              r10,  qword ptr [r11 + 56]
                        mov              r11,  qword ptr [r11 + 64];          jmp   n47_cmp_test_α
...
.Lx143_240:             mov              qword ptr [rsp + 0], rax             # result
                        ...
                        mov              r9,   qword ptr [r11 + 48]
                        mov              r10,  qword ptr [r11 + 56]
                        mov              r11,  qword ptr [r11 + 64];          jmp   n51_binop_α
...
n51_binop_α:            sub              rsp, 16
                        ...
                        mov              r9,   qword ptr [r11 + 48]
                        mov              r10,  qword ptr [r11 + 56]
                        mov              r11,  qword ptr [r11 + 64];          jmp   n52_assign_α
#-----------------------------------------------------------------------------------------------------------------------
...
.Lx176_240:             mov              qword ptr [rsp + 0], rax             # result
                        ...
                        mov              r9,   qword ptr [r11 + 48]
                        mov              r10,  qword ptr [r11 + 56]
                        mov              r11,  qword ptr [r11 + 64];          jmp   n74_binop_α
