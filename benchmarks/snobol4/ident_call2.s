...
.Ldefine_α_133_232_s:   .string          "IDENT_CALL2"
.Ldefine_α_133_231:     lea              rcx, [rip + IDENT_CALL2_γ]
...
.Ldefine_α_133_237_s:   .string          "IDENT_CALL2"
...
n31_assign_α:           mov              r11, 32
                        ...
                        .section         .rodata
.Lassign_α_143_1_s:     .string          "ident_call2.sno"
                        .section         .text
                        .intel_syntax    noprefix
...
n47_assign_α:           mov              r11, 48
                        ...
                        .section         .rodata
.Lassign_α_165_1_s:     .string          "ident_call2.sno"
                        .section         .text
                        .intel_syntax    noprefix
...
n69_assign_α:           mov              r11, 70
                        ...
                        .section         .rodata
.Lassign_α_197_1_s:     .string          "ident_call2.sno"
                        .section         .text
                        .intel_syntax    noprefix
...
.Lassign_α_207_0_s:     .string          "IDENT_CALL2"
...
n88_assign_α:           mov              r11, 89
                        ...
                        .section         .rodata
.Lassign_α_225_1_s:     .string          "ident_call2.sno"
                        .section         .text
                        .intel_syntax    noprefix
...
n90_goto_bx:
#-----------------------------------------------------------------------------------------------------------------------
n90_goto_α:             mov              r11, 91;                             jmp   LBL__IDENT_CALL2
...
LBL__IDENT_CALL2:       sub              rsp, 16
                        mov              r11, 92
                        mov              qword ptr [rsp + 0], 3               # result
                        mov              rax, qword ptr [rip + .LLBL__IDENT_CALL2_α_229_0]
                        mov              qword ptr [rsp + 8], rax;            jmp   n92_lit_integer_α
.LLBL__IDENT_CALL2_α_229_0:
                        .quad            5
