...
__gva_names:
                        ...
                        .intel_syntax    noprefix
                        .section         .rodata
.Llbln0:                .string          "IDENT_CALL2"
.Llbln1:                .string          "ZBL"
.Llbln2:                .string          "IDENT_CALL2_END"
.Llbln3:                .string          "END"
                        .align           8
__label_names:
                        .quad            .Llbln0
...
.Llit_string_α_105_0_s: .string          "ident_call2.sno"
...
n27_define_α:           mov              r11, 28
                        ...
                        .section         .data
                        .align           8
entry_cell$IDENT_CALL2: .quad            LBL__IDENT_CALL2
                        .section         .text
                        .intel_syntax    noprefix
                        lea              rax, [rip + LBL__IDENT_CALL2]
                        mov              rcx, qword ptr [rip + entry_cell$IDENT_CALL2@GOTPCREL]
...
.Ldefine_α_142_0_s:     .string          "IDENT_CALL2"
...
.Ldefine_α_143_232_s:   .string          "IDENT_CALL2"
.Ldefine_α_143_231:     lea              rcx, [rip + IDENT_CALL2_γ]
                        lea              rax, [rip + IDENT_CALL2_ω]
                        push             rax
                        push             rcx
                        mov              rax, qword ptr [rip + entry_cell$IDENT_CALL2@GOTPCREL]
...
.Ldefine_α_143_237_s:   .string          "IDENT_CALL2"
...
n34_assign_α:           mov              r11, 35
                        ...
                        .section         .rodata
.Lassign_α_153_1_s:     .string          "ident_call2.sno"
                        .section         .text
                        .intel_syntax    noprefix
...
n41_assign_α:           mov              r11, 42
                        ...
                        .section         .rodata
.Lassign_α_163_1_s:     .string          "ident_call2.sno"
                        .section         .text
                        .intel_syntax    noprefix
...
n50_assign_α:           mov              r11, 51
                        ...
                        .section         .rodata
.Lassign_α_175_1_s:     .string          "ident_call2.sno"
                        .section         .text
                        .intel_syntax    noprefix
...
n57_var_α:              sub              rsp, 16
                        ...
                        mov              rdx, qword ptr [r9 + 40]
                        mov              qword ptr [rsp + 0], rax             # result
                        mov              qword ptr [rsp + 8], rdx;            jmp   n58_ident_α
...
n72_assign_α:           mov              r11, 73
                        ...
                        .section         .rodata
.Lassign_α_207_1_s:     .string          "ident_call2.sno"
                        .section         .text
                        .intel_syntax    noprefix
...
n79_assign_α:           mov              r11, 80
                        ...
                        .section         .rodata
.Lassign_α_217_1_s:     .string          "ident_call2.sno"
                        .section         .text
                        .intel_syntax    noprefix
...
.Lassign_α_217_0_s:     .string          "IDENT_CALL2"
...
.Llit_string_α_230_0_s: .string          "ident_call2(1000) = "
...
.Lcall_β_233_0_s:       .string          "IDENT_CALL2"
...
n91_assign_α:           mov              r11, 92
                        ...
                        .section         .rodata
.Lassign_α_235_1_s:     .string          "ident_call2.sno"
                        .section         .text
                        .intel_syntax    noprefix
...
n96_goto_bx:
#-----------------------------------------------------------------------------------------------------------------------
n96_goto_α:             mov              r11, 97;                             jmp   LBL__IDENT_CALL2
...
#-----------------------------------------------------------------------------------------------------------------------
                        .loc             1 8 0
LBL__IDENT_CALL2:       sub              rsp, 16
                        mov              r11, 98
                        mov              qword ptr [rsp + 0], 3               # result
                        mov              rax, qword ptr [rip + .LLBL__IDENT_CALL2_α_243_0]
                        mov              qword ptr [rsp + 8], rax;            jmp   n98_lit_integer_α
.LLBL__IDENT_CALL2_α_243_0:
                        .quad            5
...
module_init:
                        sub              rsp, 8
                        .section         .rodata
.Lstartup_pname0:       .string          "LBL__IDENT_CALL2"
                        .align           8
.Lstartup_prec0:
                        .quad            .Lstartup_pname0
                        .quad            LBL__IDENT_CALL2
                        .quad            0
                        .quad            0
                        .quad            0
                        .long            0
