...
.Ldefine_α_88_0_s:      .string          "STRING_CONCAT"
...
.Ldefine_α_89_41:       lea              rcx, [rip + STRING_CONCAT_γ]
...
.Llit_string_α_107_0_s: .string          "x"
...
n35_cmp_test_α:         sub              rsp, 16
                        ...
                        mov              edx, eax
                        and              edx, ecx
                        cmp              dl, 3;                               jne   .Lcmp_test_α_121_0
                        mov              rax, qword ptr [rsp + 40]
                        mov              rdx, qword ptr [rsp + 24]
                        cmp              rax, rdx;                            jl    .Lcmp_test_α_121_239
                        add              rsp, 16;                             jmp   n34_coerce_numeric_β
.Lcmp_test_α_121_239:                                                         jmp   n36_var_α
.Lcmp_test_α_121_0:     lea              rdi, [rsp + 32]
                        ...
                        add              rsp, 16;                             jmp   n34_coerce_numeric_β
.Lcmp_test_α_121_240:                                                         jmp   n36_var_α
...
.Lbinop_α_124_4:        cvtsi2sd         xmm1, rdi
                        ...
                        mov              qword ptr [rsp + 8], rax
.Lbinop_α_124_7:                                                              jmp   n39_assign_α
...
.Llit_string_α_142_0_s: .string          "length after 10 appends = "
...
.Llit_string_α_152_0_s: .string          "length after 1000 appends = "
...
.Llit_integer_α_153_0:  .quad            1000
...
n58_call_α:             sub              rsp, 16
                        mov              r11, 59
                        lea              rcx, [rip + .Lcall_α_sig155z]
                        lea              rax, [rip + STRING_CONCAT_α];        jmp   rax
.Lcall_α_sig155z:       .quad            1
                        .quad            .Lcall_α_155_2
                        .quad            .Lcall_α_155_2
                        .quad            16
.Lcall_α_155_2:         mov              rcx, qword ptr [rip + rt_g_ret_by_name@GOTPCREL] # NRETURN by-name consult (live wn, consumed)
                        mov              ecx, dword ptr [rcx + 0]
                        cmp              ecx, 0;                              je    .Lcall_α_155_29
                        mov              rdi, rax
                        mov              rsi, rdx
                        mov              edx, 0
                        mov              qword ptr [rip + rtccb+40], r8
                        ...
                        mov              rax, qword ptr [rsp + 0]
                        mov              rdx, qword ptr [rsp + 8]
.Lcall_α_155_29:        mov              qword ptr [rsp + 0], rax             # result
                        mov              qword ptr [rsp + 8], rdx
                        cmp              al, 104;                             jne   .Lcall_α_155_240
                        add              rsp, 16;                             jmp   n57_lit_integer_β
.Lcall_α_155_240:                                                             jmp   n59_binop_α
n58_call_β:             mov              r11, 59;                             jmp   n57_lit_integer_β
.Lcall_β_155_0:         .quad            .Lcall_β_155_0_s
.Lcall_β_155_0_s:       .string          "STRING_CONCAT"
...
.Lassign_α_157_0_s:     .string          "OUTPUT"
