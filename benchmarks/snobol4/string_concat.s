...
n34_statement_begin_β:                                                        jmp   n22_statement_begin_α
#-----------------------------------------------------------------------------------------------------------------------
...
#-----------------------------------------------------------------------------------------------------------------------
n39_statement_end_α:    add              rsp, 48;                             jmp   n22_statement_begin_α
#=======================================================================================================================
# DONE    T2 = TIME()
#-----------------------------------------------------------------------------------------------------------------------
...
n55_binop_α:            sub              rsp, 16
                        ...
                        mov              edx, eax
                        and              edx, ecx
                        cmp              edx, 3;                              jne   .Lx141_2
                        mov              rax, qword ptr [rsp + 40]
                        mov              rdx, qword ptr [rsp + 24]
                        sub              rax, rdx
                        mov              qword ptr [rsp + 0], 3               # result
                        mov              qword ptr [rsp + 8], rax;            jmp   .Lx141_7
.Lx141_2:               and              edx, 1;                              jz    .Lx141_0
                        mov              rsi, qword ptr [rsp + 40]            # var
                        mov              rdi, qword ptr [rsp + 24]
                        cmp              eax, 5;                              je    .Lx141_3
                        cvtsi2sd         xmm0, rsi;                           jmp   .Lx141_4
.Lx141_3:               movq             xmm0, rsi
.Lx141_4:               cmp              ecx, 5;                              je    .Lx141_5
                        cvtsi2sd         xmm1, rdi;                           jmp   .Lx141_6
.Lx141_5:               movq             xmm1, rdi
.Lx141_6:               subsd            xmm0, xmm1
                        movq             rax, xmm0
                        mov              qword ptr [rsp + 0], 5               # result
                        mov              qword ptr [rsp + 8], rax
.Lx141_7:                                                                     jmp   n56_binop_α
