...
.Lx39_240:
                        add              r14d, 3
                                                                                        jmp   n35_match_assign_imm_α
n34_match_len_β:
                        sub              r14d, 3
                        add              rsp, 16
                                                                                        jmp   proc_PAT$0_ω
#-----------------------------------------------------------------------------------------------------------------------
n35_match_assign_imm_α:
...
n36_match_lit_α:
                        ...
                        add              eax, 1
                        cmp              eax, r15d
                                                                                        jg    n35_match_assign_imm_β
                        movsxd           rcx, r14d
                        movzx            eax, byte ptr [r13+rcx]
                        cmp              eax, 88
                                                                                        jne   n35_match_assign_imm_β
                        add              r14d, 1
                                                                                        jmp   proc_PAT$0_γ
n36_match_lit_β:
                        sub              r14d, 1
                                                                                        jmp   n35_match_assign_imm_β
#-----------------------------------------------------------------------------------------------------------------------
proc_PAT$0_res:
...
.Lx50_240:
                        add              r14d, 3
                                                                                        jmp   n46_match_assign_imm_α
n45_match_len_β:
                        sub              r14d, 3
                        add              rsp, 16
                                                                                        jmp   proc_PAT$1_ω
#-----------------------------------------------------------------------------------------------------------------------
n46_match_assign_imm_α:
                        mov              eax, dword ptr [rsp + 0]
                        lea              rdi, [rip + .S3]
                        mov              esi, eax
                        mov              edx, r14d
...
n47_match_lit_α:
                        ...
                        add              eax, 1
                        cmp              eax, r15d
                                                                                        jg    n46_match_assign_imm_β
                        movsxd           rcx, r14d
                        movzx            eax, byte ptr [r13+rcx]
                        cmp              eax, 88
                                                                                        jne   n46_match_assign_imm_β
                        add              r14d, 1
                                                                                        jmp   proc_PAT$1_γ
n47_match_lit_β:
                        sub              r14d, 1
                                                                                        jmp   n46_match_assign_imm_β
#-----------------------------------------------------------------------------------------------------------------------
proc_PAT$1_res:
                        mov              r10, qword ptr [rsp + 8]
                        mov              r11, qword ptr [rsp + 16]
