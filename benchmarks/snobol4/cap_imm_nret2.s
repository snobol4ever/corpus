...
.Lx200_1:
n78_match_begin_af:
.Lx200_2:               sub              r12, 24                              # cas_mark
                        mov              rax, qword ptr [r12 + 0]
                        test             rax, rax;                            jne   .Lx200_2
                        ...
                        mov              r10, qword ptr [rip + rtccb+56];     jmp   n77_assign_β
#-----------------------------------------------------------------------------------------------------------------------
...
.Lx203_10:              sub              r12, 24                              # cas_mark
                        ...
                        mov              qword ptr [rip + rtccb+56], r10
                        call             rt_match_ctx_restore@PLT
                        mov              r10, qword ptr [rip + rtccb+56];     jmp   n81_statement_end_α
#-----------------------------------------------------------------------------------------------------------------------
...
.Lx212_1:
n86_match_begin_af:
.Lx212_2:               sub              r12, 24                              # cas_mark
                        mov              rax, qword ptr [r12 + 0]
                        test             rax, rax;                            jne   .Lx212_2
                        mov              rsp, qword ptr [r12 + 8]             # cas_rsp_mark
                        mov              r13, qword ptr [rsp + 24]            # outer_Σ
                        mov              r14, qword ptr [rsp + 32]            # outer_δ
                        mov              r15, qword ptr [rsp + 40]            # outer_Δ
                        ...
                        mov              qword ptr [rip + rtccb+56], r10
                        call             rt_match_ctx_restore@PLT
                        mov              r10, qword ptr [rip + rtccb+56];     jmp   n85_assign_β
#-----------------------------------------------------------------------------------------------------------------------
...
.Lx215_10:              sub              r12, 24                              # cas_mark
                        ...
                        mov              qword ptr [rip + rtccb+56], r10
                        call             rt_match_ctx_restore@PLT
                        mov              r10, qword ptr [rip + rtccb+56];     jmp   n89_statement_end_α
#-----------------------------------------------------------------------------------------------------------------------
