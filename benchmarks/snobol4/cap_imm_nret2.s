...
n12_match_lit_α:
                        ...
                        add              eax, 1
                        cmp              eax, r15d
                                                                                        jg    n11_match_assign_imm_β
                        movsxd           rcx, r14d
                        movzx            eax, byte ptr [r13+rcx]
                        cmp              eax, 88
                                                                                        jne   n11_match_assign_imm_β
                        add              r14d, 1
                                                                                        jmp   proc_PAT$0_γ
n12_match_lit_β:
                        sub              r14d, 1
...
.Lx26_240:
                        add              r14d, 3
                                                                                        jmp   n22_match_assign_imm_α
n21_match_len_β:
                        sub              r14d, 3
                        add              rsp, 16
                                                                                        jmp   proc_PAT$1_ω
#-----------------------------------------------------------------------------------------------------------------------
n22_match_assign_imm_α:
                        mov              eax, dword ptr [rsp + 0]
                        lea              rdi, [rip + .S1]
                        mov              esi, eax
                        mov              edx, r14d
...
n23_match_lit_α:
                        ...
                        add              eax, 1
                        cmp              eax, r15d
                                                                                        jg    n22_match_assign_imm_β
                        movsxd           rcx, r14d
                        movzx            eax, byte ptr [r13+rcx]
                        cmp              eax, 88
                                                                                        jne   n22_match_assign_imm_β
                        add              r14d, 1
                                                                                        jmp   proc_PAT$1_γ
n23_match_lit_β:
                        sub              r14d, 1
                                                                                        jmp   n22_match_assign_imm_β
#-----------------------------------------------------------------------------------------------------------------------
proc_PAT$1_res:
                        mov              r10, qword ptr [rsp + 8]
                        mov              r11, qword ptr [rsp + 16]
...
.Lx225_0:
                        ...
                        mov              r11,  qword ptr [r11 + 64]
                                                                                        jmp   n95_cmp_test_α
n94_coerce_numeric_β:
                        add              rsp, 16
                                                                                        jmp   n93_coerce_numeric_β
#-----------------------------------------------------------------------------------------------------------------------
n95_cmp_test_α:
                        sub              rsp, 16
