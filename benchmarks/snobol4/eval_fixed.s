...
.Llit_string_α_105_0_s: .string          "eval_fixed.sno"
...
n26_statement_begin_β:  mov              r11, 27;                             jmp   n30_lit_integer_α
...
n28_assign_α:           mov              r11, 29
                        ...
                        .section         .rodata
.Lassign_α_142_1_s:     .string          "eval_fixed.sno"
                        .section         .text
                        .intel_syntax    noprefix
                        ...
                        mov              rdx, qword ptr [rsp + 8]
                        add              rsp, 16;                             jmp   n29_statement_end_α
.Lassign_α_142_0:       .quad            .Lassign_α_142_0_s
.Lassign_α_142_0_s:     .string          "X"
...
n33_statement_begin_α:  mov              r11, 34
                        mov              r10, 5;                              jmp   n34_define_α
n33_statement_begin_β:  mov              r11, 34;                             jmp   n36_lit_integer_α
...
.Ldefine_α_152_0_s:     .string          "EVAL_FIXED"
...
.Ldefine_α_153_232_s:   .string          "EVAL_FIXED"
.Ldefine_α_153_231:     lea              rcx, [rip + EVAL_FIXED_γ]
...
.Ldefine_α_153_237_s:   .string          "EVAL_FIXED"
...
n35_statement_end_α:    mov              r11, 36
                        mov              r10, 5;                              jmp   n36_lit_integer_α
...
n41_assign_α:           mov              r11, 42
                        ...
                        .section         .rodata
.Lassign_α_163_1_s:     .string          "eval_fixed.sno"
                        .section         .text
                        .intel_syntax    noprefix
...
.Llit_string_α_172_0_s: .string          "X + 1"
...
n49_assign_α:           mov              r11, 50
                        ...
                        .section         .rodata
.Lassign_α_175_1_s:     .string          "eval_fixed.sno"
                        .section         .text
                        .intel_syntax    noprefix
...
n54_statement_begin_β:  mov              r11, 55;                             jmp   n65_lit_integer_α
...
n56_var_α:              sub              rsp, 16
                        ...
                        mov              qword ptr [rsp + 0], rax             # result
                        mov              qword ptr [rsp + 8], rdx;            jmp   n57_coerce_numeric_α
...
.Lbinop_α_194_4:        cvtsi2sd         xmm1, rdi
                        ...
                        cmp              rdx, rcx;                            jae   .Lbinop_α_194_0
                        mov              qword ptr [rsp + 0], 5               # result
                        mov              qword ptr [rsp + 8], rax
.Lbinop_α_194_7:                                                              jmp   n63_assign_α
...
.Lcall_α_200_240:       mov              qword ptr [rsp + 0], rax             # result
                        ...
                        mov              r10, qword ptr [rip + rtccb+56]
                        mov              r11, qword ptr [rip + rtccb+64]
                        add              rsp, 48;                             jmp   n68_statement_begin_α
...
n70_assign_α:           mov              r11, 71
                        ...
                        .section         .rodata
.Lassign_α_205_1_s:     .string          "eval_fixed.sno"
                        .section         .text
                        .intel_syntax    noprefix
...
.Lassign_α_205_0_s:     .string          "EVAL_FIXED"
...
n72_statement_begin_α:  mov              r11, 73
                        mov              r10, 10;                             jmp   n73_statement_end_α
n72_statement_begin_β:  mov              r11, 73;                             jmp   n74_lit_integer_α
...
n73_statement_end_α:    mov              r11, 74
                        mov              r10, 10;                             jmp   n74_lit_integer_α
...
n77_statement_begin_α:  mov              r11, 78
                        mov              r10, 11;                             jmp   n78_lit_string_α
n77_statement_begin_β:  mov              r11, 78;                             jmp   n83_lit_integer_α
...
.Llit_string_α_218_0_s: .string          "X = "
...
n81_assign_α:           mov              r11, 82
                        ...
                        .section         .rodata
.Lassign_α_221_1_s:     .string          "eval_fixed.sno"
                        .section         .text
                        .intel_syntax    noprefix
...
.Llit_string_α_230_0_s: .string          "EVAL('X + 1') = "
...
.Lcall_β_233_0_s:       .string          "EVAL_FIXED"
...
n91_assign_α:           mov              r11, 92
                        ...
                        .section         .rodata
.Lassign_α_235_1_s:     .string          "eval_fixed.sno"
                        .section         .text
                        .intel_syntax    noprefix
...
n96_goto_bx:
#-----------------------------------------------------------------------------------------------------------------------
n96_goto_α:             mov              r11, 97;                             jmp   LBL__EVAL_FIXED
...
LBL__EVAL_FIXED:        sub              rsp, 16
                        mov              r11, 98
                        mov              qword ptr [rsp + 0], 3               # result
                        mov              rax, qword ptr [rip + .LLBL__EVAL_FIXED_α_243_0]
                        mov              qword ptr [rsp + 8], rax;            jmp   n98_lit_integer_α
.LLBL__EVAL_FIXED_α_243_0:
                        .quad            6
...
n101_goto_bx:
#-----------------------------------------------------------------------------------------------------------------------
n101_goto_α:            mov              r11, 102;                            jmp   n36_lit_integer_α
