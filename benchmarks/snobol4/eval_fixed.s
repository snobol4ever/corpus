...
.Llit_string_α_102_0_s: .string          "eval_fixed.sno"
...
n28_assign_α:           mov              r11, 29
                        ...
                        push             r11
                        mov              rsi, rax
                        mov              rdi, qword ptr [rip + .Lassign_α_139_0]
                        .section         .rodata
.Lassign_α_139_1_s:     .string          "eval_fixed.sno"
                        .section         .text
                        .intel_syntax    noprefix
                        lea              rcx, [rip + .Lassign_α_139_1_s]
                        mov              r8, 7
                        mov              r9, 4
                        mov              qword ptr [rip + rtccb+40], r8
                        mov              qword ptr [rip + rtccb+56], r10
...
.Lassign_α_139_0:       .quad            .Lassign_α_139_0_s
.Lassign_α_139_0_s:     .string          "X"
...
.Ldefine_α_149_0_s:     .string          "EVAL_FIXED"
...
.Ldefine_α_150_232_s:   .string          "EVAL_FIXED"
.Ldefine_α_150_231:     lea              rcx, [rip + EVAL_FIXED_γ]
...
.Ldefine_α_150_237_s:   .string          "EVAL_FIXED"
...
n41_assign_α:           mov              r11, 42
                        ...
                        .section         .rodata
.Lassign_α_160_1_s:     .string          "eval_fixed.sno"
                        .section         .text
                        .intel_syntax    noprefix
...
.Llit_string_α_169_0_s: .string          "X + 1"
...
n49_assign_α:           mov              r11, 50
                        ...
                        .section         .rodata
.Lassign_α_172_1_s:     .string          "eval_fixed.sno"
                        .section         .text
                        .intel_syntax    noprefix
...
.Lcmp_test_α_188_239:                                                         jmp   n60_var_α
.Lcmp_test_α_188_0:     lea              rdi, [rsp + 32]
                        ...
                        add              rsp, 16;                             jmp   n58_coerce_numeric_β
.Lcmp_test_α_188_240:                                                         jmp   n60_var_α
...
.Lbinop_α_191_4:        cvtsi2sd         xmm1, rdi
                        ...
                        mov              qword ptr [rsp + 8], rax
.Lbinop_α_191_7:                                                              jmp   n63_assign_α
...
n63_assign_α:           mov              r11, 64
                        ...
                        .section         .rodata
.Lassign_α_192_1_s:     .string          "eval_fixed.sno"
                        .section         .text
                        .intel_syntax    noprefix
...
n70_assign_α:           mov              r11, 71
                        ...
                        .section         .rodata
.Lassign_α_202_1_s:     .string          "eval_fixed.sno"
                        .section         .text
                        .intel_syntax    noprefix
...
.Lassign_α_202_0_s:     .string          "EVAL_FIXED"
...
.Llit_string_α_215_0_s: .string          "X = "
...
n81_assign_α:           mov              r11, 82
                        ...
                        .section         .rodata
.Lassign_α_218_1_s:     .string          "eval_fixed.sno"
                        .section         .text
                        .intel_syntax    noprefix
...
.Llit_string_α_227_0_s: .string          "EVAL('X + 1') = "
...
.Lcall_β_230_0_s:       .string          "EVAL_FIXED"
...
n91_assign_α:           mov              r11, 92
                        ...
                        .section         .rodata
.Lassign_α_232_1_s:     .string          "eval_fixed.sno"
                        .section         .text
                        .intel_syntax    noprefix
...
n93_goto_bx:
#-----------------------------------------------------------------------------------------------------------------------
n93_goto_α:             mov              r11, 94;                             jmp   LBL__EVAL_FIXED
...
LBL__EVAL_FIXED:        sub              rsp, 16
                        mov              r11, 95
                        mov              qword ptr [rsp + 0], 3               # result
                        mov              rax, qword ptr [rip + .LLBL__EVAL_FIXED_α_236_0]
                        mov              qword ptr [rsp + 8], rax;            jmp   n95_lit_integer_α
.LLBL__EVAL_FIXED_α_236_0:
                        .quad            6
...
n98_goto_bx:
#-----------------------------------------------------------------------------------------------------------------------
n98_goto_α:             mov              r11, 99;                             jmp   n36_lit_integer_α
