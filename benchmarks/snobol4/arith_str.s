...
n11_assign_α:
                        ...
                        mov              qword ptr [1879052328], rdx                    # SUM
                        add              rsp, 16
...
n15_assign_α:
                        ...
                        mov              qword ptr [1879052360], rdx                    # U
                        add              rsp, 16
                                                                                        jmp   n16_var_α
#=======================================================================================================================
# LOOP    N = N + 1
...
n20_var_α:
                        ...
                        mov              rdx, qword ptr [1879052328]                    # SUM
...
n25_var_α:
                        ...
                        mov              rdx, qword ptr [1879052360]                    # U
                        mov              qword ptr [rsp + 0], rax                       # U
                        mov              qword ptr [rsp + 8], rdx                       # U
                                                                                        jmp   n26_binop_α
#-----------------------------------------------------------------------------------------------------------------------
n26_binop_α:
                        sub              rsp, 16
