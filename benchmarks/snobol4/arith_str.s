...
n51_coerce_numeric_α:   sub              rsp, 16
                        ...
                        cmp              eax, 3;                    jne   .Lx153_0
.Lx153_1:               mov              rax, qword ptr [rsp + 32]                      # var
                        mov              qword ptr [rsp + 0], rax                       # result
...
n52_coerce_numeric_α:   sub              rsp, 16
                        ...
                        cmp              eax, 3;                    jne   .Lx155_0
.Lx155_1:               mov              rax, qword ptr [rsp + 32]                      # lit_integer
                        mov              qword ptr [rsp + 0], rax                       # result
...
n53_cmp_test_α:         sub              rsp, 16
                        ...
                        mov              r10,  qword ptr [r11 + 56]
                        mov              r11,  qword ptr [r11 + 64]
                        test             eax, eax;                  js    .Lx157_240
                        add              rsp, 16;                   jmp   n52_coerce_numeric_β
.Lx157_240:             mov              qword ptr [rsp + 0], 0                         # result
...
n66_assign_α:           mov              rsi, qword ptr [rsp + 0]                       # binop
                        ...
                        mov              r9,   qword ptr [r11 + 48]
                        mov              r10,  qword ptr [r11 + 56]
                        mov              r11,  qword ptr [r11 + 64]; jmp   n67_statement_end_α
...
#-----------------------------------------------------------------------------------------------------------------------
n76_goto_α:                                                         jmp   n30_statement_begin_α
