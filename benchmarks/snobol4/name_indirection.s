...
.Llit_string_α_107_0_s: .string          "name_indirection.sno"
...
.Ldefine_α_144_0_s:     .string          "name_indirection"
...
.Ldefine_α_145_232_s:   .string          "name_indirection"
.Ldefine_α_145_231:     lea              rcx, [rip + name_indirection_γ]
...
.Ldefine_α_145_237_s:   .string          "name_indirection"
...
n34_assign_α:           mov              r11, 35
                        ...
                        .section         .rodata
.Lassign_α_155_1_s:     .string          "name_indirection.sno"
                        .section         .text
                        .intel_syntax    noprefix
...
.Lassign_α_155_0_s:     .string          "target"
...
.Llit_string_α_164_0_s: .string          "target"
...
n41_assign_α:           mov              r11, 42
                        ...
                        .section         .rodata
.Lassign_α_165_1_s:     .string          "name_indirection.sno"
                        .section         .text
                        .intel_syntax    noprefix
...
.Lassign_α_165_0_s:     .string          "holder"
...
n48_assign_α:           mov              r11, 49
                        ...
                        .section         .rodata
.Lassign_α_175_1_s:     .string          "name_indirection.sno"
                        .section         .text
                        .intel_syntax    noprefix
...
.Lassign_α_175_0_s:     .string          "counter"
...
n55_call_α:             sub              rsp, 16
                        ...
                        mov              qword ptr [rsp + 8], r8
                        .section         .rodata
.Lcall_α_rkfnzd186:     .string          "SNO$NAME"
                        .section         .text
                        .intel_syntax    noprefix
...
n58_deref_α:            sub              rsp, 16
                        ...
                        mov              r10, qword ptr [rip + rtccb+56]
                        mov              r11, qword ptr [rip + rtccb+64]
                        cmp              al, 104;                             jne   .Lderef_α_190_240
                        add              rsp, 32;                             jmp   n56_var_β
.Lderef_α_190_240:      mov              qword ptr [rsp + 0], rax             # result
...
.Lbinop_α_192_4:        cvtsi2sd         xmm1, rdi
                        ...
                        mov              qword ptr [rsp + 8], rax
.Lbinop_α_192_7:                                                              jmp   n61_assign_var_α
.Lbinop_α_192_0:        mov              rdi, qword ptr [rsp + 32]            # deref
...
n61_assign_var_α:       sub              rsp, 16
                        ...
                        mov              r10, qword ptr [rip + rtccb+56]
                        mov              r11, qword ptr [rip + rtccb+64]
                        cmp              al, 104;                             jne   .Lassign_var_α_193_240
                        add              rsp, 16;                             jmp   n60_binop_β
.Lassign_var_α_193_240: mov              qword ptr [rsp + 0], rax             # result
...
.Lcmp_test_α_209_239:                                                         jmp   n72_var_α
.Lcmp_test_α_209_0:     lea              rdi, [rsp + 32]
                        ...
                        add              rsp, 16;                             jmp   n70_coerce_numeric_β
.Lcmp_test_α_209_240:                                                         jmp   n72_var_α
...
.Lbinop_α_212_4:        cvtsi2sd         xmm1, rdi
                        ...
                        mov              qword ptr [rsp + 0], 5               # result
                        mov              qword ptr [rsp + 8], rax
.Lbinop_α_212_7:                                                              jmp   n75_assign_α
...
n75_assign_α:           mov              r11, 76
                        ...
                        .section         .rodata
.Lassign_α_213_1_s:     .string          "name_indirection.sno"
                        .section         .text
                        .intel_syntax    noprefix
...
.Lassign_α_213_0_s:     .string          "counter"
...
n82_call_α:             sub              rsp, 16
                        ...
                        mov              qword ptr [rsp + 8], r8
                        .section         .rodata
.Lcall_α_rkfnzd224:     .string          "SNO$NAME"
                        .section         .text
                        .intel_syntax    noprefix
...
n83_deref_α:            sub              rsp, 16
                        ...
                        mov              r10, qword ptr [rip + rtccb+56]
                        mov              r11, qword ptr [rip + rtccb+64]
                        cmp              al, 104;                             jne   .Lderef_α_225_240
                        add              rsp, 16
                        add              rsp, 32;                             jmp   n80_statement_begin_β
.Lderef_α_225_240:      mov              qword ptr [rsp + 0], rax             # result
...
n84_assign_α:           mov              r11, 85
                        ...
                        .section         .rodata
.Lassign_α_226_1_s:     .string          "name_indirection.sno"
                        .section         .text
                        .intel_syntax    noprefix
...
.Lassign_α_226_0_s:     .string          "name_indirection"
...
.Llit_string_α_239_0_s: .string          "final value = "
...
.Llit_integer_α_240_0:  .quad            20000
...
n96_assign_α:           mov              r11, 97
                        ...
                        .section         .rodata
.Lassign_α_244_1_s:     .string          "name_indirection.sno"
                        .section         .text
                        .intel_syntax    noprefix
...
.Lassign_α_244_0_s:     .string          "OUTPUT"
...
n98_goto_bx:
#-----------------------------------------------------------------------------------------------------------------------
n98_goto_α:             mov              r11, 99;                             jmp   LBL__name_indirection
...
LBL__name_indirection:  sub              rsp, 16
                        mov              r11, 100
                        mov              qword ptr [rsp + 0], 3               # result
                        mov              rax, qword ptr [rip + .LLBL__name_indirection_α_248_0]
                        mov              qword ptr [rsp + 8], rax;            jmp   n100_lit_integer_α
.LLBL__name_indirection_α_248_0:
                        .quad            5
...
n102_goto_bx:
#-----------------------------------------------------------------------------------------------------------------------
n102_goto_α:            mov              r11, 103;                            jmp   n50_lit_integer_α
