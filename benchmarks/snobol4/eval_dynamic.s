...
n21_coerce_numeric_α:   sub              rsp, 16
                        ...
                        cmp              eax, 3;                    jne   .Lx97_0
.Lx97_1:                mov              rax, qword ptr [rsp + 32]                      # var
                        mov              qword ptr [rsp + 0], rax                       # result
...
n22_coerce_numeric_α:   sub              rsp, 16
                        ...
                        cmp              eax, 3;                    jne   .Lx99_0
.Lx99_1:                mov              rax, qword ptr [rsp + 32]                      # lit_integer
                        mov              qword ptr [rsp + 0], rax                       # result
...
n23_cmp_test_α:         sub              rsp, 16
                        ...
                        mov              r10,  qword ptr [r11 + 56]
                        mov              r11,  qword ptr [r11 + 64]
                        test             eax, eax;                  js    .Lx101_240
                        add              rsp, 16;                   jmp   n22_coerce_numeric_β
.Lx101_240:             mov              qword ptr [rsp + 0], 0                         # result
...
#-----------------------------------------------------------------------------------------------------------------------
n61_goto_α:                                                         jmp   n18_statement_begin_α
n61_goto_β:                                                         jmp   main_ω
#-----------------------------------------------------------------------------------------------------------------------
n62_goto_α:                                                         jmp   n43_statement_begin_α
