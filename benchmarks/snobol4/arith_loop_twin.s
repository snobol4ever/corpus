...
.Llit_string_α_38_0_s:  .string          "arith_loop_twin.sno"
...
n6_assign_α:            mov              r11, 7
                        ...
                        .section         .rodata
.Lassign_α_44_1_s:      .string          "arith_loop_twin.sno"
                        .section         .text
                        .intel_syntax    noprefix
...
n10_assign_α:           mov              r11, 11
                        ...
                        .section         .rodata
.Lassign_α_50_1_s:      .string          "arith_loop_twin.sno"
                        .section         .text
                        .intel_syntax    noprefix
...
n16_assign_α:           mov              r11, 17
                        ...
                        .section         .rodata
.Lassign_α_58_1_s:      .string          "arith_loop_twin.sno"
                        .section         .text
                        .intel_syntax    noprefix
...
n22_assign_α:           mov              r11, 23
                        ...
                        .section         .rodata
.Lassign_α_66_1_s:      .string          "arith_loop_twin.sno"
                        .section         .text
                        .intel_syntax    noprefix
...
.Llit_integer_α_72_0:   .quad            300000
...
n29_cmp_test_α:         sub              rsp, 16
                        ...
                        mov              rax, qword ptr [rsp + 40]
                        mov              rdx, qword ptr [rsp + 24]
                        cmp              rax, rdx;                            jle   .Lcmp_test_α_78_239
                        add              rsp, 16;                             jmp   n28_coerce_numeric_β
.Lcmp_test_α_78_239:                                                          jmp   n30_statement_end_α
.Lcmp_test_α_78_0:      lea              rdi, [rsp + 32]
                        ...
                        mov              r10, qword ptr [rip + rtccb+56]
                        mov              r11, qword ptr [rip + rtccb+64]
                        test             eax, eax;                            jle   .Lcmp_test_α_78_240
                        add              rsp, 16;                             jmp   n28_coerce_numeric_β
.Lcmp_test_α_78_240:                                                          jmp   n30_statement_end_α
...
n33_assign_α:           mov              r11, 34
                        ...
                        .section         .rodata
.Lassign_α_84_1_s:      .string          "arith_loop_twin.sno"
                        .section         .text
                        .intel_syntax    noprefix
                        lea              rcx, [rip + .Lassign_α_84_1_s]
                        mov              r8, 11
                        mov              r9, 6
                        mov              qword ptr [rip + rtccb+40], r8
                        mov              qword ptr [rip + rtccb+56], r10
...
n35_goto_bx:
#-----------------------------------------------------------------------------------------------------------------------
n35_goto_α:             mov              r11, 36;                             jmp   n12_statement_begin_α
