...
n11_binop_α:            sub              rsp, 16
                        ...
                        add              rax, rdx
                        mov              qword ptr [rsp + 0], 3               # result
                        mov              qword ptr [rsp + 8], rax;            jmp   .Lbinop_α_47_7
...
.Lbinop_α_47_7:                                                               jmp   n12_assign_α
.Lbinop_α_47_0:         mov              rdi, qword ptr [rsp + 32]            # var
                        ...
                        cmp              al, 104;                             jne   .Lbinop_α_47_240
                        add              rsp, 16;                             jmp   n10_var_β
.Lbinop_α_47_240:       mov              qword ptr [rsp + 0], rax             # result
...
n17_binop_α:            sub              rsp, 16
                        ...
                        mov              rax, qword ptr [rsp + 40]
                        cmp              cl, 3;                               jne   .Lbinop_α_55_2
                        add              rax, 1
                        mov              qword ptr [rsp + 0], 3               # result
                        mov              qword ptr [rsp + 8], rax;            jmp   .Lbinop_α_55_7
.Lbinop_α_55_2:         mov              eax, ecx
                        mov              edx, ecx
                        and              edx, 1;                              jz    .Lbinop_α_55_0
                        mov              rsi, qword ptr [rsp + 40]            # var
                        mov              rdi, 1
                        cmp              al, 5;                               je    .Lbinop_α_55_3
                        cvtsi2sd         xmm0, rsi;                           jmp   .Lbinop_α_55_4
.Lbinop_α_55_3:         movq             xmm0, rsi
.Lbinop_α_55_4:         cvtsi2sd         xmm1, rdi
                        addsd            xmm0, xmm1
                        movq             rax, xmm0
                        mov              qword ptr [rsp + 0], 5               # result
                        mov              qword ptr [rsp + 8], rax
.Lbinop_α_55_7:                                                               jmp   n18_assign_α
.Lbinop_α_55_0:         mov              rdi, qword ptr [rsp + 32]            # var
                        mov              rsi, qword ptr [rsp + 40]
                        ...
                        mov              r10, qword ptr [rip + rtccb+56]
                        mov              r11, qword ptr [rip + rtccb+64]
                        cmp              al, 104;                             jne   .Lbinop_α_55_240
                        add              rsp, 16;                             jmp   n16_lit_integer_β
.Lbinop_α_55_240:       mov              qword ptr [rsp + 0], rax             # result
...
.Llit_integer_α_62_0:   .quad            300000
...
n25_cmp_test_α:         sub              rsp, 16
                        ...
                        mov              rax, qword ptr [rsp + 40]
                        mov              rdx, qword ptr [rsp + 24]
                        cmp              rax, rdx;                            jle   .Lcmp_test_α_68_239
                        add              rsp, 16;                             jmp   n24_coerce_numeric_β
.Lcmp_test_α_68_239:                                                          jmp   n26_statement_end_α
.Lcmp_test_α_68_0:      lea              rdi, [rsp + 32]
                        ...
                        mov              r10, qword ptr [rip + rtccb+56]
                        mov              r11, qword ptr [rip + rtccb+64]
                        test             eax, eax;                            jle   .Lcmp_test_α_68_240
                        add              rsp, 16;                             jmp   n24_coerce_numeric_β
.Lcmp_test_α_68_240:                                                          jmp   n26_statement_end_α
