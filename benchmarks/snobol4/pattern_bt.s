...
.Lx121_0_s:             .string          "xxxxxxxxxxbbbccccddddaaaaxxxxxxxxxxbbbccccddddaaaa"
#-----------------------------------------------------------------------------------------------------------------------
...
PATTERN_BT_α:           sub              rsp, 64
                        ...
                        mov              qword ptr [rdi + 8], rsi;            jmp   .Lx129_41
.Lx129_10:              mov              rax, qword ptr [r9 + 16]
                        mov              qword ptr [rsp + 48], rax
                        mov              rax, qword ptr [r9 + 24]
                        mov              qword ptr [rsp + 56], rax
                        mov              qword ptr [r9 + 16], 0
                        mov              qword ptr [r9 + 24], 0
.Lx129_41:              lea              rcx, [rip + PATTERN_BT_γ]
...
PATTERN_BT_γ:           mov              rdi, qword ptr [r9 + 0]              # PATTERN_BT
                        ...
                        mov              qword ptr [r9 + 24], rax;            jmp   .Lx129_110
.Lx129_80:              mov              rax, qword ptr [rsp + 48]
                        mov              qword ptr [r9 + 16], rax
                        mov              rax, qword ptr [rsp + 56]
                        mov              qword ptr [r9 + 24], rax
.Lx129_110:             mov              rcx, qword ptr [rcx + 8]
                        add              rsp, 64
                        mov              rax, rdi
                        mov              rdx, rsi;                            jmp   rcx
PATTERN_BT_ω:           mov              rcx, qword ptr [rsp + 32]
                        ...
                        add              rax, r8
                        mov              rax, qword ptr [rax + 8]
                        mov              qword ptr [r9 + 24], rax;            jmp   .Lx129_180
.Lx129_150:             mov              rax, qword ptr [rsp + 48]
                        mov              qword ptr [r9 + 16], rax
                        mov              rax, qword ptr [rsp + 56]
                        mov              qword ptr [r9 + 24], rax
.Lx129_180:             mov              rcx, qword ptr [rcx + 16]
                        add              rsp, 64
                        mov              eax, 104
                        xor              edx, edx;                            jmp   rcx
.Lx129_245:
...
n64_coerce_numeric_α:   sub              rsp, 16
                        ...
                        mov              eax, dword ptr [rsp + 16]
                        cmp              al, 3;                               jne   .Lx155_0
.Lx155_1:               mov              rax, qword ptr [rsp + 32]
                        mov              qword ptr [rsp + 0], rax             # result
...
n65_coerce_numeric_α:   sub              rsp, 16
                        ...
                        cmp              al, 3;                               jne   .Lx157_0
.Lx157_1:               mov              rax, qword ptr [rsp + 32]
                        mov              qword ptr [rsp + 0], rax             # result
                        mov              rax, qword ptr [rsp + 40]            # var
...
n66_cmp_test_α:         sub              rsp, 16
                        ...
                        mov              edx, eax
                        and              edx, ecx
                        cmp              dl, 3;                               jne   .Lx159_0
                        mov              rax, qword ptr [rsp + 40]
                        mov              rdx, qword ptr [rsp + 24]
                        cmp              rax, rdx;                            jl    .Lx159_239
                        add              rsp, 16;                             jmp   n65_coerce_numeric_β
.Lx159_239:                                                                   jmp   n67_var_α
...
.Lx186_0_s:             .string          "captured tail = "
#-----------------------------------------------------------------------------------------------------------------------
