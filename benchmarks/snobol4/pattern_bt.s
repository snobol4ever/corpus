...
n58_match_defer_α:      mov              r11, 43
                        ...
                        lea              rdx, [rip + .S1]
                        cmp              rax, rdx;                            jne   .Lmatch_defer_α_145_30
                        mov              rax, qword ptr [rcx + 8]
                        mov              edx, dword ptr [rax + 0]
                        and              edx, 255
                        cmp              edx, 2;                              jne   .Lmatch_defer_α_145_30
                        mov              edx, dword ptr [rax + 4]
                        cmp              edx, 1;                              jne   .Lmatch_defer_α_145_30
                        movsxd           rcx, r14d
...
.Lmatch_defer_α_145_30: lea              rsi, [rip + g_sno_defer_cells+16384]
                        lea              rdi, [rip + .S1]
                        mov              rcx, qword ptr [rsi + 0]
                        cmp              rcx, rdi;                            jne   .Lmatch_defer_α_145_22
                        mov              rcx, qword ptr [rsi + 8]
                        test             rcx, rcx;                            je    .Lmatch_defer_α_145_22
                        mov              rax, qword ptr [rcx + 0]
                        cmp              al, 8;                               jne   .Lmatch_defer_α_145_22
...
n87_call_α:             sub              rsp, 16
                        mov              r11, 72
                        lea              rcx, [rip + .Lcall_sig189z]
                        lea              rax, [rip + PATTERN_BT_α];           jmp   rax
.Lcall_sig189z:         .quad            1
                        .quad            .Lcall_α_189_2
                        .quad            .Lcall_α_189_2
                        .quad            16
