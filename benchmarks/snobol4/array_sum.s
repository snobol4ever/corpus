...
__gva_names:
                        ...
                        .intel_syntax    noprefix
                        .section         .rodata
.Llbln0:                .string          "ARRAY_SUM"
.Llbln1:                .string          "ZBL"
.Llbln2:                .string          "ZFILL"
.Llbln3:                .string          "ZREAD"
.Llbln4:                .string          "ARRAY_SUM_END"
.Llbln5:                .string          "END"
                        .align           8
__label_names:
                        .quad            .Llbln0
...
.Llit_string_α_170_0_s: .string          "array_sum.sno"
...
.Ldefine_α_207_0_s:     .string          "ARRAY_SUM"
...
.Ldefine_α_208_232_s:   .string          "ARRAY_SUM"
.Ldefine_α_208_231:     lea              rcx, [rip + ARRAY_SUM_γ]
...
.Ldefine_α_208_237_s:   .string          "ARRAY_SUM"
...
n34_assign_α:           mov              r11, 35
                        ...
                        .section         .rodata
.Lassign_α_218_1_s:     .string          "array_sum.sno"
                        .section         .text
                        .intel_syntax    noprefix
...
n41_call_α:             sub              rsp, 16
                        ...
                        mov              qword ptr [rsp + 8], r8
                        .section         .rodata
.Lcall_α_rkfnzd229:     .string          "ARRAY"
                        .section         .text
                        .intel_syntax    noprefix
...
n42_assign_α:           mov              r11, 43
                        ...
                        .section         .rodata
.Lassign_α_230_1_s:     .string          "array_sum.sno"
                        .section         .text
                        .intel_syntax    noprefix
...
n49_assign_α:           mov              r11, 50
                        ...
                        .section         .rodata
.Lassign_α_240_1_s:     .string          "array_sum.sno"
                        .section         .text
                        .intel_syntax    noprefix
...
n74_assign_α:           mov              r11, 75
                        ...
                        .section         .rodata
.Lassign_α_275_1_s:     .string          "array_sum.sno"
                        .section         .text
                        .intel_syntax    noprefix
...
n81_assign_α:           mov              r11, 82
                        ...
                        .section         .rodata
.Lassign_α_285_1_s:     .string          "array_sum.sno"
                        .section         .text
                        .intel_syntax    noprefix
...
n88_assign_α:           mov              r11, 89
                        ...
                        .section         .rodata
.Lassign_α_295_1_s:     .string          "array_sum.sno"
                        .section         .text
                        .intel_syntax    noprefix
...
n100_assign_α:          mov              r11, 101
                        ...
                        .section         .rodata
.Lassign_α_310_1_s:     .string          "array_sum.sno"
                        .section         .text
                        .intel_syntax    noprefix
...
n114_assign_α:          mov              r11, 115
                        ...
                        .section         .rodata
.Lassign_α_330_1_s:     .string          "array_sum.sno"
                        .section         .text
                        .intel_syntax    noprefix
...
n128_assign_α:          mov              r11, 129
                        ...
                        .section         .rodata
.Lassign_α_350_1_s:     .string          "array_sum.sno"
                        .section         .text
                        .intel_syntax    noprefix
...
n135_assign_α:          mov              r11, 136
                        ...
                        .section         .rodata
.Lassign_α_360_1_s:     .string          "array_sum.sno"
                        .section         .text
                        .intel_syntax    noprefix
...
.Lassign_α_360_0_s:     .string          "ARRAY_SUM"
...
.Llit_string_α_373_0_s: .string          "sum of 2,4,..,1000 = "
...
.Lcall_β_376_0_s:       .string          "ARRAY_SUM"
...
n147_assign_α:          mov              r11, 148
                        ...
                        .section         .rodata
.Lassign_α_378_1_s:     .string          "array_sum.sno"
                        .section         .text
                        .intel_syntax    noprefix
...
.Lcall_β_390_0_s:       .string          "ARRAY_SUM"
...
n157_assign_α:          mov              r11, 158
                        ...
                        .section         .rodata
.Lassign_α_392_1_s:     .string          "array_sum.sno"
                        .section         .text
                        .intel_syntax    noprefix
...
n159_goto_bx:
#-----------------------------------------------------------------------------------------------------------------------
n159_goto_α:            mov              r11, 160;                            jmp   LBL__ARRAY_SUM
...
LBL__ARRAY_SUM:         sub              rsp, 16
                        mov              r11, 161
                        mov              qword ptr [rsp + 0], 3               # result
                        mov              rax, qword ptr [rip + .LLBL__ARRAY_SUM_α_396_0]
                        mov              qword ptr [rsp + 8], rax;            jmp   n161_lit_integer_α
.LLBL__ARRAY_SUM_α_396_0:
                        .quad            5
