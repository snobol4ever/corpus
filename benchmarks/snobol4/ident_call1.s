...
.Ldefine_α_85_0_s:      .string          "IDENT_CALL1"
...
.Ldefine_α_86_41:       lea              rcx, [rip + IDENT_CALL1_γ]
...
.Lbinop_α_105_4:        cvtsi2sd         xmm1, rdi
                        ...
                        mov              qword ptr [rsp + 8], rax
.Lbinop_α_105_7:                                                              jmp   n28_assign_α
...
n33_ident_α:            sub              rsp, 16
                        ...
                        mov              r10, qword ptr [rip + rtccb+56]
                        mov              r11, qword ptr [rip + rtccb+64]
                        test             eax, eax;                            jne   .Lident_α_114_240
                        add              rsp, 16;                             jmp   n32_lit_string_β
.Lident_α_114_240:                                                            jmp   n34_statement_end_α
...
n39_coerce_numeric_α:   sub              rsp, 16
                        mov              r11, 40
                        mov              eax, dword ptr [rsp + 32]            # var
                        cmp              al, 5;                               je    .Lcoerce_numeric_α_124_1
                        cmp              al, 3;                               jne   .Lcoerce_numeric_α_124_0
                        mov              eax, dword ptr [rsp + 48]
                        cmp              al, 3;                               jne   .Lcoerce_numeric_α_124_0
.Lcoerce_numeric_α_124_1:
                        mov              rax, qword ptr [rsp + 32]
                        mov              qword ptr [rsp + 0], rax             # result
                        mov              rax, qword ptr [rsp + 40]            # var
                        mov              qword ptr [rsp + 8], rax;            jmp   n40_cmp_test_α
.Lcoerce_numeric_α_124_0:
                        lea              rdi, [rsp + 32]
                        lea              rsi, [rsp + 48]
                        lea              rdx, [rsp + 0]                       # result
                        mov              rcx, 148
...
n40_cmp_test_α:         sub              rsp, 16
                        ...
                        mov              edx, eax
                        and              edx, ecx
                        cmp              dl, 3;                               jne   .Lcmp_test_α_126_0
                        mov              rax, qword ptr [rsp + 40]
                        mov              rdx, qword ptr [rsp + 24]
                        cmp              rax, rdx;                            jl    .Lcmp_test_α_126_239
                        add              rsp, 16;                             jmp   n39_coerce_numeric_β
.Lcmp_test_α_126_239:                                                         jmp   n41_var_α
.Lcmp_test_α_126_0:     lea              rdi, [rsp + 32]
                        lea              rsi, [rsp + 16]
                        mov              qword ptr [rip + rtccb+56], r10
                        mov              qword ptr [rip + rtccb+64], r11
                        call             rt_cmp_d@PLT
                        mov              r10, qword ptr [rip + rtccb+56]
                        mov              r11, qword ptr [rip + rtccb+64]
                        test             eax, eax;                            js    .Lcmp_test_α_126_240
                        add              rsp, 16;                             jmp   n39_coerce_numeric_β
.Lcmp_test_α_126_240:                                                         jmp   n41_var_α
...
n43_binop_α:            sub              rsp, 16
                        ...
                        mov              ecx, dword ptr [rsp + 32]            # var
                        mov              rax, qword ptr [rsp + 40]
                        cmp              cl, 3;                               jne   .Lbinop_α_129_2
                        add              rax, 1
                        mov              qword ptr [rsp + 0], 3               # result
                        mov              qword ptr [rsp + 8], rax;            jmp   .Lbinop_α_129_7
.Lbinop_α_129_2:        mov              eax, ecx
                        mov              edx, ecx
                        and              edx, 1;                              jz    .Lbinop_α_129_0
                        mov              rsi, qword ptr [rsp + 40]            # var
                        mov              rdi, 1
                        cmp              al, 5;                               je    .Lbinop_α_129_3
                        cvtsi2sd         xmm0, rsi;                           jmp   .Lbinop_α_129_4
.Lbinop_α_129_3:        movq             xmm0, rsi
.Lbinop_α_129_4:        cvtsi2sd         xmm1, rdi
                        addsd            xmm0, xmm1
                        movq             rax, xmm0
                        mov              qword ptr [rsp + 0], 5               # result
                        mov              qword ptr [rsp + 8], rax
.Lbinop_α_129_7:                                                              jmp   n44_assign_α
.Lbinop_α_129_0:        mov              rdi, qword ptr [rsp + 32]            # var
                        mov              rsi, qword ptr [rsp + 40]
                        mov              rdx, qword ptr [rsp + 16]            # lit_integer
                        mov              rcx, qword ptr [rsp + 24]
                        mov              qword ptr [rip + rtccb+40], r8
...
.Lbinop_α_129_240:      mov              qword ptr [rsp + 0], rax             # result
...
.Llit_string_α_145_0_s: .string          "ident_call1(1000) = "
...
.Llit_integer_α_146_0:  .quad            1000
