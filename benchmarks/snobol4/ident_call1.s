...
.Llit_string_α_49_0_s:  .string          "ident_call1.sno"
...
.Lbinop_α_74_4:         cvtsi2sd         xmm1, rdi
                        ...
                        mov              qword ptr [rsp + 8], rax
.Lbinop_α_74_7:                                                               jmp   n19_assign_α
...
n25_ident_α:            sub              rsp, 16
                        ...
                        test             eax, eax;                            jne   .Lident_α_85_240
                        add              rsp, 16;                             jmp   n24_lit_string_β
.Lident_α_85_240:                                                             jmp   n26_statement_end_α
                        .size            n25_ident_bx, .-n25_ident_bx
...
n28_statement_begin_β:  mov              r11, 29;                             jmp   n39_stmt_mark_α
...
n32_coerce_numeric_α:   sub              rsp, 16
                        ...
                        cmp              al, 5;                               je    .Lcoerce_numeric_α_97_1
                        cmp              al, 3;                               jne   .Lcoerce_numeric_α_97_0
                        mov              eax, dword ptr [rsp + 48]            # var
                        cmp              al, 3;                               jne   .Lcoerce_numeric_α_97_0
.Lcoerce_numeric_α_97_1:
                        mov              rax, qword ptr [rsp + 32]            # lit_integer
                        mov              qword ptr [rsp + 0], rax             # result
                        mov              rax, qword ptr [rsp + 40]            # lit_integer
                        mov              qword ptr [rsp + 8], rax;            jmp   n33_cmp_test_α
.Lcoerce_numeric_α_97_0:
                        lea              rdi, [rsp + 32]
                        lea              rsi, [rsp + 48]                      # var
                        lea              rdx, [rsp + 0]                       # result
                        mov              rcx, 148
...
n33_cmp_test_α:         sub              rsp, 16
                        ...
                        mov              edx, eax
                        and              edx, ecx
                        cmp              dl, 3;                               jne   .Lcmp_test_α_99_0
                        mov              rax, qword ptr [rsp + 40]
                        mov              rdx, qword ptr [rsp + 24]
                        cmp              rax, rdx;                            jl    .Lcmp_test_α_99_239
                        add              rsp, 16;                             jmp   n32_coerce_numeric_β
.Lcmp_test_α_99_239:                                                          jmp   n34_var_α
.Lcmp_test_α_99_0:      lea              rdi, [rsp + 32]
                        lea              rsi, [rsp + 16]
                        call             qword ptr [rip + rt_cmp_d@GOTPCREL]
                        test             eax, eax;                            js    .Lcmp_test_α_99_240
                        add              rsp, 16;                             jmp   n32_coerce_numeric_β
.Lcmp_test_α_99_240:                                                          jmp   n34_var_α
...
.Lbinop_α_102_4:        cvtsi2sd         xmm1, rdi
                        ...
                        add              rdx, rdx
                        movabs           rcx, 18437736874454810624
                        cmp              rdx, rcx;                            jae   .Lbinop_α_102_0
                        mov              qword ptr [rsp + 0], 5               # result
                        mov              qword ptr [rsp + 8], rax
.Lbinop_α_102_7:                                                              jmp   n37_assign_α
...
#-----------------------------------------------------------------------------------------------------------------------
n40_statement_begin_α:  mov              r11, 41;                             jmp   n41_lit_string_α
...
.Llit_string_α_110_0_s: .string          "ident_call1(1000) = "
...
.Lassign_α_113_0_s:     .string          "OUTPUT"
...
n46_goto_bx:
#-----------------------------------------------------------------------------------------------------------------------
n46_goto_α:             mov              r11, 47;                             jmp   n14_stmt_mark_α
n46_goto_β:             mov              r11, 47;                             jmp   main_ω
