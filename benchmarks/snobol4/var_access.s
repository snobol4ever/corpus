...
.Ldefine_α_220_41:      lea              rcx, [rip + VAR_ACCESS_γ]
                        lea              rax, [rip + VAR_ACCESS_ω]
                        push             rax
                        push             rcx
                        lea              rax, [rip + n178_lit_integer_α];     jmp   rax
...
n111_assign_α:          mov              r11, 112
                        ...
                        mov              rdx, qword ptr [rsp + 8]
                        mov              qword ptr [r9 + 96], rax             # E
                        mov              qword ptr [r9 + 104], rdx;           jmp   n112_statement_end_α
...
n177_goto_bx:
#-----------------------------------------------------------------------------------------------------------------------
n177_goto_α:            mov              r11, 178;                            jmp   n178_lit_integer_α
