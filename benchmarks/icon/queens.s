...
# IR_INDIRECT_GOTO alt-resume: jmp *t
 ...
 je .Lx00026_1
 call rt_proc_open_fn@PLT
 lea rcx, [rip + .Lx00026_3]
 lea rdx, [rip + .Lx00026_4]
 jmp rax
.Lx00026_3:
 call rt_proc_call_epilogue_γ@PLT
 jmp .Lx00026_2
...
.Lx00058_0:
 cmp rax, 1
 jl xchain00052_n30_α
 mov rcx, r15
 add rcx, 1
 cmp rax, rcx
 jg xchain00052_n30_α
 mov rcx, r14
 add rcx, 1
 cmp rax, rcx
 jne xchain00052_n30_α
...
.Lx00065_0:
 cmp rax, 1
 jl xchain00052_n39_α
 mov rcx, r15
 add rcx, 1
 cmp rax, rcx
 jg xchain00052_n39_α
 mov rcx, r14
 add rcx, 1
 cmp rax, rcx
 jne xchain00052_n39_α
...
.Lx00067_60:
  .section .rodata
  .Lbynamegenfn216: .string "find"
  .section .text
  .intel_syntax noprefix
 lea rdi, [rip + .Lbynamegenfn216]
 lea rsi, [rbp + 2624]
 mov edx, 2
 lea rcx, [rbp + 2656]
...
# IR_MOVE_LABEL
 ...
 lea rax, [rip + xchain00052_n00023_α]
...
# IR_ASSIGN gva
 ...
 je .Lx00091_1
 call rt_proc_open_fn@PLT
 lea rcx, [rip + .Lx00091_3]
 lea rdx, [rip + .Lx00091_4]
 jmp rax
.Lx00091_3:
 call rt_proc_call_epilogue_γ@PLT
 jmp .Lx00091_2
...
# IR_VAR
 ...
 je .Lx00105_1
 call rt_proc_open_fn@PLT
 lea rcx, [rip + .Lx00105_3]
 lea rdx, [rip + .Lx00105_4]
 jmp rax
.Lx00105_3:
 call rt_proc_call_epilogue_γ@PLT
 jmp .Lx00105_2
...
main_α_body:
 ...
 je .Lx00153_1
 call rt_proc_open_fn@PLT
 lea rcx, [rip + .Lx00153_3]
 lea rdx, [rip + .Lx00153_4]
 jmp rax
.Lx00153_3:
 call rt_proc_call_epilogue_γ@PLT
 jmp .Lx00153_2
