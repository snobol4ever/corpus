...
.Lx00039_60:
  .section .rodata
  .Lbynamegenfn269: .string "find"
  .section .text
  .intel_syntax noprefix
   lea rdi, [rip + .Lbynamegenfn269]
 lea rsi, [r12 + 1744]
 mov edx, 2
 lea rcx, [r12 + 1776]
...
.Lx00083_0_s:
 ...
 xchain00081_n5_α:
  .section .rodata
  .Lcall00042_pname: .string "Regions__"
  .section .text
  .intel_syntax noprefix
...
# IR_VAR
 ...
 xchain00081_n7_α:
  .section .rodata
  .Lcall00084_pname: .string "Time__"
  .section .text
  .intel_syntax noprefix
...
xchain00081_n7_β:
 ...
 xchain00081_n8_α:
  .section .rodata
  .Lcall00085_pname: .string "Storage__"
  .section .text
  .intel_syntax noprefix
...
# marshal arg2 = producer-box slot [zr+160] -> [zr+112]
 ...
 xchain00081_n12_α:
  .section .rodata
  .Lcall00087_pname: .string "Collections__"
  .section .text
  .intel_syntax noprefix
...
# IR_LIT_INTEGER
 ...
 mov qword ptr [r12 + 72], rax
 jmp xchain00114_n17_α
 xchain00114_n15_β:
 jmp xchain00114_n20_α
.Lx00121_0:
 .quad 1
# IR_ASSIGN gva
 xchain00114_n16_α:
...
.Lx00122_0:
 ...
 mov rcx, qword ptr [r12 + 88]
 cmp rax, rcx
 jg xchain00114_n20_α
 mov qword ptr [r12 + 32], 6
 mov qword ptr [r12 + 40], rax
 jmp xchain00114_n23_α
 xchain00114_n22_β:
 inc qword ptr [r12 + 48]
 jmp .Lx00122_0
 xchain00114_n23_α:
...
# IR_VAR_REF
 ...
 mov qword ptr [r12 + 160], rax
 mov qword ptr [r12 + 168], rdx
 jmp xchain00114_n25_α
 xchain00114_n24_β:
 jmp xchain00114_n22_β
# IR_VAR
 xchain00114_n25_α:
 mov rax, qword ptr [r12 + 768]
 mov qword ptr [r12 + 176], rax
...
# IR_SUBSCRIPT x[i] variable
 ...
 call rt_subscript_var@PLT
 cmp eax, 99
 je xchain00114_n22_β
 mov qword ptr [r12 + 192], rax
 mov qword ptr [r12 + 200], rdx
 jmp xchain00114_n27_α
 xchain00114_n26_β:
 jmp xchain00114_n22_β
# IR_DEREF variable -> value
 xchain00114_n27_α:
...
main_α_body:
 xchain00129_n0_α:
  .section .rodata
  .Lcall00130_pname: .string "Init__"
  .section .text
  .intel_syntax noprefix
...
# marshal arg1 = producer-box slot [zr+160] -> [zr+128]
 ...
 mov qword ptr [r12 + 104], rdx
 cmp eax, 99
 je xchain00129_n24_α
 jmp xchain00129_n24_α
 xchain00129_n26_β:
 jmp xchain00129_n24_α
 xchain00129_n27_α:
  .section .rodata
  .Lcall00140_pname: .string "q"
  .section .text
  .intel_syntax noprefix
 mov edi, 0
...
# IR_MOVE_LABEL: shared value := arm value; t := &arm-resume
 ...
 xchain00129_n29_α:
  .section .rodata
  .Lcall00141_pname: .string "Term__"
  .section .text
  .intel_syntax noprefix
