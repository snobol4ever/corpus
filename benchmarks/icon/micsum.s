...
.Lrkfn147:              .string          "read"
                        ...
                        cmp              al, 104;                             je    n42_var_α
                                                                              jmp   n6_assign_α
n5_call_builtin_icon_β: mov              r11, 6;                              jmp   n42_var_α
#-----------------------------------------------------------------------------------------------------------------------
...
.Lrkfn164:              .string          "integer"
                        ...
                        cmp              al, 104;                             je    n17_lit_charset_α
                                                                              jmp   n16_assign_α
n15_call_builtin_icon_β:
                        mov              r11, 16;                             jmp   n17_lit_charset_α
#-----------------------------------------------------------------------------------------------------------------------
...
n47_call_builtin_icon_β:
                        mov              r11, 48;                             jmp   n49_lit_integer_α
#-----------------------------------------------------------------------------------------------------------------------
...
n48_call_builtin_icon_β:
                        mov              r11, 49;                             jmp   n49_lit_integer_α
#-----------------------------------------------------------------------------------------------------------------------
...
n53_iterate_β:          mov              r11, 54
                        inc              qword ptr [rsp + 1792];              jmp   .Lx00018_0
#-----------------------------------------------------------------------------------------------------------------------
...
n55_coerce_numeric_α:   mov              r11, 56
                        ...
                        cmp              al, 5;                               je    .Lx00020_1
                        cmp              al, 3;                               jne   .Lx00020_0
...
n57_coerce_numeric_α:   mov              r11, 58
                        ...
                        cmp              al, 5;                               je    .Lx00021_1
                        cmp              al, 3;                               jne   .Lx00021_0
...
n66_binop_α:            mov              r11, 67
                        ...
                        mov              qword ptr [rsp + 1576], rdx;         jmp   n67_call_builtin_icon_α
#-----------------------------------------------------------------------------------------------------------------------
...
n69_coerce_numeric_α:   mov              r11, 70
                        ...
                        cmp              al, 5;                               je    .Lx00027_1
                        cmp              al, 3;                               jne   .Lx00027_0
...
.Lx00028_0:               mov              rdi, qword ptr [rsp + 1504]
                        ...
                        mov              qword ptr [rsp + 1496], rdx;         jmp   n71_call_builtin_icon_α
#-----------------------------------------------------------------------------------------------------------------------
...
n84_coerce_numeric_α:   mov              r11, 85
                        ...
                        cmp              al, 5;                               je    .Lx00031_1
                        cmp              al, 3;                               jne   .Lx00031_0
...
.Lx00037_0:               mov              rdi, qword ptr [rsp + 608]
                        ...
                        cmp              al, 104;                             je    n00038_keyword_icon_α
                                                                              jmp   n00039_assign_α
n99_iterate_β:          mov              r11, 100
                        inc              qword ptr [rsp + 592];               jmp   .Lx00037_0
#-----------------------------------------------------------------------------------------------------------------------
n00039_assign_α:          mov              r11, 101
                        mov              rax, qword ptr [rsp + 576]
                        mov              rdx, qword ptr [rsp + 584]
                        mov              qword ptr [rsp + 2992], rax
                        mov              qword ptr [rsp + 3000], rdx;         jmp   n00040_bound_α
#-----------------------------------------------------------------------------------------------------------------------
n00040_bound_α:           mov              r11, 102
                        mov              qword ptr [rsp + 624], rsp;          jmp   n00041_var_α
#-----------------------------------------------------------------------------------------------------------------------
n00041_var_α:             mov              r11, 103
                        mov              rax, qword ptr [rsp + 2960]
                        mov              qword ptr [rsp + 720], rax
                        mov              rax, qword ptr [rsp + 2968]
                        mov              qword ptr [rsp + 728], rax;          jmp   n00042_disjunction_α
#-----------------------------------------------------------------------------------------------------------------------
n00042_disjunction_α:     mov              r11, 104
                        mov              qword ptr [rsp + 736], 0
                        mov              qword ptr [rsp + 744], 0
                        mov              dword ptr [rsp + 752], 0;            jmp   n00043_var_α
n00042_disjunction_as:    mov              r11, 104
...
n00042_disjunction_β:     mov              r11, 104
                        mov              eax, dword ptr [rsp + 752]
                        cmp              eax, 0;                              je    n00046_unmark_α
                                                                              jmp   n00046_unmark_α
n00042_disjunction_af:    mov              r11, 104
                        add              dword ptr [rsp + 752], 1
                        mov              eax, dword ptr [rsp + 752]
                        cmp              eax, 1;                              je    n00047_var_α
                                                                              jmp   n00046_unmark_α
#-----------------------------------------------------------------------------------------------------------------------
n00045_coerce_numeric_α:  mov              r11, 105
                        mov              eax, dword ptr [rsp + 2960]
                        cmp              al, 5;                               je    .Lx00048_1
                        cmp              al, 3;                               jne   .Lx00048_0
...
#-----------------------------------------------------------------------------------------------------------------------
n00049_coerce_numeric_α:  mov              r11, 106
                        mov              eax, dword ptr [rsp + 736]
                        cmp              al, 5;                               je    .Lx00050_1
                        cmp              al, 3;                               jne   .Lx00050_0
                        mov              eax, dword ptr [rsp + 2960]
                        cmp              al, 3;                               jne   .Lx00050_0
...
#-----------------------------------------------------------------------------------------------------------------------
n00059_lit_integer_α:     mov              r11, 114
                        mov              qword ptr [rsp + 768], 3             # result
                        mov              rax, qword ptr [rip + .Lx00060_0]
                        mov              qword ptr [rsp + 776], rax;          jmp   n00042_disjunction_as
n00059_lit_integer_β:     mov              r11, 114;                            jmp   n00046_unmark_α
.Lx00060_0:               .quad            0
#-----------------------------------------------------------------------------------------------------------------------
n00046_unmark_α:          mov              r11, 115
                        mov              rsp, qword ptr [rsp + 624];          jmp   n99_iterate_β
#-----------------------------------------------------------------------------------------------------------------------
n00038_keyword_icon_α:    mov              r11, 116
                        mov              rdi, qword ptr [rip + .Lx00061_0]
                        mov              qword ptr [rip + rtccb+40], r8
                        mov              qword ptr [rip + rtccb+56], r10
                        mov              qword ptr [rip + rtccb+64], r11
...
#-----------------------------------------------------------------------------------------------------------------------
n00066_coerce_numeric_α:  mov              r11, 120
                        mov              eax, dword ptr [rsp + 2960]
...
#-----------------------------------------------------------------------------------------------------------------------
n00068_coerce_numeric_α:  mov              r11, 121
                        mov              eax, dword ptr [rsp + 528]
                        cmp              al, 5;                               je    .Lx00069_1
                        cmp              al, 3;                               jne   .Lx00069_0
                        mov              eax, dword ptr [rsp + 2960]
                        cmp              al, 3;                               jne   .Lx00069_0
...
n00070_binop_α:           mov              r11, 122
                        ...
                        mov              qword ptr [rsp + 472], rdx;          jmp   n00071_coerce_numeric_α
#-----------------------------------------------------------------------------------------------------------------------
n00071_coerce_numeric_α:  mov              r11, 123
                        mov              eax, dword ptr [rsp + 432]
                        cmp              al, 5;                               je    .Lx00072_1
                        cmp              al, 3;                               jne   .Lx00072_0
...
#-----------------------------------------------------------------------------------------------------------------------
n00073_coerce_numeric_α:  mov              r11, 124
                        mov              eax, dword ptr [rsp + 464]
                        cmp              al, 5;                               je    .Lx00074_1
                        cmp              al, 3;                               jne   .Lx00074_0
                        mov              eax, dword ptr [rsp + 432]
                        cmp              al, 3;                               jne   .Lx00074_0
...
n00075_binop_α:           mov              r11, 125
                        ...
                        mov              qword ptr [rsp + 392], rdx;          jmp   n00076_lit_real_α
#-----------------------------------------------------------------------------------------------------------------------
n00076_lit_real_α:        mov              r11, 126
...
#-----------------------------------------------------------------------------------------------------------------------
n00078_coerce_numeric_α:  mov              r11, 127
                        mov              eax, dword ptr [rsp + 384]
                        cmp              al, 5;                               je    .Lx00079_1
                        cmp              al, 3;                               jne   .Lx00079_0
...
.Lx00081_0:               mov              rdi, qword ptr [rsp + 368]
                        ...
                        mov              qword ptr [rsp + 360], rdx;          jmp   n00082_call_builtin_icon_α
#-----------------------------------------------------------------------------------------------------------------------
...
n00082_call_builtin_icon_β:
                        mov              r11, 129;                            jmp   n00062_var_α
#-----------------------------------------------------------------------------------------------------------------------
n00083_assign_α:          mov              r11, 130
                        mov              rax, qword ptr [rsp + 304]
                        mov              rdx, qword ptr [rsp + 312]
                        mov              qword ptr [rsp + 2960], rax
                        mov              qword ptr [rsp + 2968], rdx;         jmp   n00062_var_α
#-----------------------------------------------------------------------------------------------------------------------
n00062_var_α:             mov              r11, 131
                        mov              rax, qword ptr [rsp + 2960]
                        mov              qword ptr [rsp + 256], rax
                        mov              rax, qword ptr [rsp + 2968]
                        mov              qword ptr [rsp + 264], rax;          jmp   n00084_lit_integer_α
#-----------------------------------------------------------------------------------------------------------------------
n00084_lit_integer_α:     mov              r11, 132
...
.Lrkfn348:              .string          "right"
                        ...
                        cmp              al, 104;                             je    n00087_lit_string_α
                                                                              jmp   n00088_call_builtin_icon_α
n00086_call_builtin_icon_β:
                        mov              r11, 133;                            jmp   n00087_lit_string_α
#-----------------------------------------------------------------------------------------------------------------------
...
n00088_call_builtin_icon_β:
                        mov              r11, 134;                            jmp   n00087_lit_string_α
#-----------------------------------------------------------------------------------------------------------------------
n00087_lit_string_α:      mov              r11, 135
...
.Lrkfn355:              .string          "write"
                        ...
                        cmp              al, 104;                             je    n00092_return_α
                                                                              jmp   n00092_return_α
n00091_call_builtin_icon_β:
                        mov              r11, 137;                            jmp   n00092_return_α
#-----------------------------------------------------------------------------------------------------------------------
n00092_return_α:          mov              r11, 138
...
.Lx00093_2:               add              rsp, 24
                        pop              r12;                                 jmp   r12
.Lx00093_3:               add              rsp, 24
                        pop              r12
                        mov              eax, 104
                        xor              edx, edx;                            jmp   r12
                        .globl           main
...
main_α_body:
#-----------------------------------------------------------------------------------------------------------------------
n00094_lit_string_α:      mov              r11, 139
...
.Lrkfn385:              .string          "write"
                        ...
                        cmp              al, 104;                             je    n00097_disjunction_α
                                                                              jmp   n00097_disjunction_α
n00096_call_builtin_icon_β:
                        mov              r11, 140;                            jmp   n00097_disjunction_α
#-----------------------------------------------------------------------------------------------------------------------
n00097_disjunction_α:     mov              r11, 141
                        mov              qword ptr [rsp + 32], 0
                        mov              qword ptr [rsp + 40], 0
                        mov              dword ptr [rsp + 48], 0;             jmp   n00098_var_α
n00097_disjunction_as:    mov              r11, 141
...
n00097_disjunction_β:     mov              r11, 141
                        mov              eax, dword ptr [rsp + 48]
                        cmp              eax, 0;                              je    main_ω
                                                                              jmp   n00100_goto_β
n00097_disjunction_af:    mov              r11, 141
                        add              dword ptr [rsp + 48], 1
                        mov              eax, dword ptr [rsp + 48]
                        cmp              eax, 1;                              je    n00101_var_α
                                                                              jmp   main_ω
#-----------------------------------------------------------------------------------------------------------------------
n00101_var_α:             mov              r11, 142
                        mov              rax, qword ptr [rsp + 16]
                        mov              qword ptr [rsp + 304], rax
                        mov              rax, qword ptr [rsp + 24]
                        mov              qword ptr [rsp + 312], rax;          jmp   n00102_call_builtin_icon_α
n00101_var_β:             mov              r11, 142;                            jmp   main_ω
#-----------------------------------------------------------------------------------------------------------------------
...
n00102_call_builtin_icon_β:
                        mov              r11, 143;                            jmp   main_ω
#-----------------------------------------------------------------------------------------------------------------------
n00103_assign_α:          mov              r11, 144
                        mov              rax, qword ptr [rsp + 256]
                        mov              rdx, qword ptr [rsp + 264]
                        mov              qword ptr [rsp + 688], rax
                        mov              qword ptr [rsp + 696], rdx;          jmp   n00104_disjunction_α
#-----------------------------------------------------------------------------------------------------------------------
n00104_disjunction_α:     mov              r11, 145
                        mov              qword ptr [rsp + 432], 0
                        mov              qword ptr [rsp + 440], 0
                        mov              dword ptr [rsp + 448], 0;            jmp   n00105_var_α
n00104_disjunction_as:    mov              r11, 145
...
.Lx00112_29:              mov              qword ptr [rsp + 336], rax
                        mov              qword ptr [rsp + 344], rdx
                        cmp              al, 104;                             je    n00101_var_α
                                                                              jmp   n00113_conjunction_α
n00111_call_proc_staged_β:
                        mov              r11, 149;                            jmp   n00101_var_α
.Lx00112_0:               .quad            .Lx00112_0_s
.Lx00112_0_s:             .string          "dofile"
#-----------------------------------------------------------------------------------------------------------------------
n00113_conjunction_α:     mov              r11, 150
                        mov              rax, qword ptr [rsp + 336]
                        mov              qword ptr [rsp + 320], rax
                        mov              rax, qword ptr [rsp + 344]
                        mov              qword ptr [rsp + 328], rax;          jmp   n00101_var_α
n00113_conjunction_β:     mov              r11, 150;                            jmp   n00101_var_α
#-----------------------------------------------------------------------------------------------------------------------
n00100_goto_α:            mov              r11, 151;                            jmp   n00101_var_α
n00100_goto_β:            mov              r11, 151;                            jmp   n00101_var_α
#-----------------------------------------------------------------------------------------------------------------------
n00108_lit_string_α:      mov              r11, 152
...
n00108_lit_string_β:      mov              r11, 152;                            jmp   n00104_disjunction_af
.Lx00114_0:               .quad            .Lx00114_0_s
.Lx00114_0_s:             .string          "cannot open "
#-----------------------------------------------------------------------------------------------------------------------
n00115_var_α:             mov              r11, 153
                        mov              rax, qword ptr [rsp + 688]
                        mov              qword ptr [rsp + 608], rax
                        mov              rax, qword ptr [rsp + 696]
...
.Lrkfn408:              .string          "stop"
                        ...
                        cmp              al, 104;                             je    n00104_disjunction_af
                                                                              jmp   n00104_disjunction_as
n00116_call_builtin_icon_β:
                        mov              r11, 154;                            jmp   n00104_disjunction_af
#-----------------------------------------------------------------------------------------------------------------------
n00105_var_α:             mov              r11, 155
                        mov              rax, qword ptr [rsp + 688]
                        mov              qword ptr [rsp + 512], rax
                        mov              rax, qword ptr [rsp + 696]
                        mov              qword ptr [rsp + 520], rax;          jmp   n00117_call_builtin_icon_α
n00105_var_β:             mov              r11, 155;                            jmp   n00104_disjunction_af
#-----------------------------------------------------------------------------------------------------------------------
...
n00117_call_builtin_icon_β:
                        mov              r11, 156;                            jmp   n00104_disjunction_af
#-----------------------------------------------------------------------------------------------------------------------
n00098_var_α:             mov              r11, 157
                        mov              rax, qword ptr [rsp + 16]
                        mov              qword ptr [rsp + 208], rax
                        mov              rax, qword ptr [rsp + 24]
                        mov              qword ptr [rsp + 216], rax;          jmp   n00118_unop_α
n00098_var_β:             mov              r11, 157;                            jmp   n00097_disjunction_af
#-----------------------------------------------------------------------------------------------------------------------
n00118_unop_α:            mov              r11, 158
...
#-----------------------------------------------------------------------------------------------------------------------
n00123_keyword_icon_α:    mov              r11, 161
...
n00123_keyword_icon_β:    mov              r11, 161;                            jmp   main_ω
.Lx00124_0:               .quad            .Lx00124_0_s
.Lx00124_0_s:             .string          "&input"
#-----------------------------------------------------------------------------------------------------------------------
n00125_lit_string_α:      mov              r11, 162
