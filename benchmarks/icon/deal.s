...
# IR_INDIRECT_GOTO alt-resume: jmp *t
 ...
 xchain00001_n48_α:
  .section .rodata
  .Lcall00005_pname: .string "arrange"
  .section .text
  .intel_syntax noprefix
 mov edi, 0
...
# IR_VAR gva
 ...
 xchain00001_n53_α:
  .section .rodata
  .Lcall00012_pname: .string "arrange"
  .section .text
  .intel_syntax noprefix
 mov edi, 0
...
# IR_LIT_STRING
 ...
 jmp xchain00015_n1_α
 xchain00015_n0_β:
 jmp xchain00015_n2_α
.Lx00016_0:
 .quad .Lx00016_0_s
.Lx00016_0_s:
 .string "deal"
...
# IR_LIT_CHARSET
 ...
 mov qword ptr [r12 + 856], rax
 jmp xchain00015_n3_α
 xchain00015_n2_β:
 jmp xchain00015_n5_α
.Lx00017_0:
 .quad .Lx00017_0_s
.Lx00017_0_s:
...
# IR_VAR gva
 ...
 mov qword ptr [r12 + 752], rax
 mov qword ptr [r12 + 760], rdx
 jmp xchain00015_n7_α
 xchain00015_n5_β:
 jmp xchain00015_n8_α
# IR_ASSIGN gva
 xchain00015_n6_α:
...
# IR_LIT_STRING
 ...
 mov qword ptr [r12 + 680], rax
 jmp xchain00015_n10_α
 xchain00015_n8_β:
 jmp xchain00015_n12_α
.Lx00018_0:
 .quad .Lx00018_0_s
.Lx00018_0_s:
...
# IR_LIT_STRING
 ...
 jmp xchain00015_n14_α
 xchain00015_n12_β:
 jmp xchain00015_n17_α
.Lx00021_0:
 .quad .Lx00021_0_s
.Lx00021_0_s:
 .string " "
...
# marshal arg1 = producer-box slot [zr+640] -> [zr+608]
 ...
 cmp eax, 99
 je xchain00015_n17_α
 jmp xchain00015_n18_α
 xchain00015_n16_β:
 jmp xchain00015_n17_α
# IR_LIT_CHARSET
 xchain00015_n17_α:
 ...
 jmp xchain00015_n19_α
 xchain00015_n17_β:
 jmp xchain00015_n22_α
.Lx00022_0:
 .quad .Lx00022_0_s
.Lx00022_0_s:
...
# IR_VAR
 ...
 mov rax, qword ptr [r12 + 24]
 mov qword ptr [r12 + 440], rax
 jmp xchain00015_n24_α
 xchain00015_n22_β:
 jmp xchain00015_n25_α
# IR_SUBSCRIPT section extended (x[i+:n]/x[i-:n]; end pre-computed by IR_BINOP; wraparound→ω)
 xchain00015_n23_α:
...
# IR_VAR_REF local
 ...
 jmp xchain00015_n28_α
 xchain00015_n25_β:
 jmp xchain00015_n32_α
# IR_ASSIGN gva
 xchain00015_n26_α:
...
# marshal arg1 = producer-box slot [zr+448] -> [zr+416]
 ...
 cmp eax, 99
 je xchain00015_n25_α
 jmp xchain00015_n29_α
xchain00015_n27_β:
 jmp xchain00015_n25_α
# IR_LIT_STRING
 xchain00015_n28_α:
...
# IR_SUBSCRIPT x[i] variable
 ...
 call rt_subscript_var@PLT
 cmp eax, 99
 je xchain00015_n32_α
 mov qword ptr [r12 + 336], rax
 mov qword ptr [r12 + 344], rdx
 jmp xchain00015_n31_α
 xchain00015_n30_β:
 jmp xchain00015_n32_α
# IR_DEREF variable -> value
 xchain00015_n31_α:
...
# IR_LIT_INTEGER
 ...
 jmp xchain00015_n34_α
 xchain00015_n32_β:
 jmp xchain00015_n37_α
.Lx00027_0:
 .quad 1
# IR_UNOP
 xchain00015_n33_α:
...
# IR_MOVE_LABEL: shared value := arm value; t := &arm-resume
 ...
 mov rax, qword ptr [r12 + 280]
 mov qword ptr [r12 + 248], rax
 lea rax, [rip + xchain00015_n37_α]
 mov qword ptr [r12 + 256], rax
 jmp xchain00015_n36_α
 xchain00015_n34_β:
 jmp xchain00015_n37_α
# IR_MOVE_LABEL: shared value := arm value; t := &arm-resume
 xchain00015_n35_α:
...
# IR_VAR_REF local
 ...
 mov qword ptr [r12 + 160], rax
 mov qword ptr [r12 + 168], rdx
 jmp xchain00015_n39_α
 xchain00015_n37_β:
 jmp xchain00015_n42_α
# IR_INDIRECT_GOTO alt-resume: jmp *t
 xchain00015_n38_α:
...
# IR_SUBSCRIPT x[i] variable
 ...
 call rt_subscript_var@PLT
 cmp eax, 99
 je xchain00015_n42_α
 mov qword ptr [r12 + 192], rax
 mov qword ptr [r12 + 200], rdx
 jmp xchain00015_n41_α
 xchain00015_n40_β:
 jmp xchain00015_n42_α
# IR_DEREF variable -> value
 xchain00015_n41_α:
...
# IR_LIT_INTEGER
 ...
 mov qword ptr [r12 + 88], rax
 jmp xchain00015_n44_α
 xchain00015_n42_β:
 jmp xchain00015_n47_α
.Lx00029_0:
 .quad 1
# IR_UNOP
 xchain00015_n43_α:
...
.Lx00030_0:
 ...
 cmp rax, rcx
 jg xchain00015_n47_α
 mov qword ptr [r12 + 48], 6
 mov qword ptr [r12 + 56], rax
 jmp xchain00015_n48_α
 xchain00015_n46_β:
...
xchain00015_n47_β:
 ...
 xchain00015_n48_α:
  .section .rodata
  .Lcall00031_pname: .string "display"
  .section .text
  .intel_syntax noprefix
 ...
 mov qword ptr [r12 + 120], rdx
 cmp eax, 99
 je xchain00015_n46_β
 jmp xchain00015_n46_β
xchain00015_n48_β:
 jmp xchain00015_n46_β
main_β:
jmp main_ω
