...
.Lx00030_60:
  .section .rodata
  .Lbynamegenfn268: .string "find"
  .section .text
  .intel_syntax noprefix
   lea rdi, [rip + .Lbynamegenfn268]
 lea rsi, [r12 + 1744]
 mov edx, 2
 lea rcx, [r12 + 1776]
...
.Lx00072_0_s:
 ...
 xchain00070_n5_α:
  .section .rodata
  .Lcall00073_pname: .string "Regions__"
  .section .text
  .intel_syntax noprefix
...
# IR_VAR
 ...
 xchain00070_n7_α:
  .section .rodata
  .Lcall00074_pname: .string "Time__"
  .section .text
  .intel_syntax noprefix
...
xchain00070_n7_β:
 ...
 xchain00070_n8_α:
  .section .rodata
  .Lcall00075_pname: .string "Storage__"
  .section .text
  .intel_syntax noprefix
...
# marshal arg2 = producer-box slot [zr+160] -> [zr+112]
 ...
 xchain00070_n12_α:
  .section .rodata
  .Lcall00034_pname: .string "Collections__"
  .section .text
  .intel_syntax noprefix
...
.Lx00121_0_s:
 ...
 xchain00120_n1_α:
  .section .rodata
  .Lcall00080_pname: .string "Init__"
  .section .text
  .intel_syntax noprefix
 mov edi, 0
...
# IR_ASSIGN gva
 ...
 xchain00120_n27_α:
  .section .rodata
  .Lcall00131_pname: .string "options"
  .section .text
  .intel_syntax noprefix
 mov edi, 0
 mov rsi, qword ptr [r12 + 432]
...
.Lx00136_0:
 ...
 xchain00120_n47_α:
  .section .rodata
  .Lcall00137_pname: .string "Term__"
  .section .text
  .intel_syntax noprefix
   lea rdi, [rip + .Lcall00137_pname]
 mov esi, 0
 call rt_call_proc_descr@PLT
 mov qword ptr [r12 + 32], rax
 mov qword ptr [r12 + 40], rdx
...
xchain00120_n47_β:
 ...
 xchain00120_n48_α:
  .section .rodata
  .Lcall00090_pname: .string "display"
  .section .text
  .intel_syntax noprefix
