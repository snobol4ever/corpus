...
# IR_SUBSCRIPT section extended (x[i+:n]/x[i-:n]; end pre-computed by IR_BINOP; wraparound→ω)
 ...
 mov r8, qword ptr [r12 + 1856]
 mov r9, qword ptr [r12 + 1864]
