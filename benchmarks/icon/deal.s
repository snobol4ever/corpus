...
# marshal arg0 = producer-box slot [zr+768] -> [zr+560]
 mov rax, qword ptr [rbp + 768]
 mov qword ptr [rbp + 560], rax
 mov rax, qword ptr [rbp + 776]
 mov qword ptr [rbp + 568], rax
# marshal arg1 = producer-box slot [zr+784] -> [zr+576]
...
# marshal arg1 = producer-box slot [zr+976] -> [zr+512]
...
# IR_VAR
 ...
 je .Lx00016_1
 call rt_proc_open_fn@PLT
 lea rcx, [rip + .Lx00016_3]
 lea rdx, [rip + .Lx00016_4]
 jmp rax
.Lx00016_3:
 call rt_proc_call_epilogue_γ@PLT
 jmp .Lx00016_2
...
.Lx00025_0:
 cmp rax, 1
 jl xchain00019_n30_α
 mov rcx, r15
 add rcx, 1
 cmp rax, rcx
 jg xchain00019_n30_α
 mov rcx, r14
 add rcx, 1
 cmp rax, rcx
 jne xchain00019_n30_α
...
.Lx00032_0:
 cmp rax, 1
 jl xchain00019_n39_α
 mov rcx, r15
 add rcx, 1
 cmp rax, rcx
 jg xchain00019_n39_α
 mov rcx, r14
 add rcx, 1
 cmp rax, rcx
 jne xchain00019_n39_α
...
# marshal arg0 = producer-box slot [zr+1984] -> [zr+1952]
 ...
 mov qword ptr [rbp + 1944], rdx
 cmp eax, 99
 je xchain00019_n80_α
 jmp xchain00019_n83_α
 xchain00019_n79_β:
 jmp xchain00019_n80_α
# IR_LIT_STRING
 xchain00019_n80_α:
...
# IR_MOVE_LABEL
 ...
 mov qword ptr [rbp + 856], rax
 lea rax, [rip + xchain00019_n00053_α]
...
.Lx00067_0_s:
 ...
 je .Lx00068_1
 call rt_proc_open_fn@PLT
 lea rcx, [rip + .Lx00068_3]
 lea rdx, [rip + .Lx00068_4]
 jmp rax
.Lx00068_3:
 call rt_proc_call_epilogue_γ@PLT
 jmp .Lx00068_2
...
.Lx00078_0_s:
 ...
 je .Lx00079_1
 call rt_proc_open_fn@PLT
 lea rcx, [rip + .Lx00079_3]
 lea rdx, [rip + .Lx00079_4]
 jmp rax
.Lx00079_3:
 call rt_proc_call_epilogue_γ@PLT
 jmp .Lx00079_2
...
.Lx00130_0_s:
 ...
 je .Lx00131_1
 call rt_proc_open_fn@PLT
 lea rcx, [rip + .Lx00131_3]
 lea rdx, [rip + .Lx00131_4]
 jmp rax
.Lx00131_3:
 call rt_proc_call_epilogue_γ@PLT
 jmp .Lx00131_2
...
.Lx00148_0_s:
 ...
 je .Lx00149_1
 call rt_proc_open_fn@PLT
 lea rcx, [rip + .Lx00149_3]
 lea rdx, [rip + .Lx00149_4]
 jmp rax
.Lx00149_3:
 call rt_proc_call_epilogue_γ@PLT
 jmp .Lx00149_2
