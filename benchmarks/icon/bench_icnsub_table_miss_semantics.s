...
n67_call_builtin_icon_β:
                        mov              r11, 68;                             jmp   n68_lit_integer_α
#-----------------------------------------------------------------------------------------------------------------------
...
n72_to_β:               mov              r11, 73
                        inc              qword ptr [rsp + 688];               jmp   .Lx00030_0
#-----------------------------------------------------------------------------------------------------------------------
...
.Lrkfn214:              .string          "string"
                        ...
                        mov              r9,  qword ptr [rip + rtccb+48]
                        mov              r10, qword ptr [rip + rtccb+56]
                        mov              r11, qword ptr [rip + rtccb+64];     jmp   n78_subscript_α
n77_call_builtin_icon_β:
                        mov              r11, 78;                             jmp   n81_unmark_α
#-----------------------------------------------------------------------------------------------------------------------
...
n84_to_β:               mov              r11, 85
                        inc              qword ptr [rsp + 400];               jmp   .Lx00033_0
#-----------------------------------------------------------------------------------------------------------------------
...
.Lrkfn235:              .string          "string"
                        ...
                        mov              r9,  qword ptr [rip + rtccb+48]
                        mov              r10, qword ptr [rip + rtccb+56]
                        mov              r11, qword ptr [rip + rtccb+64];     jmp   n91_subscript_α
n90_call_builtin_icon_β:
                        mov              r11, 91;                             jmp   n97_unmark_α
#-----------------------------------------------------------------------------------------------------------------------
...
n94_coerce_numeric_α:   mov              r11, 95
                        mov              eax, dword ptr [rsp + 656]
                        cmp              al, 5;                               je    .Lx00035_1
                        cmp              al, 3;                               jne   .Lx00035_0
                        mov              eax, dword ptr [rsp + 2256]
                        cmp              al, 3;                               jne   .Lx00035_0
...
.Lrkfn249:              .string          "write"
                        ...
                        cmp              al, 104;                             je    n00037_lit_integer_α
                        mov              r8,  qword ptr [rip + rtccb+40]
                        mov              r9,  qword ptr [rip + rtccb+48]
                        mov              r10, qword ptr [rip + rtccb+56]
                        mov              r11, qword ptr [rip + rtccb+64];     jmp   n00037_lit_integer_α
n99_call_builtin_icon_β:
                        mov              r11, 100;                            jmp   n00037_lit_integer_α
#-----------------------------------------------------------------------------------------------------------------------
n00037_lit_integer_α:     mov              r11, 101
                        mov              qword ptr [rsp + 112], 3             # result
                        mov              rax, qword ptr [rip + .Lx00038_0]
                        mov              qword ptr [rsp + 120], rax;          jmp   n00039_lit_integer_α
.Lx00038_0:               .quad            1
#-----------------------------------------------------------------------------------------------------------------------
n00039_lit_integer_α:     mov              r11, 102
                        mov              qword ptr [rsp + 128], 3             # result
                        mov              rax, qword ptr [rip + .Lx00040_0]
                        mov              qword ptr [rsp + 136], rax;          jmp   n00041_to_α
.Lx00040_0:               .quad            5000
#-----------------------------------------------------------------------------------------------------------------------
n00041_to_α:              mov              r11, 103
...
n00041_to_β:              mov              r11, 103
                        inc              qword ptr [rsp + 96];                jmp   .Lx00042_0
#-----------------------------------------------------------------------------------------------------------------------
n00044_assign_α:          mov              r11, 104
                        mov              rax, qword ptr [rsp + 80]
                        mov              rdx, qword ptr [rsp + 88]
                        mov              qword ptr [rsp + 2272], rax
                        mov              qword ptr [rsp + 2280], rdx;         jmp   n00045_bound_α
#-----------------------------------------------------------------------------------------------------------------------
n00045_bound_α:           mov              r11, 105
                        mov              qword ptr [rsp + 144], rsp;          jmp   n00046_var_α
#-----------------------------------------------------------------------------------------------------------------------
n00046_var_α:             mov              r11, 106
                        mov              rax, qword ptr [rsp + 2256]
                        mov              qword ptr [rsp + 240], rax
                        mov              rax, qword ptr [rsp + 2264]
                        mov              qword ptr [rsp + 248], rax;          jmp   n00047_var_ref_α
#-----------------------------------------------------------------------------------------------------------------------
n00047_var_ref_α:         mov              r11, 107
                        mov              rax, 4294967336
                        lea              rdx, [rsp + 2288]
                        mov              qword ptr [rsp + 256], rax
                        mov              qword ptr [rsp + 264], rdx;          jmp   n00048_var_α
#-----------------------------------------------------------------------------------------------------------------------
n00048_var_α:             mov              r11, 108
                        mov              rax, qword ptr [rsp + 2272]
                        mov              qword ptr [rsp + 272], rax
                        mov              rax, qword ptr [rsp + 2280]
                        mov              qword ptr [rsp + 280], rax;          jmp   n00049_subscript_α
#-----------------------------------------------------------------------------------------------------------------------
n00049_subscript_α:       mov              r11, 109
                        ...
                        mov              r10, qword ptr [rip + rtccb+56]
                        mov              r11, qword ptr [rip + rtccb+64]
                        cmp              al, 104;                             je    n00050_unmark_α
                        mov              qword ptr [rsp + 288], rax
                        mov              qword ptr [rsp + 296], rdx;          jmp   n00051_deref_α
#-----------------------------------------------------------------------------------------------------------------------
n00051_deref_α:           mov              r11, 110
...
#-----------------------------------------------------------------------------------------------------------------------
n00052_coerce_numeric_α:  mov              r11, 111
                        mov              eax, dword ptr [rsp + 2256]
...
.Lx00053_0:               lea              rdi, [rsp + 2256]
                        ...
                        mov              r9,  qword ptr [rip + rtccb+48]
                        mov              r10, qword ptr [rip + rtccb+56]
                        mov              r11, qword ptr [rip + rtccb+64];     jmp   n00054_coerce_numeric_α
#-----------------------------------------------------------------------------------------------------------------------
n00054_coerce_numeric_α:  mov              r11, 112
                        mov              eax, dword ptr [rsp + 304]
                        cmp              al, 5;                               je    .Lx00055_1
                        cmp              al, 3;                               jne   .Lx00055_0
                        mov              eax, dword ptr [rsp + 2256]
                        cmp              al, 3;                               jne   .Lx00055_0
...
.Lx00055_0:               lea              rdi, [rsp + 304]
                        ...
                        mov              r9,  qword ptr [rip + rtccb+48]
                        mov              r10, qword ptr [rip + rtccb+56]
                        mov              r11, qword ptr [rip + rtccb+64];     jmp   n00056_binop_α
#-----------------------------------------------------------------------------------------------------------------------
n00056_binop_α:           mov              r11, 113
                        mov              eax, dword ptr [rsp + 224]
                        mov              ecx, dword ptr [rsp + 208]
                        mov              edx, eax
                        and              edx, ecx
                        cmp              dl, 3;                               jne   .Lx00057_2
...
.Lx00057_0:               mov              rdi, qword ptr [rsp + 224]
                        ...
                        mov              r9,  qword ptr [rip + rtccb+48]
                        mov              r10, qword ptr [rip + rtccb+56]
                        mov              r11, qword ptr [rip + rtccb+64];     jmp   n00058_assign_α
#-----------------------------------------------------------------------------------------------------------------------
n00058_assign_α:          mov              r11, 114
                        mov              rax, qword ptr [rsp + 192]
                        mov              rdx, qword ptr [rsp + 200]
                        mov              qword ptr [rsp + 2256], rax
                        mov              qword ptr [rsp + 2264], rdx;         jmp   n00050_unmark_α
#-----------------------------------------------------------------------------------------------------------------------
n00050_unmark_α:          mov              r11, 115
                        mov              rsp, qword ptr [rsp + 144];          jmp   n00041_to_β
#-----------------------------------------------------------------------------------------------------------------------
n00043_var_α:             mov              r11, 116
                        mov              rax, qword ptr [rsp + 2256]
