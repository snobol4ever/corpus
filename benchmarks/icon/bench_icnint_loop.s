...
.Lline_mark_α_23_0_s:   .string          "bench_icnint_loop.icn"
...
n4_assign_α:            mov              r11, 4
                        ...
                        mov              qword ptr [rbp + 376], rdx;          jmp   n5_line_mark_α
...
n8_to_β:                mov              r11, 8
                        inc              qword ptr [rbp + 128];               jo    n18_line_mark_α
                                                                              jmp   .Lto_α_33_0
...
n10_bound_α:            mov              r11, 10
                        mov              qword ptr [rbp + 176], rsp;          jmp   n11_var_α
...
n13_coerce_numeric_α:   mov              r11, 13
                        ...
                        cmp              al, 5;                               je    .Lcoerce_numeric_α_42_1
                        cmp              al, 3;                               jne   .Lcoerce_numeric_α_42_0
                        mov              eax, dword ptr [rbp + 384]
                        cmp              al, 3;                               jne   .Lcoerce_numeric_α_42_0
.Lcoerce_numeric_α_42_1:
                        mov              rax, qword ptr [rbp + 368]
                        mov              qword ptr [rbp + 256], rax
                        mov              rax, qword ptr [rbp + 376]
                        mov              qword ptr [rbp + 264], rax;          jmp   n14_coerce_numeric_α
.Lcoerce_numeric_α_42_0:
                        lea              rdi, [rbp + 368]
                        lea              rsi, [rbp + 384]
                        lea              rdx, [rbp + 256]
                        mov              rcx, 4311744614
...
n15_binop_α:            mov              r11, 15
                        ...
                        mov              edx, eax
                        and              edx, ecx
                        cmp              dl, 3;                               jne   .Lbinop_α_45_2
                        mov              rax, qword ptr [rbp + 264]
                        mov              rdx, qword ptr [rbp + 248]
                        add              rax, rdx;                            jo    .Lbinop_α_45_0
                        mov              qword ptr [rbp + 224], 3
                        mov              qword ptr [rbp + 232], rax;          jmp   .Lbinop_α_45_7
.Lbinop_α_45_2:         and              edx, 1;                              jz    .Lbinop_α_45_0
                        mov              rsi, qword ptr [rbp + 264]
                        mov              rdi, qword ptr [rbp + 248]
                        cmp              al, 5;                               je    .Lbinop_α_45_3
                        cvtsi2sd         xmm0, rsi;                           jmp   .Lbinop_α_45_4
.Lbinop_α_45_3:         movq             xmm0, rsi
.Lbinop_α_45_4:         cmp              cl, 5;                               je    .Lbinop_α_45_5
                        cvtsi2sd         xmm1, rdi;                           jmp   .Lbinop_α_45_6
.Lbinop_α_45_5:         movq             xmm1, rdi
.Lbinop_α_45_6:         addsd            xmm0, xmm1
                        movq             rax, xmm0
                        mov              rdx, rax
                        add              rdx, rdx
                        movabs           rcx, 18437736874454810624
                        cmp              rdx, rcx;                            jae   .Lbinop_α_45_0
                        mov              qword ptr [rbp + 224], 5
                        mov              qword ptr [rbp + 232], rax
.Lbinop_α_45_7:                                                               jmp   n16_assign_α
.Lbinop_α_45_0:         mov              rdi, qword ptr [rbp + 256]
                        mov              rsi, qword ptr [rbp + 264]
                        ...
                        mov              qword ptr [rbp + 232], rdx;          jmp   n16_assign_α
...
n16_assign_α:           mov              r11, 16
                        ...
                        mov              qword ptr [rbp + 368], rax
                        mov              qword ptr [rbp + 376], rdx;          jmp   n17_unmark_α
...
n21_call_icon_α:        mov              r11, 21
                        ...
                        .section         .rodata
.Lcall_icon_α_rkfn55:   .string          "write"
                        .section         .text
                        .intel_syntax    noprefix
...
main_ω:
                        ...
                        mov              rax, qword ptr [rip + g_trace@GOTPCREL]
                        mov              rax, qword ptr [rax + 0]
                        cmp              rax, 0;                              je    .Lmain_α_54_249
                        .section         .rodata
.Licn_trace_nm57:       .string          "main"
                        .section         .text
                        .intel_syntax    noprefix
                        lea              rdi, [rip + .Licn_trace_nm57]
                        mov              qword ptr [rip + rtccb+40], r8
                        mov              qword ptr [rip + rtccb+56], r10
                        mov              qword ptr [rip + rtccb+64], r11
