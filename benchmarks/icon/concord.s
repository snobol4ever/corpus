...
n7_subscript_α:         mov              rdi, qword ptr [rsp + 1184]
                        ...
                        cmp              eax, 104;                            je    proc_tabulate_ω
...
n27_scan_α:             mov              rax, qword ptr [rsp + 128]
                        ...
                        mov              r15, qword ptr [rsp + 80];           jmp   proc_tabulate_γ
n27_scan_β:                                                                   jmp   proc_tabulate_ω
#-----------------------------------------------------------------------------------------------------------------------
...
n63_scan_α:             lea              rdi, [rsp + 64]
                        ...
                        mov              r13, qword ptr [rsp + 64]
                        mov              r14, qword ptr [rsp + 72]
                        mov              r15, qword ptr [rsp + 80];           jmp   proc_tabulate_ω
n63_scan_β:                                                                   jmp   proc_tabulate_ω
#-----------------------------------------------------------------------------------------------------------------------
...
proc_tabulate_dcα:
                        ...
                        lea              rdx, [rip + .Lx00017_3];               jmp   proc_tabulate_α
.Lx00017_2:               pop              r11
                        pop              r11;                                 jmp   r11
.Lx00017_3:               pop              r11
                        pop              r11
...
.Lrkfn275:              .string          "write"
                        ...
                        mov              r9,  qword ptr [rip + rtccb+48]
                        mov              r10, qword ptr [rip + rtccb+56]
                        mov              r11, qword ptr [rip + rtccb+64];     jmp   proc_format_γ
...
proc_format_dcα:
                        ...
                        lea              rdx, [rip + .Lx00082_3];               jmp   proc_format_α
.Lx00082_2:               pop              r11
                        pop              r11;                                 jmp   r11
.Lx00082_3:               pop              r11
                        pop              r11
...
n00083_suspend_α:         lea              rax, [rip + n00083_suspend_β]
                        ...
                        mov              r9,  qword ptr [rip + rtccb+48]
                        mov              r10, qword ptr [rip + rtccb+56]
                        mov              r11, qword ptr [rip + rtccb+64];     jmp   proc_item_γ
...
proc_options_dcα:
                        ...
                        lea              rdx, [rip + .Lx00277_3];               jmp   proc_options_α
.Lx00277_2:               pop              r11
                        pop              r11;                                 jmp   r11
.Lx00277_3:               pop              r11
                        pop              r11
...
n00280_call_proc_staged_α:
                        call             proc_Signature___dcα;                jmp   .Lx00281_2
...
n00282_call_proc_staged_α:
                        call             proc_Regions___dcα;                  jmp   .Lx00283_2
...
n00284_call_proc_staged_α:
                        call             proc_Time___dcα;                     jmp   .Lx00285_2
...
proc_Init___dcα:
                        ...
                        lea              rdx, [rip + .Lx00309_3];               jmp   proc_Init___α
.Lx00309_2:               pop              r11
                        pop              r11;                                 jmp   r11
.Lx00309_3:               pop              r11
                        pop              r11
...
n00326_call_proc_staged_α:
                        call             proc_Time___dcα;                     jmp   .Lx00327_2
...
n00328_call_proc_staged_α:
                        call             proc_Regions___dcα;                  jmp   .Lx00330_2
...
n00331_call_proc_staged_α:
                        call             proc_Storage___dcα;                  jmp   .Lx00332_2
...
n00333_call_proc_staged_α:
                        call             proc_Collections___dcα;              jmp   .Lx00334_2
...
proc_Term___dcα:
                        ...
                        lea              rdx, [rip + .Lx00336_3];               jmp   proc_Term___α
.Lx00336_2:               pop              r11
                        pop              r11;                                 jmp   r11
.Lx00336_3:               pop              r11
                        pop              r11
...
proc_Collections___dcα:
                        ...
                        lea              rdx, [rip + .Lx00385_3];               jmp   proc_Collections___α
.Lx00385_2:               pop              r11
                        pop              r11;                                 jmp   r11
.Lx00385_3:               pop              r11
                        pop              r11
...
proc_Regions___dcα:
                        ...
                        lea              rdx, [rip + .Lx00432_3];               jmp   proc_Regions___α
.Lx00432_2:               pop              r11
                        pop              r11;                                 jmp   r11
.Lx00432_3:               pop              r11
                        pop              r11
...
proc_Signature___dcα:
                        ...
                        lea              rdx, [rip + .Lx00443_3];               jmp   proc_Signature___α
.Lx00443_2:               pop              r11
                        pop              r11;                                 jmp   r11
.Lx00443_3:               pop              r11
                        pop              r11
...
proc_Storage___dcα:
                        ...
                        lea              rdx, [rip + .Lx00490_3];              jmp   proc_Storage___α
.Lx00490_2:              pop              r11
                        pop              r11;                                 jmp   r11
.Lx00490_3:              pop              r11
                        pop              r11
...
n00494_keyword_icon_β:                                                         jmp   proc_Time___ω
...
proc_Time___dcα:
                        ...
                        lea              rdx, [rip + .Lx00511_3];              jmp   proc_Time___α
.Lx00511_2:              pop              r11
                        pop              r11;                                 jmp   r11
.Lx00511_3:              pop              r11
                        pop              r11
...
n00514_call_proc_staged_α:
                        lea              rsi, [rsp + 1072]
                        call             proc_Init___dcα;                     jmp   .Lx00515_2
...
n00519_call_proc_staged_α:
                        lea              rsi, [rsp + 992]
                        lea              rdx, [rsp + 1008]
                        call             proc_options_dcα;                    jmp   .Lx00520_2
...
n00543_call_proc_staged_α:
                        lea              rsi, [rsp + 528]
                        lea              rdx, [rsp + 576]
                        call             proc_tabulate_dcα;                   jmp   .Lx00544_2
...
n00559_call_proc_staged_α:
                        lea              rsi, [rsp + 192]
                        call             proc_format_dcα;                     jmp   .Lx00560_2
...
n00551_call_proc_staged_α:
                        call             proc_Term___dcα;                     jmp   .Lx00561_2
