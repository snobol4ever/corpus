...
.Lx00029_0:
 ...
 cmp rax, r15
 jge xchain00021_n24_α
 mov rcx, rax
 movzx esi, byte ptr [r13+rcx]
 mov rdi, qword ptr [rip + .Lx00029_2]
 push rax
 push r10
 call strchr@PLT
 pop r10
...
.Lx00032_0:
 ...
 movsxd rcx, eax
 movzx esi, byte ptr [r13+rcx]
 mov rdi, qword ptr [rip + .Lx00032_2]
 push rax
 push r10
 call strchr@PLT
 pop r10
...
.Lx00039_1:
 ...
 mov eax, dword ptr [rbp + 448]
 cmp eax, 0
 je xchain00037_n23_β
 jmp xchain00037_n35_α
xchain00037_n20_af:
 add dword ptr [rbp + 448], 1
 mov eax, dword ptr [rbp + 448]
 cmp eax, 1
 je xchain00037_n24_α
 jmp xchain00037_n35_α
# IR_GEN_SCAN
 xchain00037_n21_α:
 mov rax, qword ptr [rbp + 432]
...
.Lx00041_1:
 ...
 mov eax, dword ptr [rbp + 576]
 cmp eax, 0
 je xchain00037_n30_β
 jmp xchain00037_n28_α
xchain00037_n23_af:
 add dword ptr [rbp + 576], 1
 mov eax, dword ptr [rbp + 576]
 cmp eax, 1
 je xchain00037_n31_α
 jmp xchain00037_n28_α
# IR_VAR
 xchain00037_n24_α:
 mov rax, qword ptr [rbp + 3616]
...
.Lx00052_0:
 cmp rax, 1
 jl xchain00037_n50_α
 mov rcx, r15
 add rcx, 1
 cmp rax, rcx
 jg xchain00037_n50_α
 mov rcx, r14
 add rcx, 1
 cmp rax, rcx
 jne xchain00037_n50_α
...
# IR_ASSIGN local
 ...
 jmp xchain00037_n61_α
# IR_LIT_STRING
 xchain00037_n59_α:
 mov qword ptr [rbp + 2944], 1
 mov rax, qword ptr [rip + .Lx00057_0]
 mov qword ptr [rbp + 2952], rax
 jmp xchain00037_n62_α
 xchain00037_n59_β:
 jmp xchain00037_n56_af
.Lx00057_0:
 .quad .Lx00057_0_s
.Lx00057_0_s:
 .string "-"
...
.Lx00059_2:
 ...
 mov eax, dword ptr [rbp + 1792]
 cmp eax, 0
 je xchain00037_n64_af
 cmp eax, 1
 je xchain00037_n64_af
 jmp xchain00037_n64_af
xchain00037_n64_af:
 add dword ptr [rbp + 1792], 1
 mov eax, dword ptr [rbp + 1792]
 cmp eax, 1
 je xchain00037_n69_α
 cmp eax, 2
 je xchain00037_n70_α
 jmp xchain00037_n75_α
# IR_SCAN_TAB
 xchain00037_n65_α:
 sub rsp, 16
...
# IR_BINOP_TEST
 ...
 call rt_jct_relop@PLT
 test eax, eax
 jz xchain00037_n64_af
 mov rdi, qword ptr [rbp + 1872]
 mov rsi, qword ptr [rbp + 1880]
 call rt_str_coerce@PLT
 mov qword ptr [rbp + 1808], rax
 mov qword ptr [rbp + 1816], rdx
 jmp xchain00037_n64_as
 xchain00037_n71_β:
 jmp xchain00037_n64_af
 xchain00037_n72_α:
# BOX IR_CALL get(...) -> rt_call_arr [operand-marshal, FAIL->ω]
...
.Lx00065_0:
 cmp rax, 1
 jl xchain00037_n56_af
 mov rcx, r15
 add rcx, 1
 cmp rax, rcx
 jg xchain00037_n56_af
 mov rcx, r14
 add rcx, 1
 cmp rax, rcx
 jne xchain00037_n56_af
 mov qword ptr [rbp + 2816], 6
 mov qword ptr [rbp + 2824], rax
 jmp xchain00037_n81_α
# IR_LIT_STRING
 xchain00037_n79_α:
 mov qword ptr [rbp + 1616], 1
 mov rax, qword ptr [rip + .Lx00066_0]
 mov qword ptr [rbp + 1624], rax
 jmp xchain00037_n82_α
.Lx00066_0:
 .quad .Lx00066_0_s
.Lx00066_0_s:
 .string ":"
...
# marshal arg1 = producer-box slot [zr+1616] -> [zr+1728]
 ...
 cmp eax, 99
 je xchain00037_n84_α
 jmp xchain00037_n83_α
 xchain00037_n82_β:
 jmp xchain00037_n84_α
# IR_VAR
 xchain00037_n83_α:
 ...
 jmp xchain00037_n85_α
# IR_LIT_STRING
 xchain00037_n84_α:
 mov qword ptr [rbp + 1216], 1
 mov rax, qword ptr [rip + .Lx00068_0]
 mov qword ptr [rbp + 1224], rax
 jmp xchain00037_n86_α
.Lx00068_0:
 .quad .Lx00068_0_s
.Lx00068_0_s:
 .string "+"
...
# marshal arg1 = producer-box slot [zr+1216] -> [zr+1584]
 ...
 mov qword ptr [rbp + 1560], rdx
 cmp eax, 99
 je xchain00037_n89_α
 jmp xchain00037_n88_β
 xchain00037_n86_β:
 jmp xchain00037_n89_α
# IR_VAR
 xchain00037_n87_α:
 mov rax, qword ptr [rbp + 3664]
 mov qword ptr [rbp + 752], rax
...
.Lx00069_1:
 ...
 mov eax, dword ptr [rbp + 1264]
 cmp eax, 0
 je xchain00037_n88_af
 jmp xchain00037_n88_af
xchain00037_n88_af:
 add dword ptr [rbp + 1264], 1
 mov eax, dword ptr [rbp + 1264]
 cmp eax, 1
 je xchain00037_n92_α
 jmp xchain00037_n28_α
# IR_LIT_STRING
 xchain00037_n89_α:
...
# IR_VAR
 ...
 mov rax, qword ptr [rbp + 3656]
 mov qword ptr [rbp + 1480], rax
 jmp xchain00037_n98_α
# IR_DISJUNCTION_NARY
 xchain00037_n97_α:
 mov qword ptr [rbp + 848], 0
 mov qword ptr [rbp + 856], 0
 mov dword ptr [rbp + 864], 0
 jmp xchain00037_n00072_α
xchain00037_n97_as:
...
.Lx00073_1:
 ...
 mov eax, dword ptr [rbp + 864]
 cmp eax, 0
 je xchain00037_n97_af
 jmp xchain00037_n97_af
xchain00037_n97_af:
 add dword ptr [rbp + 864], 1
 mov eax, dword ptr [rbp + 864]
 cmp eax, 1
 je xchain00037_n00074_α
 jmp xchain00037_n28_α
# IR_LIT_STRING
 xchain00037_n98_α:
 mov qword ptr [rbp + 1504], 1
...
# IR_ASSIGN local
 ...
 jmp xchain00037_n87_α
# IR_VAR
 xchain00037_n00072_α:
 mov rax, qword ptr [rbp + 3696]
 mov qword ptr [rbp + 928], rax
 mov rax, qword ptr [rbp + 3704]
 mov qword ptr [rbp + 936], rax
 jmp xchain00037_n00001_α
 xchain00037_n00072_β:
 jmp xchain00037_n97_af
# IR_LIT_STRING
 xchain00037_n00074_α:
 mov qword ptr [rbp + 1040], 1
 mov rax, qword ptr [rip + .Lx00076_0]
 mov qword ptr [rbp + 1048], rax
 jmp xchain00037_n00077_α
 xchain00037_n00074_β:
 jmp xchain00037_n97_af
.Lx00076_0:
 .quad .Lx00076_0_s
.Lx00076_0_s:
 .string "-"
 xchain00037_n00001_α:
...
# marshal arg0 = producer-box slot [zr+928] -> [zr+896]
 ...
 cmp eax, 99
 je xchain00037_n97_af
 jmp xchain00037_n97_as
 xchain00037_n00001_β:
 jmp xchain00037_n97_af
 xchain00037_n00078_α:
# BOX IR_CALL stop(...) -> rt_call_arr [operand-marshal, FAIL->ω]
...
# marshal arg2 = producer-box slot [zr+1104] -> [zr+1008]
 ...
 je xchain00037_n97_af
 jmp xchain00037_n97_as
 xchain00037_n00078_β:
 jmp xchain00037_n97_af
# IR_VAR
 xchain00037_n00077_α:
 mov rax, qword ptr [rbp + 3648]
 mov qword ptr [rbp + 1072], rax
 mov rax, qword ptr [rbp + 3656]
 mov qword ptr [rbp + 1080], rax
 jmp xchain00037_n00079_α
# IR_LIT_STRING
 xchain00037_n00079_α:
 mov qword ptr [rbp + 1104], 1
 mov rax, qword ptr [rip + .Lx00080_0]
 mov qword ptr [rbp + 1112], rax
 jmp xchain00037_n00078_α
.Lx00080_0:
 .quad .Lx00080_0_s
.Lx00080_0_s:
 .string " needs numeric parameter"
...
# IR_LIT_STRING
 ...
 xchain00081_n7_β:
 jmp xchain00081_n5_af
.Lx00087_0:
 .quad .Lx00087_0_s
.Lx00087_0_s:
 .string "OUTPUT"
 xchain00081_n8_α:
 jmp xchain00081_n5_as
xchain00081_n8_β:
 jmp xchain00081_n6_α
# IR_ASSIGN gva
 xchain00081_n9_α:
...
.Lx00150_0_s:
 ...
 test rax, rax
 je .Lx00151_1
 lea rcx, [rip + .Lx00151_3]
 lea rdx, [rip + .Lx00151_4]
 jmp rax
.Lx00151_3:
 call rt_proc_call_epilogue_γ@PLT
 jmp .Lx00151_2
...
.Lx00153_1:
 ...
 mov eax, dword ptr [rbp + 1136]
 cmp eax, 0
 je xchain00149_n4_af
 jmp xchain00149_n4_af
xchain00149_n4_af:
...
.Lx00156_1:
 ...
 mov eax, dword ptr [rbp + 912]
 cmp eax, 0
 je xchain00149_n11_af
 jmp xchain00149_n11_af
xchain00149_n11_af:
 add dword ptr [rbp + 912], 1
 mov eax, dword ptr [rbp + 912]
 cmp eax, 1
 je xchain00149_n15_α
...
# marshal arg0 = producer-box slot [zr+128] -> [zr+96]
 ...
 test rax, rax
 je .Lx00165_1
 lea rcx, [rip + .Lx00165_3]
 lea rdx, [rip + .Lx00165_4]
 jmp rax
.Lx00165_3:
 call rt_proc_call_epilogue_γ@PLT
 jmp .Lx00165_2
...
# IR_BINOP_CONCAT
 ...
 test rax, rax
 je .Lx00166_1
 lea rcx, [rip + .Lx00166_3]
 lea rdx, [rip + .Lx00166_4]
 jmp rax
.Lx00166_3:
 call rt_proc_call_epilogue_γ@PLT
 jmp .Lx00166_2
