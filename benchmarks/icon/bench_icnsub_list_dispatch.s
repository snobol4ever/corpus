...
n1_line_mark_α:         mov              r11, 1
                        ...
                        mov              rcx, qword ptr [rip + .Lline_mark_α_36_0]
                        mov              qword ptr [rax + 0], rcx;            jmp   n2_line_mark_α
.Lline_mark_α_36_0:     .quad            .Lline_mark_α_36_0_s
.Lline_mark_α_36_0_s:   .string          "bench_icnsub_list_dispatch.icn"
...
n11_make_list_α:        mov              r11, 11
                        ...
                        mov              qword ptr [rbp + 408], rdx;          jmp   n12_assign_α
...
n12_assign_α:           mov              r11, 12
                        ...
                        mov              qword ptr [rbp + 744], rdx;          jmp   n13_line_mark_α
...
n16_to_β:               mov              r11, 16
                        inc              qword ptr [rbp + 128];               jo    n31_line_mark_α
                                                                              jmp   .Lto_α_55_0
...
n17_assign_α:           mov              r11, 17
                        ...
                        mov              qword ptr [rbp + 728], rdx;          jmp   n18_bound_α
...
n23_binop_α:            mov              r11, 23
                        ...
                        mov              qword ptr [rbp + 280], rdx;          jmp   n24_lit_integer_α
...
n25_coerce_numeric_α:   mov              r11, 25
                        ...
                        cmp              al, 5;                               je    .Lcoerce_numeric_α_69_1
                        cmp              al, 3;                               jne   .Lcoerce_numeric_α_69_0
                        mov              eax, dword ptr [rbp + 336]
                        cmp              al, 3;                               jne   .Lcoerce_numeric_α_69_0
.Lcoerce_numeric_α_69_1:
                        mov              rax, qword ptr [rbp + 272]
                        mov              qword ptr [rbp + 256], rax
                        mov              rax, qword ptr [rbp + 280]
                        mov              qword ptr [rbp + 264], rax;          jmp   n26_binop_α
.Lcoerce_numeric_α_69_0:
                        lea              rdi, [rbp + 272]
                        lea              rsi, [rbp + 336]
                        lea              rdx, [rbp + 256]
                        mov              rcx, 4311744614
...
n26_binop_α:            mov              r11, 26
                        ...
                        mov              edx, eax
                        and              edx, ecx
                        cmp              dl, 3;                               jne   .Lbinop_α_70_2
                        mov              rax, qword ptr [rbp + 264]
                        mov              rdx, 1
                        add              rax, rdx;                            jo    .Lbinop_α_70_0
                        mov              qword ptr [rbp + 240], 3
                        mov              qword ptr [rbp + 248], rax;          jmp   .Lbinop_α_70_7
.Lbinop_α_70_2:         and              edx, 1;                              jz    .Lbinop_α_70_0
                        mov              rsi, qword ptr [rbp + 264]
                        mov              rdi, 1
                        cmp              al, 5;                               je    .Lbinop_α_70_3
                        cvtsi2sd         xmm0, rsi;                           jmp   .Lbinop_α_70_4
.Lbinop_α_70_3:         movq             xmm0, rsi
.Lbinop_α_70_4:         cmp              cl, 5;                               je    .Lbinop_α_70_5
                        cvtsi2sd         xmm1, rdi;                           jmp   .Lbinop_α_70_6
.Lbinop_α_70_5:         movq             xmm1, rdi
.Lbinop_α_70_6:         addsd            xmm0, xmm1
                        movq             rax, xmm0
                        mov              rdx, rax
                        add              rdx, rdx
...
.Lbinop_α_70_7:                                                               jmp   n27_subscript_α
.Lbinop_α_70_0:         mov              rdi, qword ptr [rbp + 256]
                        mov              rsi, qword ptr [rbp + 264]
                        ...
                        mov              qword ptr [rbp + 248], rdx;          jmp   n27_subscript_α
...
n28_deref_α:            mov              r11, 28
                        ...
                        mov              qword ptr [rbp + 376], rdx;          jmp   n29_assign_α
...
n29_assign_α:           mov              r11, 29
                        ...
                        mov              qword ptr [rbp + 712], rdx;          jmp   n30_unmark_α
...
n33_deref_α:            mov              r11, 33
                        ...
                        mov              qword ptr [rbp + 72], rdx;           jmp   n34_call_icon_α
                        .size            n33_deref_bx, .-n33_deref_bx
                        .type            n34_call_icon_bx, @function
n34_call_icon_bx:
#-----------------------------------------------------------------------------------------------------------------------
n34_call_icon_α:        mov              r11, 34
                        mov              rax, qword ptr [rbp + 64]
                        mov              qword ptr [rbp + 16], rax
                        mov              rax, qword ptr [rbp + 72]
                        mov              qword ptr [rbp + 24], rax
                        .section         .rodata
.Lcall_icon_α_rkfn82:   .string          "write"
                        .section         .text
                        .intel_syntax    noprefix
                        lea              rdi, [rip + .Lcall_icon_α_rkfn82]
                        lea              rsi, [rbp + 16]
                        mov              edx, 1
                        mov              qword ptr [rip + rtccb+40], r8
                        mov              qword ptr [rip + rtccb+56], r10
                        ...
                        cmp              al, 104;                             je    main_ω
                                                                              jmp   main_ω
n34_call_icon_β:        mov              r11, 34;                             jmp   main_ω
                        .size            n34_call_icon_bx, .-n34_call_icon_bx
#-----------------------------------------------------------------------------------------------------------------------
main_β:
                                                                              jmp   main_ω
#-----------------------------------------------------------------------------------------------------------------------
...
main_ω:
                        ...
                        mov              rax, qword ptr [rip + g_trace@GOTPCREL]
                        mov              rax, qword ptr [rax + 0]
                        cmp              rax, 0;                              je    .Lmain_α_81_249
                        .section         .rodata
.Licn_trace_nm84:       .string          "main"
                        .section         .text
                        .intel_syntax    noprefix
                        lea              rdi, [rip + .Licn_trace_nm84]
                        mov              qword ptr [rip + rtccb+40], r8
                        mov              qword ptr [rip + rtccb+56], r10
                        mov              qword ptr [rip + rtccb+64], r11
