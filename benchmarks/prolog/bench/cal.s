...
# IR_VAR_REF local
 ...
 xchain843_n54_α:
  .section .rodata
  .Lcall537_pname: .string "leap_year"
  .section .text
  .intel_syntax noprefix
 mov edi, 0
 mov rsi, qword ptr [r12 + 272]
...
# IR_VAR_REF local
 ...
 xchain1135_n5_α:
  .section .rodata
  .Lcall643_pname: .string "day_of_week"
  .section .text
  .intel_syntax noprefix
 mov edi, 0
 mov rsi, qword ptr [r12 + 288]
