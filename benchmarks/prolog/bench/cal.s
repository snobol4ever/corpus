...
# IR_VAR_REF local
 ...
 xchain843_n60_α:
  .section .rodata
  .Lcall543_pname: .string "leap_year"
  .section .text
  .intel_syntax noprefix
 mov edi, 0
 mov rsi, qword ptr [r12 + 256]
...
# marshal arg1 = producer-box slot [r12+880] -> [r12+816]
 ...
 mov qword ptr [r12 + 824], rax
  .section .rodata
  .Lrkfn1106: .string "$cmp_ne"
  .section .text
  .intel_syntax noprefix
   lea rdi, [rip + .Lrkfn1106]
 lea rsi, [r12 + 800]
 mov edx, 2
 call rt_call_arr@PLT
 mov qword ptr [r12 + 784], rax
...
# IR_VAR_REF local
 ...
 xchain1137_n5_α:
  .section .rodata
  .Lcall650_pname: .string "day_of_week"
  .section .text
  .intel_syntax noprefix
 mov edi, 0
 mov rsi, qword ptr [r12 + 272]
...
# marshal arg0 = producer-box slot [r12+128] -> [r12+112]
 ...
 cmp eax, 99
 je xchain1137_n5_β
 jmp xchain1137_n11_α
 xchain1137_n10_β:
 jmp xchain1137_n5_β
# IR_MOVE_LABEL: shared value := arm value; t := &arm-resume
 xchain1137_n11_α:
 lea rax, [rip + xchain1137_n5_β]
