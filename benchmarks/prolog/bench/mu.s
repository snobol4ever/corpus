...
# IR_VAR_REF local
 ...
 xchain479_n32_α:
  .section .rodata
  .Lcall307_pname: .string "my_append"
  .section .text
  .intel_syntax noprefix
 mov edi, 0
 mov rsi, qword ptr [r12 + 224]
