...
n709_lit_integer_α:     mov              r11, 283
                        ...
                        mov              qword ptr [rsp + 296], rax;          jmp   n710_call_builtin_prolog_α
.Lx742_0:               .quad            1
#-----------------------------------------------------------------------------------------------------------------------
n710_call_builtin_prolog_α:
                        ...
                        mov              r9,  qword ptr [rip + rtccb+48]
                        mov              r10, qword ptr [rip + rtccb+56]
                        mov              r11, qword ptr [rip + rtccb+64];     jmp   n711_lit_string_α
...
n715_lit_integer_α:     mov              r11, 289
                        ...
                        mov              qword ptr [rsp + 424], rax;          jmp   n716_call_builtin_prolog_α
.Lx748_0:               .quad            2
#-----------------------------------------------------------------------------------------------------------------------
n716_call_builtin_prolog_α:
                        ...
                        mov              r9,  qword ptr [rip + rtccb+48]
                        mov              r10, qword ptr [rip + rtccb+56]
                        mov              r11, qword ptr [rip + rtccb+64];     jmp   n717_lit_integer_α
n716_call_builtin_prolog_β:
                        mov              r11, 290;                            jmp   main_ω
#-----------------------------------------------------------------------------------------------------------------------
n717_lit_integer_α:     mov              r11, 291
                        mov              qword ptr [rsp + 528], 3             # result
                        mov              rax, qword ptr [rip + .Lx750_0]
                        mov              qword ptr [rsp + 536], rax;          jmp   n718_call_builtin_prolog_α
.Lx750_0:               .quad            2
#-----------------------------------------------------------------------------------------------------------------------
...
n722_lit_integer_α:     mov              r11, 296
                        ...
                        mov              qword ptr [rsp + 664], rax;          jmp   n723_call_builtin_prolog_α
.Lx755_0:               .quad            3
#-----------------------------------------------------------------------------------------------------------------------
n723_call_builtin_prolog_α:
                        ...
                        mov              r9,  qword ptr [rip + rtccb+48]
                        mov              r10, qword ptr [rip + rtccb+56]
                        mov              r11, qword ptr [rip + rtccb+64];     jmp   n724_lit_integer_α
n723_call_builtin_prolog_β:
                        mov              r11, 297;                            jmp   main_ω
#-----------------------------------------------------------------------------------------------------------------------
n724_lit_integer_α:     mov              r11, 298
                        mov              qword ptr [rsp + 768], 3             # result
                        mov              rax, qword ptr [rip + .Lx757_0]
                        mov              qword ptr [rsp + 776], rax;          jmp   n725_call_builtin_prolog_α
.Lx757_0:               .quad            3
#-----------------------------------------------------------------------------------------------------------------------
n725_call_builtin_prolog_α:
                        ...
                        mov              r9,  qword ptr [rip + rtccb+48]
                        mov              r10, qword ptr [rip + rtccb+56]
                        mov              r11, qword ptr [rip + rtccb+64];     jmp   n726_call_builtin_prolog_α
n725_call_builtin_prolog_β:
                        mov              r11, 299;                            jmp   main_ω
#-----------------------------------------------------------------------------------------------------------------------
n726_call_builtin_prolog_α:
                        ...
                        mov              r9,  qword ptr [rip + rtccb+48]
                        mov              r10, qword ptr [rip + rtccb+56]
                        mov              r11, qword ptr [rip + rtccb+64];     jmp   n727_call_builtin_prolog_α
n726_call_builtin_prolog_β:
                        mov              r11, 300;                            jmp   main_ω
#-----------------------------------------------------------------------------------------------------------------------
...
n727_call_builtin_prolog_β:
                        mov              r11, 301;                            jmp   n737_call_builtin_prolog_α
#-----------------------------------------------------------------------------------------------------------------------
...
n730_call_proc_staged_β:
                        mov              r11, 304;                            jmp   n737_call_builtin_prolog_α
...
n731_var_α:             mov              r11, 305
                        ...
                        mov              qword ptr [rsp + 184], rax;          jmp   n732_call_builtin_prolog_α
#-----------------------------------------------------------------------------------------------------------------------
...
.Lrkfn769:              .string          "$write"
                        ...
                        mov              r9,  qword ptr [rip + rtccb+48]
                        mov              r10, qword ptr [rip + rtccb+56]
                        mov              r11, qword ptr [rip + rtccb+64];     jmp   n733_lit_string_α
n732_call_builtin_prolog_β:
                        mov              r11, 306;                            jmp   n730_call_proc_staged_β
#-----------------------------------------------------------------------------------------------------------------------
n733_lit_string_α:      mov              r11, 307
                        mov              qword ptr [rsp + 128], 2             # result
                        mov              dword ptr [rsp + 132], 0
                        mov              rax, qword ptr [rip + .Lx770_0]
                        mov              qword ptr [rsp + 136], rax;          jmp   n734_call_builtin_prolog_α
...
.Lrkfn772:              .string          "$nl0"
                        ...
                        mov              r9,  qword ptr [rip + rtccb+48]
                        mov              r10, qword ptr [rip + rtccb+56]
                        mov              r11, qword ptr [rip + rtccb+64];     jmp   n735_move_label_α
n734_call_builtin_prolog_β:
                        mov              r11, 308;                            jmp   n730_call_proc_staged_β
#-----------------------------------------------------------------------------------------------------------------------
