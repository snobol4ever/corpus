...
n705_call_prolog_α:     mov              r11, 279
                        lea              rdi, [rip + g_pl_zf_pending_cursor]
                        mov              rax, qword ptr [rdi]
                        test             rax, rax;                            je    .Lcall_prolog_α_738_102
                        mov              rax, qword ptr [rsp + 32]
                        mov              rdx, qword ptr [rsp + 40];           jmp   .Lcall_prolog_α_738_101
.Lcall_prolog_α_738_102:
                        lea              r12, [rip + g_plw_cellws_on]
                        mov              eax, dword ptr [r12 + 0]
                        test             eax, eax;                            jne   .Lcall_prolog_α_738_100
                        lea              r12, [rip + g_zeta_mode]
                        mov              eax, dword ptr [r12 + 0]
                        cmp              eax, 2;                              je    .Lcall_prolog_α_738_100
                        lea              r12, [rip + g_pl_trail]
                        mov              eax, dword ptr [r12 + 32]
                        movsxd           rdx, eax
                        mov              eax, 3;                              jmp   .Lcall_prolog_α_738_101
.Lcall_prolog_α_738_100:
                        lea              rdi, [rsp + 48]
                        mov              esi, 0
                        mov              qword ptr [rip + rtccb+40], r8
                        mov              qword ptr [rip + rtccb+56], r10
...
.Llit_string_α_741_0_s: .string          "x"
...
.Llit_string_α_747_0_s: .string          "x"
...
.Llit_string_α_754_0_s: .string          "x"
...
n730_call_proc_staged_α:
                        ...
                        lea              rdx, [rsp + 1072]
                        lea              rcx, [rsp + 1088]
                        call             d$2F3_dcα;                           jmp   .Lcall_proc_staged_α_765_2
...
n732_call_prolog_α:     mov              r11, 306
                        ...
                        .section         .rodata
.Lcall_prolog_rkfn769:  .string          "$write"
                        .section         .text
                        .intel_syntax    noprefix
                        lea              rdi, [rip + .Lcall_prolog_rkfn769]
                        lea              rsi, [rsp + 160]
                        mov              edx, 1
                        mov              qword ptr [rip + rtccb+40], r8
                        mov              qword ptr [rip + rtccb+56], r10
...
n734_call_prolog_α:     mov              r11, 308
                        ...
                        .section         .rodata
.Lcall_prolog_rkfn772:  .string          "$nl0"
                        .section         .text
                        .intel_syntax    noprefix
                        lea              rdi, [rip + .Lcall_prolog_rkfn772]
                        lea              rsi, [rsp + 112]
                        mov              edx, 1
                        mov              qword ptr [rip + rtccb+40], r8
                        mov              qword ptr [rip + rtccb+56], r10
