...
# IR_MOVE_LABEL
 xchain40_n244_α:
 lea rax, [rip + xchain40_n49_α]
 mov qword ptr [rbp + 80], rax
 jmp proc_d$3_γ
# IR_MOVE_LABEL
 xchain40_n245_α:
 lea rax, [rip + xchain40_n243_β]
 mov qword ptr [rbp + 80], rax
 jmp proc_d$3_γ
proc_d$3_res:
add rsp, 8
