...
# marshal arg0 = producer-box slot [zr+96] -> [zr+4464]
 ...
 mov qword ptr [r12 + 4472], rax
  .section .rodata
  .Lrkfn124: .string "$unwind_nothrow"
  .section .text
  .intel_syntax noprefix
...
# marshal arg0 = producer-box slot [zr+96] -> [zr+2384]
 ...
 mov qword ptr [r12 + 2392], rax
  .section .rodata
  .Lrkfn218: .string "$unwind_nothrow"
  .section .text
  .intel_syntax noprefix
...
# marshal arg0 = producer-box slot [zr+96] -> [zr+1856]
 ...
 mov qword ptr [r12 + 1864], rax
  .section .rodata
  .Lrkfn257: .string "$unwind_nothrow"
  .section .text
  .intel_syntax noprefix
...
# marshal arg0 = producer-box slot [zr+96] -> [zr+672]
 ...
 mov qword ptr [r12 + 680], rax
  .section .rodata
  .Lrkfn356: .string "$unwind_nothrow"
  .section .text
  .intel_syntax noprefix
...
# BOX IR_CALL $trail_mark(...) -> rt_call_arr [operand-marshal, FAIL->ω]
 ...
 xchain493_n1_α:
  .section .rodata
  .Lcall283_pname: .string "divide10/0"
  .section .text
  .intel_syntax noprefix
