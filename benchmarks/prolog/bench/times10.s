...
# marshal arg0 = producer-box slot [zr+96] -> [zr+1008]
 ...
 mov qword ptr [rbp + 1016], rax
  .section .rodata
  .Lrkfn312: .string "$unwind_nothrow"
  .section .text
  .intel_syntax noprefix
