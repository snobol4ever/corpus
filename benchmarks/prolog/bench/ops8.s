...
# marshal arg0 = producer-box slot [zr+96] -> [zr+4464]
 ...
 mov qword ptr [r12 + 4472], rax
  .section .rodata
  .Lrkfn116: .string "$unwind_nothrow"
  .section .text
  .intel_syntax noprefix
...
# marshal arg0 = producer-box slot [zr+96] -> [zr+2384]
 ...
 mov qword ptr [r12 + 2392], rax
  .section .rodata
  .Lrkfn210: .string "$unwind_nothrow"
  .section .text
  .intel_syntax noprefix
...
# marshal arg0 = producer-box slot [zr+96] -> [zr+672]
 ...
 mov qword ptr [r12 + 680], rax
  .section .rodata
  .Lrkfn348: .string "$unwind_nothrow"
  .section .text
  .intel_syntax noprefix
...
# marshal arg0 = producer-box slot [zr+96] -> [zr+400]
 ...
 mov qword ptr [r12 + 408], rax
  .section .rodata
  .Lrkfn394: .string "$unwind_nothrow"
  .section .text
  .intel_syntax noprefix
...
# BOX IR_CALL $trail_mark(...) -> rt_call_arr [operand-marshal, FAIL->ω]
 ...
 xchain495_n1_α:
  .section .rodata
  .Lcall282_pname: .string "top/0"
  .section .text
  .intel_syntax noprefix
   lea rdi, [rip + .Lcall282_pname]
 mov esi, 0
 lea rdx, [r12 + 256]
 call rt_proc_call_gen_h@PLT
 mov qword ptr [r12 + 240], rax
