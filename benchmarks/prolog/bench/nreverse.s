...
.Lx514_20:
                        mov              edi, 0                                         # idx
                        mov              rsi, qword ptr [rbp + 3552]                    # v
                        mov              rdx, qword ptr [rbp + 3560]                    # v
                        call             rt_arg_stage@PLT
.Lx514_21:
                        lea              r11, [rip + g_gc_pending]
                        mov              eax, dword ptr [r11 + 0]
...
.Lx514_22:
                        mov              edi, 1                                         # idx
                        mov              rsi, qword ptr [rbp + 3648]                    # v
                        mov              rdx, qword ptr [rbp + 3656]                    # v
                        call             rt_arg_stage@PLT
.Lx514_23:
                        lea              rax, [rip + .Lx514_7]
                        push             rax
...
main_γ:
                        ...
                        mov              rbp, qword ptr [rbp + 3720]
                                                                                        jmp   rcx
#-----------------------------------------------------------------------------------------------------------------------
main_ω:
                        lea              rsp, [rbp + 3728]
                        mov              rcx, qword ptr [rbp + 3712]
                        mov              rbp, qword ptr [rbp + 3720]
                                                                                        jmp   rcx
