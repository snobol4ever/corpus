...
n643_var_ref_α:         mov              r11, 255
                        ...
                        lea              rdx, [rsp + 176]
                        mov              qword ptr [rsp + 160], rax
                        mov              qword ptr [rsp + 168], rdx;          jmp   n644_call_proc_staged_α
...
n644_call_proc_staged_α:
                        ...
                        lea              r8, [rip + g_gc_pending]
                        mov              eax, dword ptr [r8 + 0]
                        test             eax, eax;                            jne   .Lcall_proc_staged_α_652_200
                        mov              rax, qword ptr [rsp + 160]
                        mov              rdx, qword ptr [rsp + 168]
                        lea              r8, [rip + g_call_args]
                        mov              qword ptr [r8 + 0], rax
                        mov              qword ptr [r8 + 8], rdx;             jmp   .Lcall_proc_staged_α_652_201
.Lcall_proc_staged_α_652_200:
                        mov              edi, 0
                        mov              rsi, qword ptr [rsp + 160]
                        mov              rdx, qword ptr [rsp + 168]
                        mov              qword ptr [rip + rtccb+40], r8
...
.Lcall_proc_staged_α_652_3:
                        ...
                        add              rsp, 16
                        mov              rax, qword ptr [rsp + 128]
                        test             rax, rax;                            jne   .Lcall_proc_staged_α_652_5
                        ...
                        mov              r9,  qword ptr [rip + rtccb+48]
                        mov              r10, qword ptr [rip + rtccb+56]
                        mov              r11, qword ptr [rip + rtccb+64];     jmp   .Lcall_proc_staged_α_652_2
.Lcall_proc_staged_α_652_5:
                        call             rt_gen_spine_pass_γ@PLT;             jmp   .Lcall_proc_staged_α_652_2
.Lcall_proc_staged_α_652_4:
                        add              rsp, 16
                        add              rsp, 16
                        mov              rax, qword ptr [rsp + 128]
                        test             rax, rax;                            jne   .Lcall_proc_staged_α_652_6
                        mov              qword ptr [rsp + 128], 1
                        mov              qword ptr [rip + rtccb+40], r8
                        mov              qword ptr [rip + rtccb+56], r10
                        mov              qword ptr [rip + rtccb+64], r11
...
n644_call_proc_staged_β:
                        ...
                        test             rax, rax;                            je    main_ω
                        sub              rsp, 8
                        lea              r8, [rip + .Lcall_proc_staged_α_652_7]
                        push             r8
                        lea              rcx, [rip + .Lcall_proc_staged_α_652_4] # PL-CALL-ALIGN: same 16B-unit pad as the first-call entry above -- this retry entry pushed L(7) unpadded too, 8-mod-16 into open_det/the callee jmp; matching add-rsp-8 below becomes 16.
                        push             rcx
                        lea              rcx, [rip + .Lcall_proc_staged_α_652_3]
                        push             rcx
                        lea              rdx, [rip + .Lcall_proc_staged_α_652_4]
...
n645_var_α:             mov              r11, 257
                        ...
                        mov              qword ptr [rsp + 80], rax
                        mov              rax, qword ptr [rsp + 184]
                        mov              qword ptr [rsp + 88], rax;           jmp   n646_call_prolog_α
...
n646_call_prolog_α:     mov              r11, 258
                        ...
                        .section         .rodata
.Lcall_prolog_rkfn656:  .string          "$write"
                        .section         .text
                        .intel_syntax    noprefix
                        lea              rdi, [rip + .Lcall_prolog_rkfn656]
                        lea              rsi, [rsp + 64]
                        mov              edx, 1
                        mov              qword ptr [rip + rtccb+40], r8
                        mov              qword ptr [rip + rtccb+56], r10
...
n647_lit_string_α:      mov              r11, 259
                        ...
                        mov              qword ptr [rsp + 40], rax;           jmp   n648_call_prolog_α
...
n648_call_prolog_α:     mov              r11, 260
                        ...
                        .section         .rodata
.Lcall_prolog_rkfn659:  .string          "$nl0"
                        .section         .text
                        .intel_syntax    noprefix
                        lea              rdi, [rip + .Lcall_prolog_rkfn659]
                        lea              rsi, [rsp + 16]
                        mov              edx, 1
                        mov              qword ptr [rip + rtccb+40], r8
                        mov              qword ptr [rip + rtccb+56], r10
