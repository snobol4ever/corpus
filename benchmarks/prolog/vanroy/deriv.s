...
# IR_MOVE_LABEL
 xchain74_n274_α:
 lea rax, [rip + xchain74_n271_β]
 mov qword ptr [rbp + 80], rax
 jmp proc_d$2F3_γ
# IR_MOVE_LABEL
 xchain74_n275_α:
 lea rax, [rip + xchain74_n272_β]
 mov qword ptr [rbp + 80], rax
 jmp proc_d$2F3_γ
 xchain74_n276_α:
 lea rsi, [rbp + 4240]
