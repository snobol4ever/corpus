...
n3_match_assign_cond_β: mov              r11, 4
                        sub              r12, 24;                             jmp   n2_match_arb_β
#-----------------------------------------------------------------------------------------------------------------------
n4_match_alternate_α:   mov              r11, 5
...
n4_match_alternate_s0:  mov              r11, 5
                        lea              rax, [rip + .Lx16_40]
                        mov              qword ptr [rbp + -96], rax;          jmp   n4_match_alternate_as
n4_match_alternate_s1:  mov              r11, 5
                        lea              rax, [rip + .Lx16_41]
                        mov              qword ptr [rbp + -96], rax;          jmp   n4_match_alternate_as
.Lx16_40:                                                                     jmp   n6_match_lit_β
.Lx16_41:                                                                     jmp   n5_match_lit_β
n4_match_alternate_as:  mov              r11, 5;                              jmp   PAT$0_γ
n4_match_alternate_β:   mov              r11, 5
                        mov              rax, qword ptr [rbp + -96];          jmp   rax
n4_match_alternate_af:  mov              r11, 5
...
n5_match_lit_β:         mov              r11, 6
                        sub              r14d, 3;                             jmp   n4_match_alternate_af
#-----------------------------------------------------------------------------------------------------------------------
...
n6_match_lit_β:         mov              r11, 7
                        sub              r14d, 4;                             jmp   n4_match_alternate_af
#-----------------------------------------------------------------------------------------------------------------------
PAT$0_res:
...
main_α_body:
                        sub              rsp, 0
#-----------------------------------------------------------------------------------------------------------------------
n21_statement_begin_α:  mov              r11, 8
                        mov              r10, 0;                              jmp   n22_statement_end_α
n21_statement_begin_β:  mov              r11, 8;                              jmp   n23_statement_begin_α
#-----------------------------------------------------------------------------------------------------------------------
n22_statement_end_α:    mov              r11, 9
                        mov              r10, 1;                              jmp   n23_statement_begin_α
#=======================================================================================================================
...
n28_statement_begin_α:  mov              r11, 15
                        mov              r10, 3;                              jmp   n29_var_α
n28_statement_begin_β:  mov              r11, 15;                             jmp   main_γ
#-----------------------------------------------------------------------------------------------------------------------
...
#-----------------------------------------------------------------------------------------------------------------------
n30_assign_α:           mov              r11, 17
                        mov              rax, qword ptr [rsp + 0]             # var
                        mov              rdx, qword ptr [rsp + 8]
                        mov              qword ptr [r9 + 16], rax             # LINE
                        mov              qword ptr [r9 + 24], rdx;            jmp   n31_statement_end_α
#-----------------------------------------------------------------------------------------------------------------------
n31_statement_end_α:    mov              r11, 18
                        mov              r10, 3
                        add              rsp, 16;                             jmp   n32_statement_begin_α
#=======================================================================================================================
#       LINE     ?  PAT                              :(LOOP)
#-----------------------------------------------------------------------------------------------------------------------
n32_statement_begin_α:  mov              r11, 19
                        mov              r10, 4;                              jmp   n33_var_α
n32_statement_begin_β:  mov              r11, 19;                             jmp   n28_statement_begin_α
#-----------------------------------------------------------------------------------------------------------------------
...
n34_var_β:              mov              r11, 21;                             jmp   n39_statement_end_α
#-----------------------------------------------------------------------------------------------------------------------
...
n35_assign_β:           mov              r11, 22;                             jmp   n34_var_β
.Lx62_0:                .quad            .Lx62_0_s
.Lx62_0_s:              .string          "PATV$0"
#-----------------------------------------------------------------------------------------------------------------------
n36_match_begin_α:      mov              r11, 23
...
#-----------------------------------------------------------------------------------------------------------------------
n37_match_defer_α:      mov              r11, 24
                        lea              rcx, [rip + g_sno_defer_cells+16384]
                        mov              rax, qword ptr [rcx + 0]
                        lea              rdx, [rip + .S1]
                        cmp              rax, rdx;                            jne   .Lx65_30
                        mov              rax, qword ptr [rcx + 8]
                        mov              edx, dword ptr [rax + 0]
                        and              edx, 255
                        cmp              edx, 2;                              jne   .Lx65_30
                        mov              edx, dword ptr [rax + 4]
                        cmp              edx, 1;                              jne   .Lx65_30
                        movsxd           rcx, r14d
                        cmp              ecx, r15d;                           jge   .Lx65_31
                        movzx            esi, byte ptr [r13+rcx]
                        mov              rdi, qword ptr [rax + 8]
                        xor              edx, edx
                        movzx            edi, byte ptr [rdi + rdx]
                        cmp              esi, edi;                            jne   .Lx65_31
                        mov              edx, r14d
                        add              edx, 1;                              jmp   .Lx65_0
.Lx65_31:               mov              edx, -1;                             jmp   .Lx65_0
.Lx65_30:               push             r14
                        push             r15
                        push             r13
                        sub              rsp, 8
...
#-----------------------------------------------------------------------------------------------------------------------
n39_statement_end_α:    mov              r11, 26
                        mov              r10, 4
                        add              rsp, 32;                             jmp   n28_statement_begin_α
#-----------------------------------------------------------------------------------------------------------------------
main_β:
