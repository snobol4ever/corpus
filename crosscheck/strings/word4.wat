...
(module
  ...
  (data (i32.const 65536) "  : invented the  in ")
  ...
  (global $var_WHEN_off (mut i32) (i32.const 0))
  (global $var_WHEN_len (mut i32) (i32.const 0))
  (global $var_WHO_off (mut i32) (i32.const 0))
  (global $var_WHO_len (mut i32) (i32.const 0))
  (global $var_WHAT_off (mut i32) (i32.const 0))
  (global $var_WHAT_len (mut i32) (i32.const 0))
  ...
  (func (export "main") (result i32)
    ...
    (global.get $var_PAT_len)
      ...
      (if (i32.eqz (local.get $ok)) (then
      (local.set $pc (i32.const 1)) ;; → LOOP
      (br $dispatch)
      ))
      ;; OUTPUT = ...
    (global.get $var_WHO_off)
    (global.get $var_WHO_len)
    (i32.const 65539)
    (i32.const 14)
    (call $sno_str_concat)
    (global.get $var_WHAT_off)
    (global.get $var_WHAT_len)
    (call $sno_str_concat)
    (i32.const 65553)
    (i32.const 4)
    (call $sno_str_concat)
    (global.get $var_WHEN_off)
    (global.get $var_WHEN_len)
    (call $sno_str_concat)
      (call $sno_output_str)
      (local.set $ok (i32.const 1))
      (local.set $pc (i32.const 1)) ;; → LOOP
