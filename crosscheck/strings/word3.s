...
dol2_child_α:               BREAK_α     lit_str_1, 1, r12+104, cursor, subject_data, subject_len_val, dol2_γ, dol2_ω ; BREAK α
dol2_child_β:               BREAK_β     r12+104, cursor, dol2_ω ; BREAK β
...
seq_l5_α:                   LIT_α1      32, r12+112, cursor, subject_data, subject_len_val, seq_r5_α, seq_l1_β ; LIT α
seq_l5_β:                   LIT_β       r12+112, cursor, seq_l1_β ; LIT β
seq_r5_α:                   SPAN_α      lit_str_1, 1, r12+120, cursor, subject_data, subject_len_val, seq_r4_α, seq_l5_β ; SPAN α
seq_r5_β:                   SPAN_β      r12+120, cursor, seq_l5_β ; SPAN β
...
dol8_child_α:               ARB_α       r12+128, r12+136, cursor, dol8_γ ; ARB α
dol8_child_β:               ARB_β       r12+128, r12+136, cursor, subject_len_val, dol8_γ, dol8_ω ; ARB β
...
seq_l11_α:                  LIT_α1      32, r12+144, cursor, subject_data, subject_len_val, seq_r11_α, seq_l7_β ; LIT α
seq_l11_β:                  LIT_β       r12+144, cursor, seq_l7_β ; LIT β
seq_r11_α:                  SPAN_α      lit_str_2, 2, r12+152, cursor, subject_data, subject_len_val, seq_r10_α, seq_l11_β ; SPAN α
seq_r11_β:                  SPAN_β      r12+152, cursor, seq_l11_β ; SPAN β

seq_r10_α: ; DOL(WHAT $  WHAT)
                            DOL_SAVE    r12+88, cursor, dol13_child_α ; DOL α — save entry cursor
seq_r10_β:                  jmp         dol13_child_β ; DOL β
dol13_child_α:              REM_α       r12+160, cursor, subject_len_val, dol13_γ ; REM
dol13_child_β:              REM_β       r12+160, cursor, dol13_ω ; REM β
dol13_γ:                    DOL_CAPTURE r12+88, cursor, cap_WHAT_buf, cap_WHAT_len, subject_data, patdef_PAT_γ ; DOL γ — capture span
...
dq 0  ; [r12+104] = brk3_saved
dq 0  ; [r12+112] = seq_l5_α_saved
dq 0  ; [r12+120] = span6_saved
dq 0  ; [r12+128] = arb9_start
dq 0  ; [r12+136] = arb9_step
dq 0  ; [r12+144] = seq_l11_α_saved
dq 0  ; [r12+152] = span12_saved
dq 0  ; [r12+160] = rem14_saved
