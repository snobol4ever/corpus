...
(module
  ...
  (global $var_H_off (mut i32) (i32.const 0))
  (global $var_H_len (mut i32) (i32.const 0))
  (global $var_V_off (mut i32) (i32.const 0))
  (global $var_V_len (mut i32) (i32.const 0))
  (global $var_HC_off (mut i32) (i32.const 0))
  (global $var_HC_len (mut i32) (i32.const 0))
  (global $var_NH_off (mut i32) (i32.const 0))
  (global $var_NH_len (mut i32) (i32.const 0))
  (global $var_CROSS_off (mut i32) (i32.const 0))
  (global $var_CROSS_len (mut i32) (i32.const 0))
  (global $var_VC_off (mut i32) (i32.const 0))
  (global $var_VC_len (mut i32) (i32.const 0))
  (global $var_NV_off (mut i32) (i32.const 0))
  (global $var_NV_len (mut i32) (i32.const 0))
  (global $var_PRINTV_off (mut i32) (i32.const 0))
  (global $var_PRINTV_len (mut i32) (i32.const 0))
  ...
  (func (export "main") (result i32)
    ...
    (global.get $var_INPUT_len)
      (global.set $var_H_len)
      (global.set $var_H_off)
      (local.set $ok (i32.const 1))
    ...
    (global.get $var_INPUT_len)
      ...
      ;; HC = ...
    (global.get $var_H_off)
    (global.get $var_H_len)
      (global.set $var_HC_len)
      (global.set $var_HC_off)
      (local.set $ok (i32.const 1))
      ) ;; $L2 NEXTH
      ;; HC = ...
    (i32.const 65536)
    (i32.const 1)
      ...
      (local.set $ok (i32.const 1))
      (if (i32.eqz (local.get $ok)) (then
      (local.set $pc (i32.const 1)) ;; → AGAIN
      (br $dispatch)
      ))
      ;; VC = ...
    (global.get $var_V_off)
    (global.get $var_V_len)
      (global.set $var_VC_len)
      (global.set $var_VC_off)
      (local.set $ok (i32.const 1))
      ) ;; $L3 NEXTV
      ;; VC = ...
    (i32.const 65537)
    (i32.const 1)
      ...
      (local.set $ok (i32.const 1))
      (if (i32.eqz (local.get $ok)) (then
      (local.set $pc (i32.const 2)) ;; → NEXTH
      (br $dispatch)
      ))
      ;; OUTPUT = ...
    (i32.const 65536)
    ...
    (global.get $var_V_off)
    (global.get $var_V_len)
      (global.set $var_PRINTV_len)
      (global.set $var_PRINTV_off)
      (local.set $ok (i32.const 1))
      ;; PRINTV = ...
    (i32.const 65537)
    (i32.const 1)
    ...
    (i32.const 0)
      ...
      (local.set $ok (i32.const 1))
      (if (i32.eqz (local.get $ok)) (then
      (local.set $pc (i32.const 3)) ;; → NEXTV
      (br $dispatch)
      ))
      ;; OUTPUT = ...
    ...
    (i32.const 1)
    ;; DIFFER(a,b): ok = (a != b)
    (local.set $proto_len)  ;; a_len
    (local.set $arr_ok)     ;; a_off
    ;; b on stack: (b_off b_len)
    (local.get $arr_ok) (local.get $proto_len)
    (call $sno_str_eq)
    (local.set $ok (i32.eqz))  ;; ok = NOT equal
    (i32.const 65536)
    (i32.const 0)
    (i32.const 65538)
    (i32.const 1)
    (global.get $var_NH_off)
    (global.get $var_NH_len)
    (call $sno_str_to_int)
    (call $sno_dupl)
    (call $sno_str_concat)
    (global.get $var_C_off)
    ...
    (call $sno_str_concat)
      ...
      (local.set $pc (i32.const 4)) ;; → PRINT
      (br $dispatch)
      ))
      ;; OUTPUT = ...
    (global.get $var_H_off)
