...
(module
  ...
  (data (i32.const 65536) "hello worldhelloanchored match okworldshould not reachwronganchor prevented mid-string match")
  ...
  (func (export "main") (result i32)
    ...
    (i64.const 1)
      (call $sno_int_to_str)
      (global.set $var_ANCHOR_len)
      (global.set $var_ANCHOR_off)
