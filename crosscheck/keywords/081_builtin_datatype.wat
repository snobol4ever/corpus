...
(module
  ...
  (data (i32.const 65536) "helloabcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ")
  ...
  (func (export "main") (result i32)
    ...
    (block $datatype_done (result i32 i32)
      (if (i32.eq (call $sno_handle_type (local.get $arr_ok)) (i32.const 3)) (then
        ...
        (br $datatype_done)))
      (i32.const 65593) (i32.const 6)
    ) ;; $datatype_done
    (i32.const 65541) ;; &LCASE
    (i32.const 26)
    (i32.const 65567) ;; &UCASE
    (i32.const 26)
    (call $sno_replace)
      (call $sno_output_str)
    ...
    (i64.const 42)
    (drop)
    (i32.const 65599) ;; datatype=integer
    (i32.const 7)
    (i32.const 65541) ;; &LCASE
    (i32.const 26)
    (i32.const 65567) ;; &UCASE
