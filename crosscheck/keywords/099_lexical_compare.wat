...
(module
  ...
  (data (i32.const 65536) "bab > aa < bcatcat = catdogcat != dog")
  ...
  (func (export "main") (result i32)
    ...
    (i32.const 1)
      (drop)
      (drop)
      (i32.const 1) ;; builtin 'LLT' — treated as succeed
      (local.set $ok)
      (if (local.get $ok) (then
    ...
    (i32.const 3)
      (drop)
      (drop)
      (i32.const 1) ;; builtin 'LEQ' — treated as succeed
      (local.set $ok)
      (if (local.get $ok) (then
    ...
    (i32.const 3)
      (drop)
      (drop)
      (i32.const 1) ;; builtin 'LNE' — treated as succeed
      (local.set $ok)
      (if (local.get $ok) (then
