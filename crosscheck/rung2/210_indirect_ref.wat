...
(module
  ...
  (data (i32.const 65536) "the real balbalFAIL 210/001: $string lookupFAIL 210/002: $.var lookupPASS 210_indirect_ref (2/2)")

  ;; SNOBOL4 variables: each → (offset, length) global pair
  (global $var_bal_off (mut i32) (i32.const 0))
  (global $var_bal_len (mut i32) (i32.const 0))

  ;; $sno_var_get — indirect variable lookup by name
  (func $sno_var_get (param $no i32) (param $nl i32) (result i32 i32)
    (if (call $sno_str_eq (local.get $no) (local.get $nl) (i32.const 65548) (i32.const 3)) (then
      (return (global.get $var_bal_off) (global.get $var_bal_len))
    ))
  ...
  (func $sno_var_set (param $no i32) (param $nl i32) (param $vo i32) (param $vl i32)
    (if (call $sno_str_eq (local.get $no) (local.get $nl) (i32.const 65548) (i32.const 3)) (then
      (global.set $var_bal_off (local.get $vo))
      (global.set $var_bal_len (local.get $vl))
      (return)
    ))
  )
  ...
  (func (export "main") (result i32)
    ...
    (i32.const 65536)
    (i32.const 12)
      (global.set $var_bal_len)
      (global.set $var_bal_off)
      (local.set $ok (i32.const 1))
      ;; subject eval
    (i32.const 65548)
    (i32.const 3)
    (call $sno_var_get)
    (global.get $var_bal_off)
    (global.get $var_bal_len)
      (call $sno_str_eq)
      (i32.eqz)
      (local.set $ok)
    ...
    (i32.const 28)
      ...
      ;; subject eval
    (i32.const 65548) ;; $.var(child) name=bal
    (i32.const 3)
    (call $sno_var_get)
    (global.get $var_bal_off)
    (global.get $var_bal_len)
