...
(module
  ...
  (data (i32.const 65536) "xFAIL 212/001: $.var<index> indirect arrayPASS 212_indirect_array (1/1)")
  ...
  (func $sno_var_get (param $no i32) (param $nl i32) (result i32 i32)
    (if (call $sno_str_eq (local.get $no) (local.get $nl) (i32.const 65607) (i32.const 1)) (then
