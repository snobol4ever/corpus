...
n195_match_defer_α:     mov              r11, 196
                        ...
                        lea              rdx, [rip + .S2]
                        cmp              rax, rdx;                            jne   .Lx689_30
                        mov              rax, qword ptr [rcx + 8]
                        mov              edx, dword ptr [rax + 0]
                        and              edx, 255
                        cmp              edx, 2;                              jne   .Lx689_30
                        mov              edx, dword ptr [rax + 4]
                        cmp              edx, 1;                              jne   .Lx689_30
                        movsxd           rcx, r14d
                        cmp              ecx, r15d;                           jge   .Lx689_31
                        movzx            esi, byte ptr [r13+rcx]
                        mov              rdi, qword ptr [rax + 8]
                        xor              edx, edx
                        movzx            edi, byte ptr [rdi + rdx]
                        cmp              esi, edi;                            jne   .Lx689_31
                        mov              edx, r14d
                        add              edx, 1;                              jmp   .Lx689_0
.Lx689_31:              mov              edx, -1;                             jmp   .Lx689_0
.Lx689_30:              push             r14
                        push             r15
                        push             r13
                        sub              rsp, 8
...
n209_match_defer_α:     mov              r11, 210
                        ...
                        mov              rax, qword ptr [rcx + 0]
                        lea              rdx, [rip + .S3]
                        cmp              rax, rdx;                            jne   .Lx713_30
                        mov              rax, qword ptr [rcx + 8]
                        mov              edx, dword ptr [rax + 0]
                        and              edx, 255
                        cmp              edx, 2;                              jne   .Lx713_30
                        mov              edx, dword ptr [rax + 4]
                        cmp              edx, 1;                              jne   .Lx713_30
                        movsxd           rcx, r14d
                        cmp              ecx, r15d;                           jge   .Lx713_31
                        movzx            esi, byte ptr [r13+rcx]
                        mov              rdi, qword ptr [rax + 8]
                        xor              edx, edx
                        movzx            edi, byte ptr [rdi + rdx]
                        cmp              esi, edi;                            jne   .Lx713_31
                        mov              edx, r14d
                        add              edx, 1;                              jmp   .Lx713_0
.Lx713_31:              mov              edx, -1;                             jmp   .Lx713_0
.Lx713_30:              push             r14
                        push             r15
                        push             r13
                        sub              rsp, 8
...
n222_match_defer_α:     mov              r11, 223
                        ...
                        mov              rax, qword ptr [rcx + 0]
                        lea              rdx, [rip + .S4]
                        cmp              rax, rdx;                            jne   .Lx736_30
                        mov              rax, qword ptr [rcx + 8]
                        mov              edx, dword ptr [rax + 0]
                        and              edx, 255
                        cmp              edx, 2;                              jne   .Lx736_30
                        mov              edx, dword ptr [rax + 4]
                        cmp              edx, 1;                              jne   .Lx736_30
                        movsxd           rcx, r14d
                        cmp              ecx, r15d;                           jge   .Lx736_31
                        movzx            esi, byte ptr [r13+rcx]
                        mov              rdi, qword ptr [rax + 8]
                        xor              edx, edx
                        movzx            edi, byte ptr [rdi + rdx]
                        cmp              esi, edi;                            jne   .Lx736_31
                        mov              edx, r14d
                        add              edx, 1;                              jmp   .Lx736_0
.Lx736_31:              mov              edx, -1;                             jmp   .Lx736_0
.Lx736_30:              push             r14
                        push             r15
                        push             r13
                        sub              rsp, 8
