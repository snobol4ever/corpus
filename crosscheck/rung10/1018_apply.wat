...
(module
  ...
  (data (i32.const 65536) "FAIL 1018/001: apply(.eq,1,2) should failFAIL 1018/002: apply(.eq,1,1) should succeedabc   abcFAIL 1018/003: apply(.trim,...)PASS 1018_apply (3/3)")

  ;; SNOBOL4 variables: each → (offset, length) global pair
  (global $var_eq_off (mut i32) (i32.const 0))
  (global $var_eq_len (mut i32) (i32.const 0))
  (global $var_trim_off (mut i32) (i32.const 0))
  (global $var_trim_len (mut i32) (i32.const 0))
  ...
  (func (export "main") (result i32)
    ...
    (i64.const 2)
      (drop)
      (i32.const 1) ;; builtin 'apply' — treated as succeed
      (local.set $ok)
    ...
    (drop)
    (drop)
    ;; unimplemented builtin 'apply' in value ctx — empty string
    (i32.const 65536)
    (i32.const 0)
    (i32.const 65627)
    (i32.const 3)
