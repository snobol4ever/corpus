...
(module
  ...
  (data (i32.const 65536) "abcdefabcdefFAIL 1016/001: eval concat exprqqqFAIL 1016/002: eval var refFAIL 1016/003: eval failing expr should failPASS 1016_eval (3/3)")
  ...
  (global $var_q_off (mut i32) (i32.const 0))
  (global $var_q_len (mut i32) (i32.const 0))
  (global $var_sexp_off (mut i32) (i32.const 0))
  (global $var_sexp_len (mut i32) (i32.const 0))
  (global $var_fexp_off (mut i32) (i32.const 0))
  (global $var_fexp_len (mut i32) (i32.const 0))
  ...
  (func (export "main") (result i32)
    ...
    (drop)
    (drop)
    ;; unimplemented builtin 'eval' in value ctx — empty string
    (i32.const 65536)
    (i32.const 0)
    (i32.const 65542)
    (i32.const 6)
    ...
    (i32.const 65579)
    (i32.const 3)
      (global.set $var_q_len)
      (global.set $var_q_off)
      (local.set $ok (i32.const 1))
      ;; sexp = ...
    ;; UNHANDLED EKind 8
    (i32.const 65536)
    (i32.const 0)
      (global.set $var_sexp_len)
      (global.set $var_sexp_off)
      (local.set $ok (i32.const 1))
      ;; subject eval
    (global.get $var_sexp_off)
    (global.get $var_sexp_len)
    (drop)
    (drop)
    ;; unimplemented builtin 'eval' in value ctx — empty string
    (i32.const 65536)
    ...
    (i32.const 65536)
    (i32.const 0)
      (global.set $var_fexp_len)
      (global.set $var_fexp_off)
      (local.set $ok (i32.const 1))
      ;; subject eval
    (global.get $var_fexp_off)
    (global.get $var_fexp_len)
      (drop)
      (drop)
      (i32.const 1) ;; builtin 'eval' — treated as succeed
      (local.set $ok)
      (if (i32.eqz (local.get $ok)) (then
