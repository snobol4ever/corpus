...
(module
  ...
  (data (i32.const 65536) "@aaaaaFAIL 1015/001: @ as binary dupl|stringFAIL 1015/002: | as unary sizePASS 1015_opsyn (2/2)")

  ;; SNOBOL4 variables: each → (offset, length) global pair
  (global $var_dupl_off (mut i32) (i32.const 0))
  (global $var_dupl_len (mut i32) (i32.const 0))
  (global $var_size_off (mut i32) (i32.const 0))
  (global $var_size_len (mut i32) (i32.const 0))
