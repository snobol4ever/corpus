...
(module
  ...
  (data (i32.const 65536) "pointxypoint(x,y)")
  ...
  (func $sno_data_init
    (local $fp i32)
    (local $ti i32)
    ;; DATA point: 2 field(s)
    (local.set $fp (call $sno_str_alloc (i32.const 16)))
    (i32.store (i32.add (local.get $fp) (i32.const 0)) (i32.const 65541))
    (i32.store (i32.add (local.get $fp) (i32.const 4)) (i32.const 1))
    (i32.store (i32.add (local.get $fp) (i32.const 8)) (i32.const 65542))
    (i32.store (i32.add (local.get $fp) (i32.const 12)) (i32.const 1))
  ...
  (func (export "main") (result i32)
    ...
    (i32.const 10)
      ...
      (local.set $ok)
      ;; P = ...
    (i32.const 0)  ;; type_idx for point
    (i32.const 2)  ;; nfields
    (call $sno_data_new)
    (local.set $arr_h)
    (i64.const 10)
