...
(module
  ...
  (data (i32.const 65536) "nodevalnextnode(val,next)helloabcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ")
  ...
  (func (export "main") (result i32)
    ...
    (block $datatype_done (result i32 i32)
      (if (i32.eq (call $sno_handle_type (local.get $arr_ok)) (i32.const 3)) (then
        ...
        (br $datatype_done)))
      (i32.const 65618) (i32.const 6)
    ) ;; $datatype_done
    (i32.const 65566) ;; &LCASE
    (i32.const 26)
    (i32.const 65592) ;; &UCASE
    (i32.const 26)
    (call $sno_replace)
      (call $sno_output_str)
      (local.set $ok (i32.const 1))
