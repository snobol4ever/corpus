...
(module
  ...
  (data (i32.const 65536) "complexrealimagcomplex(real,imag)")
  ...
  (func $sno_data_init
    (local $fp i32)
    (local $ti i32)
    ;; DATA complex: 2 field(s)
    (local.set $fp (call $sno_str_alloc (i32.const 16)))
    (i32.store (i32.add (local.get $fp) (i32.const 0)) (i32.const 65543))
    (i32.store (i32.add (local.get $fp) (i32.const 4)) (i32.const 4))
    (i32.store (i32.add (local.get $fp) (i32.const 8)) (i32.const 65547))
    (i32.store (i32.add (local.get $fp) (i32.const 12)) (i32.const 4))
    (local.set $ti (call $sno_data_define
      (i32.const 65536) (i32.const 7)
  ...
  (func (export "main") (result i32)
    ...
    (i32.const 18)
      ...
      (local.set $ok)
      ;; X = ...
    (i32.const 0)  ;; type_idx for complex
    (i32.const 2)  ;; nfields
    (call $sno_data_new)
    (local.set $arr_h)
    (i64.const 3)
