...
_pc = 38; continue dispatch;
    case 48: /* uid12 PROCEED */
        ...
        if (_subj2.slice(_cur2, _cur2+3) !== "FOO") { _pc = 28; continue dispatch;
 }
...
/* line 4 */
    var _v14 = _cat("PASS W07/001: imm cap=", _vars["CAP1"]);
...
/* line 5 */
    var _v15 = "FAIL W07/001: imm capture should match";
...
_pc = 98; continue dispatch;
    case 108: /* uid27 PROCEED */
        ...
        if (_subj17.slice(_cur17, _cur17+3) !== "BAR") { _pc = 88; continue dispatch;
 }
...
/* line 8 */
    var _v29 = _cat("PASS W07/002: imm cap BAR=", _vars["CAP2"]);
...
/* line 9 */
    var _v30 = "FAIL W07/002: BAR capture should match";
