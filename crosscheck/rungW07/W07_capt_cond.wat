...
(module
  ...
  (data (i32.const 65536) "HELLO WORLDHELLOPASS W07/001: cond cap=FAIL W07/001: cond capture should matchABCXYZPASS W07/002: cond cap correctly failsFAIL W07/002: failed match should not succeed")
  ...
  (func (export "main") (result i32)
    ...
    (global.get $var_subject_len)
      ...
      ;; E_CAPT_COND .cap1: save cursor, run child, capture on success
    ...
    (global.get $var_subject_len)
      ...
      (local.set $pat_subj_off)
      (local.set $pat_cursor (i32.const 0))
      ;; E_CAPT_COND .cap2: save cursor, run child, capture on success
      (local.set $pat_before (local.get $pat_cursor))
      ;; E_QLIT pattern node: sno_pat_search
      (local.get $pat_subj_off) (local.get $pat_subj_len)
      (i32.const 65617) (i32.const 3)
      (local.get $pat_cursor)
      (call $sno_pat_search)
      (local.set $pat_cursor)
      (if (i32.ge_s (local.get $pat_cursor) (i32.const 0)) (then
