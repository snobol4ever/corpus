...
.Lx52_0:                mov              r14d, dword ptr [rbp + -40];         jmp   n7_match_assign_save_α
...
n28_match_begin_α:      mov              rdi, qword ptr [rsp + 0]             # var
                        ...
                        mov              r11, qword ptr [rip + rtccb+64]
                        mov              dword ptr [rbp + -40], 0             # start_δ
.Lx87_0:                mov              r14d, dword ptr [rbp + -40];         jmp   n29_match_assign_save_α
...
.Lx95_4:                mov              qword ptr [rip + rtccb+40], r8
                        mov              qword ptr [rip + rtccb+56], r10
                        mov              qword ptr [rip + rtccb+64], r11
                        call             rt_proc_call_epilogue_ω@PLT
                        mov              r8,  qword ptr [rip + rtccb+40]
                        ...
                        mov              r10, qword ptr [rip + rtccb+56]
                        mov              r11, qword ptr [rip + rtccb+64];     jmp   .Lx95_1
.Lx95_2:                call             rt_dcap_end_ok_close@PLT
                        add              rsp, 8
                        pop              r13
                        pop              r15
                        pop              r14
