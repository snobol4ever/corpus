...
n10_statement_begin_β:  mov              r11, 11;                             jmp   n35_statement_begin_α
#-----------------------------------------------------------------------------------------------------------------------
...
.Lx90_0:                lea              rdi, [rsp + 32]                      # a
                        lea              rsi, [rsp + 16]                      # b
                        call             rt_cmp_d@PLT
                        test             eax, eax;                            js    .Lx90_240
                        add              rsp, 16;                             jmp   n14_coerce_numeric_β
.Lx90_240:                                                                    jmp   n16_var_α
n15_cmp_test_β:         mov              r11, 16
                        add              rsp, 16;                             jmp   n14_coerce_numeric_β
#-----------------------------------------------------------------------------------------------------------------------
...
n20_statement_end_α:    mov              r11, 21
                        mov              r10, 3
                        add              rsp, 128;                            jmp   n21_statement_begin_α
#=======================================================================================================================
...
n32_statement_end_α:    mov              r11, 33
                        mov              r10, 4
                        add              rsp, 144;                            jmp   n33_statement_begin_α
#=======================================================================================================================
#         :(cl)
#-----------------------------------------------------------------------------------------------------------------------
n33_statement_begin_α:  mov              r11, 34
                        mov              r10, 5;                              jmp   n34_statement_end_α
n33_statement_begin_β:  mov              r11, 34;                             jmp   n10_statement_begin_α
#-----------------------------------------------------------------------------------------------------------------------
n34_statement_end_α:    mov              r11, 35
                        mov              r10, 5;                              jmp   n10_statement_begin_α
#=======================================================================================================================
# rd      OUTPUT = SIZE(BIG)
#-----------------------------------------------------------------------------------------------------------------------
...
#-----------------------------------------------------------------------------------------------------------------------
n43_match_pos_α:        mov              r11, 44
                        mov              rax, 0
                        cmp              r14d, eax;                           jne   n42_match_begin_β
                                                                              jmp   n44_match_assign_save_α
n43_match_pos_β:        mov              r11, 44;                             jmp   n42_match_begin_β
#-----------------------------------------------------------------------------------------------------------------------
...
n53_statement_begin_α:  mov              r11, 54
                        mov              r10, 9;                              jmp   n54_var_α
n53_statement_begin_β:  mov              r11, 54;                             jmp   n62_statement_begin_α
#-----------------------------------------------------------------------------------------------------------------------
