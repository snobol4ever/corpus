...
n112_call_α:
                        ...
                        mov              qword ptr [rsp + 8], r11
                        .section         .rodata
.Lrkfnzd286:            .string          "nxt"
                        .section         .text
                        .intel_syntax    noprefix
                        lea              rdi, [rip + .Lrkfnzd286]                       # fn
                        lea              rsi, [rsp + 0]                                 # args
                        mov              edx, 1                                         # nargs
                        call             rt_call_arr@PLT
                        add              rsp, 16
...
n113_call_α:
                        ...
                        mov              qword ptr [rsp + 8], r11
                        .section         .rodata
.Lrkfnzd288:            .string          "val"
                        .section         .text
                        .intel_syntax    noprefix
                        lea              rdi, [rip + .Lrkfnzd288]                       # fn
                        lea              rsi, [rsp + 0]                                 # args
                        mov              edx, 1                                         # nargs
                        call             rt_call_arr@PLT
                        add              rsp, 16
