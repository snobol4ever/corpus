...
n10_assign_α:
                        ...
                        mov              qword ptr [1879052296], rdx                    # j3
...
n32_assign_α:
                        ...
                        mov              qword ptr [1879052360], rdx                    # I
                        add              rsp, 16
                                                                                        jmp   n33_var_α
#=======================================================================================================================
...
n33_var_α:
                        ...
                        mov              rdx, qword ptr [1879052360]                    # I
...
n43_lit_string_α:
                        ...
                        mov              qword ptr [rsp + 416], 1                       # lit_string
                        mov              dword ptr [rsp + 420], 1                       # lit_string
                        mov              rax, qword ptr [rip + .Lx88_0]
                        mov              qword ptr [rsp + 424], rax                     # lit_string
                                                                                        jmp   n44_var_α
.Lx88_0:
                        .quad            .Lx88_0_s
.Lx88_0_s:
...
n44_var_α:
                        mov              rax, qword ptr [1879052352]                    # I
                        mov              rdx, qword ptr [1879052360]                    # I
                        mov              qword ptr [rsp + 432], rax                     # I
                        mov              qword ptr [rsp + 440], rdx                     # I
                                                                                        jmp   n45_binop_α
#-----------------------------------------------------------------------------------------------------------------------
n45_binop_α:
...
#-----------------------------------------------------------------------------------------------------------------------
n46_lit_string_α:
                        mov              qword ptr [rsp + 528], 1                       # lit_string
                        mov              dword ptr [rsp + 532], 1                       # lit_string
                        mov              rax, qword ptr [rip + .Lx91_0]
                        mov              qword ptr [rsp + 536], rax                     # lit_string
...
#-----------------------------------------------------------------------------------------------------------------------
n47_lit_integer_α:
                        mov              qword ptr [rsp + 544], 6                       # lit_integer
                        mov              rax, qword ptr [rip + .Lx92_0]
                        mov              qword ptr [rsp + 552], rax                     # lit_integer
                                                                                        jmp   n48_call_α
.Lx92_0:
                        .quad            10
#-----------------------------------------------------------------------------------------------------------------------
...
n49_var_α:
                        mov              rax, qword ptr [1879052352]                    # I
                        mov              rdx, qword ptr [1879052360]                    # I
                        mov              qword ptr [rsp + 560], rax                     # I
                        mov              qword ptr [rsp + 568], rdx                     # I
                                                                                        jmp   n50_binop_α
#-----------------------------------------------------------------------------------------------------------------------
n50_binop_α:
...
n51_lit_string_α:
                        ...
                        mov              dword ptr [rsp + 596], 1                       # lit_string
...
n52_var_α:
                        mov              rax, qword ptr [1879052352]                    # I
                        mov              rdx, qword ptr [1879052360]                    # I
                        mov              qword ptr [rsp + 608], rax                     # I
                        mov              qword ptr [rsp + 616], rdx                     # I
                                                                                        jmp   n53_binop_α
#-----------------------------------------------------------------------------------------------------------------------
n53_binop_α:
...
n54_call_α:
                        ...
                        mov              rax, qword ptr [1879052344]                    # c
                        mov              qword ptr [rsp + 40], rax
                        mov              rax, qword ptr [1879052288]                    # j3
                        mov              qword ptr [rsp + 48], rax
                        mov              rax, qword ptr [1879052296]                    # j3
                        ...
                        mov              qword ptr [1879052344], rax                    # c
...
.Lx101_6:
                        ...
                        mov              rsi, qword ptr [1879052296]                    # j3
                        mov              rax, qword ptr [rsp + 48]
                        mov              qword ptr [1879052288], rax                    # j3
                        mov              rax, qword ptr [rsp + 56]
                        mov              qword ptr [1879052296], rax                    # j3
