...
_pc = 42; continue dispatch;
    case 44: /* uid11 PROCEED */
        ...
        if (_subj2.slice(_cur2, _cur2+3) !== "foo") { _pc = 40; continue dispatch;
 }
...
_pc = 40; continue dispatch;
    case 48: /* uid12 PROCEED */
        ...
        if (_subj2.slice(_cur2, _cur2+3) !== "baz") { _pc = 28; continue dispatch;
 }
...
/* line 6 */
    var _v14 = "PASS W03/001: alt first branch matched";
...
/* line 7 */
    var _v15 = "FAIL W03/001: alt first branch should match";
