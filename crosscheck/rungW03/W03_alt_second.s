...
n9_statement_begin_β:   mov              r11, 4;                              jmp   n11_statement_begin_α
#-----------------------------------------------------------------------------------------------------------------------
n10_statement_end_α:    mov              r11, 5
                        mov              r10, 1;                              jmp   n11_statement_begin_α
n10_statement_end_β:    mov              r11, 5;                              jmp   n11_statement_begin_α
#=======================================================================================================================
#         subject = 'foobar'
#-----------------------------------------------------------------------------------------------------------------------
n11_statement_begin_α:  mov              r11, 6
                        mov              r10, 2;                              jmp   n12_lit_string_α
n11_statement_begin_β:  mov              r11, 6;                              jmp   n15_statement_begin_α
#-----------------------------------------------------------------------------------------------------------------------
...
n12_lit_string_β:       mov              r11, 7
                        add              rsp, 16;                             jmp   n11_statement_begin_β
.Lx42_0:                .quad            .Lx42_0_s
.Lx42_0_s:              .string          "foobar"
#-----------------------------------------------------------------------------------------------------------------------
n13_assign_α:           mov              r11, 8
                        mov              rax, qword ptr [rsp + 0]             # lit_string
                        mov              rdx, qword ptr [rsp + 8]
                        mov              qword ptr [r9 + 0], rax              # subject
                        mov              qword ptr [r9 + 8], rdx;             jmp   n14_statement_end_α
n13_assign_β:           mov              r11, 8;                              jmp   n11_statement_begin_β
#-----------------------------------------------------------------------------------------------------------------------
n14_statement_end_α:    mov              r11, 9
                        mov              r10, 2
                        add              rsp, 16;                             jmp   n15_statement_begin_α
n14_statement_end_β:    mov              r11, 9
                        add              rsp, 16;                             jmp   n15_statement_begin_α
#=======================================================================================================================
#         pat = 'baz' | 'bar'
#-----------------------------------------------------------------------------------------------------------------------
n15_statement_begin_α:  mov              r11, 10
                        mov              r10, 3;                              jmp   n16_lit_string_α
n15_statement_begin_β:  mov              r11, 10;                             jmp   n20_statement_begin_α
#-----------------------------------------------------------------------------------------------------------------------
...
n17_call_β:             mov              r11, 12
                        add              rsp, 16
                        add              rsp, 16;                             jmp   n15_statement_begin_β
#-----------------------------------------------------------------------------------------------------------------------
n18_assign_α:           mov              r11, 13
                        mov              rax, qword ptr [rsp + 0]             # call
                        mov              rdx, qword ptr [rsp + 8]
                        mov              qword ptr [r9 + 16], rax             # pat
                        mov              qword ptr [r9 + 24], rdx;            jmp   n19_statement_end_α
n18_assign_β:           mov              r11, 13;                             jmp   n15_statement_begin_β
#-----------------------------------------------------------------------------------------------------------------------
n19_statement_end_α:    mov              r11, 14
                        mov              r10, 3
                        add              rsp, 32;                             jmp   n20_statement_begin_α
n19_statement_end_β:    mov              r11, 14
                        add              rsp, 32;                             jmp   n20_statement_begin_α
#=======================================================================================================================
#         subject pat              :f(e001)
#-----------------------------------------------------------------------------------------------------------------------
n20_statement_begin_α:  mov              r11, 15
                        mov              r10, 4;                              jmp   n21_var_α
n20_statement_begin_β:  mov              r11, 15;                             jmp   n32_statement_begin_α
#-----------------------------------------------------------------------------------------------------------------------
...
n21_var_β:              mov              r11, 16
                        add              rsp, 16;                             jmp   n32_statement_begin_α
#-----------------------------------------------------------------------------------------------------------------------
n22_match_begin_α:      mov              r11, 17
...
n22_match_begin_af:     mov              r11, 17
                        ...
                        add              rsp, 16;                             jmp   n32_statement_begin_α
#-----------------------------------------------------------------------------------------------------------------------
n23_match_alternate_α:  mov              r11, 18
                        sub              rsp, 32
...
n23_match_alternate_s0: mov              r11, 18
                        lea              rax, [rip + .Lx60_40]
                        mov              qword ptr [rsp + 8], rax;            jmp   n23_match_alternate_as
n23_match_alternate_s1: mov              r11, 18
                        lea              rax, [rip + .Lx60_41]
                        mov              qword ptr [rsp + 8], rax;            jmp   n23_match_alternate_as
.Lx60_40:                                                                     jmp   n27_match_lit_β
.Lx60_41:                                                                     jmp   n26_match_lit_β
n23_match_alternate_as: mov              r11, 18;                             jmp   n24_match_end_α
n23_match_alternate_β:  mov              r11, 18
                        mov              rax, qword ptr [rsp + 8];            jmp   rax
n23_match_alternate_af: mov              r11, 18
...
n25_statement_end_β:    mov              r11, 20
                        add              rsp, 16;                             jmp   n32_statement_begin_α
#-----------------------------------------------------------------------------------------------------------------------
n26_match_lit_α:        mov              r11, 21
                        mov              eax, r14d
                        add              eax, 3
...
n26_match_lit_β:        mov              r11, 21
                        sub              r14d, 3;                             jmp   n23_match_alternate_af
#-----------------------------------------------------------------------------------------------------------------------
n27_match_lit_α:        mov              r11, 22
                        mov              eax, r14d
                        add              eax, 3
                        cmp              eax, r15d;                           jg    n23_match_alternate_af
                        movsxd           rcx, r14d
...
n30_assign_β:           mov              r11, 25;                             jmp   n28_statement_begin_β
...
n31_statement_end_β:    mov              r11, 26
                        add              rsp, 16;                             jmp   main_γ
#=======================================================================================================================
...
n34_assign_β:           mov              r11, 29;                             jmp   n32_statement_begin_β
...
n35_statement_end_α:    mov              r11, 30
                        mov              r10, 6
                        add              rsp, 16;                             jmp   main_γ
n35_statement_end_β:    mov              r11, 30
                        add              rsp, 16;                             jmp   main_γ
#-----------------------------------------------------------------------------------------------------------------------
main_β:
                                                                              jmp   main_ω
