...
; ======================================================================================================================
                            mov         edi, 2
                            call        comm_stno
                            ASSIGN_STR  S_subject, S_42abc, Ln_0
                            jmp         Ln_0
...
P_1_α:                      SPAN_α      lit_str_1, 10, span0_saved, cursor, subject_data, subject_len_val, P_1_γ, P_1_ω ; SPAN α
P_1_β:                      SPAN_β      span0_saved, cursor, P_1_ω ; SPAN β
...
Ln_1:                       mov         edi, 4
                            call        comm_stno
                            LOAD_STR    S_PASS_SP_W05_SL_003_CL_SP_span_SP_matched
                            FAIL_BR     Lf_2
                            SET_OUTPUT
...
L_e001_0:                   mov         edi, 5
                            call        comm_stno
                            LOAD_STR    S_FAIL_SP_W05_SL_003_CL_SP_span_SP_should_SP_match
                            FAIL_BR     Ln_3
                            SET_OUTPUT
                            jmp         Ln_3
...
S_42abc              db 52, 50, 97, 98, 99, 0  ; "42abc"
...
S_PASS_SP_W05_SL_003_CL_SP_span_SP_matched db 80, 65, 83, 83, 32, 87, 48, 53, 47, 48, 48, 51, 58, 32, 115, 112, 97, 110, 32, 109, 97, 116, 99, 104, 101, 100, 0  ; "PASS W05/003: span matched"
S_e001               db 101, 48, 48, 49, 0  ; "e001"
S_FAIL_SP_W05_SL_003_CL_SP_span_SP_should_SP_match db 70, 65, 73, 76, 32, 87, 48, 53, 47, 48, 48, 51, 58, 32, 115, 112, 97, 110, 32, 115, 104, 111, 117, 108, 100, 32, 109, 97, 116, 99, 104, 0  ; "FAIL W05/003: span should match"
