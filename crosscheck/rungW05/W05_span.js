...
_pc = 16; continue dispatch;
    case 32: /* uid8 PROCEED */
        { var _start8 = _cur2;
          while (_cur2 < _slen2 && "0123456789".indexOf(_subj2[_cur2]) >= 0) _cur2++;
          _saved[8] = _cur2 - _start8;
          if (_saved[8] === 0) { _pc = 28; continue dispatch;
 } }
_pc = 12; continue dispatch;
    case 34: /* uid8 CONCEDE */
        if (_saved[8] <= 1) { _cur2 -= _saved[8]; _saved[8] = 0; _pc = 28; continue dispatch;
 }
        _saved[8]--; _cur2--;
_pc = 12; continue dispatch;
...
goto_v__C9 = function() {
/* line 4 */
    var _v10 = "PASS W05/003: span matched";
...
/* line 5 */
    var _v11 = "FAIL W05/003: span should match";
