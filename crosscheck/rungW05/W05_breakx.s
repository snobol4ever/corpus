...
; ======================================================================================================================
                            mov         edi, 2
                            call        comm_stno
                            ASSIGN_STR  S_subject, S_key_CL_value, Ln_0
                            jmp         Ln_0
...
P_1_α:                      BREAKX_α_LIT lit_str_1, brkx0_saved, cursor, subject_data, subject_len_val, P_1_γ, P_1_ω ; BREAKX(lit) α
P_1_β:                      BREAKX_β_LIT brkx0_saved, cursor, P_1_ω ; BREAKX(lit) β
...
Ln_1:                       mov         edi, 4
                            call        comm_stno
                            LOAD_STR    S_PASS_SP_W05_SL_005_CL_SP_breakx_SP_matched
                            FAIL_BR     Lf_2
                            SET_OUTPUT
...
L_e001_0:                   mov         edi, 5
                            call        comm_stno
                            LOAD_STR    S_FAIL_SP_W05_SL_005_CL_SP_breakx_SP_should_SP_match
                            FAIL_BR     Ln_3
                            SET_OUTPUT
                            jmp         Ln_3
...
S_key_CL_value       db 107, 101, 121, 58, 118, 97, 108, 117, 101, 0  ; "key:value"
S_BREAKX             db 66, 82, 69, 65, 75, 88, 0  ; "BREAKX"
S_CL                 db 58, 0  ; ":"
S_OUTPUT             db 79, 85, 84, 80, 85, 84, 0  ; "OUTPUT"
S_PASS_SP_W05_SL_005_CL_SP_breakx_SP_matched db 80, 65, 83, 83, 32, 87, 48, 53, 47, 48, 48, 53, 58, 32, 98, 114, 101, 97, 107, 120, 32, 109, 97, 116, 99, 104, 101, 100, 0  ; "PASS W05/005: breakx matched"
S_e001               db 101, 48, 48, 49, 0  ; "e001"
S_FAIL_SP_W05_SL_005_CL_SP_breakx_SP_should_SP_match db 70, 65, 73, 76, 32, 87, 48, 53, 47, 48, 48, 53, 58, 32, 98, 114, 101, 97, 107, 120, 32, 115, 104, 111, 117, 108, 100, 32, 109, 97, 116, 99, 104, 0  ; "FAIL W05/005: breakx should match"
