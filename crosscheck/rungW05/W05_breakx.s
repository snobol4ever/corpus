...
.Lx28_0:                mov              r14d, dword ptr [rbp + -40];         jmp   n7_match_breakx_α
...
.Lx30_240:              movzx            esi, byte ptr [r13+rcx]
                        cmp              esi, 58;                             je    .Lx30_1
                        add              ecx, 1;                              jmp   .Lx30_0
.Lx30_1:                mov              r14d, ecx;                           jmp   n8_match_end_α
n7_match_breakx_β:      movsxd           rcx, r14d
                        add              ecx, 1
.Lx30_2:                cmp              ecx, r15d;                           jge   .Lx30_4
                        movzx            esi, byte ptr [r13+rcx]
                        cmp              esi, 58;                             je    .Lx30_3
                        add              ecx, 1;                              jmp   .Lx30_2
.Lx30_3:                mov              r14d, ecx;                           jmp   n8_match_end_α
.Lx30_4:                mov              r14d, dword ptr [rsp + 4]
                        add              rsp, 16;                             jmp   n6_match_begin_β
#-----------------------------------------------------------------------------------------------------------------------
...
.Lx37_0_s:              .string          "PASS W05/005: breakx matched"
#-----------------------------------------------------------------------------------------------------------------------
...
.Lx43_0_s:              .string          "FAIL W05/005: breakx should match"
#-----------------------------------------------------------------------------------------------------------------------
