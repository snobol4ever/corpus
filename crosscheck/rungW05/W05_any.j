...
.method static <clinit>()V
    ...
    putstatic       W05_any/sno_stdout Ljava/io/PrintStream;
    iconst_0
    putstatic       W05_any/sno_kw_TRIM I
    iconst_0
    putstatic       W05_any/sno_kw_ANCHOR I
    iconst_0
    putstatic       W05_any/sno_kw_STNO I
    iconst_m1
    putstatic       W05_any/sno_kw_STLIMIT I
    iconst_0
    putstatic       W05_any/sno_kw_STCOUNT I
    new java/util/HashMap
    dup
    invokespecial java/util/HashMap/<init>()V
    putstatic       W05_any/sno_vars Ljava/util/HashMap;
    new java/util/HashMap
    dup
    invokespecial java/util/HashMap/<init>()V
    putstatic       W05_any/sno_arrays Ljava/util/HashMap;
    new java/util/HashMap
    dup
    invokespecial java/util/HashMap/<init>()V
    putstatic       W05_any/sno_data_types Ljava/util/HashMap;
    ldc             ""
    putstatic       W05_any/sno_var_subject Ljava/lang/String;
    getstatic       W05_any/sno_vars Ljava/util/HashMap;
    ldc             "subject"
    ldc             ""
...
.method static sno_mon_init()V
    ...
    putstatic W05_any/sno_mon_fd Ljava/io/OutputStream;
    ldc "MONITOR_GO_PIPE"
    invokestatic java/lang/System/getenv(Ljava/lang/String;)Ljava/lang/String;
    astore_1
    aload_1
    ...
    putstatic W05_any/sno_mon_go_fd Ljava/io/InputStream;
Lsmi_done:
    return
.end method
...
.method public static main([Ljava/lang/String;)V
    ...
    invokestatic W05_any/sno_mon_init()V
    getstatic W05_any/sno_kw_STNO I
    iconst_1
    iadd
    putstatic W05_any/sno_kw_STNO I
    invokestatic W05_any/sno_stcount_tick()V
    ldc "hello"
    dup
    ifnonnull Lvar_ok_0
    pop
...
Lvar_ok_0:
    ldc "subject"
    swap
    invokestatic W05_any/sno_var_put(Ljava/lang/String;Ljava/lang/String;)V
Lvar_fail_0:
    getstatic W05_any/sno_kw_STNO I
    iconst_1
    iadd
...
; --- pattern match statement ---
    ldc "subject"
    invokestatic W05_any/sno_indr_get(Ljava/lang/String;)Ljava/lang/String;
    astore 6
    iconst_0
    istore 7
    aload 6
...
Jpat0_tok:
    goto Jpat0_success
Jpat0_tfail:
    getstatic W05_any/sno_kw_ANCHOR I
    ifeq Jpat0_askip
    goto Jpat0_fail
Jpat0_askip:
    iinc 7 1
...
Jpat0_after:
    ...
    putstatic W05_any/sno_kw_STNO I
    invokestatic W05_any/sno_stcount_tick()V
    ldc "PASS W05/001: any matched"
    dup
    ifnonnull Lout_ok_0
    pop
    goto Lout_fail_0
Lout_ok_0:
    getstatic W05_any/sno_stdout Ljava/io/PrintStream;
    swap
...
L_e001:
    ...
    putstatic W05_any/sno_kw_STNO I
    invokestatic W05_any/sno_stcount_tick()V
    ldc "FAIL W05/001: any should match"
    dup
    ifnonnull Lout_ok_1
    pop
    goto Lout_fail_1
...
Lkwg_not_stno:
    ...
    invokevirtual java/lang/String/equalsIgnoreCase(Ljava/lang/String;)Z
    ifeq Lkwg_not_trim
    getstatic W05_any/sno_kw_TRIM I
    invokestatic java/lang/Integer/toString(I)Ljava/lang/String;
    areturn
Lkwg_not_trim:
    aload_0
...
Lkwg_not_anchor:
    ...
    getstatic W05_any/sno_kw_STLIMIT I
    invokestatic java/lang/Integer/toString(I)Ljava/lang/String;
    areturn
Lkwg_not_stlimit:
    aload_0
    ...
    getstatic W05_any/sno_kw_STCOUNT I
    invokestatic java/lang/Integer/toString(I)Ljava/lang/String;
    areturn
Lkwg_not_stcount:
    ldc ""
...
Lsvp_not_output:
    ...
    aload_0
    aload_1
    invokestatic W05_any/sno_mon_var(Ljava/lang/String;Ljava/lang/String;)V
    return
.end method
...
.method static sno_mon_var(Ljava/lang/String;Ljava/lang/String;)V
    .limit stack 6
    .limit locals 3
    getstatic W05_any/sno_mon_fd Ljava/io/OutputStream;
    ifnull Lsmv_done
    new java/lang/StringBuilder
    dup
    invokespecial java/lang/StringBuilder/<init>()V
    ...
    getstatic W05_any/sno_mon_go_fd Ljava/io/InputStream;
    ifnull Lsmv_done
    getstatic W05_any/sno_mon_go_fd Ljava/io/InputStream;
