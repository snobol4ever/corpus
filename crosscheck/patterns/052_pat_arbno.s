...
n9_match_arbno_α:       mov              r11, 10
                        ...
                        mov              dword ptr [rsp + 4], r14d;           jmp   n10_match_assign_cond_α
n9_match_arbno_β:       mov              r11, 10;                             jmp   n14_match_lit_α
...
n14_match_lit_β:        mov              r11, 15
                        sub              r14d, 1;                             jmp   n9_match_arbno_af
#=======================================================================================================================
#         OUTPUT = 'fail'
#-----------------------------------------------------------------------------------------------------------------------
...
n19_statement_begin_α:  mov              r11, 20
                        mov              r10, 4;                              jmp   n20_statement_end_α
