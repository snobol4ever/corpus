...
n74_match_arbno_as:
                        mov              eax, dword ptr [rsp + 4]
                        cmp              r14d, eax
                                                                                        je    n83_match_defer_β
                        mov              dword ptr [rsp + 4], r14d
                                                                                        jmp   n75_lit_integer_α
n74_match_arbno_af:
                        mov              eax, dword ptr [rsp + 0]
                        cmp              r14d, eax
                                                                                        jne   n83_match_defer_β
                        add              rsp, 16
                                                                                        jmp   n73_match_pos_β
#-----------------------------------------------------------------------------------------------------------------------
n75_lit_integer_α:
...
n93_match_arbno_as:
                        mov              eax, dword ptr [rsp + 4]
                        cmp              r14d, eax
                                                                                        je    n102_match_defer_β
                        mov              dword ptr [rsp + 4], r14d
                                                                                        jmp   n94_lit_integer_α
n93_match_arbno_af:
                        mov              eax, dword ptr [rsp + 0]
                        cmp              r14d, eax
                                                                                        jne   n102_match_defer_β
                        add              rsp, 16
                                                                                        jmp   n92_match_pos_β
#-----------------------------------------------------------------------------------------------------------------------
n94_lit_integer_α:
...
n111_match_pos_α:
                        ...
                        cmp              r14d, eax
                                                                                        je    .Lx383_240
                        add              rsp, 16
                                                                                        jmp   n109_match_begin_β
.Lx383_240:
                                                                                        jmp   n112_match_arbno_α
n111_match_pos_β:
                        add              rsp, 16
                                                                                        jmp   n109_match_begin_β
#-----------------------------------------------------------------------------------------------------------------------
...
.Lx398_11:
                        ...
                        lea              r11, [rip + .Lx398_5]
                                                                                        jmp   rax
.Lx398_4:
                                                                                        jmp   n112_match_arbno_as
.Lx398_5:
                                                                                        jmp   n112_match_arbno_af
.Lx398_0:
                        push             r14
                        push             r15
                        push             r13
...
n131_match_arbno_af:
                        mov              eax, dword ptr [rsp + 0]
                        cmp              r14d, eax
                                                                                        jne   n140_match_defer_β
                        add              rsp, 16
                                                                                        jmp   n130_match_pos_β
#-----------------------------------------------------------------------------------------------------------------------
n132_lit_integer_α:
                        sub              rsp, 16
                        mov              qword ptr [rsp + 0], 3                         # result
...
n133_match_rpos_α:
                        ...
                        cmp              r14d, ecx
                                                                                        je    .Lx415_240
                        add              rsp, 16
                                                                                        jmp   n131_match_arbno_β
.Lx415_240:
                                                                                        jmp   n134_match_end_α
#-----------------------------------------------------------------------------------------------------------------------
n134_match_end_α:
                        mov              r10, r12
.Lx417_9:
...
.Lx426_11:
                        ...
                        lea              r11, [rip + .Lx426_5]
                                                                                        jmp   rax
.Lx426_4:
                                                                                        jmp   n131_match_arbno_as
.Lx426_5:
                                                                                        jmp   n131_match_arbno_af
.Lx426_0:
                        push             r14
                        push             r15
                        push             r13
...
n189_match_arbno_as:
                        mov              eax, dword ptr [rsp + 4]
                        cmp              r14d, eax
                                                                                        je    n198_match_defer_β
                        mov              dword ptr [rsp + 4], r14d
                                                                                        jmp   n190_lit_integer_α
n189_match_arbno_af:
                        mov              eax, dword ptr [rsp + 0]
                        cmp              r14d, eax
                                                                                        jne   n198_match_defer_β
                        add              rsp, 16
                                                                                        jmp   n188_match_pos_β
#-----------------------------------------------------------------------------------------------------------------------
n190_lit_integer_α:
                        sub              rsp, 16
                        mov              qword ptr [rsp + 0], 3                         # result
...
n207_match_pos_α:
                        ...
                        cmp              r14d, eax
                                                                                        je    .Lx524_240
                        add              rsp, 16
                                                                                        jmp   n205_match_begin_β
.Lx524_240:
                                                                                        jmp   n208_match_arbno_α
n207_match_pos_β:
                        add              rsp, 16
                                                                                        jmp   n205_match_begin_β
#-----------------------------------------------------------------------------------------------------------------------
...
n208_match_arbno_af:
                        mov              eax, dword ptr [rsp + 0]
                        cmp              r14d, eax
                                                                                        jne   n218_match_defer_β
                        add              rsp, 16
                                                                                        jmp   n207_match_pos_β
#-----------------------------------------------------------------------------------------------------------------------
n209_match_defer_α:
                        sub              rsp, 16
...
.Lx540_11:
                        ...
                        lea              r11, [rip + .Lx540_5]
                                                                                        jmp   rax
.Lx540_4:
                                                                                        jmp   n208_match_arbno_as
.Lx540_5:
                                                                                        jmp   n208_match_arbno_af
.Lx540_0:
                        push             r14
                        push             r15
                        push             r13
