...
n5_statement_α:
                        add              rsp, 48
                                                                                        jmp   n6_lit_string_α
proc_LBL__F_zw5s2_ω_d48:
                        add              rsp, 48
                                                                                        jmp   n6_lit_string_α
proc_LBL__F_zw5s2_ω_d32:
                        add              rsp, 32
                                                                                        jmp   n6_lit_string_α
proc_LBL__F_zw5s2_ω_d16:
                        add              rsp, 16
                                                                                        jmp   n6_lit_string_α
#=======================================================================================================================
#         JUNK = 'xxyy'
...
n8_statement_α:
                        add              rsp, 16
                                                                                        jmp   n9_var_α
proc_LBL__F_zw5s3_ω_d16:
                        add              rsp, 16
                                                                                        jmp   n9_var_α
proc_LBL__F_zw5s3_ω_d48:
                        add              rsp, 48
                                                                                        jmp   n9_var_α
#=======================================================================================================================
#         JUNK ? 'xx'
...
n90_match_lit_α:
                        ...
                        add              eax, 1
                        cmp              eax, r15d
                                                                                        jg    n91_match_defer_β
                        movsxd           rcx, r14d
                        movzx            eax, byte ptr [r13+rcx]
                        cmp              eax, 90
                                                                                        jne   n91_match_defer_β
                        add              r14d, 1
                                                                                        jmp   n80_match_end_α
n90_match_lit_β:
                        sub              r14d, 1
