...
n6_assign_α:
                        ...
                        mov              qword ptr [1879052328], rdx                    # JUNK
                        add              rsp, 16
                                                                                        jmp   n7_var_α
#=======================================================================================================================
#         JUNK ? 'xx'
...
n7_var_α:
                        ...
                        mov              rdx, qword ptr [1879052328]                    # JUNK
                        mov              qword ptr [rsp + 0], rax                       # JUNK
                        mov              qword ptr [rsp + 8], rdx                       # JUNK
                                                                                        jmp   n8_match_head_α
#-----------------------------------------------------------------------------------------------------------------------
n8_match_head_α:
...
n12_assign_α:
                        ...
                        mov              qword ptr [1879052296], rdx                    # F
...
n38_call_α:
                        ...
                        mov              rax, qword ptr [1879052296]                    # F
...
.Lx41_6:
                        ...
                        mov              rsi, qword ptr [1879052296]                    # F
                        mov              rax, qword ptr [rsp + 0]
                        mov              qword ptr [1879052288], rax                    # F
                        mov              rax, qword ptr [rsp + 8]
                        mov              qword ptr [1879052296], rax                    # F
                        add              rsp, 16
...
n39_assign_α:
                        ...
                        mov              qword ptr [1879052344], rdx                    # EXPR$0
                        add              rsp, 16
                                                                                        jmp   proc_EXPR$0_γ
#-----------------------------------------------------------------------------------------------------------------------
proc_EXPR$0_res:
...
n44_assign_α:
                        ...
                        mov              qword ptr [1879052360], rdx                    # EXPR$1
                        add              rsp, 16
                                                                                        jmp   proc_EXPR$1_γ
#-----------------------------------------------------------------------------------------------------------------------
proc_EXPR$1_res:
...
.Lx118_0:
                        mov              r14d, dword ptr [rbp + 464]                    # start_δ
                                                                                        jmp   n62_match_sequence_α
n61_match_head_β:
                        add              dword ptr [rbp + 464], 1                       # start_δ
                        mov              eax, dword ptr [rbp + 464]                     # start_δ
                        cmp              eax, r15d
                                                                                        jg    .Lx118_1
                        lea              rcx, [rip + g_anchor]
                        mov              rax, qword ptr [rcx]
