...
n4_statement_begin_β:                                                         jmp   n20_statement_begin_α
#-----------------------------------------------------------------------------------------------------------------------
n5_var_α:               sub              rsp, 16
...
n5_var_β:               add              rsp, 16;                             jmp   n20_statement_begin_α
#-----------------------------------------------------------------------------------------------------------------------
...
.Lx34_0:                mov              r14d, dword ptr [rbp + -40];         jmp   n7_match_pos_α
...
.Lx40_3:                mov              qword ptr [rip + rtccb+40], r8
                        ...
                        mov              r9,  qword ptr [rip + rtccb+48]
                        mov              r10, qword ptr [rip + rtccb+56]
                        mov              r11, qword ptr [rip + rtccb+64];     jmp   .Lx40_1
.Lx40_4:                mov              qword ptr [rip + rtccb+40], r8
                        mov              qword ptr [rip + rtccb+56], r10
                        mov              qword ptr [rip + rtccb+64], r11
                        ...
                        mov              r10, qword ptr [rip + rtccb+56]
                        mov              r11, qword ptr [rip + rtccb+64];     jmp   .Lx40_1
.Lx40_2:                call             rt_dcap_end_ok_close@PLT
                        add              rsp, 8
                        pop              r13
                        pop              r15
                        pop              r14
...
.Lx44_19:               add              rsp, 32;                             jmp   n8_match_fence1_af
#-----------------------------------------------------------------------------------------------------------------------
n13_match_lit_α:        mov              eax, r14d
                        ...
                        cmp              eax, 65;                             jne   n12_match_alternate_af
                        movzx            eax, byte ptr [r13+rcx+1]
                        cmp              eax, 66;                             jne   n12_match_alternate_af
                        movzx            eax, byte ptr [r13+rcx+2]
                        cmp              eax, 67;                             jne   n12_match_alternate_af
                        add              r14d, 3;                             jmp   n12_match_alternate_s2
n13_match_lit_β:        sub              r14d, 3;                             jmp   n12_match_alternate_af
#-----------------------------------------------------------------------------------------------------------------------
...
n14_match_lit_β:        sub              r14d, 2;                             jmp   n12_match_alternate_af
#-----------------------------------------------------------------------------------------------------------------------
...
.Lx53_0_s:              .string          "should not reach"
#-----------------------------------------------------------------------------------------------------------------------
