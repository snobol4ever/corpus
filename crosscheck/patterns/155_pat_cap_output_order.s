...
.Lx20_13:               lea              rsp, [rbp + -88]                     # retry_whack
...
n3_match_assign_save_α: sub              rsp, 16
                        mov              r11, 4
                        mov              dword ptr [rbp + -64], r14d;         jmp   n4_match_alternate_α
...
n4_match_alternate_as:  mov              r11, 5;                              jmp   n5_match_assign_cond_α
...
n5_match_assign_cond_β: mov              r11, 6
                        sub              r12, 24;                             jmp   n4_match_alternate_β
#-----------------------------------------------------------------------------------------------------------------------
n6_match_assign_save_α: sub              rsp, 16
                        mov              r11, 7
                        mov              dword ptr [rbp + -80], r14d;         jmp   n7_match_alternate_α
n6_match_assign_save_β: mov              r11, 7
                        add              rsp, 16;                             jmp   n5_match_assign_cond_β
#-----------------------------------------------------------------------------------------------------------------------
...
n7_match_alternate_s1:  mov              r11, 8
                        lea              rax, [rip + .Lx30_41]
                        mov              qword ptr [rsp + 8], rax;            jmp   n7_match_alternate_as
n7_match_alternate_s2:  mov              r11, 8
                        lea              rax, [rip + .Lx30_42]
                        mov              qword ptr [rsp + 8], rax;            jmp   n7_match_alternate_as
.Lx30_40:                                                                     jmp   n13_match_lit_β
.Lx30_41:                                                                     jmp   n12_match_lit_β
.Lx30_42:                                                                     jmp   n11_match_lit_β
n7_match_alternate_as:  mov              r11, 8;                              jmp   n8_match_assign_cond_α
...
n8_match_assign_cond_β: mov              r11, 9
                        sub              r12, 24;                             jmp   n7_match_alternate_β
#-----------------------------------------------------------------------------------------------------------------------
