...
n1_match_arbno_β:                                                             jmp   n3_match_len_α
...
n3_match_len_β:         sub              r14d, 1;                             jmp   n1_match_arbno_af
#-----------------------------------------------------------------------------------------------------------------------
PAT$0_res:
...
.Lx41_0_s:              .string          "AB"
#-----------------------------------------------------------------------------------------------------------------------
n16_match_begin_α:      mov              rdi, qword ptr [rsp + 0]             # lit_string
...
.Lx43_13:               lea              rsp, [rbp + -56]                     # retry_whack
                        ...
                        cmp              rax, 0;                              jne   .Lx43_1
                                                                              jmp   .Lx43_0
.Lx43_1:
n16_match_begin_af:     mov              rcx, qword ptr [rip + rtccb@GOTPCREL] # mbc_restore
...
#-----------------------------------------------------------------------------------------------------------------------
n17_match_pos_α:        mov              rax, 0
                        cmp              r14d, eax;                           jne   n16_match_begin_β
                                                                              jmp   n18_match_arbno_α
n17_match_pos_β:                                                              jmp   n16_match_begin_β
#-----------------------------------------------------------------------------------------------------------------------
n18_match_arbno_α:      sub              rsp, 16
                        mov              dword ptr [rsp + 0], r14d
                        mov              dword ptr [rsp + 4], r14d;           jmp   n19_match_rpos_α
n18_match_arbno_β:                                                            jmp   n22_match_len_α
n18_match_arbno_as:     mov              eax, dword ptr [rsp + 4]
                        cmp              r14d, eax;                           je    n22_match_len_β
                        mov              dword ptr [rsp + 4], r14d;           jmp   n19_match_rpos_α
n18_match_arbno_af:     mov              eax, dword ptr [rsp + 0]
...
n22_match_len_β:        sub              r14d, 1;                             jmp   n18_match_arbno_af
#=======================================================================================================================
# WIN     OUTPUT = 'PASS'            :(END)
#-----------------------------------------------------------------------------------------------------------------------
