...
.Lx40_0:                mov              r14d, dword ptr [rbp + -40];         jmp   n17_match_defer_α
n16_match_begin_β:      lea              rsp, [rbp + -56]                     # retry_whack
                        ...
                        cmp              rax, 0;                              jne   .Lx40_1
                                                                              jmp   .Lx40_0
.Lx40_1:
n16_match_begin_af:     mov              r12, qword ptr [rbp + -8]            # cas_mark
...
.Lx41_9:                xor              eax, eax
.Lx41_10:               lea              rsi, [rip + g_sno_defer_cells+0]
                        mov              qword ptr [rsi + 0], rax
.Lx41_11:               test             rax, rax;                            jz    .Lx41_0
                        mov              r8d, 1
                        lea              r10, [rip + .Lx41_4]
                        lea              r11, [rip + .Lx41_5];                jmp   rax
.Lx41_4:                                                                      jmp   n18_match_end_α
.Lx41_5:                add              rsp, 16;                             jmp   n16_match_begin_β
.Lx41_0:                push             r14
                        push             r15
                        push             r13
                        sub              rsp, 8
...
.Lx41_3:                add              rsp, 8
                        ...
                        add              rsp, 16;                             jmp   n16_match_begin_β
.Lx41_240:              mov              r14d, eax
                        lea              rax, [rip + .Lx41_6]
                        sub              rsp, 8
                        push             rax;                                 jmp   n18_match_end_α
.Lx41_6:                add              rsp, 16
                        add              rsp, 16;                             jmp   n16_match_begin_β
