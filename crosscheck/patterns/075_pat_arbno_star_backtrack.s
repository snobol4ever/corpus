...
n3_lit_string_α:        sub              rsp, 16
                        ...
                        mov              qword ptr [rsp + 8], rax;            jmp   n4_match_begin_α
.Lx25_0:                .quad            .Lx25_0_s
.Lx25_0_s:              .string          "AB"
#-----------------------------------------------------------------------------------------------------------------------
n4_match_begin_α:       mov              rdi, qword ptr [rsp + 0]             # lit_string
...
.Lx27_0:                mov              r14d, dword ptr [rbp + -40]
                        ...
                        lea              rax, [rip + .Lx27_13]
                        mov              qword ptr [rcx + 248], rax;          jmp   n5_match_pos_α
n4_match_begin_β:
.Lx27_13:               lea              rsp, [rbp + -56]                     # retry_whack
                        ...
                        cmp              rax, 0;                              jne   .Lx27_1
                                                                              jmp   .Lx27_0
.Lx27_1:
n4_match_begin_af:      mov              rcx, qword ptr [rip + rtccb@GOTPCREL] # mbc_restore
...
#-----------------------------------------------------------------------------------------------------------------------
n5_match_pos_α:         mov              rax, 0
                        cmp              r14d, eax;                           jne   n4_match_begin_β
                                                                              jmp   n6_match_arbno_α
n5_match_pos_β:                                                               jmp   n4_match_begin_β
#-----------------------------------------------------------------------------------------------------------------------
n6_match_arbno_α:       sub              rsp, 16
                        mov              dword ptr [rsp + 0], r14d
                        mov              dword ptr [rsp + 4], r14d;           jmp   n7_match_rpos_α
n6_match_arbno_β:                                                             jmp   n10_match_len_α
n6_match_arbno_as:      mov              eax, dword ptr [rsp + 4]
                        cmp              r14d, eax;                           je    n10_match_len_β
                        mov              dword ptr [rsp + 4], r14d;           jmp   n7_match_rpos_α
n6_match_arbno_af:      mov              eax, dword ptr [rsp + 0]
                        cmp              r14d, eax;                           jne   n10_match_len_β
                        add              rsp, 16;                             jmp   n5_match_pos_β
#-----------------------------------------------------------------------------------------------------------------------
n7_match_rpos_α:        mov              rax, 0
                        mov              ecx, r15d
                        sub              ecx, eax
                        cmp              r14d, ecx;                           jne   n6_match_arbno_β
                                                                              jmp   n8_match_end_α
#-----------------------------------------------------------------------------------------------------------------------
...
n10_match_len_α:        mov              eax, r14d
                        add              eax, 1
                        cmp              eax, r15d;                           jg    n6_match_arbno_af
                        add              r14d, 1;                             jmp   n6_match_arbno_as
n10_match_len_β:        sub              r14d, 1;                             jmp   n6_match_arbno_af
#=======================================================================================================================
# WIN     OUTPUT = 'PASS'            :(END)
#-----------------------------------------------------------------------------------------------------------------------
