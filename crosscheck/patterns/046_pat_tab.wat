...
(module
  ...
  (func (export "main") (result i32)
    ...
    (global.get $var_X_len)
      ...
      ;; TAB: evaluate arg → $pat_n
    (i64.const 3)
      (i32.wrap_i64)
      (local.set $pat_n)
      (if (i32.or
            (i32.gt_s (local.get $pat_cursor) (local.get $pat_n))
            (i32.gt_s (local.get $pat_n) (local.get $pat_subj_len))) (then
        (local.set $pat_cursor (i32.const -1))
      ) (else
        (local.set $pat_cursor (local.get $pat_n))
      ))
