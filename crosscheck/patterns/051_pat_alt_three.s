...
n7_match_assign_save_α: sub              rsp, 16
                        mov              r11, 8
                        mov              dword ptr [rbp + -64], r14d;         jmp   n8_match_alternate_α
n7_match_assign_save_β: mov              r11, 8
                        add              rsp, 16;                             jmp   n6_match_begin_β
#-----------------------------------------------------------------------------------------------------------------------
n8_match_alternate_α:   mov              r11, 9
                        sub              rsp, 32
...
n8_match_alternate_s0:  mov              r11, 9
                        lea              rax, [rip + .Lx39_40]
                        mov              qword ptr [rsp + 8], rax;            jmp   n8_match_alternate_as
n8_match_alternate_s1:  mov              r11, 9
                        lea              rax, [rip + .Lx39_41]
                        mov              qword ptr [rsp + 8], rax;            jmp   n8_match_alternate_as
n8_match_alternate_s2:  mov              r11, 9
                        lea              rax, [rip + .Lx39_42]
                        mov              qword ptr [rsp + 8], rax;            jmp   n8_match_alternate_as
.Lx39_40:                                                                     jmp   n14_match_lit_β
.Lx39_41:                                                                     jmp   n13_match_lit_β
.Lx39_42:                                                                     jmp   n12_match_lit_β
n8_match_alternate_as:  mov              r11, 9;                              jmp   n9_match_assign_cond_α
n8_match_alternate_β:   mov              r11, 9
                        mov              rax, qword ptr [rsp + 8];            jmp   rax
n8_match_alternate_af:  mov              r11, 9
...
n9_match_assign_cond_β: mov              r11, 10
                        sub              r12, 24;                             jmp   n8_match_alternate_β
#-----------------------------------------------------------------------------------------------------------------------
...
n12_match_lit_β:        mov              r11, 13
                        sub              r14d, 6;                             jmp   n8_match_alternate_af
#-----------------------------------------------------------------------------------------------------------------------
...
n14_match_lit_β:        mov              r11, 15
                        sub              r14d, 5;                             jmp   n8_match_alternate_af
#=======================================================================================================================
#         OUTPUT = 'no match'
#-----------------------------------------------------------------------------------------------------------------------
...
n20_statement_end_β:    mov              r11, 21;                             jmp   main_γ
#=======================================================================================================================
# YES     OUTPUT = V
#-----------------------------------------------------------------------------------------------------------------------
