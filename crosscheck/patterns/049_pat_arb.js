...
_pc = 54; continue dispatch;
    case 64: /* uid16 PROCEED */
        { var _pat_val16 = _vars["ARB"];
          var _pat_s16 = (_pat_val16 === null || _pat_val16 === undefined) ? '' : String(_pat_val16);
          var _pat_n16 = _pat_s16.length;
          if (_cur2 + _pat_n16 > _slen2) { _pc = 28; continue dispatch;
 }
          if (_subj2.slice(_cur2, _cur2+_pat_n16) !== _pat_s16) { _pc = 28; continue dispatch;
 }
          _saved[16] = _cur2; _cur2 += _pat_n16; }
_pc = 60; continue dispatch;
    case 66: /* uid16 CONCEDE */
        _cur2 = _saved[16];
_pc = 28; continue dispatch;
    case 60: /* uid15 PROCEED */
        _vars["V"] = _subj2.slice(_saved[14], _cur2);
