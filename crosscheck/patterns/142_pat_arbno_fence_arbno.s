...
n24_match_defer_α:      mov              r11, 24
                        ...
                        lea              rdx, [rip + .S0]
                        cmp              rax, rdx;                            jne   .Lx68_30
                        mov              rax, qword ptr [rcx + 8]
                        mov              edx, dword ptr [rax + 0]
                        and              edx, 255
                        cmp              edx, 2;                              jne   .Lx68_30
                        mov              edx, dword ptr [rax + 4]
                        cmp              edx, 1;                              jne   .Lx68_30
                        movsxd           rcx, r14d
                        cmp              ecx, r15d;                           jge   .Lx68_31
                        movzx            esi, byte ptr [r13+rcx]
                        mov              rdi, qword ptr [rax + 8]
                        xor              edx, edx
                        movzx            edi, byte ptr [rdi + rdx]
                        cmp              esi, edi;                            jne   .Lx68_31
                        mov              edx, r14d
                        add              edx, 1;                              jmp   .Lx68_0
.Lx68_31:               mov              edx, -1;                             jmp   .Lx68_0
.Lx68_30:               push             r14
                        push             r15
                        push             r13
                        sub              rsp, 8
