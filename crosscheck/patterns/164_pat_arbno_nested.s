...
.Lx42_0:                mov              r14d, dword ptr [rbp + -40];         jmp   n3_match_pos_α
...
#-----------------------------------------------------------------------------------------------------------------------
n4_match_arbno_α:       mov              dword ptr [rbp + -64], r14d
                        mov              dword ptr [rbp + -60], r14d;         jmp   n5_match_rpos_α
n4_match_arbno_β:                                                             jmp   n8_match_arbno_α
n4_match_arbno_as:      mov              eax, dword ptr [rbp + -60]
                        cmp              r14d, eax;                           je    n8_match_arbno_β
                        mov              dword ptr [rbp + -60], r14d;         jmp   n5_match_rpos_α
n4_match_arbno_af:      mov              eax, dword ptr [rbp + -64]
                        cmp              r14d, eax;                           jne   n8_match_arbno_β
                                                                              jmp   n3_match_pos_β
#-----------------------------------------------------------------------------------------------------------------------
...
.Lx48_3:                mov              qword ptr [rip + rtccb+40], r8
                        mov              qword ptr [rip + rtccb+56], r10
                        mov              qword ptr [rip + rtccb+64], r11
                        ...
                        mov              r9,  qword ptr [rip + rtccb+48]
                        mov              r10, qword ptr [rip + rtccb+56]
                        mov              r11, qword ptr [rip + rtccb+64];     jmp   .Lx48_1
.Lx48_4:                mov              qword ptr [rip + rtccb+40], r8
                        mov              qword ptr [rip + rtccb+56], r10
                        mov              qword ptr [rip + rtccb+64], r11
                        ...
                        mov              r10, qword ptr [rip + rtccb+56]
                        mov              r11, qword ptr [rip + rtccb+64];     jmp   .Lx48_1
.Lx48_2:                call             rt_dcap_end_ok_close@PLT
                        add              rsp, 8
                        pop              r13
                        pop              r15
                        pop              r14
...
#-----------------------------------------------------------------------------------------------------------------------
n7_statement_end_α:     add              rsp, 16;                             jmp   n11_statement_begin_α
#-----------------------------------------------------------------------------------------------------------------------
n8_match_arbno_α:       sub              rsp, 16
                        mov              dword ptr [rsp + 0], r14d
                        mov              dword ptr [rsp + 4], r14d;           jmp   n9_match_lit_α
n8_match_arbno_β:                                                             jmp   n10_match_lit_α
...
n9_match_lit_β:         sub              r14d, 1;                             jmp   n8_match_arbno_β
#-----------------------------------------------------------------------------------------------------------------------
...
n10_match_lit_β:        sub              r14d, 1;                             jmp   n8_match_arbno_af
#=======================================================================================================================
# Y1 OUTPUT = '1:ok'                                            :(T2)
#-----------------------------------------------------------------------------------------------------------------------
...
n19_statement_begin_β:                                                        jmp   n34_statement_begin_α
#-----------------------------------------------------------------------------------------------------------------------
...
#-----------------------------------------------------------------------------------------------------------------------
n21_match_begin_α:      mov              rdi, qword ptr [rsp + 0]             # lit_string
                        mov              rsi, qword ptr [rsp + 8]
                        push             rbp
                        mov              rbp, rsp
                        push             r12                                  # cas_mark
                        ...
                        mov              r11, qword ptr [rip + rtccb+64]
                        mov              dword ptr [rbp + -40], 0             # start_δ
.Lx73_0:                mov              r14d, dword ptr [rbp + -40];         jmp   n22_match_pos_α
n21_match_begin_β:      lea              rsp, [rbp + -72]                     # retry_whack
                        add              dword ptr [rbp + -40], 1             # start_δ
                        mov              eax, dword ptr [rbp + -40]
...
#-----------------------------------------------------------------------------------------------------------------------
n22_match_pos_α:        mov              rax, 0
                        cmp              r14d, eax;                           jne   n21_match_begin_β
                                                                              jmp   n23_match_arbno_α
n22_match_pos_β:                                                              jmp   n21_match_begin_β
#-----------------------------------------------------------------------------------------------------------------------
n23_match_arbno_α:      mov              dword ptr [rbp + -64], r14d
                        mov              dword ptr [rbp + -60], r14d;         jmp   n24_match_rpos_α
n23_match_arbno_β:                                                            jmp   n27_match_arbno_α
n23_match_arbno_as:     mov              eax, dword ptr [rbp + -60]
                        cmp              r14d, eax;                           je    n27_match_arbno_β
                        mov              dword ptr [rbp + -60], r14d;         jmp   n24_match_rpos_α
n23_match_arbno_af:     mov              eax, dword ptr [rbp + -64]
                        cmp              r14d, eax;                           jne   n27_match_arbno_β
                                                                              jmp   n22_match_pos_β
#-----------------------------------------------------------------------------------------------------------------------
...
.Lx79_4:                mov              qword ptr [rip + rtccb+40], r8
                        mov              qword ptr [rip + rtccb+56], r10
                        mov              qword ptr [rip + rtccb+64], r11
                        call             rt_proc_call_epilogue_ω@PLT
                        mov              r8,  qword ptr [rip + rtccb+40]
                        ...
                        mov              r10, qword ptr [rip + rtccb+56]
                        mov              r11, qword ptr [rip + rtccb+64];     jmp   .Lx79_1
.Lx79_2:                call             rt_dcap_end_ok_close@PLT
                        add              rsp, 8
                        pop              r13
                        pop              r15
                        pop              r14
...
#-----------------------------------------------------------------------------------------------------------------------
n27_match_arbno_α:      sub              rsp, 16
                        mov              dword ptr [rsp + 0], r14d
                        mov              dword ptr [rsp + 4], r14d;           jmp   n28_match_lit_α
n27_match_arbno_β:                                                            jmp   n29_match_lit_α
n27_match_arbno_as:     mov              eax, dword ptr [rsp + 4]
                        cmp              r14d, eax;                           je    n29_match_lit_β
                        mov              dword ptr [rsp + 4], r14d;           jmp   n28_match_lit_α
n27_match_arbno_af:     mov              eax, dword ptr [rsp + 0]
...
n28_match_lit_β:        sub              r14d, 1;                             jmp   n27_match_arbno_β
#-----------------------------------------------------------------------------------------------------------------------
...
n29_match_lit_β:        sub              r14d, 1;                             jmp   n27_match_arbno_af
#=======================================================================================================================
# Y2 OUTPUT = '2:ok'                                            :(END)
#-----------------------------------------------------------------------------------------------------------------------
