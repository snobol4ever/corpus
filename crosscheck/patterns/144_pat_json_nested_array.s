...
n13_match_patref_α:
                        ...
                        mov              rdx, qword ptr [1879052296]                    # eps
                        cmp              eax, 3
                                                                                        jne   .Lx22_9
...
n15_match_defer_α:
                        ...
                        mov              rdx, qword ptr [1879052328]                    # layer
                        cmp              eax, 3
                                                                                        jne   .Lx25_9
                        mov              rax, qword ptr [rdx + 0]
                        test             rax, rax
...
n17_match_patref_α:
                        ...
                        mov              rdx, qword ptr [1879052312]                    # choose
                        cmp              eax, 3
                                                                                        jne   .Lx28_9
                        mov              rax, qword ptr [rdx + 0]
                        test             rax, rax
...
n31_assign_α:
                        ...
                        mov              qword ptr [1879052296], rdx                    # eps
                        add              rsp, 32
                                                                                        jmp   n32_lit_string_α
#=======================================================================================================================
#         choose = FENCE('A' | 'B')
...
n34_assign_α:
                        ...
                        mov              qword ptr [1879052312], rdx                    # choose
                        add              rsp, 32
                                                                                        jmp   n35_lit_string_α
#=======================================================================================================================
...
n37_assign_α:
                        ...
                        mov              qword ptr [1879052328], rdx                    # layer
                        add              rsp, 32
                                                                                        jmp   n38_lit_string_α
#=======================================================================================================================
#         s      = 'A-A-B'
...
n39_assign_α:
                        ...
                        mov              qword ptr [1879052344], rdx                    # s
                        add              rsp, 16
                                                                                        jmp   n40_var_α
#=======================================================================================================================
...
n40_var_α:
                        ...
                        mov              rdx, qword ptr [1879052344]                    # s
