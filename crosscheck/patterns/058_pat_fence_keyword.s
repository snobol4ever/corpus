...
.Lx30_0:                mov              r14d, dword ptr [rbp + -40];         jmp   n7_match_len_α
n6_match_begin_β:       lea              rsp, [rbp + -56]                     # retry_whack
                        add              dword ptr [rbp + -40], 1             # start_δ
                        mov              eax, dword ptr [rbp + -40]
                        cmp              eax, r15d;                           jg    .Lx30_1
                        mov              rcx, qword ptr [rip + rt_anchor_g@GOTPCREL]
                        mov              rax, qword ptr [rcx]
                        cmp              rax, 0;                              jne   .Lx30_1
                                                                              jmp   .Lx30_0
.Lx30_1:
...
#-----------------------------------------------------------------------------------------------------------------------
n7_match_len_α:         mov              eax, r14d
                        add              eax, 1
                        cmp              eax, r15d;                           jg    n6_match_begin_β
                        add              r14d, 1;                             jmp   n8_match_fence1_α
n7_match_len_β:         sub              r14d, 1;                             jmp   n6_match_begin_β
#-----------------------------------------------------------------------------------------------------------------------
n8_match_fence1_α:                                                            jmp   n9_match_len_α
n8_match_fence1_β:                                                            jmp   n6_match_begin_β
#-----------------------------------------------------------------------------------------------------------------------
n9_match_len_α:         mov              eax, r14d
                        add              eax, 2
                        cmp              eax, r15d;                           jg    n6_match_begin_af
                        add              r14d, 2;                             jmp   n10_match_end_α
n9_match_len_β:         sub              r14d, 2;                             jmp   n6_match_begin_af
#-----------------------------------------------------------------------------------------------------------------------
...
.Lx36_3:                mov              qword ptr [rip + rtccb+40], r8
                        ...
                        mov              r9,  qword ptr [rip + rtccb+48]
                        mov              r10, qword ptr [rip + rtccb+56]
                        mov              r11, qword ptr [rip + rtccb+64];     jmp   .Lx36_1
.Lx36_4:                mov              qword ptr [rip + rtccb+40], r8
                        ...
                        mov              r10, qword ptr [rip + rtccb+56]
                        mov              r11, qword ptr [rip + rtccb+64];     jmp   .Lx36_1
.Lx36_2:                call             rt_dcap_end_ok_close@PLT
                        add              rsp, 8
                        pop              r13
                        pop              r15
                        pop              r14
...
.Lx41_0_s:              .string          "should not reach"
#-----------------------------------------------------------------------------------------------------------------------
...
.Lx47_0_s:              .string          "aborted correctly"
#-----------------------------------------------------------------------------------------------------------------------
