...
n34_lit_string_β:       add              rsp, 32;                             jmp   n32_lit_integer_β
...
#-----------------------------------------------------------------------------------------------------------------------
n39_statement_end_α:    add              rsp, 112;                            jmp   n40_statement_begin_α
#=======================================================================================================================
...
.Lx92_0:                mov              r14d, dword ptr [rbp + -40];         jmp   n43_match_pos_α
...
#-----------------------------------------------------------------------------------------------------------------------
n44_match_defer_α:      sub              rsp, 16
                        lea              rsi, [rip + g_sno_defer_cells+8]
                        mov              rax, qword ptr [rsi + 0]
                        test             rax, rax;                            jne   .Lx94_11
                        mov              rax, qword ptr [r9 + 16]             # B
                        mov              rdx, qword ptr [r9 + 24]
                        cmp              eax, 8;                              jne   .Lx94_9
                        mov              rax, qword ptr [rdx + 0]
                        ...
                        mov              r9,  qword ptr [rip + rtccb+48]
                        mov              r10, qword ptr [rip + rtccb+56]
                        mov              r11, qword ptr [rip + rtccb+64];     jmp   .Lx94_10
.Lx94_9:                xor              eax, eax
.Lx94_10:               lea              rsi, [rip + g_sno_defer_cells+8]
                        mov              qword ptr [rsi + 0], rax
.Lx94_11:               test             rax, rax;                            jz    .Lx94_0
                        mov              r8d, 0
                        lea              r10, [rip + .Lx94_4]
                        lea              r11, [rip + .Lx94_5];                jmp   rax
.Lx94_4:                                                                      jmp   n45_match_rpos_α
.Lx94_5:                add              rsp, 16;                             jmp   n42_match_begin_β
.Lx94_0:                push             r14
                        push             r15
                        push             r13
                        sub              rsp, 8
...
.Lx94_3:                add              rsp, 8
                        ...
                        mov              r10, qword ptr [rip + rtccb+56]
                        mov              r11, qword ptr [rip + rtccb+64]
                        test             eax, eax;                            jns   .Lx94_240
                        add              rsp, 16;                             jmp   n42_match_begin_β
.Lx94_240:              mov              r14d, eax
                        lea              rax, [rip + .Lx94_6]
                        sub              rsp, 8
                        push             rax;                                 jmp   n45_match_rpos_α
.Lx94_6:                add              rsp, 16
                        add              rsp, 16;                             jmp   n42_match_begin_β
...
n45_match_rpos_α:       mov              rax, 0
                        mov              ecx, r15d
                        sub              ecx, eax
                        cmp              r14d, ecx;                           jne   n42_match_begin_β
                                                                              jmp   n46_match_end_α
#-----------------------------------------------------------------------------------------------------------------------
...
.Lx97_4:                mov              qword ptr [rip + rtccb+40], r8
                        mov              qword ptr [rip + rtccb+56], r10
                        mov              qword ptr [rip + rtccb+64], r11
                        call             rt_proc_call_epilogue_ω@PLT
                        mov              r8,  qword ptr [rip + rtccb+40]
                        ...
                        mov              r10, qword ptr [rip + rtccb+56]
                        mov              r11, qword ptr [rip + rtccb+64];     jmp   .Lx97_1
.Lx97_2:                call             rt_dcap_end_ok_close@PLT
                        add              rsp, 8
                        pop              r13
                        pop              r15
                        pop              r14
...
.Lx102_0_s:             .string          "balanced depth 40"
#-----------------------------------------------------------------------------------------------------------------------
