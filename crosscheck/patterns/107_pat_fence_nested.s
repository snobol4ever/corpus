...
.Lx51_0:
                        .quad            .Lx51_0_s
.Lx51_0_s:
                        .string          "inner LEN(1) then outer alt LEN(2)"
#-----------------------------------------------------------------------------------------------------------------------
n16_assign_α:
...
n21_match_len_α:
                        ...
                        add              eax, 1
                        cmp              eax, r15d
                                                                                        jg    n20_match_fence1_af
                        add              r14d, 1
                                                                                        jmp   n20_match_fence1_as
n21_match_len_β:
                        sub              r14d, 1
                                                                                        jmp   n20_match_fence1_af
#=======================================================================================================================
