...
#-----------------------------------------------------------------------------------------------------------------------
n5_match_defer_α:       mov              rax, qword ptr [r9 + 64]             # PAT$1$V0
...
#-----------------------------------------------------------------------------------------------------------------------
n15_func_activate_α:    mov              rdi, qword ptr [rip + .Lx52_0]
                        mov              rsi, qword ptr [rip + .Lx52_1]
                        mov              edx, 0
                        mov              ecx, 0
                        mov              r8d, 0
                        lea              r9, [rip + proc_makeP_α]
                        mov              qword ptr [rip + rtccb+40], r8
                        mov              qword ptr [rip + rtccb+56], r10
                        mov              qword ptr [rip + rtccb+64], r11
...
n26_call_β:             add              rsp, 16;                             jmp   n25_lit_string_β
#-----------------------------------------------------------------------------------------------------------------------
...
.Lx75_0_s:              .string          "aaa"
#-----------------------------------------------------------------------------------------------------------------------
n31_assign_α:           mov              rax, qword ptr [rsp + 0]             # lit_string
                        mov              rdx, qword ptr [rsp + 8]
...
.Lx83_0:                mov              r14d, dword ptr [rbp + -40];         jmp   n36_match_pos_α
...
.Lx85_3:                add              rsp, 8
                        ...
                        mov              r10, qword ptr [rip + rtccb+56]
                        mov              r11, qword ptr [rip + rtccb+64]
                        test             eax, eax;                            jns   .Lx85_240
                        add              rsp, 16;                             jmp   n35_match_begin_β
.Lx85_240:              mov              r14d, eax
                        lea              rax, [rip + .Lx85_6]
                        sub              rsp, 8
...
.Lx88_3:                mov              qword ptr [rip + rtccb+40], r8
                        ...
                        mov              r9,  qword ptr [rip + rtccb+48]
                        mov              r10, qword ptr [rip + rtccb+56]
                        mov              r11, qword ptr [rip + rtccb+64];     jmp   .Lx88_1
.Lx88_4:                mov              qword ptr [rip + rtccb+40], r8
                        ...
                        mov              r10, qword ptr [rip + rtccb+56]
                        mov              r11, qword ptr [rip + rtccb+64];     jmp   .Lx88_1
.Lx88_2:                call             rt_dcap_end_ok_close@PLT
                        add              rsp, 8
                        pop              r13
                        pop              r15
                        pop              r14
...
.Lx93_0_s:              .string          "matched depth 3"
#-----------------------------------------------------------------------------------------------------------------------
