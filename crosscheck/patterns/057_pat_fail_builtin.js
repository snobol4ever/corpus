...
_pc = 28; continue dispatch;
    case 52: /* uid13 PROCEED */
        { var _pat_val13 = _vars["FAIL"];
          var _pat_s13 = (_pat_val13 === null || _pat_val13 === undefined) ? '' : String(_pat_val13);
          var _pat_n13 = _pat_s13.length;
          if (_cur2 + _pat_n13 > _slen2) { _pc = 44; continue dispatch;
 }
          if (_subj2.slice(_cur2, _cur2+_pat_n13) !== _pat_s13) { _pc = 44; continue dispatch;
 }
          _saved[13] = _cur2; _cur2 += _pat_n13; }
