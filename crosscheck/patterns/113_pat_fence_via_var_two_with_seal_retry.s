...
PAT$1_α_body:
                        ...
                        mov              qword ptr [rbp + -32], r12
#-----------------------------------------------------------------------------------------------------------------------
n9_match_alternate_α:   mov              dword ptr [rbp + -72], r14d
                        lea              rax, [rip + .Lx13_21]
...
n9_match_alternate_β:   mov              rax, qword ptr [rbp + -64];          jmp   rax
n9_match_alternate_af:  mov              r14d, dword ptr [rbp + -72]
                        mov              rax, qword ptr [rbp + -56];          jmp   rax
.Lx13_19:                                                                     jmp   PAT$1_ω
#-----------------------------------------------------------------------------------------------------------------------
...
n10_match_lit_β:        sub              r14d, 2;                             jmp   n9_match_alternate_af
#-----------------------------------------------------------------------------------------------------------------------
...
n11_match_lit_β:        sub              r14d, 1;                             jmp   n9_match_alternate_af
#-----------------------------------------------------------------------------------------------------------------------
PAT$1_res:
                        mov              rbp, qword ptr [rsp + 24]
                        add              rsp, 32
