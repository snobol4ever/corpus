...
.Lx70_0:                mov              r14d, dword ptr [rbp + -40];         jmp   n31_match_pos_α
n30_match_begin_β:      lea              rsp, [rbp + -56]                     # retry_whack
                        ...
                        cmp              rax, 0;                              jne   .Lx70_1
                                                                              jmp   .Lx70_0
.Lx70_1:
n30_match_begin_af:     mov              r12, qword ptr [rbp + -8]            # cas_mark
...
n32_match_defer_α:      sub              rsp, 16
                        ...
                        mov              r9,  qword ptr [rip + rtccb+48]
                        mov              r10, qword ptr [rip + rtccb+56]
                        mov              r11, qword ptr [rip + rtccb+64];     jmp   .Lx72_10
.Lx72_9:                xor              eax, eax
.Lx72_10:               lea              rsi, [rip + g_sno_defer_cells+0]
...
.Lx75_3:                mov              qword ptr [rip + rtccb+40], r8
                        mov              qword ptr [rip + rtccb+56], r10
                        mov              qword ptr [rip + rtccb+64], r11
                        call             rt_proc_call_epilogue_γ@PLT
                        mov              r8,  qword ptr [rip + rtccb+40]
                        ...
                        mov              r9,  qword ptr [rip + rtccb+48]
                        mov              r10, qword ptr [rip + rtccb+56]
                        mov              r11, qword ptr [rip + rtccb+64];     jmp   .Lx75_1
.Lx75_4:                mov              qword ptr [rip + rtccb+40], r8
                        mov              qword ptr [rip + rtccb+56], r10
                        mov              qword ptr [rip + rtccb+64], r11
                        call             rt_proc_call_epilogue_ω@PLT
                        mov              r8,  qword ptr [rip + rtccb+40]
                        ...
                        mov              r10, qword ptr [rip + rtccb+56]
                        mov              r11, qword ptr [rip + rtccb+64];     jmp   .Lx75_1
.Lx75_2:                call             rt_dcap_end_ok_close@PLT
                        add              rsp, 8
                        pop              r13
                        pop              r15
                        pop              r14
