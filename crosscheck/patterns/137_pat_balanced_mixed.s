...
n32_match_patref_α:
                        ...
                        mov              rdx, qword ptr [1879052312]                    # open
                        cmp              eax, 3
                                                                                        jne   .Lx38_9
...
n34_match_patref_α:
                        ...
                        mov              rdx, qword ptr [1879052328]                    # close
                        cmp              eax, 3
                                                                                        jne   .Lx41_9
                        mov              rax, qword ptr [rdx + 0]
                        test             rax, rax
...
n51_assign_α:
                        ...
                        mov              qword ptr [1879052312], rdx                    # open
                        add              rsp, 32
                                                                                        jmp   n52_lit_string_α
#=======================================================================================================================
#         close  = ')' | ']' | '}' | '>'
...
n54_assign_α:
                        ...
                        mov              qword ptr [1879052328], rdx                    # close
                        add              rsp, 32
                                                                                        jmp   n55_lit_string_α
#=======================================================================================================================
...
n57_assign_α:
                        ...
                        mov              qword ptr [1879052344], rdx                    # B
                        add              rsp, 32
                                                                                        jmp   n58_lit_string_α
#=======================================================================================================================
#         s      = '([{<>}])'
