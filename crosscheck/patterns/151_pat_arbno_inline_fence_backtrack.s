...
n8_match_arbno_α:       mov              r11, 9
                        ...
                        mov              qword ptr [rbp + -56], r12;          jmp   n9_match_rpos_α
n8_match_arbno_β:       mov              r11, 9
                        mov              r12, qword ptr [rbp + -56];          jmp   n12_match_alternate_α
...
n9_match_rpos_α:        mov              r11, 10
                        ...
                        cmp              r14d, ecx;                           jne   n8_match_arbno_β
                                                                              jmp   n10_match_end_α
n9_match_rpos_β:        mov              r11, 10;                             jmp   n8_match_arbno_β
#-----------------------------------------------------------------------------------------------------------------------
...
n12_match_alternate_as: mov              r11, 13;                             jmp   n8_match_arbno_as
...
n13_match_lit_α:        mov              r11, 14
                        ...
                        cmp              eax, 98;                             jne   n12_match_alternate_af
...
.Lx50_0_s:              .string          "leak: inline FENCE ab alt retried"
#-----------------------------------------------------------------------------------------------------------------------
...
.Lx56_0_s:              .string          "inline FENCE in ARBNO sealed"
#-----------------------------------------------------------------------------------------------------------------------
