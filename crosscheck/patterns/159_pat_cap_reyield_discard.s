...
.Lx16_0:                mov              r14d, dword ptr [rbp + -40]
...
n2_match_begin_β:
.Lx16_13:               lea              rsp, [rbp + -56]                     # retry_whack
                        add              dword ptr [rbp + -40], 1             # start_δ
                        mov              eax, dword ptr [rbp + -40]
                        cmp              eax, r15d;                           jg    .Lx16_1
                        mov              rcx, qword ptr [rip + rt_anchor_g@GOTPCREL]
                        mov              rax, qword ptr [rcx]
                        cmp              rax, 0;                              jne   .Lx16_1
                                                                              jmp   .Lx16_0
.Lx16_1:
...
n5_match_arb_β:         add              dword ptr [rsp + 0], 1
                        ...
                        cmp              eax, r15d;                           jg    .Lx22_0
                        mov              r14d, eax;                           jmp   n6_match_assign_cond_α
.Lx22_0:                mov              r14d, dword ptr [rsp + 4]
                        add              rsp, 16
...
n7_match_alternate_s0:  lea              rax, [rip + .Lx26_40]
                        mov              qword ptr [rsp + 8], rax;            jmp   n7_match_alternate_as
n7_match_alternate_s1:  lea              rax, [rip + .Lx26_41]
                        mov              qword ptr [rsp + 8], rax;            jmp   n7_match_alternate_as
.Lx26_40:                                                                     jmp   n11_match_lit_β
.Lx26_41:                                                                     jmp   n10_match_lit_β
...
.Lx26_19:               add              rsp, 32;                             jmp   n6_match_assign_cond_β
#-----------------------------------------------------------------------------------------------------------------------
...
n9_statement_end_β:     add              rsp, 48;                             jmp   main_γ
#-----------------------------------------------------------------------------------------------------------------------
