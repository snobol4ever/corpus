...
n4_statement_begin_β:                                                         jmp   n21_statement_begin_α
#-----------------------------------------------------------------------------------------------------------------------
n5_var_α:               sub              rsp, 16
...
n5_var_β:               add              rsp, 16;                             jmp   n21_statement_begin_α
#-----------------------------------------------------------------------------------------------------------------------
...
#-----------------------------------------------------------------------------------------------------------------------
n9_match_fence1_α:      mov              qword ptr [rbp + -64], rsp
                        sub              rsp, 0;                              jmp   n14_match_alternate_α
n9_match_fence1_as:     add              rsp, 0
                        mov              rsp, qword ptr [rbp + -64];          jmp   n10_match_lit_α
n9_match_fence1_af:     add              rsp, 0
n9_match_fence1_β:      mov              rsp, qword ptr [rbp + -64];          jmp   n8_match_lit_β
#-----------------------------------------------------------------------------------------------------------------------
...
n10_match_lit_β:        sub              r14d, 1;                             jmp   n6_match_begin_β
#-----------------------------------------------------------------------------------------------------------------------
n11_match_rpos_α:       mov              rax, 0
                        ...
                        cmp              r14d, ecx;                           jne   n9_match_fence1_β
                                                                              jmp   n12_match_end_α
n11_match_rpos_β:                                                             jmp   n9_match_fence1_β
#-----------------------------------------------------------------------------------------------------------------------
...
n13_statement_end_β:    add              rsp, 16;                             jmp   n21_statement_begin_α
#-----------------------------------------------------------------------------------------------------------------------
...
n14_match_alternate_s0: lea              rax, [rip + .Lx49_40]
                        mov              qword ptr [rsp + 8], rax;            jmp   n14_match_alternate_as
n14_match_alternate_s1: lea              rax, [rip + .Lx49_41]
                        mov              qword ptr [rsp + 8], rax;            jmp   n14_match_alternate_as
.Lx49_40:                                                                     jmp   n16_match_lit_β
.Lx49_41:                                                                     jmp   n15_match_lit_β
n14_match_alternate_as:                                                       jmp   n9_match_fence1_as
...
n15_match_lit_β:        sub              r14d, 2;                             jmp   n14_match_alternate_af
#-----------------------------------------------------------------------------------------------------------------------
