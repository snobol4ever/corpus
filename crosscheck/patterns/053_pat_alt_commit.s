...
n15_assign_β:           mov              r11, 8;                              jmp   n12_statement_begin_β
#-----------------------------------------------------------------------------------------------------------------------
n16_statement_end_α:    mov              r11, 9
                        mov              r10, 1
                        add              rsp, 32;                             jmp   n17_statement_begin_α
n16_statement_end_β:    mov              r11, 9
                        add              rsp, 32;                             jmp   n17_statement_begin_α
#=======================================================================================================================
#         X = 'b'
#-----------------------------------------------------------------------------------------------------------------------
...
n19_assign_β:           mov              r11, 12;                             jmp   n17_statement_begin_β
#-----------------------------------------------------------------------------------------------------------------------
n20_statement_end_α:    mov              r11, 13
                        mov              r10, 2
                        add              rsp, 16;                             jmp   n21_statement_begin_α
n20_statement_end_β:    mov              r11, 13
                        add              rsp, 16;                             jmp   n21_statement_begin_α
#=======================================================================================================================
#         X P . V                                                     :S(YES)F(NO)
#-----------------------------------------------------------------------------------------------------------------------
...
n21_statement_begin_β:  mov              r11, 14;                             jmp   n38_statement_begin_α
#-----------------------------------------------------------------------------------------------------------------------
...
n22_var_β:              mov              r11, 15
                        add              rsp, 16;                             jmp   n38_statement_begin_α
#-----------------------------------------------------------------------------------------------------------------------
n23_match_begin_α:      mov              r11, 16
...
#-----------------------------------------------------------------------------------------------------------------------
n25_match_alternate_α:  mov              r11, 18
                        sub              rsp, 32
...
n25_match_alternate_s0: mov              r11, 18
                        lea              rax, [rip + .Lx64_40]
                        mov              qword ptr [rsp + 8], rax;            jmp   n25_match_alternate_as
n25_match_alternate_s1: mov              r11, 18
                        lea              rax, [rip + .Lx64_41]
                        mov              qword ptr [rsp + 8], rax;            jmp   n25_match_alternate_as
n25_match_alternate_s2: mov              r11, 18
                        lea              rax, [rip + .Lx64_42]
                        mov              qword ptr [rsp + 8], rax;            jmp   n25_match_alternate_as
.Lx64_40:                                                                     jmp   n31_match_lit_β
.Lx64_41:                                                                     jmp   n30_match_lit_β
.Lx64_42:                                                                     jmp   n29_match_lit_β
n25_match_alternate_as: mov              r11, 18;                             jmp   n26_match_assign_cond_α
n25_match_alternate_β:  mov              r11, 18
                        mov              rax, qword ptr [rsp + 8];            jmp   rax
n25_match_alternate_af: mov              r11, 18
...
n28_statement_end_β:    mov              r11, 21
                        add              rsp, 32;                             jmp   n38_statement_begin_α
#-----------------------------------------------------------------------------------------------------------------------
n29_match_lit_α:        mov              r11, 22
                        mov              eax, r14d
                        add              eax, 1
...
n29_match_lit_β:        mov              r11, 22
                        sub              r14d, 1;                             jmp   n25_match_alternate_af
#-----------------------------------------------------------------------------------------------------------------------
n30_match_lit_α:        mov              r11, 23
                        mov              eax, r14d
                        add              eax, 1
                        cmp              eax, r15d;                           jg    n25_match_alternate_af
                        movsxd           rcx, r14d
...
n30_match_lit_β:        mov              r11, 23
                        sub              r14d, 1;                             jmp   n25_match_alternate_af
#-----------------------------------------------------------------------------------------------------------------------
n31_match_lit_α:        mov              r11, 24
                        mov              eax, r14d
                        add              eax, 1
                        cmp              eax, r15d;                           jg    n25_match_alternate_af
                        movsxd           rcx, r14d
...
n31_match_lit_β:        mov              r11, 24
                        sub              r14d, 1;                             jmp   n25_match_alternate_af
#=======================================================================================================================
# YES     OUTPUT = V
#-----------------------------------------------------------------------------------------------------------------------
n32_statement_begin_α:  mov              r11, 25
                        mov              r10, 4;                              jmp   n33_var_α
n32_statement_begin_β:  mov              r11, 25;                             jmp   n36_statement_begin_α
#-----------------------------------------------------------------------------------------------------------------------
...
n34_assign_β:           mov              r11, 27;                             jmp   n32_statement_begin_β
.Lx80_0:                .quad            .Lx80_0_s
.Lx80_0_s:              .string          "OUTPUT"
#-----------------------------------------------------------------------------------------------------------------------
n35_statement_end_α:    mov              r11, 28
                        mov              r10, 4
                        add              rsp, 16;                             jmp   n36_statement_begin_α
n35_statement_end_β:    mov              r11, 28
                        add              rsp, 16;                             jmp   n36_statement_begin_α
#=======================================================================================================================
#         :(END)
#-----------------------------------------------------------------------------------------------------------------------
n36_statement_begin_α:  mov              r11, 29
                        mov              r10, 5;                              jmp   n37_statement_end_α
n36_statement_begin_β:  mov              r11, 29;                             jmp   main_γ
#-----------------------------------------------------------------------------------------------------------------------
n37_statement_end_α:    mov              r11, 30
                        mov              r10, 5;                              jmp   main_γ
n37_statement_end_β:    mov              r11, 30;                             jmp   main_γ
#=======================================================================================================================
# NO      OUTPUT = 'no match'
#-----------------------------------------------------------------------------------------------------------------------
n38_statement_begin_α:  mov              r11, 31
                        mov              r10, 6;                              jmp   n39_lit_string_α
n38_statement_begin_β:  mov              r11, 31;                             jmp   main_γ
#-----------------------------------------------------------------------------------------------------------------------
...
n40_assign_β:           mov              r11, 33;                             jmp   n38_statement_begin_β
.Lx90_0:                .quad            .Lx90_0_s
.Lx90_0_s:              .string          "OUTPUT"
#-----------------------------------------------------------------------------------------------------------------------
n41_statement_end_α:    mov              r11, 34
                        mov              r10, 6
                        add              rsp, 16;                             jmp   main_γ
n41_statement_end_β:    mov              r11, 34
                        add              rsp, 16;                             jmp   main_γ
#-----------------------------------------------------------------------------------------------------------------------
main_β:
                                                                              jmp   main_ω
