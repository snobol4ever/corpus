...
_pc = 58; continue dispatch;
    case 60: /* uid15 PROCEED */
        if (_cur2 + 3 > _slen2) { _pc = 56; continue dispatch;
 }
        if (_subj2.slice(_cur2, _cur2+3) !== "cat") { _pc = 56; continue dispatch;
 }
        _saved[15] = _cur2; _cur2 += 3;
...
_pc = 56; continue dispatch;
    case 64: /* uid16 PROCEED */
        ...
        if (_subj2.slice(_cur2, _cur2+3) !== "dog") { _pc = 28; continue dispatch;
 }
