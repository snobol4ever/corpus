...
(module
  ...
  (data (i32.const 65536) "abcno match")

  ;; SNOBOL4 variables: each → (offset, length) global pair
  (global $var_P_off (mut i32) (i32.const 0))
  (global $var_P_len (mut i32) (i32.const 0))
  ...
  (func (export "main") (result i32)
    ...
    (i32.const 65536)
    (i32.const 0)
      (global.set $var_P_len)
      (global.set $var_P_off)
    ...
    (global.get $var_P_off)
    (global.get $var_P_len)
