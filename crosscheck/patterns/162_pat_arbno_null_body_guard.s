...
n20_match_arbno_α:
                        ...
                        mov              dword ptr [rsp + 788], r14d
                        mov              dword ptr [rsp + 792], 1
...
n35_match_arbno_α:
                        ...
                        mov              dword ptr [rsp + 1360], r14d
                        mov              dword ptr [rsp + 1364], r14d
...
n35_match_arbno_as:
                        ...
                        mov              dword ptr [rsp + 1364], r14d
                                                                                        jmp   n36_match_lit_α
n35_match_arbno_af:
                        mov              eax, dword ptr [rsp + 1368]
                        test             eax, eax
                                                                                        jnz   .Lx126_2
                        add              rsp, 1392
                                                                                        jmp   n45_match_alternate_β
.Lx126_2:
                        mov              r14d, dword ptr [rsp + 1360]
                        add              rsp, 1392
                                                                                        jmp   n34_match_pos_β
#-----------------------------------------------------------------------------------------------------------------------
n36_match_lit_α:
