...
n25_match_arbno_as:
                        mov              eax, dword ptr [rsp + 4]
                        cmp              r14d, eax
                                                                                        je    n35_match_alternate_β
                        mov              dword ptr [rsp + 4], r14d
                                                                                        jmp   n26_match_lit_α
n25_match_arbno_af:
                        mov              eax, dword ptr [rsp + 0]
                        cmp              r14d, eax
                                                                                        jne   n35_match_alternate_β
                        add              rsp, 16
                                                                                        jmp   n24_match_pos_β
#-----------------------------------------------------------------------------------------------------------------------
n26_match_lit_α:
...
n47_match_arbno_α:
                        ...
                        mov              dword ptr [rsp + 4], r14d
                                                                                        jmp   n48_match_lit_α
n47_match_arbno_β:
                                                                                        jmp   n57_match_alternate_α
n47_match_arbno_as:
                        mov              eax, dword ptr [rsp + 4]
                        cmp              r14d, eax
                                                                                        je    n57_match_alternate_β
                        mov              dword ptr [rsp + 4], r14d
                                                                                        jmp   n48_match_lit_α
n47_match_arbno_af:
                        mov              eax, dword ptr [rsp + 0]
                        cmp              r14d, eax
                                                                                        jne   n57_match_alternate_β
                        add              rsp, 16
                                                                                        jmp   n46_match_pos_β
#-----------------------------------------------------------------------------------------------------------------------
n48_match_lit_α:
...
n56_statement_end_β:
                        add              rsp, 16
                                                                                        jmp   main_γ
#-----------------------------------------------------------------------------------------------------------------------
n57_match_alternate_α:
                        mov              dword ptr [rbp + 768], r14d
                        lea              rax, [rip + .Lx162_21]
                        mov              qword ptr [rbp + 784], rax
                                                                                        jmp   n59_match_lit_α
.Lx162_21:
                        lea              rax, [rip + .Lx162_19]
                        mov              qword ptr [rbp + 784], rax
                                                                                        jmp   n58_match_lit_α
n57_match_alternate_s0:
                        lea              rax, [rip + .Lx162_40]
                        mov              qword ptr [rbp + 776], rax
                                                                                        jmp   n57_match_alternate_as
n57_match_alternate_s1:
                        lea              rax, [rip + .Lx162_41]
                        mov              qword ptr [rbp + 776], rax
                                                                                        jmp   n57_match_alternate_as
.Lx162_40:
                                                                                        jmp   n59_match_lit_β
.Lx162_41:
                                                                                        jmp   n58_match_lit_β
n57_match_alternate_as:
                                                                                        jmp   n47_match_arbno_as
n57_match_alternate_β:
                        mov              rax, qword ptr [rbp + 776]
                                                                                        jmp   rax
n57_match_alternate_af:
...
#-----------------------------------------------------------------------------------------------------------------------
n58_match_lit_α:
                                                                                        jmp   n57_match_alternate_s1
n58_match_lit_β:
                                                                                        jmp   n57_match_alternate_af
#-----------------------------------------------------------------------------------------------------------------------
n59_match_lit_α:
                        mov              eax, r14d
                        add              eax, 1
                        cmp              eax, r15d
                                                                                        jg    n57_match_alternate_af
                        movsxd           rcx, r14d
                        movzx            eax, byte ptr [r13+rcx]
                        cmp              eax, 65
                                                                                        jne   n57_match_alternate_af
                        add              r14d, 1
                                                                                        jmp   n57_match_alternate_s0
n59_match_lit_β:
                        sub              r14d, 1
                                                                                        jmp   n57_match_alternate_af
#=======================================================================================================================
