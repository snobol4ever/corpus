...
n0_statement_begin_β:   mov              r11, 1;                              jmp   n12_statement_begin_α
#-----------------------------------------------------------------------------------------------------------------------
...
n6_match_assign_cond_β: mov              r11, 7
                        sub              r12, 24;                             jmp   n5_match_arb_β
#-----------------------------------------------------------------------------------------------------------------------
n7_match_alternate_α:   mov              r11, 8
                        sub              rsp, 32
...
n7_match_alternate_s0:  mov              r11, 8
                        lea              rax, [rip + .Lx54_40]
                        mov              qword ptr [rsp + 8], rax;            jmp   n7_match_alternate_as
n7_match_alternate_s1:  mov              r11, 8
                        lea              rax, [rip + .Lx54_41]
                        mov              qword ptr [rsp + 8], rax;            jmp   n7_match_alternate_as
.Lx54_40:                                                                     jmp   n11_match_lit_β
.Lx54_41:                                                                     jmp   n10_match_lit_β
n7_match_alternate_as:  mov              r11, 8;                              jmp   n8_match_end_α
n7_match_alternate_β:   mov              r11, 8
                        mov              rax, qword ptr [rsp + 8];            jmp   rax
n7_match_alternate_af:  mov              r11, 8
...
n10_match_lit_β:        mov              r11, 11
                        sub              r14d, 1;                             jmp   n7_match_alternate_af
#-----------------------------------------------------------------------------------------------------------------------
...
n12_statement_begin_β:  mov              r11, 13;                             jmp   n20_statement_begin_α
#-----------------------------------------------------------------------------------------------------------------------
...
n20_statement_begin_β:  mov              r11, 21;                             jmp   n32_statement_begin_α
#-----------------------------------------------------------------------------------------------------------------------
...
n23_match_lit_β:        mov              r11, 24
                        sub              r14d, 1;                             jmp   n22_match_begin_β
#-----------------------------------------------------------------------------------------------------------------------
...
n27_match_alternate_as: mov              r11, 28;                             jmp   n28_match_end_α
...
n29_statement_end_α:    mov              r11, 30
                        mov              r10, 3
                        add              rsp, 16;                             jmp   n32_statement_begin_α
n29_statement_end_β:    mov              r11, 30
...
n31_match_lit_β:        mov              r11, 32
                        sub              r14d, 1;                             jmp   n27_match_alternate_af
#=======================================================================================================================
#  OUTPUT = 'W=[' W ']'
#-----------------------------------------------------------------------------------------------------------------------
n32_statement_begin_α:  mov              r11, 33
                        mov              r10, 4;                              jmp   n33_lit_string_α
...
n38_assign_β:           mov              r11, 39;                             jmp   n32_statement_begin_β
...
n39_statement_end_β:    mov              r11, 40
                        add              rsp, 80;                             jmp   main_γ
#-----------------------------------------------------------------------------------------------------------------------
main_β:
                                                                              jmp   main_ω
