...
(module
  ...
  (data (i32.const 65536) "abcshould not reachcorrectly failed")

  ;; SNOBOL4 variables: each → (offset, length) global pair
  (global $var_X_off (mut i32) (i32.const 0))
  (global $var_X_len (mut i32) (i32.const 0))
  (global $var_FAIL_off (mut i32) (i32.const 0))
  (global $var_FAIL_len (mut i32) (i32.const 0))
