...
_pc = 38; continue dispatch;
    case 48: /* uid12 PROCEED */
        { var _start12 = _cur2;
          ...
          _saved[12] = _cur2 - _start12;
          if (_saved[12] === 0) { _pc = 28; continue dispatch;
 } }
_pc = 44; continue dispatch;
    case 50: /* uid12 CONCEDE */
        if (_saved[12] <= 1) { _cur2 -= _saved[12]; _saved[12] = 0; _pc = 28; continue dispatch;
 }
        _saved[12]--; _cur2--;
_pc = 44; continue dispatch;
    case 44: /* uid11 PROCEED */
        _vars["V"] = _subj2.slice(_saved[10], _cur2);
