...
_pc = 42; continue dispatch;
    case 52: /* uid13 PROCEED */
        { var _pat_val13 = _vars["P"];
          var _pat_s13 = (_pat_val13 === null || _pat_val13 === undefined) ? '' : String(_pat_val13);
          var _pat_n13 = _pat_s13.length;
          if (_cur3 + _pat_n13 > _slen3) { _pc = 32; continue dispatch;
 }
          if (_subj3.slice(_cur3, _cur3+_pat_n13) !== _pat_s13) { _pc = 32; continue dispatch;
 }
          _saved[13] = _cur3; _cur3 += _pat_n13; }
