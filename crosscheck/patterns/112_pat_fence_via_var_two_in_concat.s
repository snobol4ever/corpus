...
n13_assign_α:
                        ...
                        mov              qword ptr [1879052296], rdx                    # cmd1
                        add              rsp, 32
                                                                                        jmp   n14_lit_string_α
#=======================================================================================================================
#         cmd2 = LEN(1)
...
n16_assign_α:
                        ...
                        mov              qword ptr [1879052312], rdx                    # cmd2
                        add              rsp, 32
                                                                                        jmp   n17_lit_string_α
#=======================================================================================================================
#         s = 'ab'
...
n27_match_defer_α:
                        ...
                        mov              rdx, qword ptr [1879052312]                    # cmd2
                        cmp              eax, 3
                                                                                        jne   .Lx56_9
...
n28_match_defer_α:
                        ...
                        mov              rdx, qword ptr [1879052296]                    # cmd1
                        cmp              eax, 3
                                                                                        jne   .Lx57_9
                        mov              rax, qword ptr [rdx + 0]
                        test             rax, rax
