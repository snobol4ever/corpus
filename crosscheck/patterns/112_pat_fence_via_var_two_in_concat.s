...
PAT$1_α_body:
                        ...
                        mov              qword ptr [rbp + -32], r12
#-----------------------------------------------------------------------------------------------------------------------
n9_match_len_α:         mov              r11, 4
                        mov              eax, r14d
                        add              eax, 1
                        cmp              eax, r15d;                           jg    PAT$1_ω
                        add              r14d, 1;                             jmp   PAT$1_γ
n9_match_len_β:         mov              r11, 4
...
n16_statement_begin_β:  mov              r11, 10;                             jmp   n21_statement_begin_α
#-----------------------------------------------------------------------------------------------------------------------
...
n18_call_β:             mov              r11, 12
                        add              rsp, 16
                        add              rsp, 16;                             jmp   n16_statement_begin_β
#-----------------------------------------------------------------------------------------------------------------------
n19_assign_α:           mov              r11, 13
                        mov              rax, qword ptr [rsp + 0]             # call
                        mov              rdx, qword ptr [rsp + 8]
                        mov              qword ptr [r9 + 16], rax             # cmd2
                        mov              qword ptr [r9 + 24], rdx;            jmp   n20_statement_end_α
#-----------------------------------------------------------------------------------------------------------------------
n20_statement_end_α:    mov              r11, 14
                        mov              r10, 2
                        add              rsp, 32;                             jmp   n21_statement_begin_α
#=======================================================================================================================
#         s = 'ab'
#-----------------------------------------------------------------------------------------------------------------------
n21_statement_begin_α:  mov              r11, 15
                        mov              r10, 3;                              jmp   n22_lit_string_α
n21_statement_begin_β:  mov              r11, 15;                             jmp   n25_statement_begin_α
#-----------------------------------------------------------------------------------------------------------------------
...
n26_var_α:              sub              rsp, 16
                        ...
                        mov              qword ptr [rsp + 8], rdx;            jmp   n27_match_begin_α
#-----------------------------------------------------------------------------------------------------------------------
n27_match_begin_α:      mov              r11, 21
...
.Lx68_0:                mov              r14d, dword ptr [rbp + -40]
                        mov              rcx, qword ptr [rip + rtccb@GOTPCREL] # match_beta_cont
                        mov              rax, qword ptr [rcx + 248]
                        mov              qword ptr [rbp + -48], rax
                        lea              rax, [rip + .Lx68_13]
                        mov              qword ptr [rcx + 248], rax;          jmp   n28_match_pos_α
n27_match_begin_β:      mov              r11, 21
.Lx68_13:               lea              rsp, [rbp + -56]                     # retry_whack
...
#-----------------------------------------------------------------------------------------------------------------------
n28_match_pos_α:        mov              r11, 22
                        mov              rax, 0
                        cmp              r14d, eax;                           jne   n27_match_begin_β
                                                                              jmp   n29_match_defer_α
n28_match_pos_β:        mov              r11, 22;                             jmp   n27_match_begin_β
#-----------------------------------------------------------------------------------------------------------------------
n29_match_defer_α:      sub              rsp, 16
                        ...
                        test             rax, rax;                            jne   .Lx70_10
                        mov              rdi, rdx
                        mov              qword ptr [rip + rtccb+40], r8
                        call             dtp_fn_of@PLT
                        mov              r8,  qword ptr [rip + rtccb+40]
                        mov              r9,  qword ptr [rip + rtccb+48]
                        mov              rdx, qword ptr [r9 + 8];             jmp   .Lx70_10
.Lx70_9:                cmp              al, 88;                              jne   .Lx70_21
                        mov              rdi, rdx
                        mov              qword ptr [rip + rtccb+40], r8
                        ...
                        mov              r9,  qword ptr [rip + rtccb+48]
                        mov              rdx, rax
                        test             rax, rax;                            je    .Lx70_21
                        mov              rax, qword ptr [rdx + 0];            jmp   .Lx70_10
.Lx70_21:               xor              eax, eax
.Lx70_10:               test             rax, rax;                            jz    .Lx70_0
                        mov              r8d, 0
                        lea              rcx, [rip + .Lx70_5]
                        push             rcx
                        lea              rcx, [rip + .Lx70_4]
                        push             rcx;                                 jmp   rax
.Lx70_4:                mov              rsp, rbp
                        pop              rbp;                                 jmp   n30_match_len_α
.Lx70_5:                mov              rsp, rbp
                        pop              rbp
                        add              rsp, 16;                             jmp   n27_match_begin_β
.Lx70_0:                push             r14
                        push             r15
                        push             r13
                        sub              rsp, 8
                        ...
                        add              rsp, 16;                             jmp   n27_match_begin_β
.Lx70_240:              mov              ecx, r14d
                        mov              r14d, eax
                        lea              rax, [rip + .Lx70_6]
                        push             rcx
                        push             rax;                                 jmp   n30_match_len_α
.Lx70_6:                add              rsp, 8
                        pop              rax
                        mov              r14d, eax
                        add              rsp, 16;                             jmp   n27_match_begin_β
n29_match_defer_β:      mov              r11, 23
                        mov              rsp, rbp
                        pop              rbp
                        add              rsp, 16;                             jmp   n27_match_begin_β
#-----------------------------------------------------------------------------------------------------------------------
n30_match_len_α:        mov              r11, 24
                        mov              eax, r14d
                        add              eax, 1
                        cmp              eax, r15d;                           jg    n27_match_begin_β
                        add              r14d, 1;                             jmp   n31_match_rpos_α
n30_match_len_β:        mov              r11, 24
                        sub              r14d, 1;                             jmp   n27_match_begin_β
#-----------------------------------------------------------------------------------------------------------------------
n31_match_rpos_α:       mov              r11, 25
                        mov              rax, 0
                        mov              ecx, r15d
                        sub              ecx, eax
                        cmp              r14d, ecx;                           jne   n30_match_len_β
                                                                              jmp   n32_match_end_α
#-----------------------------------------------------------------------------------------------------------------------
n32_match_end_α:        mov              r11, 26
                        mov              rcx, qword ptr [rip + rtccb@GOTPCREL] # mbc_restore
                        mov              rax, qword ptr [rbp + -48]
                        mov              qword ptr [rcx + 248], rax
                        push             r14
...
#-----------------------------------------------------------------------------------------------------------------------
n33_statement_end_α:    mov              r11, 27
                        mov              r10, 4
                        add              rsp, 16;                             jmp   n34_statement_begin_α
#=======================================================================================================================
# YES     OUTPUT = 'two-star-var matched'                       :(END)
#-----------------------------------------------------------------------------------------------------------------------
n34_statement_begin_α:  mov              r11, 28
                        mov              r10, 5;                              jmp   n35_lit_string_α
n34_statement_begin_β:  mov              r11, 28;                             jmp   main_γ
#-----------------------------------------------------------------------------------------------------------------------
...
.Lx79_0_s:              .string          "two-star-var matched"
#-----------------------------------------------------------------------------------------------------------------------
n36_assign_α:           mov              r11, 30
...
#-----------------------------------------------------------------------------------------------------------------------
n37_statement_end_α:    mov              r11, 31
                        mov              r10, 5
                        add              rsp, 16;                             jmp   main_γ
#=======================================================================================================================
# NO      OUTPUT = 'fail'
#-----------------------------------------------------------------------------------------------------------------------
n38_statement_begin_α:  mov              r11, 32
                        mov              r10, 6;                              jmp   n39_lit_string_α
n38_statement_begin_β:  mov              r11, 32;                             jmp   main_γ
#-----------------------------------------------------------------------------------------------------------------------
...
#-----------------------------------------------------------------------------------------------------------------------
n41_statement_end_α:    mov              r11, 35
                        mov              r10, 6
                        add              rsp, 16;                             jmp   main_γ
#-----------------------------------------------------------------------------------------------------------------------
main_β:
