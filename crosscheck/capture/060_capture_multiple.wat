...
(module
  ...
  (data (i32.const 65536) "John Smith fail / ")

  ;; SNOBOL4 variables: each → (offset, length) global pair
  (global $var_X_off (mut i32) (i32.const 0))
  (global $var_X_len (mut i32) (i32.const 0))
  (global $var_FIRST_off (mut i32) (i32.const 0))
  (global $var_FIRST_len (mut i32) (i32.const 0))
  (global $var_LAST_off (mut i32) (i32.const 0))
  (global $var_LAST_len (mut i32) (i32.const 0))
  (global $var_REM_off (mut i32) (i32.const 0))
  (global $var_REM_len (mut i32) (i32.const 0))
  ...
  (func (export "main") (result i32)
    ...
    (i32.const 4)
      ...
      ;; OUTPUT = ...
    (global.get $var_FIRST_off)
    (global.get $var_FIRST_len)
    (i32.const 65551)
    (i32.const 3)
    (call $sno_str_concat)
    (global.get $var_LAST_off)
    (global.get $var_LAST_len)
    (call $sno_str_concat)
      (call $sno_output_str)
      (local.set $ok (i32.const 1))
      ) ;; $L2 END
