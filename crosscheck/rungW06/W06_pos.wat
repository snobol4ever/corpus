...
(module
  ...
  (data (i32.const 65536) "HELLOHPASS W06/001: POS(0) matchedFAIL W06/001: POS(0) should matchELPASS W06/002: POS(3) after EL matchedFAIL W06/002: POS(3) after EL should matchPASS W06/003: POS(2) H correctly failsFAIL W06/003: POS(2) H should fail")
