...
.Lx67_0:                mov              r14d, dword ptr [rbp + -40];         jmp   n7_match_pos_α
...
n8_match_lit_α:         mov              eax, r14d
                        ...
                        cmp              eax, 72;                             jne   n6_match_begin_β
                        add              r14d, 1;                             jmp   n9_match_end_α
n8_match_lit_β:         sub              r14d, 1;                             jmp   n6_match_begin_β
#-----------------------------------------------------------------------------------------------------------------------
...
.Lx77_0_s:              .string          "PASS W06/001: POS(0) matched"
#-----------------------------------------------------------------------------------------------------------------------
...
.Lx83_0_s:              .string          "FAIL W06/001: POS(0) should match"
#-----------------------------------------------------------------------------------------------------------------------
...
n26_match_lit_α:        mov              eax, r14d
                        ...
                        add              r14d, 2;                             jmp   n27_match_pos_α
n26_match_lit_β:        sub              r14d, 2;                             jmp   n25_match_begin_β
#-----------------------------------------------------------------------------------------------------------------------
n27_match_pos_α:        mov              rax, 3
                        cmp              r14d, eax;                           jne   n26_match_lit_β
                                                                              jmp   n28_match_end_α
#-----------------------------------------------------------------------------------------------------------------------
...
.Lx107_0_s:             .string          "PASS W06/002: POS(3) after EL matched"
#-----------------------------------------------------------------------------------------------------------------------
...
.Lx113_0_s:             .string          "FAIL W06/002: POS(3) after EL should match"
#-----------------------------------------------------------------------------------------------------------------------
...
n44_match_begin_α:      mov              rdi, qword ptr [rsp + 0]             # var
                        ...
                        mov              r11, qword ptr [rip + rtccb+64]
                        mov              dword ptr [rbp + -40], 0             # start_δ
.Lx127_0:               mov              r14d, dword ptr [rbp + -40];         jmp   n45_match_pos_α
...
n46_match_lit_α:        mov              eax, r14d
                        ...
                        movsxd           rcx, r14d
                        movzx            eax, byte ptr [r13+rcx]
                        cmp              eax, 72;                             jne   n44_match_begin_β
                        add              r14d, 1;                             jmp   n47_match_end_α
n46_match_lit_β:        sub              r14d, 1;                             jmp   n44_match_begin_β
#-----------------------------------------------------------------------------------------------------------------------
...
.Lx137_0_s:             .string          "PASS W06/003: POS(2) H correctly fails"
#-----------------------------------------------------------------------------------------------------------------------
...
.Lx143_0_s:             .string          "FAIL W06/003: POS(2) H should fail"
#-----------------------------------------------------------------------------------------------------------------------
