...
(module
  ...
  (data (i32.const 65536) "ABCDEDEPASS W06/001: TAB(3) then DE matchedFAIL W06/001: TAB(3) then DE should matchABCDEPASS W06/002: AB TAB(2) CDE matchedFAIL W06/002: AB TAB(2) CDE should matchABCPASS W06/003: TAB(1) behind cursor correctly failsFAIL W06/003: TAB(1) behind cursor should fail")
