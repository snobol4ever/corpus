...
(module
  ...
  (data (i32.const 65536) "ABCDEDEPASS W06/001: LEN(3) then DE matchedFAIL W06/001: LEN(3) then DE should matchPASS W06/002: LEN(0) then full string matchedFAIL W06/002: LEN(0) then full string should matchABPASS W06/003: LEN(5) on 2-char string correctly failsFAIL W06/003: LEN(5) on short string should fail")
