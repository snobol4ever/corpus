...
_pc = 28; continue dispatch;
    case 48: /* uid12 PROCEED */
        if (_cur2 !== 0) { _pc = 28; continue dispatch;
 }
_pc = 40; continue dispatch;
    case 50: /* uid12 CONCEDE */
_pc = 28; continue dispatch;
    case 52: /* uid13 PROCEED */
        if (_cur2 + 1 > _slen2) { _pc = 44; continue dispatch;
 }
        if (_subj2[_cur2] !== "H") { _pc = 44; continue dispatch;
 }
        _saved[13] = _cur2; _cur2 += 1;
...
/* line 4 */
    var _v15 = "PASS W06/001: POS(0) matched";
...
/* line 5 */
    var _v16 = "FAIL W06/001: POS(0) should match";
...
_pc = 92; continue dispatch;
    case 112: /* uid28 PROCEED */
        ...
        if (_subj18.slice(_cur18, _cur18+2) !== "EL") { _pc = 92; continue dispatch;
 }
        _saved[28] = _cur18; _cur18 += 2;
_pc = 104; continue dispatch;
    case 114: /* uid28 CONCEDE */
        _cur18 = _saved[28];
_pc = 92; continue dispatch;
    case 116: /* uid29 PROCEED */
        if (_cur18 !== 3) { _pc = 108; continue dispatch;
 }
...
/* line 8 */
    var _v31 = "PASS W06/002: POS(3) after EL matched";
...
/* line 9 */
    var _v32 = "FAIL W06/002: POS(3) after EL should match";
...
_pc = 156; continue dispatch;
    case 176: /* uid44 PROCEED */
        if (_cur34 !== 2) { _pc = 156; continue dispatch;
 }
_pc = 168; continue dispatch;
    case 178: /* uid44 CONCEDE */
_pc = 156; continue dispatch;
    case 180: /* uid45 PROCEED */
        if (_cur34 + 1 > _slen34) { _pc = 172; continue dispatch;
 }
        if (_subj34[_cur34] !== "H") { _pc = 172; continue dispatch;
 }
        _saved[45] = _cur34; _cur34 += 1;
...
/* line 12 */
    var _v47 = "PASS W06/003: POS(2) H correctly fails";
...
/* line 13 */
    var _v48 = "FAIL W06/003: POS(2) H should fail";
