...
/* line 4 */
    var _v15 = "PASS W06/001: LEN(3) then DE matched";
...
/* line 5 */
    var _v16 = "FAIL W06/001: LEN(3) then DE should match";
...
_pc = 92; continue dispatch;
    case 112: /* uid28 PROCEED */
        if (_cur18 + 0 > _slen18) { _pc = 92; continue dispatch;
 }
        _saved[28] = _cur18; _cur18 += 0;
_pc = 104; continue dispatch;
    case 114: /* uid28 CONCEDE */
        _cur18 = _saved[28];
_pc = 92; continue dispatch;
    case 116: /* uid29 PROCEED */
        if (_cur18 + 5 > _slen18) { _pc = 108; continue dispatch;
 }
        if (_subj18.slice(_cur18, _cur18+5) !== "ABCDE") { _pc = 108; continue dispatch;
 }
        _saved[29] = _cur18; _cur18 += 5;
...
/* line 8 */
    var _v31 = "PASS W06/002: LEN(0) then full string matched";
...
/* line 9 */
    var _v32 = "FAIL W06/002: LEN(0) then full string should match";
...
_pc = 144; continue dispatch;
    case 160: /* uid40 PROCEED */
        if (_cur34 + 5 > _slen34) { _pc = 156; continue dispatch;
 }
        _saved[40] = _cur34; _cur34 += 5;
...
/* line 12 */
    var _v42 = "PASS W06/003: LEN(5) on 2-char string correctly fails";
...
/* line 13 */
    var _v43 = "FAIL W06/003: LEN(5) on short string should fail";
