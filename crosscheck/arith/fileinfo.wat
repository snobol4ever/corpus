...
(module
  ...
  (data (i32.const 65536) " characters,  lines read")

  ;; SNOBOL4 variables: each → (offset, length) global pair
  (global $var_CHARS_off (mut i32) (i32.const 0))
  (global $var_CHARS_len (mut i32) (i32.const 0))
  (global $var_LINES_off (mut i32) (i32.const 0))
  (global $var_LINES_len (mut i32) (i32.const 0))
  ...
  (func (export "main") (result i32)
    ...
    (i64.const 1)
      ...
      ;; CHARS = ...
    (global.get $var_CHARS_off)
    (global.get $var_CHARS_len)
    (call $sno_str_to_int)
    ...
    (i64.add)
      (call $sno_int_to_str)
      (global.set $var_CHARS_len)
      (global.set $var_CHARS_off)
      (local.set $ok (i32.const 1))
      ...
      ;; LINES = ...
    (global.get $var_LINES_off)
    (global.get $var_LINES_len)
    (call $sno_str_to_int)
    (i64.const 1)
    (i64.add)
      (call $sno_int_to_str)
      (global.set $var_LINES_len)
      (global.set $var_LINES_off)
      (local.set $ok (i32.const 1))
