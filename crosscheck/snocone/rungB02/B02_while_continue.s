...
n16_var_α:
                        mov              rax, qword ptr [1879052288]                    # i
                        mov              rdx, qword ptr [1879052296]                    # i
                        mov              qword ptr [rsp + 192], rax                     # i
                        mov              qword ptr [rsp + 200], rdx                     # i
                                                                                        jmp   n17_assign_α
#-----------------------------------------------------------------------------------------------------------------------
n17_assign_α:
...
n18_var_α:
                        mov              rax, qword ptr [1879052288]                    # i
                        mov              rdx, qword ptr [1879052296]                    # i
                        mov              qword ptr [rsp + 160], rax                     # i
                        mov              qword ptr [rsp + 168], rdx                     # i
