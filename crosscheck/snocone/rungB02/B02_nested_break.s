...
n19_var_α:
                        mov              rax, qword ptr [1879052288]                    # i
                        mov              rdx, qword ptr [1879052296]                    # i
                        mov              qword ptr [rsp + 384], rax                     # i
                        mov              qword ptr [rsp + 392], rdx                     # i
                                                                                        jmp   n20_lit_string_α
#-----------------------------------------------------------------------------------------------------------------------
n20_lit_string_α:
                        mov              qword ptr [rsp + 400], 1                       # lit_string
                        mov              dword ptr [rsp + 404], 1                       # lit_string
                        mov              rax, qword ptr [rip + .Lx62_0]
                        mov              qword ptr [rsp + 408], rax                     # lit_string
                                                                                        jmp   n21_binop_α
.Lx62_0:
                        .quad            .Lx62_0_s
.Lx62_0_s:
...
n22_var_α:
                        mov              rax, qword ptr [1879052304]                    # j
                        mov              rdx, qword ptr [1879052312]                    # j
                        mov              qword ptr [rsp + 416], rax                     # j
                        mov              qword ptr [rsp + 424], rdx                     # j
                                                                                        jmp   n23_binop_α
#-----------------------------------------------------------------------------------------------------------------------
n23_binop_α:
...
n25_var_α:
                        mov              rax, qword ptr [1879052304]                    # j
                        mov              rdx, qword ptr [1879052312]                    # j
                        mov              qword ptr [rsp + 320], rax                     # j
                        mov              qword ptr [rsp + 328], rdx                     # j
