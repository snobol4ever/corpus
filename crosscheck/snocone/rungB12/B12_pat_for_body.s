...
.Lx41_0:                lea              rdi, [rsp + 32]
                        ...
                        mov              r9,  qword ptr [rip + rtccb+48]
                        mov              r10, qword ptr [rip + rtccb+56]
                        mov              r11, qword ptr [rip + rtccb+64];     jmp   n11_cmp_test_α
...
n15_match_break_β:      mov              r14d, dword ptr [rsp + 0]
                        add              rsp, 16
                        add              rsp, 16;                             jmp   n13_match_begin_β
#-----------------------------------------------------------------------------------------------------------------------
...
n17_match_len_β:        sub              r14d, 1;                             jmp   n16_match_assign_cond_β
#-----------------------------------------------------------------------------------------------------------------------
...
n23_binop_α:            sub              rsp, 16
                        ...
                        mov              edx, eax
                        and              edx, ecx
                        cmp              edx, 3;                              jne   .Lx60_2
                        mov              rax, qword ptr [rsp + 40]            # var
                        mov              rdx, qword ptr [rsp + 24]            # lit_integer
                        add              rax, rdx
                        mov              qword ptr [rsp + 0], 3               # result
                        mov              qword ptr [rsp + 8], rax;            jmp   .Lx60_7
.Lx60_2:                and              edx, 1;                              jz    .Lx60_0
                        mov              rsi, qword ptr [rsp + 40]            # var
                        mov              rdi, qword ptr [rsp + 24]            # lit_integer
                        cmp              eax, 5;                              je    .Lx60_3
                        cvtsi2sd         xmm0, rsi;                           jmp   .Lx60_4
.Lx60_3:                movq             xmm0, rsi
.Lx60_4:                cmp              ecx, 5;                              je    .Lx60_5
                        cvtsi2sd         xmm1, rdi;                           jmp   .Lx60_6
.Lx60_5:                movq             xmm1, rdi
.Lx60_6:                addsd            xmm0, xmm1
                        movq             rax, xmm0
