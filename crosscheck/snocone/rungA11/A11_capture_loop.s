...
.Lx44_0:                mov              r14d, dword ptr [rbp + -40];         jmp   n13_match_pos_α
n12_match_begin_β:      lea              rsp, [rbp + -56]                     # retry_whack
                        ...
                        cmp              rax, 0;                              jne   .Lx44_1
                                                                              jmp   .Lx44_0
.Lx44_1:
n12_match_begin_af:     mov              r12, qword ptr [rbp + -8]            # cas_mark
...
.Lx53_3:                mov              qword ptr [rip + rtccb+40], r8
                        ...
                        mov              r9,  qword ptr [rip + rtccb+48]
                        mov              r10, qword ptr [rip + rtccb+56]
                        mov              r11, qword ptr [rip + rtccb+64];     jmp   .Lx53_1
.Lx53_4:                mov              qword ptr [rip + rtccb+40], r8
                        ...
                        mov              r10, qword ptr [rip + rtccb+56]
                        mov              r11, qword ptr [rip + rtccb+64];     jmp   .Lx53_1
.Lx53_2:                call             rt_dcap_end_ok_close@PLT
                        add              rsp, 8
                        pop              r13
                        pop              r15
                        pop              r14
