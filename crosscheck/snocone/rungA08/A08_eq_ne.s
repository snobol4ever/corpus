...
n3_coerce_numeric_α:    sub              rsp, 16
                        ...
                        cmp              eax, 3;                              jne   .Lx27_0
.Lx27_1:                mov              rax, qword ptr [rsp + 32]
...
n4_coerce_numeric_α:    sub              rsp, 16
                        ...
                        cmp              eax, 3;                              jne   .Lx29_0
.Lx29_1:                mov              rax, qword ptr [rsp + 32]
                        mov              qword ptr [rsp + 0], rax             # result
                        mov              rax, qword ptr [rsp + 40]            # lit_integer
...
n5_cmp_test_α:          sub              rsp, 16
                        ...
                        mov              edx, eax
                        and              edx, ecx
                        cmp              edx, 3;                              jne   .Lx31_0
                        mov              rax, qword ptr [rsp + 40]
                        mov              rdx, qword ptr [rsp + 24]
                        cmp              rax, rdx;                            je    .Lx31_239
                        add              rsp, 16;                             jmp   n4_coerce_numeric_β
.Lx31_239:                                                                    jmp   n6_lit_string_α
.Lx31_0:                lea              rdi, [rsp + 32]
                        ...
                        test             eax, eax;                            je    .Lx31_240
                        add              rsp, 16;                             jmp   n4_coerce_numeric_β
.Lx31_240:                                                                    jmp   n6_lit_string_α
#-----------------------------------------------------------------------------------------------------------------------
...
#-----------------------------------------------------------------------------------------------------------------------
n10_statement_end_α:    add              rsp, 96;                             jmp   n11_statement_begin_α
#=======================================================================================================================
...
n14_coerce_numeric_α:   sub              rsp, 16
                        ...
                        mov              eax, dword ptr [rsp + 16]
                        cmp              eax, 3;                              jne   .Lx43_0
.Lx43_1:                mov              rax, qword ptr [rsp + 32]
                        mov              qword ptr [rsp + 0], rax             # result
                        mov              rax, qword ptr [rsp + 40]            # lit_integer
...
n14_coerce_numeric_β:   add              rsp, 16;                             jmp   n13_lit_integer_β
#-----------------------------------------------------------------------------------------------------------------------
n15_coerce_numeric_α:   sub              rsp, 16
                        mov              eax, dword ptr [rsp + 32]            # lit_integer
                        cmp              eax, 5;                              je    .Lx45_1
                        cmp              eax, 3;                              jne   .Lx45_0
                        mov              eax, dword ptr [rsp + 48]
                        cmp              eax, 3;                              jne   .Lx45_0
.Lx45_1:                mov              rax, qword ptr [rsp + 32]
                        mov              qword ptr [rsp + 0], rax             # result
                        mov              rax, qword ptr [rsp + 40]            # lit_integer
...
n15_coerce_numeric_β:   add              rsp, 16;                             jmp   n14_coerce_numeric_β
#-----------------------------------------------------------------------------------------------------------------------
n16_cmp_test_α:         sub              rsp, 16
                        ...
                        mov              edx, eax
                        and              edx, ecx
                        cmp              edx, 3;                              jne   .Lx47_0
                        mov              rax, qword ptr [rsp + 40]
                        mov              rdx, qword ptr [rsp + 24]
                        cmp              rax, rdx;                            jne   .Lx47_239
                        add              rsp, 16;                             jmp   n15_coerce_numeric_β
.Lx47_239:                                                                    jmp   n17_lit_string_α
.Lx47_0:                lea              rdi, [rsp + 32]
                        ...
                        mov              r8,  qword ptr [rip + rtccb+40]
                        mov              r9,  qword ptr [rip + rtccb+48]
                        test             eax, eax;                            jne   .Lx47_240
                        add              rsp, 16;                             jmp   n15_coerce_numeric_β
.Lx47_240:                                                                    jmp   n17_lit_string_α
#-----------------------------------------------------------------------------------------------------------------------
...
n19_lit_string_α:       mov              qword ptr [rsp + 128], 2             # result
                        ...
                        mov              qword ptr [rsp + 136], rax;          jmp   n20_assign_α
.Lx50_0:                .quad            .Lx50_0_s
.Lx50_0_s:              .string          "wrong"
#-----------------------------------------------------------------------------------------------------------------------
n20_assign_α:           mov              rsi, qword ptr [rsp + 128]
...
#-----------------------------------------------------------------------------------------------------------------------
n21_statement_end_α:    add              rsp, 96;                             jmp   main_γ
#-----------------------------------------------------------------------------------------------------------------------
main_β:
                                                                              jmp   main_ω
#-----------------------------------------------------------------------------------------------------------------------
