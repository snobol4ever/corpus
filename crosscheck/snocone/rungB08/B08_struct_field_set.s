...
.Lx33_0_s:              .string          "rect(width,height)"
#-----------------------------------------------------------------------------------------------------------------------
...
n10_statement_begin_β:  mov              r11, 11;                             jmp   n15_statement_begin_α
#-----------------------------------------------------------------------------------------------------------------------
...
n15_statement_begin_α:  mov              r11, 16
                        mov              r10, 4;                              jmp   n16_var_α
n15_statement_begin_β:  mov              r11, 16;                             jmp   n21_statement_begin_α
#-----------------------------------------------------------------------------------------------------------------------
n16_var_α:              sub              rsp, 16
                        ...
                        mov              rdx, qword ptr [r9 + 8]
                        mov              qword ptr [rsp + 0], rax             # result
                        mov              qword ptr [rsp + 8], rdx;            jmp   n17_field_var_α
#-----------------------------------------------------------------------------------------------------------------------
n17_field_var_α:        sub              rsp, 16
                        mov              r11, 18
...
n17_field_var_β:        mov              r11, 18
                        add              rsp, 16
                        add              rsp, 16;                             jmp   n15_statement_begin_β
.Lx58_0:                .quad            .Lx58_0_s
.Lx58_0_s:              .string          "width"
#-----------------------------------------------------------------------------------------------------------------------
n18_lit_integer_α:      sub              rsp, 16
                        mov              r11, 19
                        mov              qword ptr [rsp + 0], 3               # result
                        mov              rax, qword ptr [rip + .Lx59_0]
                        mov              qword ptr [rsp + 8], rax;            jmp   n19_assign_var_α
n18_lit_integer_β:      mov              r11, 19
                        add              rsp, 16;                             jmp   n17_field_var_β
.Lx59_0:                .quad            20
#-----------------------------------------------------------------------------------------------------------------------
...
n21_statement_begin_β:  mov              r11, 22;                             jmp   n26_statement_begin_α
#-----------------------------------------------------------------------------------------------------------------------
