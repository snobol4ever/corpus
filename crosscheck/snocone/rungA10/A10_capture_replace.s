...
.Lx26_0:                mov              r14d, dword ptr [rbp + -40];         jmp   n7_match_lit_α
...
n6_match_begin_af:      mov              r12, qword ptr [rbp + -8]            # cas_mark
                        ...
                        mov              r10, qword ptr [rip + rtccb+56]
                        mov              rsp, rbp
                        pop              rbp;                                 jmp   n4_statement_begin_β
#-----------------------------------------------------------------------------------------------------------------------
n7_match_lit_α:         mov              eax, r14d
                        ...
                        cmp              edx, 1819438967;                     jne   n6_match_begin_β
                        movzx            eax, byte ptr [r13+rcx+4]
                        cmp              eax, 100;                            jne   n6_match_begin_β
                        add              r14d, 5;                             jmp   n8_match_end_α
...
.Lx30_3:                mov              qword ptr [rip + rtccb+40], r8
                        ...
                        mov              r9,  qword ptr [rip + rtccb+48]
                        mov              r10, qword ptr [rip + rtccb+56]
                        mov              r11, qword ptr [rip + rtccb+64];     jmp   .Lx30_1
.Lx30_4:                mov              qword ptr [rip + rtccb+40], r8
                        ...
                        mov              r10, qword ptr [rip + rtccb+56]
                        mov              r11, qword ptr [rip + rtccb+64];     jmp   .Lx30_1
.Lx30_2:                call             rt_dcap_end_ok_close@PLT
                        add              rsp, 8
                        pop              r13
                        pop              r15
                        pop              r14
                        ...
                        pop              rbp;                                 jmp   n9_lit_string_α
#-----------------------------------------------------------------------------------------------------------------------
n9_lit_string_α:        sub              rsp, 16
                        mov              qword ptr [rsp + 0], 2               # result
                        mov              dword ptr [rsp + 4], 5
                        mov              rax, qword ptr [rip + .Lx31_0]
                        mov              qword ptr [rsp + 8], rax;            jmp   n10_match_replace_α
.Lx31_0:                .quad            .Lx31_0_s
.Lx31_0_s:              .string          "there"
#-----------------------------------------------------------------------------------------------------------------------
n10_match_replace_α:    mov              rdi, qword ptr [rip + .Lx33_0]
                        ...
                        mov              r10, qword ptr [rip + rtccb+56]
                        mov              r11, qword ptr [rip + rtccb+64]
                        add              rsp, 16;                             jmp   .Lx33_1
.Lx33_0:                .quad            .Lx33_0_s
.Lx33_0_s:              .string          "x"
.Lx33_1:                                                                      jmp   n11_statement_end_α
#-----------------------------------------------------------------------------------------------------------------------
