...
.Lx30_0:                mov              r14d, dword ptr [rbp + -40];         jmp   n7_match_lit_α
...
n7_match_lit_α:         mov              eax, r14d
                        ...
                        cmp              edx, 1685024615;                     jne   n6_match_begin_β
                        movzx            eax, byte ptr [r13+rcx+4]
                        cmp              eax, 98;                             jne   n6_match_begin_β
                        movzx            eax, byte ptr [r13+rcx+5]
                        cmp              eax, 121;                            jne   n6_match_begin_β
                        movzx            eax, byte ptr [r13+rcx+6]
                        cmp              eax, 101;                            jne   n6_match_begin_β
                        add              r14d, 7;                             jmp   n8_match_end_α
n7_match_lit_β:         sub              r14d, 7;                             jmp   n6_match_begin_β
#-----------------------------------------------------------------------------------------------------------------------
n8_match_end_α:         push             r14
                        push             r15
                        push             r13
                        sub              rsp, 8
                        mov              rsi, r12
...
#-----------------------------------------------------------------------------------------------------------------------
n15_statement_end_α:                                                          jmp   main_γ
#=======================================================================================================================
