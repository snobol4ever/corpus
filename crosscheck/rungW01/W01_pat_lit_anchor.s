...
n6_statement_begin_β:   mov              r11, 7;                              jmp   n16_statement_begin_α
#-----------------------------------------------------------------------------------------------------------------------
n7_var_α:               sub              rsp, 16
                        mov              r11, 8
...
.Lx34_0:                mov              r14d, dword ptr [rbp + -40]
                        ...
                        lea              rax, [rip + .Lx34_13]
                        mov              qword ptr [rcx + 248], rax;          jmp   n9_match_lit_α
...
n9_match_lit_α:         mov              r11, 10
                        mov              eax, r14d
                        add              eax, 5
                        cmp              eax, r15d;                           jg    n8_match_begin_β
                        movsxd           rcx, r14d
                        mov              edx, dword ptr [r13+rcx]
                        cmp              edx, 1819438967;                     jne   n8_match_begin_β
                        movzx            eax, byte ptr [r13+rcx+4]
                        cmp              eax, 100;                            jne   n8_match_begin_β
                        add              r14d, 5;                             jmp   n10_match_end_α
n9_match_lit_β:         mov              r11, 10
                        sub              r14d, 5;                             jmp   n8_match_begin_β
#-----------------------------------------------------------------------------------------------------------------------
...
.Lx43_0_s:              .string          "PASS W01/003: unanchored substring match"
#-----------------------------------------------------------------------------------------------------------------------
...
.Lx49_0_s:              .string          "FAIL W01/003: unanchored substring match should succeed"
#-----------------------------------------------------------------------------------------------------------------------
