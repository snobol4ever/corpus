...
n9_match_lit_α:         mov              r11, 10
                        ...
                        cmp              eax, 120;                            jne   n8_match_begin_β
                        movzx            eax, byte ptr [r13+rcx+1]
                        cmp              eax, 121;                            jne   n8_match_begin_β
                        movzx            eax, byte ptr [r13+rcx+2]
                        cmp              eax, 122;                            jne   n8_match_begin_β
                        add              r14d, 3;                             jmp   n10_match_end_α
n9_match_lit_β:         mov              r11, 10
                        sub              r14d, 3;                             jmp   n8_match_begin_β
#-----------------------------------------------------------------------------------------------------------------------
...
.Lx43_0_s:              .string          "PASS W01/002: literal mismatch failed correctly"
#-----------------------------------------------------------------------------------------------------------------------
...
.Lx49_0_s:              .string          "FAIL W01/002: literal mismatch should fail"
#-----------------------------------------------------------------------------------------------------------------------
