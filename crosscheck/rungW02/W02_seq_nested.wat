...
(module
  ...
  (data (i32.const 65536) "xabcabcPASS W02/002: nested seq match succeededFAIL W02/002: nested seq match should succeed")
  ...
  (func (export "main") (result i32)
    ...
    (global.get $var_pat_off)
    (global.get $var_pat_len)
