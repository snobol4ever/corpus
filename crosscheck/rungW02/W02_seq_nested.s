...
; ======================================================================================================================
                            mov         edi, 4
                            call        comm_stno
                            ASSIGN_STR  S_subject, S_xabc, Ln_0
                            jmp         Ln_0
...
Ln_2:                       mov         edi, 7
                            call        comm_stno
                            LOAD_STR    S_PASS_SP_W02_SL_002_CL_SP_nested_SP_seq_SP_match_SP_succeeded
                            FAIL_BR     Lf_3
                            SET_OUTPUT
...
L_e001_0:                   mov         edi, 8
                            call        comm_stno
                            LOAD_STR    S_FAIL_SP_W02_SL_002_CL_SP_nested_SP_seq_SP_match_SP_should_SP_succeed
                            FAIL_BR     Ln_4
                            SET_OUTPUT
                            jmp         Ln_4
...
S_xabc               db 120, 97, 98, 99, 0  ; "xabc"
S_pat                db 112, 97, 116, 0  ; "pat"
S_c                  db 99, 0  ; "c"
S_b                  db 98, 0  ; "b"
S_a                  db 97, 0  ; "a"
S_OUTPUT             db 79, 85, 84, 80, 85, 84, 0  ; "OUTPUT"
S_PASS_SP_W02_SL_002_CL_SP_nested_SP_seq_SP_match_SP_succeeded db 80, 65, 83, 83, 32, 87, 48, 50, 47, 48, 48, 50, 58, 32, 110, 101, 115, 116, 101, 100, 32, 115, 101, 113, 32, 109, 97, 116, 99, 104, 32, 115, 117, 99, 99, 101, 101, 100, 101, 100, 0  ; "PASS W02/002: nested seq match succeeded"
S_e001               db 101, 48, 48, 49, 0  ; "e001"
S_FAIL_SP_W02_SL_002_CL_SP_nested_SP_seq_SP_match_SP_should_SP_succeed db 70, 65, 73, 76, 32, 87, 48, 50, 47, 48, 48, 50, 58, 32, 110, 101, 115, 116, 101, 100, 32, 115, 101, 113, 32, 109, 97, 116, 99, 104, 32, 115, 104, 111, 117, 108, 100, 32, 115, 117, 99, 99, 101, 101, 100, 0  ; "FAIL W02/002: nested seq match should succeed"
