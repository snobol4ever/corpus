...
(module
  ...
  (data (i32.const 65536) "12integerFAIL 910/001: string->integerFAIL 910/002: real->integer truncationrealFAIL 910/003: integer->real.2FAIL 910/004: string->realPASS 910_convert (4/4)")
