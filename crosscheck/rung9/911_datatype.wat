...
(module
  ...
  (data (i32.const 65536) "hellostringFAIL 911/001: string literal datatypeintegerFAIL 911/002: integer datatyperealFAIL 911/003: real datatypeFAIL 911/004: null is stringPASS 911_datatype (4/4)")
  ...
  (func (export "main") (result i32)
    ...
    (block $datatype_done (result i32 i32)
      (if (i32.eq (call $sno_handle_type (local.get $arr_ok)) (i32.const 3)) (then
        ...
        (br $datatype_done)))
      (i32.const 65541) (i32.const 6)
    ) ;; $datatype_done
    (drop)
    (drop)
    ;; unimplemented builtin 'lcase' in value ctx — empty string
    (i32.const 65536)
    (i32.const 0)
    (i32.const 65541)
    (i32.const 6)
    ...
    (i64.const 12)
    (drop)
    (i32.const 65584) ;; datatype=integer
    (i32.const 7)
    (drop)
    (drop)
    ;; unimplemented builtin 'lcase' in value ctx — empty string
