...
.method static <clinit>()V
    ...
    putstatic       _10_convert/sno_stdout Ljava/io/PrintStream;
    iconst_0
    putstatic       _10_convert/sno_kw_TRIM I
    iconst_0
    putstatic       _10_convert/sno_kw_ANCHOR I
    iconst_0
    putstatic       _10_convert/sno_kw_STNO I
    iconst_m1
    putstatic       _10_convert/sno_kw_STLIMIT I
    iconst_0
    putstatic       _10_convert/sno_kw_STCOUNT I
    new java/util/HashMap
    dup
    invokespecial java/util/HashMap/<init>()V
    putstatic       _10_convert/sno_vars Ljava/util/HashMap;
    new java/util/HashMap
    dup
    invokespecial java/util/HashMap/<init>()V
    putstatic       _10_convert/sno_arrays Ljava/util/HashMap;
    new java/util/HashMap
    dup
    invokespecial java/util/HashMap/<init>()V
    putstatic       _10_convert/sno_data_types Ljava/util/HashMap;
    return
.end method
...
.method static sno_mon_init()V
    ...
    putstatic _10_convert/sno_mon_fd Ljava/io/OutputStream;
    ldc "MONITOR_GO_PIPE"
    invokestatic java/lang/System/getenv(Ljava/lang/String;)Ljava/lang/String;
    astore_1
    aload_1
    ...
    putstatic _10_convert/sno_mon_go_fd Ljava/io/InputStream;
Lsmi_done:
    return
.end method
...
.method public static main([Ljava/lang/String;)V
    ...
    invokestatic _10_convert/sno_mon_init()V
    getstatic _10_convert/sno_kw_STNO I
    iconst_1
    iadd
    putstatic _10_convert/sno_kw_STNO I
    invokestatic _10_convert/sno_stcount_tick()V
    ldc "12"
    invokestatic _10_convert/sno_to_double(Ljava/lang/String;)D
    d2l
...
Lef_dn_0:
    ...
    putstatic _10_convert/sno_kw_STNO I
    invokestatic _10_convert/sno_stcount_tick()V
    ldc "FAIL 910/001: string->integer"
    dup
    ifnonnull Lout_ok_0
    pop
    goto Lout_fail_0
Lout_ok_0:
    getstatic _10_convert/sno_stdout Ljava/io/PrintStream;
    swap
...
Lef_dn_1:
    ...
    putstatic _10_convert/sno_kw_STNO I
    invokestatic _10_convert/sno_stcount_tick()V
    ldc "FAIL 910/002: real->integer truncation"
    dup
    ifnonnull Lout_ok_1
    pop
    goto Lout_fail_1
...
L_e002:
    ...
    ldc "2"
    invokestatic _10_convert/sno_to_double(Ljava/lang/String;)D
    invokestatic _10_convert/sno_fmt_double(D)Ljava/lang/String;
    dup
...
Lkwg_not_stno:
    ...
    invokevirtual java/lang/String/equalsIgnoreCase(Ljava/lang/String;)Z
    ifeq Lkwg_not_trim
    getstatic _10_convert/sno_kw_TRIM I
    invokestatic java/lang/Integer/toString(I)Ljava/lang/String;
    areturn
Lkwg_not_trim:
    aload_0
    ...
    getstatic _10_convert/sno_kw_ANCHOR I
    invokestatic java/lang/Integer/toString(I)Ljava/lang/String;
    areturn
Lkwg_not_anchor:
    aload_0
    ...
    getstatic _10_convert/sno_kw_STLIMIT I
    invokestatic java/lang/Integer/toString(I)Ljava/lang/String;
    areturn
Lkwg_not_stlimit:
    aload_0
    ...
    getstatic _10_convert/sno_kw_STCOUNT I
    invokestatic java/lang/Integer/toString(I)Ljava/lang/String;
    areturn
Lkwg_not_stcount:
    ldc ""
...
.method static sno_var_put(Ljava/lang/String;Ljava/lang/String;)V
    ...
    return
Lsvp_not_output:
    getstatic _10_convert/sno_vars Ljava/util/HashMap;
    aload_0
    aload_1
    ...
    aload_0
    aload_1
    invokestatic _10_convert/sno_mon_var(Ljava/lang/String;Ljava/lang/String;)V
    return
.end method
...
.method static sno_mon_var(Ljava/lang/String;Ljava/lang/String;)V
    .limit stack 6
    .limit locals 3
    getstatic _10_convert/sno_mon_fd Ljava/io/OutputStream;
    ifnull Lsmv_done
    new java/lang/StringBuilder
    dup
    invokespecial java/lang/StringBuilder/<init>()V
    ...
    getstatic _10_convert/sno_mon_go_fd Ljava/io/InputStream;
    ifnull Lsmv_done
    getstatic _10_convert/sno_mon_go_fd Ljava/io/InputStream;
