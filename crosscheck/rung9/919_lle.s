...
n5_cmp_test_α:          sub              rsp, 16
                        ...
                        cmp              rax, rdx;                            jle   .Lx81_239
                        add              rsp, 16;                             jmp   n4_lit_string_β
.Lx81_239:                                                                    jmp   n6_statement_end_α
.Lx81_0:                lea              rdi, [rsp + 32]                      # a
                        lea              rsi, [rsp + 16]                      # b
                        call             rt_cmp_d@PLT
                        test             eax, eax;                            jle   .Lx81_240
                        add              rsp, 16;                             jmp   n4_lit_string_β
...
.Lx86_0_s:              .string          "FAIL 919/001: LLE(abc,abc) should succeed"
#-----------------------------------------------------------------------------------------------------------------------
...
n16_cmp_test_α:         sub              rsp, 16
                        ...
                        mov              rax, qword ptr [rsp + 40]
                        mov              rdx, qword ptr [rsp + 24]
                        cmp              rax, rdx;                            jle   .Lx99_239
                        add              rsp, 16;                             jmp   n15_lit_string_β
.Lx99_239:                                                                    jmp   n17_statement_end_α
.Lx99_0:                lea              rdi, [rsp + 32]                      # a
                        lea              rsi, [rsp + 16]                      # b
                        call             rt_cmp_d@PLT
                        test             eax, eax;                            jle   .Lx99_240
                        add              rsp, 16;                             jmp   n15_lit_string_β
...
.Lx104_0_s:             .string          "FAIL 919/002: LLE(abc,xyz) should succeed"
#-----------------------------------------------------------------------------------------------------------------------
...
n27_cmp_test_α:         sub              rsp, 16
                        ...
                        mov              rax, qword ptr [rsp + 40]
                        mov              rdx, qword ptr [rsp + 24]
                        cmp              rax, rdx;                            jle   .Lx117_239
                        add              rsp, 16;                             jmp   n26_lit_string_β
.Lx117_239:                                                                   jmp   n28_statement_end_α
.Lx117_0:               lea              rdi, [rsp + 32]                      # a
                        lea              rsi, [rsp + 16]                      # b
                        call             rt_cmp_d@PLT
                        test             eax, eax;                            jle   .Lx117_240
                        add              rsp, 16;                             jmp   n26_lit_string_β
...
.Lx122_0_s:             .string          "FAIL 919/003: LLE(xyz,abc) should fail"
#-----------------------------------------------------------------------------------------------------------------------
...
.Lx140_0_s:             .string          "FAIL 919/004: LLE(null,abc) should succeed"
#-----------------------------------------------------------------------------------------------------------------------
...
n49_cmp_test_α:         sub              rsp, 16
                        ...
                        mov              rax, qword ptr [rsp + 40]
                        mov              rdx, qword ptr [rsp + 24]
                        cmp              rax, rdx;                            jle   .Lx153_239
                        add              rsp, 16;                             jmp   n48_lit_string_β
.Lx153_239:                                                                   jmp   n50_statement_end_α
.Lx153_0:               lea              rdi, [rsp + 32]                      # a
                        lea              rsi, [rsp + 16]                      # b
                        call             rt_cmp_d@PLT
                        test             eax, eax;                            jle   .Lx153_240
                        add              rsp, 16;                             jmp   n48_lit_string_β
...
.Lx158_0_s:             .string          "FAIL 919/005: LLE(null,null) should succeed"
#-----------------------------------------------------------------------------------------------------------------------
...
n60_cmp_test_α:         sub              rsp, 16
                        ...
                        mov              rax, qword ptr [rsp + 40]
                        mov              rdx, qword ptr [rsp + 24]
                        cmp              rax, rdx;                            jle   .Lx171_239
                        add              rsp, 16;                             jmp   n59_lit_string_β
.Lx171_239:                                                                   jmp   n61_statement_end_α
.Lx171_0:               lea              rdi, [rsp + 32]                      # a
                        lea              rsi, [rsp + 16]                      # b
                        call             rt_cmp_d@PLT
                        test             eax, eax;                            jle   .Lx171_240
                        add              rsp, 16;                             jmp   n59_lit_string_β
...
.Lx176_0_s:             .string          "FAIL 919/006: LLE(A,a) should succeed (ordinal)"
#-----------------------------------------------------------------------------------------------------------------------
...
.Lx186_0_s:             .string          "PASS 919_lle (6/6)"
#-----------------------------------------------------------------------------------------------------------------------
