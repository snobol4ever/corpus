...
(module
  ...
  (data (i32.const 65536) "abcxyzFAIL 914/001: lgt(abc,xyz) should failFAIL 914/002: lgt(abc,abc) should failFAIL 914/003: lgt(xyz,abc) should succeedFAIL 914/004: lgt(null,abc) should failFAIL 914/005: lgt(abc,null) should succeedPASS 914_lgt (5/5)")
