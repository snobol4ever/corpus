...
(module
  ...
  (func $sno_var_get (param $no i32) (param $nl i32) (result i32 i32)
    (if (call $sno_str_eq (local.get $no) (local.get $nl) (i32.const 65542) (i32.const 1)) (then
      (return (global.get $var_V_off) (global.get $var_V_len))
    ))
    (if (call $sno_str_eq (local.get $no) (local.get $nl) (i32.const 65536) (i32.const 1)) (then
  ...
  (func $sno_var_set (param $no i32) (param $nl i32) (param $vo i32) (param $vl i32)
    (if (call $sno_str_eq (local.get $no) (local.get $nl) (i32.const 65542) (i32.const 1)) (then
      (global.set $var_V_off (local.get $vo))
      (global.set $var_V_len (local.get $vl))
      (return)
    ))
    (if (call $sno_str_eq (local.get $no) (local.get $nl) (i32.const 65536) (i32.const 1)) (then
  ...
  (func (export "main") (result i32)
    ...
    (i32.const 1)
      ...
      ;; $... = (indirect assign)
      (i32.const 65542) ;; $var lval name=V
      (i32.const 1)
      (local.set $indr_nl)
      (local.set $indr_no)
    (i32.const 65537)
