...
(module
  ...
  (func (export "main") (result i32)
    ...
    (global.get $var_X_len)
      (global.set $var_Y_len)
      (global.set $var_Y_off)
      (local.set $ok (i32.const 1))
      ;; OUTPUT = ...
    (global.get $var_Y_off)
    (global.get $var_Y_len)
      (call $sno_output_str)
      (local.set $ok (i32.const 1))
      ) ;; $L1 END
      ;; END
