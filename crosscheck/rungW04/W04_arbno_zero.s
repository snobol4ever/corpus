...
n10_match_lit_α:        mov              eax, r14d
                        ...
                        cmp              edx, 1819043176;                     jne   n9_match_arbno_β
                        movzx            eax, byte ptr [r13+rcx+4]
                        cmp              eax, 111;                            jne   n9_match_arbno_β
                        add              r14d, 5;                             jmp   n11_match_end_α
n10_match_lit_β:        sub              r14d, 5;                             jmp   n9_match_arbno_β
#-----------------------------------------------------------------------------------------------------------------------
...
n13_match_lit_α:        mov              eax, r14d
                        ...
                        cmp              eax, 120;                            jne   n9_match_arbno_af
                        movzx            eax, byte ptr [r13+rcx+1]
                        cmp              eax, 121;                            jne   n9_match_arbno_af
                        movzx            eax, byte ptr [r13+rcx+2]
                        cmp              eax, 122;                            jne   n9_match_arbno_af
                        add              r14d, 3;                             jmp   n9_match_arbno_as
n13_match_lit_β:        sub              r14d, 3;                             jmp   n9_match_arbno_af
#=======================================================================================================================
...
.Lx49_0_s:              .string          "PASS W04/002: arbno zero match"
#-----------------------------------------------------------------------------------------------------------------------
...
.Lx55_0_s:              .string          "FAIL W04/002: arbno zero should succeed"
#-----------------------------------------------------------------------------------------------------------------------
