...
_pc = 28; continue dispatch;
    case 52: /* uid13 PROCEED */
        if (_cur2 + 5 > _slen2) { _pc = 44; continue dispatch;
 }
        if (_subj2.slice(_cur2, _cur2+5) !== "hello") { _pc = 44; continue dispatch;
 }
        _saved[13] = _cur2; _cur2 += 5;
...
/* line 6 */
    var _v15 = "PASS W04/002: arbno zero match";
...
/* line 7 */
    var _v16 = "FAIL W04/002: arbno zero should succeed";
