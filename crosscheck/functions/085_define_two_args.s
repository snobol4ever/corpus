...
.Lx28_81:               mov              rax, qword ptr [rsp + 64]
                        ...
                        mov              qword ptr [r9 + 40], rax
.Lx28_111:              mov              rcx, qword ptr [rcx + 8]
                        add              rsp, 80
                        mov              rax, rdi
                        mov              rdx, rsi;                            jmp   rcx
...
.Lx28_151:              mov              rax, qword ptr [rsp + 64]
                        ...
                        mov              rax, qword ptr [rsp + 72]
                        mov              qword ptr [r9 + 40], rax
.Lx28_181:              mov              rcx, qword ptr [rcx + 16]
                        add              rsp, 80
                        mov              eax, 104
                        xor              edx, edx;                            jmp   rcx
.Lx28_245:
...
n14_call_β:             mov              r11, 15;                             jmp   n13_lit_integer_β
...
n16_statement_end_α:    mov              r11, 17
                        mov              r10, 4
                        add              rsp, 48;                             jmp   n17_statement_begin_α
#=======================================================================================================================
#         OUTPUT = add(10, 32)
#-----------------------------------------------------------------------------------------------------------------------
...
n20_call_β:             mov              r11, 21;                             jmp   n19_lit_integer_β
