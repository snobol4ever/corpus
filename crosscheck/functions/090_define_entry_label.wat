...
(module
  ...
  (data (i32.const 65536) "bumpit(v)")

  ;; SNOBOL4 variables: each → (offset, length) global pair
  (global $var_bumpit_off (mut i32) (i32.const 0))
  (global $var_bumpit_len (mut i32) (i32.const 0))
  ...
  (func (export "main") (result i32)
    ...
    (i64.add)
      (call $sno_int_to_str)
      (global.set $var_bumpit_len)
      (global.set $var_bumpit_off)
    ...
    (i64.const 41)
    (drop)
    ;; unimplemented builtin 'bumpit' in value ctx — empty string
    (i32.const 65536)
    (i32.const 0)
      (call $sno_output_str)
      (local.set $ok (i32.const 1))
