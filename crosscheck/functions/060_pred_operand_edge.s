...
.Lx243_0:
                        ...
                        call             rt_coerce_num2_d@PLT
                                                                                        jmp   n81_cmp_test_α
n80_coerce_numeric_β:
                        add              rsp, 16
                                                                                        jmp   n79_coerce_numeric_β
#-----------------------------------------------------------------------------------------------------------------------
n81_cmp_test_α:
                        sub              rsp, 16
                        lea              rdi, [rsp + 32]                                # coerce_numeric
