...
(module
  ...
  (func (export "main") (result i32)
    ...
    (i32.const 6)
      ...
      (local.set $ok)
      (local.set $pc (i32.const 3)) ;; → fib_end
      (br $dispatch)
      ) ;; $L1 fib
      ;; subject eval
    ...
    (i64.sub)
    (drop)
    ;; unimplemented builtin 'fib' in value ctx — empty string
    (i32.const 65536)
    (i32.const 0)
    (call $sno_str_to_int)
    (global.get $var_n_off)
    ...
    (i64.add)
      (call $sno_int_to_str)
      (global.set $var_fib_len)
      (global.set $var_fib_off)
