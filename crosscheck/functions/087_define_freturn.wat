...
(module
  ...
  (data (i32.const 65536) "ispos(x)positivewrongnot positive")
  ...
  (func (export "main") (result i32)
    ...
    (i32.const 8)
      ...
      (local.set $ok)
      (local.set $pc (i32.const 2)) ;; → ispos_end
      (br $dispatch)
      ) ;; $L1 ispos
      ;; subject eval
    ...
    (i64.const 5)
      (drop)
      (i32.const 1) ;; builtin 'ispos' — treated as succeed
      (local.set $ok)
      (if (local.get $ok) (then
