...
.Lx16_0:                cmp              eax, 1;                              jne   .Lx16_1
                        ...
                        mov              qword ptr [rsp + 8], rax;            jmp   main_γ
.Lx16_1:                                                                      jmp   main_γ
n2_disjunction_β:       mov              eax, dword ptr [rsp + 16]
                        cmp              eax, 0;                              je    main_ω
                                                                              jmp   main_ω
...
n3_lit_string_β:                                                              jmp   n5_var_α
.Lx17_0:                .quad            .Lx17_0_s
.Lx17_0_s:              .string          "small"
#-----------------------------------------------------------------------------------------------------------------------
n4_call_builtin_icon_α: mov              rax, qword ptr [rsp + 272]
...
#-----------------------------------------------------------------------------------------------------------------------
n5_var_α:               mov              rax, qword ptr [rsp + 320]
...
.Lrkfn23:               .string          "write"
                        ...
                        mov              r8,  qword ptr [rip + rtccb+40]
                        mov              r9,  qword ptr [rip + rtccb+48];     jmp   n7_conjunction_α
n6_call_builtin_icon_β:                                                       jmp   main_ω
#-----------------------------------------------------------------------------------------------------------------------
n7_conjunction_α:       mov              rax, qword ptr [rsp + 160]
                        mov              qword ptr [rsp + 144], rax
                        mov              rax, qword ptr [rsp + 168]
                        mov              qword ptr [rsp + 152], rax;          jmp   n2_disjunction_as
n7_conjunction_β:                                                             jmp   main_ω
#-----------------------------------------------------------------------------------------------------------------------
n8_var_α:               mov              rax, qword ptr [rsp + 320]
                        mov              qword ptr [rsp + 112], rax
                        mov              rax, qword ptr [rsp + 328]
                        mov              qword ptr [rsp + 120], rax;          jmp   n9_lit_integer_α
n8_var_β:                                                                     jmp   n2_disjunction_af
#-----------------------------------------------------------------------------------------------------------------------
...
.Lx27_0:                .quad            3
#-----------------------------------------------------------------------------------------------------------------------
n10_binop_test_α:       mov              eax, dword ptr [rsp + 320]
