...
n0_disjunction_β:       mov              eax, dword ptr [rsp + 160];          jmp   n6_disjunction_α
n0_disjunction_af:      add              dword ptr [rsp + 160], 1
                        mov              eax, dword ptr [rsp + 160];          jmp   n6_disjunction_α
#-----------------------------------------------------------------------------------------------------------------------
n1_lit_string_α:        mov              qword ptr [rsp + 256], 2             # result
...
#-----------------------------------------------------------------------------------------------------------------------
n3_binop_test_α:        mov              rdi, qword ptr [rsp + 256]
...
.Lx17_0:                .quad            1
#-----------------------------------------------------------------------------------------------------------------------
n5_call_builtin_icon_α: mov              rax, qword ptr [rsp + 224]
...
.Lx21_0:                                                                      jmp   main_γ
n6_disjunction_β:       mov              eax, dword ptr [rsp + 16];           jmp   main_ω
