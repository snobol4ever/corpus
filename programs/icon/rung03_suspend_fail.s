...
n0_disjunction_as:      mov              eax, dword ptr [rsp + 48]
                        cmp              eax, 0;                              jne   .Lx7_0
                                                                              jmp   proc_positive_γ
.Lx7_0:                                                                       jmp   proc_positive_γ
n0_disjunction_β:       mov              eax, dword ptr [rsp + 48];           jmp   proc_positive_ω
n0_disjunction_af:      add              dword ptr [rsp + 48], 1
                        mov              eax, dword ptr [rsp + 48];           jmp   proc_positive_ω
#-----------------------------------------------------------------------------------------------------------------------
n1_var_α:               mov              rax, qword ptr [rsp + 16]
                        mov              qword ptr [rsp + 96], rax
                        mov              rax, qword ptr [rsp + 24]
                        mov              qword ptr [rsp + 104], rax;          jmp   n2_lit_integer_α
n1_var_β:                                                                     jmp   n0_disjunction_af
#-----------------------------------------------------------------------------------------------------------------------
...
#-----------------------------------------------------------------------------------------------------------------------
n5_return_α:            mov              rax, qword ptr [rsp + 64]
                        mov              rdx, qword ptr [rsp + 72]
                        mov              qword ptr [rsp + 0], rax
                        mov              qword ptr [rsp + 8], rdx;            jmp   proc_positive_γ
#-----------------------------------------------------------------------------------------------------------------------
proc_positive_res:
                        add              rsp, 8
                        pop              rsp
...
proc_positive_dcα:
                        ...
                        add              rsp, 16
                        lea              rcx, [rip + .Lx15_2]
                        lea              rdx, [rip + .Lx15_3];                jmp   proc_positive_α
.Lx15_2:                pop              r11
                        pop              r11;                                 jmp   r11
.Lx15_3:                pop              r11
                        pop              r11
...
main_α_body:
#-----------------------------------------------------------------------------------------------------------------------
n16_disjunction_α:      mov              qword ptr [rsp + 224], 0
                        mov              qword ptr [rsp + 232], 0
                        mov              dword ptr [rsp + 240], 0;            jmp   n17_lit_integer_α
n16_disjunction_as:     mov              eax, dword ptr [rsp + 240]
...
n16_disjunction_β:      mov              eax, dword ptr [rsp + 240];          jmp   n21_disjunction_α
n16_disjunction_af:     add              dword ptr [rsp + 240], 1
...
n17_lit_integer_β:                                                            jmp   n16_disjunction_af
.Lx30_0:                .quad            5
#-----------------------------------------------------------------------------------------------------------------------
n18_call_proc_staged_α: lea              rsi, [rsp + 368]
                        call             proc_positive_dcα;                   jmp   .Lx32_2
...
#-----------------------------------------------------------------------------------------------------------------------
n19_lit_integer_α:      mov              qword ptr [rsp + 304], 3             # result
...
#-----------------------------------------------------------------------------------------------------------------------
n21_disjunction_α:      mov              qword ptr [rsp + 0], 0
                        mov              qword ptr [rsp + 8], 0
                        mov              dword ptr [rsp + 16], 0;             jmp   n24_lit_integer_α
n21_disjunction_as:     mov              eax, dword ptr [rsp + 16]
...
.Lx37_0:                cmp              eax, 1;                              jne   .Lx37_1
                        ...
                        mov              qword ptr [rsp + 8], rax;            jmp   main_γ
.Lx37_1:                                                                      jmp   main_γ
n21_disjunction_β:      mov              eax, dword ptr [rsp + 16]
                        cmp              eax, 0;                              je    main_ω
                                                                              jmp   main_ω
n21_disjunction_af:     add              dword ptr [rsp + 16], 1
                        mov              eax, dword ptr [rsp + 16]
...
n23_call_builtin_icon_β:
                                                                              jmp   main_ω
#-----------------------------------------------------------------------------------------------------------------------
n24_lit_integer_α:      mov              qword ptr [rsp + 144], 3             # result
                        mov              rax, qword ptr [rip + .Lx41_0]
                        mov              qword ptr [rsp + 152], rax;          jmp   n25_call_proc_staged_α
n24_lit_integer_β:                                                            jmp   n21_disjunction_af
.Lx41_0:                .quad            0
#-----------------------------------------------------------------------------------------------------------------------
n25_call_proc_staged_α: lea              rsi, [rsp + 144]
                        call             proc_positive_dcα;                   jmp   .Lx43_2
...
#-----------------------------------------------------------------------------------------------------------------------
n26_lit_integer_α:      mov              qword ptr [rsp + 80], 3              # result
