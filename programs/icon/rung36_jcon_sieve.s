...
n2_call_builtin_icon_β: mov              r11, 3;                              jmp   n4_var_α
#-----------------------------------------------------------------------------------------------------------------------
...
n7_to_β:                mov              r11, 8
                        inc              qword ptr [rsp + 864];               jmp   .Lx55_0
#-----------------------------------------------------------------------------------------------------------------------
...
.Lrkfn57:               .string          "insert"
                        ...
                        cmp              al, 104;                             je    n7_to_β
                        mov              r8,  qword ptr [rip + rtccb+40]
                        mov              r9,  qword ptr [rip + rtccb+48];     jmp   n7_to_β
n8_call_builtin_icon_β: mov              r11, 9;                              jmp   n7_to_β
#-----------------------------------------------------------------------------------------------------------------------
n9_var_α:               mov              r11, 10
                        mov              rax, qword ptr [rsp + 1120]
...
n12_to_β:               mov              r11, 13
                        inc              qword ptr [rsp + 448];               jmp   .Lx64_0
#-----------------------------------------------------------------------------------------------------------------------
...
.Lrkfn67:               .string          "member"
                        ...
                        cmp              al, 104;                             je    n12_to_β
                        mov              r8,  qword ptr [rip + rtccb+40]
                        mov              r9,  qword ptr [rip + rtccb+48];     jmp   n15_bound_α
n14_call_builtin_icon_β:
                        mov              r11, 15;                             jmp   n12_to_β
#-----------------------------------------------------------------------------------------------------------------------
n15_bound_α:            mov              r11, 16
                        mov              qword ptr [rsp + 496], rsp;          jmp   n16_var_α
#-----------------------------------------------------------------------------------------------------------------------
...
.Lrkfn88:               .string          "delete"
                        ...
                        cmp              al, 104;                             je    n24_to_by_β
                        mov              r8,  qword ptr [rip + rtccb+40]
                        mov              r9,  qword ptr [rip + rtccb+48];     jmp   n24_to_by_β
n25_call_builtin_icon_β:
                        mov              r11, 26;                             jmp   n24_to_by_β
#-----------------------------------------------------------------------------------------------------------------------
n26_unmark_α:           mov              r11, 27
                        mov              rsp, qword ptr [rsp + 496];          jmp   n12_to_β
#-----------------------------------------------------------------------------------------------------------------------
...
n29_call_builtin_icon_β:
                        mov              r11, 30;                             jmp   n30_lit_string_α
#-----------------------------------------------------------------------------------------------------------------------
...
n37_lit_integer_β:      mov              r11, 38;                             jmp   n0_disjunction_af
.Lx106_0:               .quad            1000
#-----------------------------------------------------------------------------------------------------------------------
...
n38_var_ref_β:          mov              r11, 39;                             jmp   n0_disjunction_af
#-----------------------------------------------------------------------------------------------------------------------
...
n42_call_builtin_icon_β:
                        mov              r11, 43;                             jmp   n0_disjunction_af
#-----------------------------------------------------------------------------------------------------------------------
main_β:
                                                                              jmp   main_ω
#-----------------------------------------------------------------------------------------------------------------------
