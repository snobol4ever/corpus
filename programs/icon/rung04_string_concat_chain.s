...
n4_var_α:               mov              rax, qword ptr [rsp + 176]
                        ...
                        mov              qword ptr [rsp + 88], rax;           jmp   n5_var_α
#-----------------------------------------------------------------------------------------------------------------------
n5_var_α:               mov              rax, qword ptr [rsp + 192]
                        mov              qword ptr [rsp + 96], rax
                        mov              rax, qword ptr [rsp + 200]
                        mov              qword ptr [rsp + 104], rax;          jmp   n6_binop_α
#-----------------------------------------------------------------------------------------------------------------------
n6_binop_α:             mov              rdi, qword ptr [rsp + 176]
...
n7_lit_string_α:        mov              qword ptr [rsp + 112], 2             # result
                        ...
                        mov              qword ptr [rsp + 120], rax;          jmp   n8_binop_α
.Lx19_0:                .quad            .Lx19_0_s
.Lx19_0_s:              .string          "!"
#-----------------------------------------------------------------------------------------------------------------------
n8_binop_α:             mov              rdi, qword ptr [rsp + 64]
