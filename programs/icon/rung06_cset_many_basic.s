...
n2_lit_charset_α:       mov              r11, 3
                        ...
                        mov              qword ptr [rsp + 152], rax;          jmp   n3_scan_many_α
.Lx10_0:                .quad            .Lx10_0_s
.Lx10_0_s:              .string          "abc"
#-----------------------------------------------------------------------------------------------------------------------
n3_scan_many_α:         mov              r11, 4
                        mov              eax, r14d
.Lx12_0:                cmp              eax, r15d;                           jge   .Lx12_1
                        movsxd           rcx, eax
                        ...
                        test             rax, rax
                        pop              rax;                                 je    .Lx12_1
                        add              eax, 1;                              jmp   .Lx12_0
.Lx12_1:                cmp              eax, r14d;                           je    n6_scan_α
                        mov              qword ptr [rsp + 128], 3
                        movsxd           rcx, eax
                        add              rcx, 1
                        mov              qword ptr [rsp + 136], rcx;          jmp   n4_call_builtin_icon_α
n3_scan_many_β:         mov              r11, 4;                              jmp   n6_scan_α
