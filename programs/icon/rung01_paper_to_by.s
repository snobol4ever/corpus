...
main_α_body:
#-----------------------------------------------------------------------------------------------------------------------
n0_lit_integer_α:       mov              qword ptr [rsp + 336], 3             # result
                        mov              rax, qword ptr [rip + .Lx15_0]
                        mov              qword ptr [rsp + 344], rax;          jmp   n1_lit_integer_α
.Lx15_0:                .quad            1
#-----------------------------------------------------------------------------------------------------------------------
n1_lit_integer_α:       mov              qword ptr [rsp + 352], 3             # result
                        mov              rax, qword ptr [rip + .Lx16_0]
                        mov              qword ptr [rsp + 360], rax;          jmp   n2_lit_integer_α
.Lx16_0:                .quad            10
#-----------------------------------------------------------------------------------------------------------------------
n2_lit_integer_α:       mov              qword ptr [rsp + 368], 3             # result
                        mov              rax, qword ptr [rip + .Lx17_0]
                        mov              qword ptr [rsp + 376], rax;          jmp   n3_to_by_α
.Lx17_0:                .quad            3
#-----------------------------------------------------------------------------------------------------------------------
n3_to_by_α:             mov              rdi, qword ptr [rsp + 336]
...
n3_to_by_β:             mov              rdx, qword ptr [rsp + 376]
                        mov              rax, qword ptr [rsp + 320]
                        add              rax, rdx
                        mov              qword ptr [rsp + 320], rax;          jmp   .Lx19_0
#-----------------------------------------------------------------------------------------------------------------------
n4_call_builtin_icon_α: mov              rax, qword ptr [rsp + 304]
...
.Lx22_0:                .quad            10
#-----------------------------------------------------------------------------------------------------------------------
n6_lit_integer_α:       mov              qword ptr [rsp + 224], 3             # result
...
#-----------------------------------------------------------------------------------------------------------------------
n8_to_by_α:             mov              rdi, qword ptr [rsp + 208]
...
n8_to_by_β:             mov              rdx, qword ptr [rsp + 248]
                        mov              rax, qword ptr [rsp + 192]
                        add              rax, rdx
                        mov              qword ptr [rsp + 192], rax;          jmp   .Lx26_0
#-----------------------------------------------------------------------------------------------------------------------
n9_call_builtin_icon_α: mov              rax, qword ptr [rsp + 176]
...
#-----------------------------------------------------------------------------------------------------------------------
n10_lit_integer_α:      mov              qword ptr [rsp + 80], 3              # result
                        mov              rax, qword ptr [rip + .Lx29_0]
                        mov              qword ptr [rsp + 88], rax;           jmp   n11_lit_integer_α
.Lx29_0:                .quad            2
#-----------------------------------------------------------------------------------------------------------------------
n11_lit_integer_α:      mov              qword ptr [rsp + 96], 3              # result
                        mov              rax, qword ptr [rip + .Lx30_0]
                        mov              qword ptr [rsp + 104], rax;          jmp   n12_lit_integer_α
.Lx30_0:                .quad            2
#-----------------------------------------------------------------------------------------------------------------------
n12_lit_integer_α:      mov              qword ptr [rsp + 112], 3             # result
                        mov              rax, qword ptr [rip + .Lx31_0]
                        mov              qword ptr [rsp + 120], rax;          jmp   n13_to_by_α
.Lx31_0:                .quad            1
#-----------------------------------------------------------------------------------------------------------------------
n13_to_by_α:            mov              rdi, qword ptr [rsp + 80]
...
n13_to_by_β:            mov              rdx, qword ptr [rsp + 120]
