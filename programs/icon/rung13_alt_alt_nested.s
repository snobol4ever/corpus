...
n0_disjunction_af:      add              dword ptr [rsp + 80], 1
                        ...
                        cmp              eax, 1;                              je    n6_lit_string_α
                                                                              jmp   main_ω
#-----------------------------------------------------------------------------------------------------------------------
n1_disjunction_α:       mov              qword ptr [rsp + 128], 0
                        mov              qword ptr [rsp + 136], 0
                        mov              dword ptr [rsp + 144], 0;            jmp   n5_lit_string_α
n1_disjunction_as:      mov              eax, dword ptr [rsp + 144]
...
n1_disjunction_β:       mov              eax, dword ptr [rsp + 144]
                        cmp              eax, 0;                              je    n1_disjunction_af
                                                                              jmp   n1_disjunction_af
n1_disjunction_af:      add              dword ptr [rsp + 144], 1
...
#-----------------------------------------------------------------------------------------------------------------------
n4_lit_string_α:        mov              qword ptr [rsp + 176], 2             # result
...
.Lx16_0_s:              .string          "x"
#-----------------------------------------------------------------------------------------------------------------------
n6_lit_string_α:        mov              qword ptr [rsp + 112], 2             # result
                        mov              dword ptr [rsp + 116], 1
                        mov              rax, qword ptr [rip + .Lx17_0]
                        mov              qword ptr [rsp + 120], rax;          jmp   n0_disjunction_as
n6_lit_string_β:                                                              jmp   n0_disjunction_af
.Lx17_0:                .quad            .Lx17_0_s
.Lx17_0_s:              .string          "b"
#-----------------------------------------------------------------------------------------------------------------------
n7_lit_string_α:        mov              qword ptr [rsp + 96], 2              # result
