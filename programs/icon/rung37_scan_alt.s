...
main_α_body:
#-----------------------------------------------------------------------------------------------------------------------
n0_disjunction_α:       mov              qword ptr [rsp + 1136], 0
                        mov              qword ptr [rsp + 1144], 0
                        mov              dword ptr [rsp + 1152], 0;           jmp   n9_lit_string_α
n0_disjunction_as:      mov              eax, dword ptr [rsp + 1152]
...
#-----------------------------------------------------------------------------------------------------------------------
n2_lit_integer_α:       mov              qword ptr [rsp + 1120], 3            # result
...
n3_scan_move_α:         sub              rsp, 16
                        ...
                        add              rax, r14
                        add              rax, 1
                        cmp              rax, 1;                              jge   .Lx55_239
                        add              rsp, 16;                             jmp   n6_scan_α
.Lx55_239:              mov              rcx, r15
                        add              rcx, 1
                        cmp              rax, rcx;                            jle   .Lx55_240
                        add              rsp, 16;                             jmp   n6_scan_α
.Lx55_240:              mov              qword ptr [rsp + 0], r14
                        mov              rdi, r13
                        mov              rsi, r14
                        mov              rdx, rax
                        sub              rdx, 1
...
n3_scan_move_β:         mov              r14, qword ptr [rsp + 0]
                        add              rsp, 16;                             jmp   n6_scan_α
#-----------------------------------------------------------------------------------------------------------------------
n4_scan_α:              mov              rax, qword ptr [rsp + 1088]
...
n4_scan_β:                                                                    jmp   n10_call_builtin_icon_α
#-----------------------------------------------------------------------------------------------------------------------
n5_call_builtin_icon_α: mov              rax, qword ptr [rsp + 1056]
...
n5_call_builtin_icon_β:                                                       jmp   n0_disjunction_β
#-----------------------------------------------------------------------------------------------------------------------
n6_scan_α:              lea              rdi, [rsp + 1024]
                        mov              qword ptr [rip + rtccb+40], r8
                        mov              qword ptr [rip + rtccb+56], r10
                        mov              qword ptr [rip + rtccb+64], r11
                        call             rt_scan_leave@PLT
...
n6_scan_β:                                                                    jmp   n0_disjunction_β
#-----------------------------------------------------------------------------------------------------------------------
...
n7_lit_string_β:                                                              jmp   n0_disjunction_af
.Lx62_0:                .quad            .Lx62_0_s
.Lx62_0_s:              .string          "ef"
#-----------------------------------------------------------------------------------------------------------------------
n8_lit_string_α:        mov              qword ptr [rsp + 1184], 2            # result
                        mov              dword ptr [rsp + 1188], 2
                        mov              rax, qword ptr [rip + .Lx63_0]
                        mov              qword ptr [rsp + 1192], rax;         jmp   n0_disjunction_as
n8_lit_string_β:                                                              jmp   n0_disjunction_af
.Lx63_0:                .quad            .Lx63_0_s
.Lx63_0_s:              .string          "cd"
#-----------------------------------------------------------------------------------------------------------------------
n9_lit_string_α:        mov              qword ptr [rsp + 1168], 2            # result
                        mov              dword ptr [rsp + 1172], 2
                        mov              rax, qword ptr [rip + .Lx64_0]
                        mov              qword ptr [rsp + 1176], rax;         jmp   n0_disjunction_as
n9_lit_string_β:                                                              jmp   n0_disjunction_af
...
.Lrkfn66:               .string          "write"
                        ...
                        cmp              eax, 104;                            je    n11_disjunction_α
                        mov              r8,  qword ptr [rip + rtccb+40]
                        mov              r9,  qword ptr [rip + rtccb+48]
                        mov              r10, qword ptr [rip + rtccb+56]
...
#-----------------------------------------------------------------------------------------------------------------------
n11_disjunction_α:      mov              qword ptr [rsp + 848], 0
                        mov              qword ptr [rsp + 856], 0
                        mov              dword ptr [rsp + 864], 0;            jmp   n20_lit_string_α
n11_disjunction_as:     mov              eax, dword ptr [rsp + 864]
...
#-----------------------------------------------------------------------------------------------------------------------
n13_lit_integer_α:      mov              qword ptr [rsp + 832], 3             # result
                        mov              rax, qword ptr [rip + .Lx71_0]
                        mov              qword ptr [rsp + 840], rax;          jmp   n14_scan_tab_α
.Lx71_0:                .quad            2
#-----------------------------------------------------------------------------------------------------------------------
n14_scan_tab_α:         sub              rsp, 16
                        mov              rax, 2
                        cmp              rax, 1;                              jge   .Lx73_0
                        add              rax, r15
                        add              rax, 1
.Lx73_0:                cmp              rax, 1;                              jge   .Lx73_239
                        add              rsp, 16;                             jmp   n17_scan_α
.Lx73_239:              mov              rcx, r15
                        add              rcx, 1
                        cmp              rax, rcx;                            jle   .Lx73_240
                        add              rsp, 16;                             jmp   n17_scan_α
.Lx73_240:              mov              qword ptr [rsp + 0], r14
                        mov              rdi, r13
                        mov              rsi, r14
                        mov              rdx, rax
                        sub              rdx, 1
...
n14_scan_tab_β:         mov              r14, qword ptr [rsp + 0]
                        add              rsp, 16;                             jmp   n17_scan_α
#-----------------------------------------------------------------------------------------------------------------------
n15_scan_α:             mov              rax, qword ptr [rsp + 800]
...
n15_scan_β:                                                                   jmp   n21_call_builtin_icon_α
#-----------------------------------------------------------------------------------------------------------------------
...
.Lrkfn77:               .string          "write"
                        ...
                        cmp              eax, 104;                            je    n11_disjunction_β
                        mov              r8,  qword ptr [rip + rtccb+40]
                        mov              r9,  qword ptr [rip + rtccb+48]
                        mov              r10, qword ptr [rip + rtccb+56]
...
#-----------------------------------------------------------------------------------------------------------------------
n22_lit_integer_α:      mov              qword ptr [rsp + 624], 3             # result
                        mov              rax, qword ptr [rip + .Lx85_0]
                        mov              qword ptr [rsp + 632], rax;          jmp   n23_assign_α
.Lx85_0:                .quad            0
#-----------------------------------------------------------------------------------------------------------------------
n23_assign_α:           mov              rax, qword ptr [rsp + 624]
                        mov              rdx, qword ptr [rsp + 632]
                        mov              qword ptr [rsp + 1216], rax
                        mov              qword ptr [rsp + 1224], rdx;         jmp   n24_disjunction_α
#-----------------------------------------------------------------------------------------------------------------------
n24_disjunction_α:      mov              qword ptr [rsp + 528], 0
                        mov              qword ptr [rsp + 536], 0
                        mov              dword ptr [rsp + 544], 0;            jmp   n35_lit_string_α
n24_disjunction_as:     mov              eax, dword ptr [rsp + 544]
...
#-----------------------------------------------------------------------------------------------------------------------
n26_var_α:              mov              rax, qword ptr [rsp + 1216]
                        mov              qword ptr [rsp + 496], rax
                        mov              rax, qword ptr [rsp + 1224]
                        mov              qword ptr [rsp + 504], rax;          jmp   n27_lit_integer_α
#-----------------------------------------------------------------------------------------------------------------------
n27_lit_integer_α:      mov              qword ptr [rsp + 512], 3             # result
                        mov              rax, qword ptr [rip + .Lx93_0]
                        mov              qword ptr [rsp + 520], rax;          jmp   n28_coerce_numeric_α
.Lx93_0:                .quad            1
#-----------------------------------------------------------------------------------------------------------------------
n28_coerce_numeric_α:   mov              eax, dword ptr [rsp + 1216]
                        cmp              eax, 5;                              je    .Lx95_1
...
#-----------------------------------------------------------------------------------------------------------------------
n29_binop_α:            mov              eax, dword ptr [rsp + 480]
                        cmp              eax, 3;                              jne   .Lx96_0
                        mov              rax, qword ptr [rsp + 488]
                        mov              rcx, 1
                        add              rax, rcx
                        mov              qword ptr [rsp + 464], 3
                        mov              qword ptr [rsp + 472], rax;          jmp   n30_assign_α
...
#-----------------------------------------------------------------------------------------------------------------------
n30_assign_α:           mov              rax, qword ptr [rsp + 464]
...
#-----------------------------------------------------------------------------------------------------------------------
n31_scan_α:             mov              rax, qword ptr [rsp + 448]
...
n31_scan_β:                                                                   jmp   n36_var_α
#-----------------------------------------------------------------------------------------------------------------------
n32_scan_α:             lea              rdi, [rsp + 384]
                        mov              qword ptr [rip + rtccb+40], r8
                        mov              qword ptr [rip + rtccb+56], r10
                        mov              qword ptr [rip + rtccb+64], r11
                        call             rt_scan_leave@PLT
                        ...
                        mov              r14, qword ptr [rsp + 392]
                        mov              r15, qword ptr [rsp + 400];          jmp   n24_disjunction_β
n32_scan_β:                                                                   jmp   n24_disjunction_β
#-----------------------------------------------------------------------------------------------------------------------
n33_lit_string_α:       mov              qword ptr [rsp + 592], 2             # result
                        mov              dword ptr [rsp + 596], 1
                        mov              rax, qword ptr [rip + .Lx102_0]
                        mov              qword ptr [rsp + 600], rax;          jmp   n24_disjunction_as
n33_lit_string_β:                                                             jmp   n24_disjunction_af
.Lx102_0:               .quad            .Lx102_0_s
.Lx102_0_s:             .string          "z"
#-----------------------------------------------------------------------------------------------------------------------
n34_lit_string_α:       mov              qword ptr [rsp + 576], 2             # result
                        mov              dword ptr [rsp + 580], 1
                        mov              rax, qword ptr [rip + .Lx103_0]
                        mov              qword ptr [rsp + 584], rax;          jmp   n24_disjunction_as
n34_lit_string_β:                                                             jmp   n24_disjunction_af
.Lx103_0:               .quad            .Lx103_0_s
.Lx103_0_s:             .string          "y"
#-----------------------------------------------------------------------------------------------------------------------
n35_lit_string_α:       mov              qword ptr [rsp + 560], 2             # result
                        mov              dword ptr [rsp + 564], 1
                        mov              rax, qword ptr [rip + .Lx104_0]
                        mov              qword ptr [rsp + 568], rax;          jmp   n24_disjunction_as
n35_lit_string_β:                                                             jmp   n24_disjunction_af
.Lx104_0:               .quad            .Lx104_0_s
.Lx104_0_s:             .string          "x"
#-----------------------------------------------------------------------------------------------------------------------
n36_var_α:              mov              rax, qword ptr [rsp + 1216]
...
.Lrkfn110:              .string          "write"
                        ...
                        cmp              eax, 104;                            je    n39_disjunction_α
                        mov              r8,  qword ptr [rip + rtccb+40]
                        mov              r9,  qword ptr [rip + rtccb+48]
                        mov              r10, qword ptr [rip + rtccb+56]
...
#-----------------------------------------------------------------------------------------------------------------------
n39_disjunction_α:      mov              qword ptr [rsp + 208], 0
                        mov              qword ptr [rsp + 216], 0
                        mov              dword ptr [rsp + 224], 0;            jmp   n47_lit_string_α
n39_disjunction_as:     mov              eax, dword ptr [rsp + 224]
...
n39_disjunction_β:      mov              eax, dword ptr [rsp + 224]
                        cmp              eax, 0;                              je    n39_disjunction_af
                                                                              jmp   n39_disjunction_af
n39_disjunction_af:     add              dword ptr [rsp + 224], 1
                        mov              eax, dword ptr [rsp + 224]
                        cmp              eax, 1;                              je    n46_lit_string_α
                                                                              jmp   n48_call_builtin_icon_α
#-----------------------------------------------------------------------------------------------------------------------
n40_scan_enter_α:       mov              rdi, qword ptr [rsp + 208]
...
#-----------------------------------------------------------------------------------------------------------------------
n41_lit_integer_α:      mov              qword ptr [rsp + 192], 3             # result
                        mov              rax, qword ptr [rip + .Lx115_0]
                        mov              qword ptr [rsp + 200], rax;          jmp   n42_scan_move_α
.Lx115_0:               .quad            5
#-----------------------------------------------------------------------------------------------------------------------
n42_scan_move_α:        sub              rsp, 16
                        mov              rax, 5
                        add              rax, r14
                        add              rax, 1
                        cmp              rax, 1;                              jge   .Lx117_239
                        add              rsp, 16;                             jmp   n45_scan_α
.Lx117_239:             mov              rcx, r15
                        add              rcx, 1
                        cmp              rax, rcx;                            jle   .Lx117_240
                        add              rsp, 16;                             jmp   n45_scan_α
.Lx117_240:             mov              qword ptr [rsp + 0], r14
                        mov              rdi, r13
                        mov              rsi, r14
                        mov              rdx, rax
                        sub              rdx, 1
...
n42_scan_move_β:        mov              r14, qword ptr [rsp + 0]
                        add              rsp, 16;                             jmp   n45_scan_α
#-----------------------------------------------------------------------------------------------------------------------
n43_scan_α:             mov              rax, qword ptr [rsp + 160]
...
n43_scan_β:                                                                   jmp   n48_call_builtin_icon_α
#-----------------------------------------------------------------------------------------------------------------------
...
.Lrkfn121:              .string          "write"
                        ...
                        cmp              eax, 104;                            je    n39_disjunction_β
                        mov              r8,  qword ptr [rip + rtccb+40]
                        mov              r9,  qword ptr [rip + rtccb+48]
                        mov              r10, qword ptr [rip + rtccb+56]
...
n45_scan_β:                                                                   jmp   n39_disjunction_β
#-----------------------------------------------------------------------------------------------------------------------
n46_lit_string_α:       mov              qword ptr [rsp + 256], 2             # result
                        mov              dword ptr [rsp + 260], 6
                        mov              rax, qword ptr [rip + .Lx124_0]
                        mov              qword ptr [rsp + 264], rax;          jmp   n39_disjunction_as
n46_lit_string_β:                                                             jmp   n39_disjunction_af
...
n47_lit_string_β:                                                             jmp   n39_disjunction_af
