...
#-----------------------------------------------------------------------------------------------------------------------
n2_lit_integer_α:       mov              qword ptr [rsp + 160], 3             # result
                        mov              rax, qword ptr [rip + .Lx10_0]
                        mov              qword ptr [rsp + 168], rax;          jmp   n3_scan_tab_α
.Lx10_0:                .quad            4
#-----------------------------------------------------------------------------------------------------------------------
n3_scan_tab_α:          mov              rax, 4
                        cmp              rax, 1;                              jge   .Lx12_0
                        add              rax, r15
                        add              rax, 1
.Lx12_0:                cmp              rax, 1;                              jl    n6_scan_α
                        mov              rcx, r15
                        add              rcx, 1
...
n3_scan_tab_β:          mov              r14, qword ptr [rsp + 144];          jmp   n6_scan_α
#-----------------------------------------------------------------------------------------------------------------------
