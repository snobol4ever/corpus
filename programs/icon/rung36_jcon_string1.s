...
#-----------------------------------------------------------------------------------------------------------------------
n8_unop_α:
                        mov              rdi, qword ptr [rbp + 6192]                    # lo
                        mov              rsi, qword ptr [rbp + 6200]                    # hi
                        call             rt_size_d@PLT
...
n15_call_builtin_icon_α:
                        ...
                        .section         .rodata
.Lrkfn57:               .string          "image"
                        .section         .text
                        .intel_syntax    noprefix
                        lea              rdi, [rip + .Lrkfn57]                          # fn
                        lea              rsi, [rbp + 5776]                              # args
                        mov              edx, 1                                         # nargs
                        call             rt_call_arr@PLT
...
.Lx68_0:
                        mov              rdi, qword ptr [rbp + 5648]                    # obj
                        mov              rsi, qword ptr [rbp + 5656]                    # obj
                        mov              rdx, qword ptr [rbp + 5632]                    # idx
...
#-----------------------------------------------------------------------------------------------------------------------
n28_lit_integer_α:
                        mov              qword ptr [rbp + 5456], 3                      # result
...
#-----------------------------------------------------------------------------------------------------------------------
n29_to_α:
                        mov              rdi, qword ptr [rbp + 5440]                    # v
                        mov              rsi, qword ptr [rbp + 5448]                    # v
                        call             to_int@PLT
                        mov              qword ptr [rbp + 5440], 3
                        mov              qword ptr [rbp + 5448], rax
                        mov              rdi, qword ptr [rbp + 5456]                    # v
                        mov              rsi, qword ptr [rbp + 5464]                    # v
                        call             to_int@PLT
                        mov              qword ptr [rbp + 5456], 3
                        mov              qword ptr [rbp + 5464], rax
...
#-----------------------------------------------------------------------------------------------------------------------
n30_subscript_α:
                        mov              rdi, qword ptr [rbp + 5392]                    # base
                        mov              rsi, qword ptr [rbp + 5400]                    # base
                        mov              rdx, qword ptr [rbp + 5408]                    # idx
                        mov              rcx, qword ptr [rbp + 5416]                    # idx
...
#-----------------------------------------------------------------------------------------------------------------------
n31_deref_α:
                        mov              rdi, qword ptr [rbp + 5472]                    # d
                        mov              rsi, qword ptr [rbp + 5480]                    # d
                        call             rt_deref@PLT
                        cmp              eax, 104
                                                                                        je    n29_to_β
