...
.Lx8_0:                 .quad            2
#-----------------------------------------------------------------------------------------------------------------------
n1_disjunction_α:       mov              qword ptr [rsp + 96], 0
                        mov              qword ptr [rsp + 104], 0
                        mov              dword ptr [rsp + 112], 0;            jmp   n6_lit_string_α
n1_disjunction_as:      mov              eax, dword ptr [rsp + 112]
...
n1_disjunction_β:       mov              eax, dword ptr [rsp + 112]
                        cmp              eax, 0;                              je    n1_disjunction_af
                        cmp              eax, 1;                              je    n1_disjunction_af
                                                                              jmp   n1_disjunction_af
n1_disjunction_af:      add              dword ptr [rsp + 112], 1
...
n2_limit_β:                                                                   jmp   n1_disjunction_β
#-----------------------------------------------------------------------------------------------------------------------
...
n4_lit_string_β:                                                              jmp   n1_disjunction_af
.Lx15_0:                .quad            .Lx15_0_s
.Lx15_0_s:              .string          "c"
#-----------------------------------------------------------------------------------------------------------------------
n5_lit_string_α:        mov              qword ptr [rsp + 144], 2             # result
                        mov              dword ptr [rsp + 148], 1
                        mov              rax, qword ptr [rip + .Lx16_0]
                        mov              qword ptr [rsp + 152], rax;          jmp   n1_disjunction_as
n5_lit_string_β:                                                              jmp   n1_disjunction_af
...
n6_lit_string_β:                                                              jmp   n1_disjunction_af
