...
#-----------------------------------------------------------------------------------------------------------------------
n18_scan_tab_α:         mov              rax, qword ptr [rsp + 792]
...
n18_scan_tab_β:         mov              r14, qword ptr [rsp + 768];          jmp   n17_scan_upto_β
#-----------------------------------------------------------------------------------------------------------------------
...
#-----------------------------------------------------------------------------------------------------------------------
n22_scan_tab_α:         mov              rax, qword ptr [rsp + 888]
...
n22_scan_tab_β:         mov              r14, qword ptr [rsp + 864];          jmp   n16_var_α
#-----------------------------------------------------------------------------------------------------------------------
...
.Lx95_0:                mov              rdi, qword ptr [rsp + 960]
                        ...
                        mov              r8,  qword ptr [rip + rtccb+40]
                        mov              r9,  qword ptr [rip + rtccb+48];     jmp   n27_assign_var_α
#-----------------------------------------------------------------------------------------------------------------------
...
.Lx111_0:               lea              rdi, [rsp + 128]
                        ...
                        mov              r8,  qword ptr [rip + rtccb+40]
                        mov              r9,  qword ptr [rip + rtccb+48];     jmp   n38_binop_α
#-----------------------------------------------------------------------------------------------------------------------
n38_binop_α:            mov              eax, dword ptr [rsp + 112]
                        mov              ecx, 3
                        mov              edx, eax
                        and              edx, ecx
                        cmp              edx, 3;                              jne   .Lx112_2
...
.Lx112_0:               mov              rdi, qword ptr [rsp + 112]
                        ...
                        mov              qword ptr [rip + rtccb+40], r8
                        call             rt_sub@PLT
                        cmp              eax, 104;                            je    wordcount_ω
                        mov              qword ptr [rsp + 96], rax
                        mov              qword ptr [rsp + 104], rdx
                        mov              r8,  qword ptr [rip + rtccb+40]
                        mov              r9,  qword ptr [rip + rtccb+48];     jmp   n39_lit_integer_α
#-----------------------------------------------------------------------------------------------------------------------
...
.Lx135_0:               lea              rdi, [rsp + 1232]
                        ...
                        call             rt_coerce_num2_d@PLT
                        mov              r8,  qword ptr [rip + rtccb+40]
                        mov              r9,  qword ptr [rip + rtccb+48];     jmp   n53_binop_α
#-----------------------------------------------------------------------------------------------------------------------
n53_binop_α:            mov              eax, dword ptr [rsp + 480]
                        mov              ecx, 3
                        mov              edx, eax
                        and              edx, ecx
                        cmp              edx, 3;                              jne   .Lx136_2
...
.Lx136_0:               mov              rdi, qword ptr [rsp + 480]
                        ...
                        mov              r8,  qword ptr [rip + rtccb+40]
                        mov              r9,  qword ptr [rip + rtccb+48];     jmp   n54_subscript_α
#-----------------------------------------------------------------------------------------------------------------------
...
.Lrkfn140:              .string          "write"
                        ...
                        cmp              eax, 104;                            je    n57_unmark_α
                        mov              r8,  qword ptr [rip + rtccb+40]
                        mov              r9,  qword ptr [rip + rtccb+48];     jmp   n57_unmark_α
