...
#-----------------------------------------------------------------------------------------------------------------------
n0_disjunction_α:       mov              qword ptr [rsp + 1072], 0
                        mov              qword ptr [rsp + 1080], 0
                        mov              dword ptr [rsp + 1088], 0;           jmp   n1_var_ref_α
n0_disjunction_as:      mov              eax, dword ptr [rsp + 1088]
...
n0_disjunction_β:       mov              eax, dword ptr [rsp + 1088];         jmp   n9_lit_integer_α
n0_disjunction_af:      add              dword ptr [rsp + 1088], 1
...
#-----------------------------------------------------------------------------------------------------------------------
n2_nulltest_var_α:      mov              eax, dword ptr [rsp + 1168]
...
#-----------------------------------------------------------------------------------------------------------------------
n3_lit_integer_α:       mov              qword ptr [rsp + 1216], 3            # result
                        mov              rax, qword ptr [rip + .Lx63_0]
                        mov              qword ptr [rsp + 1224], rax;         jmp   n4_assign_var_α
.Lx63_0:                .quad            1
#-----------------------------------------------------------------------------------------------------------------------
n4_assign_var_α:        mov              rdi, qword ptr [rsp + 1184]
...
#-----------------------------------------------------------------------------------------------------------------------
n5_lit_charset_α:       mov              qword ptr [rsp + 1136], 2            # result
...
#-----------------------------------------------------------------------------------------------------------------------
n6_lit_charset_α:       mov              qword ptr [rsp + 1152], 2            # result
...
#-----------------------------------------------------------------------------------------------------------------------
n7_binop_α:             mov              rdi, qword ptr [rsp + 1136]
...
#-----------------------------------------------------------------------------------------------------------------------
n8_assign_α:            mov              rax, qword ptr [rsp + 1120]
...
n8_assign_β:                                                                  jmp   n9_lit_integer_α
#-----------------------------------------------------------------------------------------------------------------------
n9_lit_integer_α:       mov              qword ptr [rsp + 1056], 3            # result
...
.Lrkfn71:               .string          "table"
                        ...
                        cmp              eax, 104;                            je    n12_call_builtin_icon_α
                        mov              r8,  qword ptr [rip + rtccb+40]
                        mov              r9,  qword ptr [rip + rtccb+48]
                        mov              r10, qword ptr [rip + rtccb+56]
...
#-----------------------------------------------------------------------------------------------------------------------
n11_assign_α:           mov              rax, qword ptr [rsp + 1008]
...
n12_call_builtin_icon_β:
                                                                              jmp   n29_var_α
#-----------------------------------------------------------------------------------------------------------------------
n13_assign_α:           mov              rax, qword ptr [rsp + 656]
                        mov              rdx, qword ptr [rsp + 664]
                        mov              qword ptr [rsp + 1280], rax
                        mov              qword ptr [rsp + 1288], rdx;         jmp   n14_var_α
#-----------------------------------------------------------------------------------------------------------------------
n14_var_α:              mov              rax, qword ptr [rsp + 1280]
                        mov              qword ptr [rsp + 992], rax
                        mov              rax, qword ptr [rsp + 1288]
                        mov              qword ptr [rsp + 1000], rax;         jmp   n15_scan_enter_α
#-----------------------------------------------------------------------------------------------------------------------
n15_scan_enter_α:       mov              rdi, qword ptr [rsp + 992]
...
#-----------------------------------------------------------------------------------------------------------------------
n16_var_α:              mov              rax, qword ptr [r9 + 0]              # wordcount__STATIC__letters
                        mov              rdx, qword ptr [r9 + 8]
                        mov              qword ptr [rsp + 816], rax           # result
                        mov              qword ptr [rsp + 824], rdx;          jmp   n17_scan_upto_α
#-----------------------------------------------------------------------------------------------------------------------
n17_scan_upto_α:        mov              qword ptr [rsp + 800], r14
...
n17_scan_upto_β:        inc              qword ptr [rsp + 800];               jmp   .Lx82_0
#-----------------------------------------------------------------------------------------------------------------------
n18_scan_tab_α:         sub              rsp, 16
                        mov              rax, qword ptr [rsp + 792]
                        cmp              rax, 1;                              jge   .Lx84_0
                        add              rax, r15
                        add              rax, 1
.Lx84_0:                cmp              rax, 1;                              jge   .Lx84_239
                        add              rsp, 16;                             jmp   n17_scan_upto_β
.Lx84_239:              mov              rcx, r15
                        add              rcx, 1
                        cmp              rax, rcx;                            jle   .Lx84_240
                        add              rsp, 16;                             jmp   n17_scan_upto_β
.Lx84_240:              mov              qword ptr [rsp + 0], r14
                        mov              rdi, r13
                        mov              rsi, r14
                        mov              rdx, rax
                        sub              rdx, 1
...
n18_scan_tab_β:         mov              r14, qword ptr [rsp + 0]
                        add              rsp, 16;                             jmp   n17_scan_upto_β
#-----------------------------------------------------------------------------------------------------------------------
...
#-----------------------------------------------------------------------------------------------------------------------
n20_var_α:              mov              rax, qword ptr [r9 + 0]              # wordcount__STATIC__letters
                        mov              rdx, qword ptr [r9 + 8]
                        mov              qword ptr [rsp + 896], rax           # result
                        mov              qword ptr [rsp + 904], rdx;          jmp   n21_scan_many_α
#-----------------------------------------------------------------------------------------------------------------------
n21_scan_many_α:        mov              eax, r14d
...
n21_scan_many_β:                                                              jmp   n16_var_α
#-----------------------------------------------------------------------------------------------------------------------
n22_scan_tab_α:         sub              rsp, 16
                        mov              rax, qword ptr [rsp + 888]
                        cmp              rax, 1;                              jge   .Lx91_0
                        add              rax, r15
                        add              rax, 1
.Lx91_0:                cmp              rax, 1;                              jge   .Lx91_239
                        add              rsp, 16;                             jmp   n16_var_α
.Lx91_239:              mov              rcx, r15
                        add              rcx, 1
                        cmp              rax, rcx;                            jle   .Lx91_240
                        add              rsp, 16;                             jmp   n16_var_α
.Lx91_240:              mov              qword ptr [rsp + 0], r14
                        mov              rdi, r13
                        mov              rsi, r14
                        mov              rdx, rax
                        sub              rdx, 1
...
n22_scan_tab_β:         mov              r14, qword ptr [rsp + 0]
                        add              rsp, 16;                             jmp   n16_var_α
#-----------------------------------------------------------------------------------------------------------------------
n23_subscript_α:        mov              rdi, qword ptr [rsp + 832]
...
#-----------------------------------------------------------------------------------------------------------------------
n24_deref_α:            mov              rdi, qword ptr [rsp + 912]
...
#-----------------------------------------------------------------------------------------------------------------------
n25_lit_integer_α:      mov              qword ptr [rsp + 976], 3             # result
                        mov              rax, qword ptr [rip + .Lx94_0]
                        mov              qword ptr [rsp + 984], rax;          jmp   n26_binop_α
.Lx94_0:                .quad            1
#-----------------------------------------------------------------------------------------------------------------------
n26_binop_α:            mov              eax, dword ptr [rsp + 960]
                        cmp              eax, 3;                              jne   .Lx95_0
                        mov              rax, qword ptr [rsp + 968]
                        mov              rcx, 1
                        add              rax, rcx
                        mov              qword ptr [rsp + 944], 3
                        mov              qword ptr [rsp + 952], rax;          jmp   n27_assign_var_α
...
#-----------------------------------------------------------------------------------------------------------------------
n27_assign_var_α:       mov              rdi, qword ptr [rsp + 912]
                        mov              rsi, qword ptr [rsp + 920]
...
n28_scan_β:                                                                   jmp   n12_call_builtin_icon_α
#-----------------------------------------------------------------------------------------------------------------------
...
#-----------------------------------------------------------------------------------------------------------------------
n30_lit_integer_α:      mov              qword ptr [rsp + 640], 3             # result
...
#-----------------------------------------------------------------------------------------------------------------------
n32_assign_α:           mov              rax, qword ptr [rsp + 560]
                        mov              rdx, qword ptr [rsp + 568]
                        mov              qword ptr [rsp + 1248], rax
                        mov              qword ptr [rsp + 1256], rdx;         jmp   n33_lit_integer_α
#-----------------------------------------------------------------------------------------------------------------------
n33_lit_integer_α:      mov              qword ptr [rsp + 80], 3              # result
                        mov              rax, qword ptr [rip + .Lx105_0]
                        mov              qword ptr [rsp + 88], rax;           jmp   n34_var_α
.Lx105_0:               .quad            1
#-----------------------------------------------------------------------------------------------------------------------
n34_var_α:              mov              rax, qword ptr [rsp + 1248]
                        mov              qword ptr [rsp + 144], rax
                        mov              rax, qword ptr [rsp + 1256]
                        mov              qword ptr [rsp + 152], rax;          jmp   n35_unop_α
#-----------------------------------------------------------------------------------------------------------------------
n35_unop_α:             mov              rdi, qword ptr [rsp + 1248]
...
#-----------------------------------------------------------------------------------------------------------------------
n36_lit_integer_α:      mov              qword ptr [rsp + 160], 3             # result
                        mov              rax, qword ptr [rip + .Lx109_0]
                        mov              qword ptr [rsp + 168], rax;          jmp   n37_coerce_numeric_α
.Lx109_0:               .quad            1
#-----------------------------------------------------------------------------------------------------------------------
n37_coerce_numeric_α:   mov              eax, dword ptr [rsp + 128]
...
#-----------------------------------------------------------------------------------------------------------------------
n38_binop_α:            mov              eax, dword ptr [rsp + 112]
                        cmp              eax, 3;                              jne   .Lx112_0
                        mov              rax, qword ptr [rsp + 120]
                        mov              rcx, 1
                        sub              rax, rcx
                        mov              qword ptr [rsp + 96], 3
                        mov              qword ptr [rsp + 104], rax;          jmp   n39_lit_integer_α
.Lx112_0:               mov              rdi, qword ptr [rsp + 112]
                        ...
                        mov              qword ptr [rip + rtccb+64], r11
                        call             rt_sub@PLT
                        cmp              eax, 104;                            je    proc_wordcount_ω
...
#-----------------------------------------------------------------------------------------------------------------------
n39_lit_integer_α:      mov              qword ptr [rsp + 176], 3             # result
                        mov              rax, qword ptr [rip + .Lx113_0]
                        mov              qword ptr [rsp + 184], rax;          jmp   n40_to_by_α
.Lx113_0:               .quad            2
#-----------------------------------------------------------------------------------------------------------------------
n40_to_by_α:            mov              rdi, qword ptr [rsp + 80]
...
.Lx115_0:               mov              rax, qword ptr [rsp + 64]
                        ...
                        cmp              rax, rcx;                            jg    proc_wordcount_ω
                                                                              jmp   .Lx115_2
.Lx115_1:               cmp              rax, rcx;                            jl    proc_wordcount_ω
.Lx115_2:               mov              qword ptr [rsp + 48], 3
                        mov              qword ptr [rsp + 56], rax;           jmp   n41_assign_α
n40_to_by_β:            mov              rdx, qword ptr [rsp + 184]
                        mov              rax, qword ptr [rsp + 64]
                        add              rax, rdx
                        mov              qword ptr [rsp + 64], rax;           jmp   .Lx115_0
#-----------------------------------------------------------------------------------------------------------------------
n41_assign_α:           mov              rax, qword ptr [rsp + 48]
                        mov              rdx, qword ptr [rsp + 56]
                        mov              qword ptr [rsp + 1232], rax
                        mov              qword ptr [rsp + 1240], rdx;         jmp   n42_bound_α
#-----------------------------------------------------------------------------------------------------------------------
n42_bound_α:            mov              qword ptr [rsp + 192], rsp;          jmp   n43_var_ref_α
#-----------------------------------------------------------------------------------------------------------------------
...
#-----------------------------------------------------------------------------------------------------------------------
n44_var_α:              mov              rax, qword ptr [rsp + 1232]
                        mov              qword ptr [rsp + 384], rax
                        mov              rax, qword ptr [rsp + 1240]
                        mov              qword ptr [rsp + 392], rax;          jmp   n45_subscript_α
#-----------------------------------------------------------------------------------------------------------------------
n45_subscript_α:        mov              rdi, qword ptr [rsp + 368]
                        ...
                        mov              r10, qword ptr [rip + rtccb+56]
                        mov              r11, qword ptr [rip + rtccb+64]
                        cmp              eax, 104;                            je    n57_unmark_α
                        mov              qword ptr [rsp + 400], rax
                        mov              qword ptr [rsp + 408], rdx;          jmp   n46_deref_α
#-----------------------------------------------------------------------------------------------------------------------
n46_deref_α:            mov              rdi, qword ptr [rsp + 400]
...
#-----------------------------------------------------------------------------------------------------------------------
n47_var_α:              mov              rax, qword ptr [rsp + 16]
...
#-----------------------------------------------------------------------------------------------------------------------
n50_var_α:              mov              rax, qword ptr [rsp + 1232]
                        mov              qword ptr [rsp + 496], rax
                        mov              rax, qword ptr [rsp + 1240]
                        mov              qword ptr [rsp + 504], rax;          jmp   n51_lit_integer_α
#-----------------------------------------------------------------------------------------------------------------------
n51_lit_integer_α:      mov              qword ptr [rsp + 512], 3             # result
                        mov              rax, qword ptr [rip + .Lx133_0]
                        mov              qword ptr [rsp + 520], rax;          jmp   n52_coerce_numeric_α
.Lx133_0:               .quad            1
#-----------------------------------------------------------------------------------------------------------------------
n52_coerce_numeric_α:   mov              eax, dword ptr [rsp + 1232]
...
#-----------------------------------------------------------------------------------------------------------------------
n53_binop_α:            mov              eax, dword ptr [rsp + 480]
                        cmp              eax, 3;                              jne   .Lx136_0
                        mov              rax, qword ptr [rsp + 488]
                        mov              rcx, 1
                        add              rax, rcx
                        mov              qword ptr [rsp + 464], 3
                        mov              qword ptr [rsp + 472], rax;          jmp   n54_subscript_α
...
#-----------------------------------------------------------------------------------------------------------------------
n54_subscript_α:        mov              rdi, qword ptr [rsp + 448]
...
#-----------------------------------------------------------------------------------------------------------------------
n55_deref_α:            mov              rdi, qword ptr [rsp + 528]
...
n56_call_builtin_icon_β:
                                                                              jmp   n57_unmark_α
#-----------------------------------------------------------------------------------------------------------------------
n57_unmark_α:           mov              rsp, qword ptr [rsp + 192];          jmp   n40_to_by_β
#-----------------------------------------------------------------------------------------------------------------------
proc_wordcount_res:
                        add              rsp, 8
                        pop              rsp
...
proc_wordcount_dcα:
                        ...
                        add              rsp, 16
                        lea              rcx, [rip + .Lx143_2]
                        lea              rdx, [rip + .Lx143_3];               jmp   proc_wordcount_α
.Lx143_2:               pop              r11
                        pop              r11;                                 jmp   r11
.Lx143_3:               pop              r11
                        pop              r11
...
n145_call_proc_staged_α:
                        ...
                        call             proc_wordcount_dcα;                  jmp   .Lx148_2
