...
n0_disjunction_as:      mov              eax, dword ptr [rsp + 704]
...
n0_disjunction_β:       mov              eax, dword ptr [rsp + 704];          jmp   n1_disjunction_α
n0_disjunction_af:      add              dword ptr [rsp + 704], 1
                        mov              eax, dword ptr [rsp + 704];          jmp   n1_disjunction_α
#-----------------------------------------------------------------------------------------------------------------------
n1_disjunction_α:       mov              qword ptr [rsp + 560], 0
                        mov              qword ptr [rsp + 568], 0
                        mov              dword ptr [rsp + 576], 0;            jmp   n28_var_α
n1_disjunction_as:      mov              eax, dword ptr [rsp + 576]
...
n1_disjunction_β:       mov              eax, dword ptr [rsp + 576]
...
.Lx52_0_s:              .string          ""
#-----------------------------------------------------------------------------------------------------------------------
n3_assign_α:            mov              rax, qword ptr [rsp + 544]
...
#-----------------------------------------------------------------------------------------------------------------------
n5_iterate_α:           mov              qword ptr [rsp + 208], 0
.Lx57_0:                mov              rdi, qword ptr [rsp + 224]
                        ...
                        cmp              rax, 104;                            je    n22_disjunction_α
                                                                              jmp   n6_assign_α
n5_iterate_β:           inc              qword ptr [rsp + 208];               jmp   .Lx57_0
#-----------------------------------------------------------------------------------------------------------------------
n6_assign_α:            mov              rax, qword ptr [rsp + 192]
                        mov              rdx, qword ptr [rsp + 200]
                        mov              qword ptr [rsp + 1152], rax
                        mov              qword ptr [rsp + 1160], rdx;         jmp   n7_bound_α
#-----------------------------------------------------------------------------------------------------------------------
n7_bound_α:             mov              qword ptr [rsp + 240], rsp;          jmp   n8_var_α
#-----------------------------------------------------------------------------------------------------------------------
n8_var_α:               mov              rax, qword ptr [rsp + 1136]
...
#-----------------------------------------------------------------------------------------------------------------------
n10_lit_string_α:       mov              qword ptr [rsp + 416], 2             # result
...
#-----------------------------------------------------------------------------------------------------------------------
n13_var_α:              mov              rax, qword ptr [rsp + 1152]
                        mov              qword ptr [rsp + 480], rax
                        mov              rax, qword ptr [rsp + 1160]
                        mov              qword ptr [rsp + 488], rax;          jmp   n14_lit_integer_α
#-----------------------------------------------------------------------------------------------------------------------
n14_lit_integer_α:      mov              qword ptr [rsp + 496], 3             # result
                        mov              rax, qword ptr [rip + .Lx71_0]
                        mov              qword ptr [rsp + 504], rax;          jmp   n15_coerce_numeric_α
.Lx71_0:                .quad            1
#-----------------------------------------------------------------------------------------------------------------------
n15_coerce_numeric_α:   mov              eax, dword ptr [rsp + 1152]
                        cmp              eax, 5;                              je    .Lx73_1
...
.Lx73_0:                lea              rdi, [rsp + 1152]
                        ...
                        mov              r8,  qword ptr [rip + rtccb+40]
                        mov              r9,  qword ptr [rip + rtccb+48];     jmp   n16_binop_α
#-----------------------------------------------------------------------------------------------------------------------
...
.Lx74_0:                mov              rdi, qword ptr [rsp + 464]
                        ...
                        mov              r8,  qword ptr [rip + rtccb+40]
                        mov              r9,  qword ptr [rip + rtccb+48];     jmp   n17_subscript_α
#-----------------------------------------------------------------------------------------------------------------------
n17_subscript_α:        mov              rdi, qword ptr [rsp + 432]
...
#-----------------------------------------------------------------------------------------------------------------------
n18_deref_α:            mov              rdi, qword ptr [rsp + 512]
...
#-----------------------------------------------------------------------------------------------------------------------
n19_binop_α:            mov              rdi, qword ptr [rsp + 304]
...
#-----------------------------------------------------------------------------------------------------------------------
n20_assign_α:           mov              rax, qword ptr [rsp + 288]
                        mov              rdx, qword ptr [rsp + 296]
                        mov              qword ptr [rsp + 1136], rax
                        mov              qword ptr [rsp + 1144], rdx;         jmp   n21_unmark_α
#-----------------------------------------------------------------------------------------------------------------------
n21_unmark_α:           mov              rsp, qword ptr [rsp + 240];          jmp   n5_iterate_β
#-----------------------------------------------------------------------------------------------------------------------
n22_disjunction_α:      mov              qword ptr [rsp + 32], 0
...
n25_lit_string_β:                                                             jmp   n22_disjunction_af
.Lx86_0:                .quad            .Lx86_0_s
.Lx86_0_s:              .string          "*"
#-----------------------------------------------------------------------------------------------------------------------
n26_var_α:              mov              rax, qword ptr [rsp + 1136]
                        mov              qword ptr [rsp + 144], rax
                        mov              rax, qword ptr [rsp + 1144]
                        mov              qword ptr [rsp + 152], rax;          jmp   n27_call_builtin_gen_α
#-----------------------------------------------------------------------------------------------------------------------
n27_call_builtin_gen_α: mov              rax, qword ptr [rsp + 144]
...
.Lbynamegenfn28:        .string          "find"
                        ...
                        mov              r8,  qword ptr [rip + rtccb+40]
                        mov              r9,  qword ptr [rip + rtccb+48];     jmp   roman_ω
...
n28_var_β:                                                                    jmp   n1_disjunction_af
#-----------------------------------------------------------------------------------------------------------------------
...
.Lrkfn93:               .string          "integer"
                        ...
                        mov              r8,  qword ptr [rip + rtccb+40]
                        mov              r9,  qword ptr [rip + rtccb+48];     jmp   n30_lit_integer_α
n29_call_builtin_icon_β:
                                                                              jmp   n1_disjunction_af
#-----------------------------------------------------------------------------------------------------------------------
n30_lit_integer_α:      mov              qword ptr [rsp + 672], 3             # result
                        mov              rax, qword ptr [rip + .Lx94_0]
                        mov              qword ptr [rsp + 680], rax;          jmp   n31_binop_test_α
.Lx94_0:                .quad            0
#-----------------------------------------------------------------------------------------------------------------------
n31_binop_test_α:       mov              eax, dword ptr [rsp + 608]
                        cmp              eax, 112;                            je    .Lx95_0
                        mov              eax, dword ptr [rsp + 672]
                        cmp              eax, 112;                            je    .Lx95_0
                        mov              eax, dword ptr [rsp + 608]
                        cmp              eax, 3;                              jne   .Lx95_2
                        mov              eax, dword ptr [rsp + 672]
                        cmp              eax, 3;                              jne   .Lx95_2
...
n31_binop_test_β:                                                             jmp   n1_disjunction_af
#-----------------------------------------------------------------------------------------------------------------------
...
n32_var_ref_β:                                                                jmp   n0_disjunction_af
#-----------------------------------------------------------------------------------------------------------------------
n33_nulltest_var_α:     mov              eax, dword ptr [rsp + 1072]
...
#-----------------------------------------------------------------------------------------------------------------------
n34_lit_integer_α:      mov              qword ptr [rsp + 1120], 3            # result
                        mov              rax, qword ptr [rip + .Lx99_0]
                        mov              qword ptr [rsp + 1128], rax;         jmp   n35_assign_var_α
.Lx99_0:                .quad            1
#-----------------------------------------------------------------------------------------------------------------------
n35_assign_var_α:       mov              rdi, qword ptr [rsp + 1088]
...
#-----------------------------------------------------------------------------------------------------------------------
n36_lit_string_α:       mov              qword ptr [rsp + 912], 2             # result
...
.Lx101_0_s:             .string          ""
#-----------------------------------------------------------------------------------------------------------------------
n37_lit_string_α:       mov              qword ptr [rsp + 928], 2             # result
...
.Lx102_0_s:             .string          "I"
#-----------------------------------------------------------------------------------------------------------------------
n38_lit_string_α:       mov              qword ptr [rsp + 944], 2             # result
...
.Lx103_0_s:             .string          "II"
#-----------------------------------------------------------------------------------------------------------------------
n39_lit_string_α:       mov              qword ptr [rsp + 960], 2             # result
...
#-----------------------------------------------------------------------------------------------------------------------
n40_lit_string_α:       mov              qword ptr [rsp + 976], 2             # result
...
.Lx105_0_s:             .string          "IV"
#-----------------------------------------------------------------------------------------------------------------------
n41_lit_string_α:       mov              qword ptr [rsp + 992], 2             # result
...
.Lx106_0_s:             .string          "V"
#-----------------------------------------------------------------------------------------------------------------------
n42_lit_string_α:       mov              qword ptr [rsp + 1008], 2            # result
...
.Lx107_0_s:             .string          "VI"
#-----------------------------------------------------------------------------------------------------------------------
n43_lit_string_α:       mov              qword ptr [rsp + 1024], 2            # result
...
#-----------------------------------------------------------------------------------------------------------------------
n44_lit_string_α:       mov              qword ptr [rsp + 1040], 2            # result
...
#-----------------------------------------------------------------------------------------------------------------------
n45_lit_string_α:       mov              qword ptr [rsp + 1056], 2            # result
...
.Lx110_0_s:             .string          "IX"
#-----------------------------------------------------------------------------------------------------------------------
n46_make_list_α:        mov              rax, qword ptr [rsp + 912]
...
#-----------------------------------------------------------------------------------------------------------------------
n47_assign_α:           mov              rax, qword ptr [rsp + 736]
...
n115_call_builtin_icon_β:
                                                                              jmp   main_ω
#-----------------------------------------------------------------------------------------------------------------------
n116_assign_α:          mov              rax, qword ptr [rsp + 16]
                        mov              rdx, qword ptr [rsp + 24]
                        mov              qword ptr [rsp + 208], rax
                        mov              qword ptr [rsp + 216], rdx;          jmp   n117_disjunction_α
#-----------------------------------------------------------------------------------------------------------------------
n117_disjunction_α:     mov              qword ptr [rsp + 96], 0
                        mov              qword ptr [rsp + 104], 0
                        mov              dword ptr [rsp + 112], 0;            jmp   n120_var_α
n117_disjunction_as:    mov              eax, dword ptr [rsp + 112]
...
n117_disjunction_β:     mov              eax, dword ptr [rsp + 112]
                        cmp              eax, 0;                              je    n117_disjunction_af
                                                                              jmp   n117_disjunction_af
n117_disjunction_af:    add              dword ptr [rsp + 112], 1
...
.Lx133_29:              mov              qword ptr [rsp + 128], rax
                        mov              qword ptr [rsp + 136], rdx
                        cmp              eax, 104;                            je    n117_disjunction_af
