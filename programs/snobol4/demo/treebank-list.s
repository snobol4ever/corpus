...
.Lpc16:                 CALL_FN .Lstr_5, 1                    # SM_CALL fname="DEFINE" nargs=1
.Lpc17:                 VOID_POP                              # SM_POP: discard TOS
.Lpc18:                 JUMP .Lpc48                           # SM_JUMP -> pc=48
.Lpc19:
...
.Lpc29:                 CALL_FN .Lstr_12, 1                   # SM_CALL fname="DIFFER" nargs=1
.Lpc30:                 VOID_POP                              # SM_POP: discard TOS
.Lpc31:                 JUMP_F .Lpc43                         # SM_JUMP_F -> pc=43
...
.Lpc34:                 CALL_FN .Lstr_13, 1                   # SM_CALL fname="head" nargs=1
.Lpc35:                 PUSH_VAR .Lstr_8                      # var=acc
.Lpc36:                 CALL_FN .Lstr_14, 2                   # SM_CALL fname="list" nargs=2
...
.Lpc40:                 CALL_FN .Lstr_15, 1                   # SM_CALL fname="tail" nargs=1
.Lpc41:                 STORE_VAR .Lstr_10                    # store -> cur
.Lpc42:                 JUMP .Lpc26                           # SM_JUMP -> pc=26
.Lpc43:
...
.Lpc52:                 CALL_FN .Lstr_5, 1                    # SM_CALL fname="DEFINE" nargs=1
.Lpc53:                 VOID_POP                              # SM_POP: discard TOS
.Lpc54:                 JUMP .Lpc68                           # SM_JUMP -> pc=68
.Lpc55:
...
.Lpc58:                 PUSH_NULL                             # SM_PUSH_NULL
.Lpc59:                 CALL_FN .Lstr_14, 2                   # SM_CALL fname="list" nargs=2
.Lpc60:                 PUSH_VAR .Lstr_21                     # var=stk
.Lpc61:                 CALL_FN .Lstr_14, 2                   # SM_CALL fname="list" nargs=2
...
.Lpc65:                 CALL_FN .Lstr_23, 1                   # SM_CALL fname="NAME_PUSH" nargs=1
.Lpc66:                 STORE_VAR .Lstr_19                    # store -> stk_push_frame
.Lpc67:                 RETURN                                # SM_RETURN
.Lpc68:
...
.Lpc72:                 CALL_FN .Lstr_5, 1                    # SM_CALL fname="DEFINE" nargs=1
.Lpc73:                 VOID_POP                              # SM_POP: discard TOS
.Lpc74:                 JUMP .Lpc88                           # SM_JUMP -> pc=88
.Lpc75:
...
.Lpc79:                 CALL_FN .Lstr_13, 1                   # SM_CALL fname="head" nargs=1
.Lpc80:                 CALL_FN .Lstr_14, 2                   # SM_CALL fname="list" nargs=2
.Lpc81:                 PUSH_VAR .Lstr_21                     # var=stk
.Lpc82:                 CALL_FN .Lstr_27, 2                   # SM_CALL fname="head_SET" nargs=2
...
.Lpc85:                 CALL_FN .Lstr_23, 1                   # SM_CALL fname="NAME_PUSH" nargs=1
.Lpc86:                 STORE_VAR .Lstr_26                    # store -> stk_push_item
.Lpc87:                 RETURN                                # SM_RETURN
.Lpc88:
...
.Lpc92:                 CALL_FN .Lstr_5, 1                    # SM_CALL fname="DEFINE" nargs=1
.Lpc93:                 VOID_POP                              # SM_POP: discard TOS
.Lpc94:                 JUMP .Lpc118                          # SM_JUMP -> pc=118
.Lpc95:
...
.Lpc99:                 CALL_FN .Lstr_13, 1                   # SM_CALL fname="head" nargs=1
.Lpc100:                CALL_FN .Lstr_6, 1                    # SM_CALL fname="list_reverse" nargs=1
...
.Lpc104:                CALL_FN .Lstr_15, 1                   # SM_CALL fname="tail" nargs=1
...
.Lpc109:                CALL_FN .Lstr_13, 1                   # SM_CALL fname="head" nargs=1
.Lpc110:                CALL_FN .Lstr_14, 2                   # SM_CALL fname="list" nargs=2
.Lpc111:                PUSH_VAR .Lstr_21                     # var=stk
.Lpc112:                CALL_FN .Lstr_27, 2                   # SM_CALL fname="head_SET" nargs=2
...
.Lpc115:                CALL_FN .Lstr_23, 1                   # SM_CALL fname="NAME_PUSH" nargs=1
.Lpc116:                STORE_VAR .Lstr_30                    # store -> stk_pop_into_parent
.Lpc117:                RETURN                                # SM_RETURN
.Lpc118:
...
.Lpc122:                CALL_FN .Lstr_5, 1                    # SM_CALL fname="DEFINE" nargs=1
.Lpc123:                VOID_POP                              # SM_POP: discard TOS
.Lpc124:                JUMP .Lpc141                          # SM_JUMP -> pc=141
.Lpc125:
...
.Lpc128:                CALL_FN .Lstr_13, 1                   # SM_CALL fname="head" nargs=1
.Lpc129:                CALL_FN .Lstr_6, 1                    # SM_CALL fname="list_reverse" nargs=1
.Lpc130:                PUSH_VAR .Lstr_35                     # var=var
.Lpc131:                CALL_FN .Lstr_36, 2                   # SM_CALL fname="ASGN_INDIR" nargs=2
...
.Lpc134:                CALL_FN .Lstr_15, 1                   # SM_CALL fname="tail" nargs=1
...
.Lpc138:                CALL_FN .Lstr_23, 1                   # SM_CALL fname="NAME_PUSH" nargs=1
.Lpc139:                STORE_VAR .Lstr_34                    # store -> stk_pop_final
.Lpc140:                RETURN                                # SM_RETURN
.Lpc141:
...
.Lpc145:                CALL_FN .Lstr_5, 1                    # SM_CALL fname="DEFINE" nargs=1
.Lpc146:                VOID_POP                              # SM_POP: discard TOS
...
.Lpc149:                CALL_FN .Lstr_5, 1                    # SM_CALL fname="DEFINE" nargs=1
.Lpc150:                VOID_POP                              # SM_POP: discard TOS
.Lpc151:                JUMP .Lpc175                          # SM_JUMP -> pc=175
.Lpc152:
...
.Lpc156:                CALL_FN .Lstr_36, 2                   # SM_CALL fname="ASGN_INDIR" nargs=2
...
.Lpc162:                CALL_FN .Lstr_23, 1                   # SM_CALL fname="NAME_PUSH" nargs=1
...
.Lpc170:                CONCAT                                # SM_CONCAT
.Lpc171:                CONCAT                                # SM_CONCAT
.Lpc172:                CALL_FN .Lstr_45, 1                   # SM_CALL fname="EVAL" nargs=1
.Lpc173:                STORE_VAR .Lstr_41                    # store -> Init_list
.Lpc174:                RETURN                                # SM_RETURN
.Lpc175:
...
.Lpc179:                CALL_FN .Lstr_5, 1                    # SM_CALL fname="DEFINE" nargs=1
.Lpc180:                VOID_POP                              # SM_POP: discard TOS
...
.Lpc183:                CALL_FN .Lstr_5, 1                    # SM_CALL fname="DEFINE" nargs=1
.Lpc184:                VOID_POP                              # SM_POP: discard TOS
.Lpc185:                JUMP .Lpc206                          # SM_JUMP -> pc=206
.Lpc186:
...
.Lpc189:                CALL_FN .Lstr_19, 1                   # SM_CALL fname="stk_push_frame" nargs=1
...
.Lpc193:                CALL_FN .Lstr_23, 1                   # SM_CALL fname="NAME_PUSH" nargs=1
...
.Lpc201:                CONCAT                                # SM_CONCAT
.Lpc202:                CONCAT                                # SM_CONCAT
.Lpc203:                CALL_FN .Lstr_45, 1                   # SM_CALL fname="EVAL" nargs=1
.Lpc204:                STORE_VAR .Lstr_50                    # store -> Push_list
.Lpc205:                RETURN                                # SM_RETURN
.Lpc206:
...
.Lpc210:                CALL_FN .Lstr_5, 1                    # SM_CALL fname="DEFINE" nargs=1
.Lpc211:                VOID_POP                              # SM_POP: discard TOS
...
.Lpc214:                CALL_FN .Lstr_5, 1                    # SM_CALL fname="DEFINE" nargs=1
.Lpc215:                VOID_POP                              # SM_POP: discard TOS
.Lpc216:                JUMP .Lpc237                          # SM_JUMP -> pc=237
.Lpc217:
...
.Lpc220:                CALL_FN .Lstr_26, 1                   # SM_CALL fname="stk_push_item" nargs=1
...
.Lpc224:                CALL_FN .Lstr_23, 1                   # SM_CALL fname="NAME_PUSH" nargs=1
...
.Lpc232:                CONCAT                                # SM_CONCAT
.Lpc233:                CONCAT                                # SM_CONCAT
.Lpc234:                CALL_FN .Lstr_45, 1                   # SM_CALL fname="EVAL" nargs=1
.Lpc235:                STORE_VAR .Lstr_56                    # store -> Push_item
.Lpc236:                RETURN                                # SM_RETURN
.Lpc237:
...
.Lpc241:                CALL_FN .Lstr_5, 1                    # SM_CALL fname="DEFINE" nargs=1
.Lpc242:                VOID_POP                              # SM_POP: discard TOS
...
.Lpc245:                CALL_FN .Lstr_5, 1                    # SM_CALL fname="DEFINE" nargs=1
.Lpc246:                VOID_POP                              # SM_POP: discard TOS
.Lpc247:                JUMP .Lpc265                          # SM_JUMP -> pc=265
.Lpc248:
...
# ============================================================================
.Lpc249:
.Lpc250:                CALL_FN .Lstr_30, 0                   # SM_CALL fname="stk_pop_into_parent" nargs=0
...
.Lpc254:                CALL_FN .Lstr_23, 1                   # SM_CALL fname="NAME_PUSH" nargs=1
...
.Lpc260:                PAT_DEREF                             # SM_PAT_DEREF
.Lpc261:                PAT_CAPTURE_FN 0, .Lstr_61            # SM_PAT_CAPTURE_FN fname=pop_list is_imm=0 namelist=(NULL)
.Lpc262:                PAT_BOXVAL                            # SM_PAT_BOXVAL
.Lpc263:                STORE_VAR .Lstr_62                    # store -> Pop_list
.Lpc264:                RETURN                                # SM_RETURN
.Lpc265:
...
.Lpc269:                CALL_FN .Lstr_5, 1                    # SM_CALL fname="DEFINE" nargs=1
.Lpc270:                VOID_POP                              # SM_POP: discard TOS
...
.Lpc273:                CALL_FN .Lstr_5, 1                    # SM_CALL fname="DEFINE" nargs=1
.Lpc274:                VOID_POP                              # SM_POP: discard TOS
.Lpc275:                JUMP .Lpc296                          # SM_JUMP -> pc=296
.Lpc276:
...
.Lpc279:                CALL_FN .Lstr_34, 1                   # SM_CALL fname="stk_pop_final" nargs=1
...
.Lpc283:                CALL_FN .Lstr_23, 1                   # SM_CALL fname="NAME_PUSH" nargs=1
...
.Lpc291:                CONCAT                                # SM_CONCAT
.Lpc292:                CONCAT                                # SM_CONCAT
.Lpc293:                CALL_FN .Lstr_45, 1                   # SM_CALL fname="EVAL" nargs=1
.Lpc294:                STORE_VAR .Lstr_68                    # store -> Pop_final
.Lpc295:                RETURN                                # SM_RETURN
.Lpc296:
...
.Lpc301:                CONCAT                                # SM_CONCAT
.Lpc302:                PAT_SPAN                              # SM_PAT_SPAN
.Lpc303:                PAT_BOXVAL                            # SM_PAT_BOXVAL
...
.Lpc309:                PAT_NOTANY                            # SM_PAT_NOTANY
.Lpc310:                PAT_BOXVAL                            # SM_PAT_BOXVAL
.Lpc311:                PUSH_STR .Lstr_73, 0                  # str="( )"
.Lpc312:                PUSH_VAR .Lstr_0                      # var=nl
.Lpc313:                CONCAT                                # SM_CONCAT
.Lpc314:                PAT_BREAK                             # SM_PAT_BREAK
.Lpc315:                PAT_BOXVAL                            # SM_PAT_BOXVAL
.Lpc316:                CONCAT                                # SM_CONCAT
...
.Lpc321:                PAT_DEREF                             # SM_PAT_DEREF
.Lpc322:                PAT_CAPTURE 0, .Lstr_76               # SM_PAT_CAPTURE var=tag kind=0
.Lpc323:                PAT_BOXVAL                            # SM_PAT_BOXVAL
.Lpc324:                PUSH_STR .Lstr_76, 0                  # str="tag"
.Lpc325:                CALL_FN .Lstr_50, 1                   # SM_CALL fname="Push_list" nargs=1
.Lpc326:                PAT_REFNAME .Lstr_72                  # SM_PAT_REFNAME arg="delim"
.Lpc327:                PAT_REFNAME .Lstr_77                  # SM_PAT_REFNAME arg="group"
.Lpc328:                PUSH_VAR .Lstr_74                     # var=word
.Lpc329:                PAT_DEREF                             # SM_PAT_DEREF
.Lpc330:                PAT_CAPTURE 0, .Lstr_78               # SM_PAT_CAPTURE var=wrd kind=0
.Lpc331:                PUSH_STR .Lstr_78, 0                  # str="wrd"
.Lpc332:                CALL_FN .Lstr_56, 1                   # SM_CALL fname="Push_item" nargs=1
.Lpc333:                PAT_DEREF                             # SM_PAT_DEREF
.Lpc334:                PAT_CAT                               # SM_PAT_CAT
.Lpc335:                PAT_ALT                               # SM_PAT_ALT
.Lpc336:                PAT_CAT                               # SM_PAT_CAT
.Lpc337:                PAT_ARBNO                             # SM_PAT_ARBNO
.Lpc338:                PAT_BOXVAL                            # SM_PAT_BOXVAL
.Lpc339:                CALL_FN .Lstr_62, 0                   # SM_CALL fname="Pop_list" nargs=0
.Lpc340:                PUSH_STR .Lstr_44, 0                  # str=")"
.Lpc341:                CONCAT                                # SM_CONCAT
.Lpc342:                CONCAT                                # SM_CONCAT
.Lpc343:                CONCAT                                # SM_CONCAT
.Lpc344:                CONCAT                                # SM_CONCAT
.Lpc345:                CONCAT                                # SM_CONCAT
...
.Lpc347:
.Lpc348:                PUSH_INT 0                          
.Lpc349:                PAT_POS                               # SM_PAT_POS
.Lpc350:                PAT_BOXVAL                            # SM_PAT_BOXVAL
.Lpc351:                PUSH_STR .Lstr_79, 0                  # str="'bank'"
.Lpc352:                CALL_FN .Lstr_41, 1                   # SM_CALL fname="Init_list" nargs=1
.Lpc353:                PUSH_STR .Lstr_80, 0                  # str="'BANK'"
.Lpc354:                CALL_FN .Lstr_50, 1                   # SM_CALL fname="Push_list" nargs=1
.Lpc355:                PUSH_STR .Lstr_81, 0                  # str="'ROOT'"
.Lpc356:                CALL_FN .Lstr_50, 1                   # SM_CALL fname="Push_list" nargs=1
.Lpc357:                PAT_DEREF                             # SM_PAT_DEREF
.Lpc358:                PAT_REFNAME .Lstr_77                  # SM_PAT_REFNAME arg="group"
.Lpc359:                PAT_ARBNO                             # SM_PAT_ARBNO
.Lpc360:                PAT_REFNAME .Lstr_72                  # SM_PAT_REFNAME arg="delim"
.Lpc361:                CALL_FN .Lstr_62, 0                   # SM_CALL fname="Pop_list" nargs=0
.Lpc362:                PAT_DEREF                             # SM_PAT_DEREF
.Lpc363:                PAT_CAT                               # SM_PAT_CAT
.Lpc364:                PAT_CAT                               # SM_PAT_CAT
.Lpc365:                PAT_CAT                               # SM_PAT_CAT
.Lpc366:                PAT_ARBNO                             # SM_PAT_ARBNO
.Lpc367:                PAT_BOXVAL                            # SM_PAT_BOXVAL
.Lpc368:                PUSH_STR .Lstr_79, 0                  # str="'bank'"
.Lpc369:                CALL_FN .Lstr_68, 1                   # SM_CALL fname="Pop_final" nargs=1
.Lpc370:                PUSH_INT 0                          
.Lpc371:                PAT_RPOS                              # SM_PAT_RPOS
.Lpc372:                PAT_BOXVAL                            # SM_PAT_BOXVAL
.Lpc373:                CONCAT                                # SM_CONCAT
.Lpc374:                CONCAT                                # SM_CONCAT
.Lpc375:                CONCAT                                # SM_CONCAT
.Lpc376:                CONCAT                                # SM_CONCAT
...
.Lpc381:                CALL_FN .Lstr_5, 1                    # SM_CALL fname="DEFINE" nargs=1
.Lpc382:                VOID_POP                              # SM_POP: discard TOS
.Lpc383:                JUMP .Lpc443                          # SM_JUMP -> pc=443
.Lpc384:
...
.Lpc387:                CALL_FN .Lstr_86, 1                   # SM_CALL fname="DATATYPE" nargs=1
.Lpc388:                PUSH_VAR .Lstr_87                     # var=LCASE
.Lpc389:                PUSH_VAR .Lstr_88                     # var=UCASE
.Lpc390:                CALL_FN .Lstr_89, 3                   # SM_CALL fname="REPLACE" nargs=3
.Lpc391:                PUSH_STR .Lstr_90, 0                  # str="STRING"
.Lpc392:                CALL_FN .Lstr_91, 2                   # SM_CALL fname="IDENT" nargs=2
.Lpc393:                VOID_POP                              # SM_POP: discard TOS
.Lpc394:                JUMP_F .Lpc403                        # SM_JUMP_F -> pc=403
...
.Lpc399:                CONCAT                                # SM_CONCAT
.Lpc400:                CONCAT                                # SM_CONCAT
.Lpc401:                STORE_VAR .Lstr_84                    # store -> node_repr
.Lpc402:                RETURN                                # SM_RETURN
.Lpc403:
...
.Lpc416:                CALL_FN .Lstr_12, 1                   # SM_CALL fname="DIFFER" nargs=1
.Lpc417:                VOID_POP                              # SM_POP: discard TOS
.Lpc418:                JUMP_F .Lpc436                        # SM_JUMP_F -> pc=436
...
.Lpc423:                CALL_FN .Lstr_13, 1                   # SM_CALL fname="head" nargs=1
.Lpc424:                CALL_FN .Lstr_84, 1                   # SM_CALL fname="node_repr" nargs=1
.Lpc425:                CONCAT                                # SM_CONCAT
.Lpc426:                CONCAT                                # SM_CONCAT
...
.Lpc433:                CALL_FN .Lstr_15, 1                   # SM_CALL fname="tail" nargs=1
.Lpc434:                STORE_VAR .Lstr_96                    # store -> c
.Lpc435:                JUMP .Lpc413                          # SM_JUMP -> pc=413
.Lpc436:
...
.Lpc440:                CONCAT                                # SM_CONCAT
.Lpc441:                STORE_VAR .Lstr_84                    # store -> node_repr
.Lpc442:                RETURN                                # SM_RETURN
.Lpc443:
...
.Lpc447:                CALL_FN .Lstr_5, 1                    # SM_CALL fname="DEFINE" nargs=1
.Lpc448:                VOID_POP                              # SM_POP: discard TOS
.Lpc449:                JUMP .Lpc538                          # SM_JUMP -> pc=538
.Lpc450:
...
.Lpc453:                CALL_FN .Lstr_84, 1                   # SM_CALL fname="node_repr" nargs=1
...
.Lpc458:                CALL_FN .Lstr_104, 2                  # SM_CALL fname="DUPL" nargs=2
...
.Lpc464:                CALL_FN .Lstr_106, 1                  # SM_CALL fname="SIZE" nargs=1
.Lpc465:                ARITH 17                              # SM_ADD
.Lpc466:                CALL_FN .Lstr_107, 2                  # SM_CALL fname="GT" nargs=2
.Lpc467:                VOID_POP                              # SM_POP: discard TOS
.Lpc468:                JUMP_F .Lpc477                        # SM_JUMP_F -> pc=477
...
.Lpc474:                CONCAT                                # SM_CONCAT
.Lpc475:                STORE_VAR .Lstr_109                   # store -> OUTPUT
.Lpc476:                RETURN                                # SM_RETURN
.Lpc477:
...
.Lpc483:                CALL_FN .Lstr_13, 1                   # SM_CALL fname="head" nargs=1
.Lpc484:                PUSH_STR .Lstr_112, 0                 # str="',"
.Lpc485:                CONCAT                                # SM_CONCAT
.Lpc486:                CONCAT                                # SM_CONCAT
.Lpc487:                CONCAT                                # SM_CONCAT
.Lpc488:                CONCAT                                # SM_CONCAT
...
.Lpc492:                CALL_FN .Lstr_15, 1                   # SM_CALL fname="tail" nargs=1
...
.Lpc497:                CALL_FN .Lstr_12, 1                   # SM_CALL fname="DIFFER" nargs=1
.Lpc498:                VOID_POP                              # SM_POP: discard TOS
.Lpc499:                JUMP_F .Lpc535                        # SM_JUMP_F -> pc=535
...
.Lpc502:                CALL_FN .Lstr_15, 1                   # SM_CALL fname="tail" nargs=1
...
.Lpc506:                CALL_FN .Lstr_12, 1                   # SM_CALL fname="DIFFER" nargs=1
.Lpc507:                VOID_POP                              # SM_POP: discard TOS
.Lpc508:                JUMP_F .Lpc522                        # SM_JUMP_F -> pc=522
...
.Lpc511:                CALL_FN .Lstr_13, 1                   # SM_CALL fname="head" nargs=1
.Lpc512:                PUSH_VAR .Lstr_103                    # var=indent
.Lpc513:                PUSH_INT 2                          
.Lpc514:                ARITH 17                              # SM_ADD
.Lpc515:                PUSH_STR .Lstr_115, 0                 # str=","
.Lpc516:                CALL_FN .Lstr_102, 3                  # SM_CALL fname="pp_node" nargs=3
.Lpc517:                VOID_POP                              # SM_POP: discard TOS
...
.Lpc521:                JUMP .Lpc494                          # SM_JUMP -> pc=494
.Lpc522:
...
.Lpc525:                CALL_FN .Lstr_13, 1                   # SM_CALL fname="head" nargs=1
...
.Lpc531:                CONCAT                                # SM_CONCAT
.Lpc532:                CALL_FN .Lstr_102, 3                  # SM_CALL fname="pp_node" nargs=3
.Lpc533:                VOID_POP                              # SM_POP: discard TOS
.Lpc534:                RETURN                                # SM_RETURN
.Lpc535:
...
.Lpc542:                CALL_FN .Lstr_5, 1                    # SM_CALL fname="DEFINE" nargs=1
.Lpc543:                VOID_POP                              # SM_POP: discard TOS
.Lpc544:                JUMP .Lpc557                          # SM_JUMP -> pc=557
.Lpc545:
...
.Lpc550:                CALL_FN .Lstr_102, 3                  # SM_CALL fname="pp_node" nargs=3
.Lpc551:                VOID_POP                              # SM_POP: discard TOS
...
.Lpc554:                CALL_FN .Lstr_23, 1                   # SM_CALL fname="NAME_PUSH" nargs=1
.Lpc555:                STORE_VAR .Lstr_120                   # store -> pp_bank
.Lpc556:                RETURN                                # SM_RETURN
.Lpc557:
...
.Lpc563:                JUMP_F .Lpc572                        # SM_JUMP_F -> pc=572
...
.Lpc568:                CONCAT                                # SM_CONCAT
.Lpc569:                CONCAT                                # SM_CONCAT
.Lpc570:                STORE_VAR .Lstr_126                   # store -> src
.Lpc571:                JUMP .Lpc559                          # SM_JUMP -> pc=559
.Lpc572:
...
.Lpc575:                PAT_DEREF                             # SM_PAT_DEREF
.Lpc576:                PUSH_VAR .Lstr_126                    # var=src
.Lpc577:                PUSH_INT 0                          
.Lpc578:                EXEC_STMT_VARIANT 0, .Lstr_126        # SM_EXEC_STMT_VARIANT subj=src has_repl=0
.Lpc579:                JUMP_F .Lpc584                        # SM_JUMP_F -> pc=584

# ============================================================================
# stmt 100  (line 100):  +                  ARBNO(*group)
# ============================================================================
.Lpc580:
.Lpc581:                CALL_FN .Lstr_120, 0                  # SM_CALL fname="pp_bank" nargs=0
.Lpc582:                STORE_VAR .Lstr_22                    # store -> dummy
.Lpc583:                JUMP .Lpc588                          # SM_JUMP -> pc=588
.Lpc584:
