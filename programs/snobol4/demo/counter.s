...
n17_coerce_numeric_α:   sub              rsp, 16
                        ...
                        cmp              eax, 3;                    jne   .Lx47_0
.Lx47_1:                mov              rax, qword ptr [rsp + 32]                      # var
                        mov              qword ptr [rsp + 0], rax                       # result
...
n18_coerce_numeric_α:   sub              rsp, 16
                        ...
                        cmp              eax, 3;                    jne   .Lx49_0
.Lx49_1:                mov              rax, qword ptr [rsp + 32]                      # lit_integer
                        mov              qword ptr [rsp + 0], rax                       # result
...
n19_cmp_test_α:         sub              rsp, 16
                        ...
                        test             eax, eax;                  js    .Lx51_240
                        add              rsp, 16;                   jmp   n18_coerce_numeric_β
.Lx51_240:                                                          jmp   n20_statement_end_α
#-----------------------------------------------------------------------------------------------------------------------
n20_statement_end_α:    add              rsp, 80;                   jmp   n4_statement_begin_α
#-----------------------------------------------------------------------------------------------------------------------
n21_goto_α:                                                         jmp   n4_statement_begin_α
