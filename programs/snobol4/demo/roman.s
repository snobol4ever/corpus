...
.Lx136_0:               mov              r14d, dword ptr [rbp + -40];         jmp   n28_match_rpos_α
...
#-----------------------------------------------------------------------------------------------------------------------
n32_match_end_α:        mov              eax, dword ptr [rbp + -40]           # repl_start
...
n42_match_begin_α:      mov              rdi, qword ptr [rsp + 16]            # lit_string
                        ...
                        mov              r11, qword ptr [rip + rtccb+64]
                        mov              dword ptr [rbp + -40], 0             # start_δ
.Lx160_0:               mov              r14d, dword ptr [rbp + -40];         jmp   n43_match_defer_α
n42_match_begin_β:      lea              rsp, [rbp + -56]                     # retry_whack
                        add              dword ptr [rbp + -40], 1             # start_δ
                        mov              eax, dword ptr [rbp + -40]
                        ...
                        cmp              rax, 0;                              jne   .Lx160_1
                                                                              jmp   .Lx160_0
.Lx160_1:
n42_match_begin_af:     mov              r12, qword ptr [rbp + -8]            # cas_mark
                        mov              r13, qword ptr [rbp + -16]           # outer_Σ
                        mov              r14, qword ptr [rbp + -24]           # outer_δ
                        mov              r15, qword ptr [rbp + -32]           # outer_Δ
                        mov              rdi, r13
...
.Lsig180z:              .quad            1
                        ...
                        .quad            .Lx180_2
                        .quad            16
.Lx180_2:               mov              rcx, qword ptr [rip + rt_g_ret_by_name@GOTPCREL] # NRETURN by-name consult wn=0
...
.Lsig249z:              .quad            2
                        ...
                        .quad            32
                        .quad            16
.Lx249_2:               mov              rcx, qword ptr [rip + rt_g_ret_by_name@GOTPCREL] # NRETURN by-name consult wn=0
                        mov              ecx, dword ptr [rcx + 0]
...
.Lsig265z:              .quad            2
                        ...
                        .quad            32
                        .quad            16
.Lx265_2:               mov              rcx, qword ptr [rip + rt_g_ret_by_name@GOTPCREL] # NRETURN by-name consult wn=0
                        mov              ecx, dword ptr [rcx + 0]
...
.Lx273_2:               mov              rcx, qword ptr [rip + rt_g_ret_by_name@GOTPCREL] # NRETURN by-name consult wn=0
                        ...
                        mov              rax, qword ptr [rsp + 0]
                        mov              rdx, qword ptr [rsp + 8]
.Lx273_29:              mov              qword ptr [rsp + 0], rax             # result
                        mov              qword ptr [rsp + 8], rdx
