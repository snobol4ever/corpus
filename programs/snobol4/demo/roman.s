...
.Lx63_2:
                        ...
                        cmp              eax, 104
                                                                                        jne   .Lx63_240
                        add              rsp, 16
                                                                                        jmp   proc_LBL__ROMAN_zw5s8_ω_d16
.Lx63_240:
...
n18_lit_string_β:
                        add              rsp, 16
                                                                                        jmp   proc_LBL__ROMAN_zw5s8_ω_d48
.Lx65_0:
                        .quad            .Lx65_0_s
.Lx65_0_s:
                        .string          "XLCDM**"
...
n20_var_β:
                        add              rsp, 16
                                                                                        jmp   proc_LBL__ROMAN_zw5s8_ω_d80
#-----------------------------------------------------------------------------------------------------------------------
n21_binop_α:
                        sub              rsp, 16
...
n21_binop_β:
                        add              rsp, 16
                                                                                        jmp   proc_LBL__ROMAN_zw5s8_ω_d96
#-----------------------------------------------------------------------------------------------------------------------
n22_assign_α:
                        ...
                        mov              qword ptr [1879052296], rdx
                                                                                        jmp   n23_statement_α
n22_assign_β:
                                                                                        jmp   proc_LBL__ROMAN_zw5s8_ω_d112
#-----------------------------------------------------------------------------------------------------------------------
n23_statement_α:
                                                                                        jmp   n34_save_restore_α
n23_statement_β:
                        add              rsp, 112
                                                                                        jmp   n24_save_restore_α
proc_LBL__ROMAN_zw5s8_ω_d112:
                        add              rsp, 112
                                                                                        jmp   n24_save_restore_α
proc_LBL__ROMAN_zw5s8_ω_d96:
                        add              rsp, 96
                                                                                        jmp   n24_save_restore_α
...
.Lx118_2:
                        ...
                        cmp              eax, 104
                                                                                        jne   .Lx118_240
                        add              rsp, 16
                                                                                        jmp   proc_LBL__TEST_zw5s13_ω_d64
.Lx118_240:
                                                                                        jmp   n97_binop_α
n96_call_β:
                                                                                        jmp   proc_LBL__TEST_zw5s13_ω_d64
...
n99_statement_α:
                        add              rsp, 96
                                                                                        jmp   n100_var_α
proc_LBL__TEST_zw5s13_ω_d96:
                        add              rsp, 96
                                                                                        jmp   n100_var_α
proc_LBL__TEST_zw5s13_ω_d80:
                        add              rsp, 80
                                                                                        jmp   n100_var_α
proc_LBL__TEST_zw5s13_ω_d64:
                        add              rsp, 64
                                                                                        jmp   n100_var_α
proc_LBL__TEST_zw5s13_ω_d48:
                        add              rsp, 48
                                                                                        jmp   n100_var_α
proc_LBL__TEST_zw5s13_ω_d32:
                        add              rsp, 32
                                                                                        jmp   n100_var_α
proc_LBL__TEST_zw5s13_ω_d16:
                        add              rsp, 16
                                                                                        jmp   n100_var_α
#=======================================================================================================================
# 	EQ(I,J)						:S(RETURN)
...
n104_cmp_test_α:
                        ...
                        test             eax, eax
                                                                                        je    .Lx130_240
                        add              rsp, 16
                                                                                        jmp   proc_LBL__TEST_zw5s14_ω_d64
.Lx130_240:
                                                                                        jmp   n105_statement_α
#-----------------------------------------------------------------------------------------------------------------------
n105_statement_α:
                                                                                        jmp   n106_save_restore_α
proc_LBL__TEST_zw5s14_ω_d64:
                        add              rsp, 64
                                                                                        jmp   n107_var_α
proc_LBL__TEST_zw5s14_ω_d48:
                        add              rsp, 48
                                                                                        jmp   n107_var_α
proc_LBL__TEST_zw5s14_ω_d32:
                        add              rsp, 32
                                                                                        jmp   n107_var_α
proc_LBL__TEST_zw5s14_ω_d16:
                        add              rsp, 16
                                                                                        jmp   n107_var_α
proc_LBL__TEST_zw5s14_ω_d96:
                        add              rsp, 96
                                                                                        jmp   n107_var_α
#-----------------------------------------------------------------------------------------------------------------------
n106_save_restore_α:
...
n109_binop_α:
                        ...
                        cmp              eax, 104
                                                                                        jne   .Lx137_240
                        add              rsp, 16
                                                                                        jmp   proc_LBL__TEST_zw5s15_ω_d32
.Lx137_240:
                        mov              qword ptr [rsp + 0], rax                       # result
                        mov              qword ptr [rsp + 8], rdx
                                                                                        jmp   n110_assign_α
...
n111_statement_α:
                        add              rsp, 48
                                                                                        jmp   n92_var_α
proc_LBL__TEST_zw5s15_ω_d48:
                        add              rsp, 48
                                                                                        jmp   n92_var_α
proc_LBL__TEST_zw5s15_ω_d32:
                        add              rsp, 32
                                                                                        jmp   n92_var_α
proc_LBL__TEST_zw5s15_ω_d16:
                        add              rsp, 16
                                                                                        jmp   n92_var_α
proc_LBL__TEST_zw5s15_ω_d80:
                        add              rsp, 80
                                                                                        jmp   n92_var_α
#-----------------------------------------------------------------------------------------------------------------------
proc_LBL__TEST_res:
