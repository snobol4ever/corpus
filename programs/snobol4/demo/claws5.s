...
.Lpc30:                 CALL_FN          .Lstr_13, 3 # fname="IDX_SET"
# ============================================================================
# stmt 7  (line 7):  *------------------------------------------------------------------------------
# ============================================================================
.Lpc31:                 STNO             
...
.Lpc49:                 CALL_FN          .Lstr_19, 2 # fname="IDX"
.Lpc50:                 CALL_FN          .Lstr_21, 1 # fname="DIFFER"
.Lpc51:                 VOID_POP         
.Lpc52:                 JUMP_F           .Lpc82
# ============================================================================
# stmt 11  (line 11):  *------------------------------------------------------------------------------
...
.Lpc58:                 CALL_FN          .Lstr_19, 2 # fname="IDX"
.Lpc59:                 PUSH_VAR         .Lstr_22 # var=tag
.Lpc60:                 CALL_FN          .Lstr_19, 2 # fname="IDX"
.Lpc61:                 CALL_FN          .Lstr_21, 1 # fname="DIFFER"
.Lpc62:                 VOID_POP         
.Lpc63:                 JUMP_F           .Lpc90
# ============================================================================
...
.Lpc69:                 CALL_FN          .Lstr_19, 2 # fname="IDX"
.Lpc70:                 PUSH_VAR         .Lstr_22 # var=tag
.Lpc71:                 CALL_FN          .Lstr_19, 2 # fname="IDX"
.Lpc72:                 PUSH_INT         1
.Lpc73:                 ADD_NUM          
.Lpc74:                 PUSH_VAR         .Lstr_12 # var=mem
.Lpc75:                 PUSH_VAR         .Lstr_10 # var=sentno
.Lpc76:                 CALL_FN          .Lstr_19, 2 # fname="IDX"
.Lpc77:                 PUSH_VAR         .Lstr_20 # var=wrd
.Lpc78:                 CALL_FN          .Lstr_19, 2 # fname="IDX"
...
.Lpc95:                 CALL_FN          .Lstr_19, 2 # fname="IDX"
...
.Lpc133:                PUSH_INT         1
.Lpc134:                CALL_FN          .Lstr_19, 3 # fname="IDX"
.Lpc135:                VOID_POP         
...
.Lpc154:                PUSH_INT         1
.Lpc155:                CALL_FN          .Lstr_19, 3 # fname="IDX"
...
.Lpc172:                PUSH_INT         4
.Lpc173:                ADD_NUM          
.Lpc174:                CALL_FN          .Lstr_40, 2 # fname="DUPL"
...
.Lpc202:                CALL_FN          .Lstr_29, 1 # fname="SORT"
...
.Lpc216:                PUSH_INT         1
.Lpc217:                CALL_FN          .Lstr_19, 3 # fname="IDX"
...
.Lpc227:                ADD_NUM          
.Lpc228:                PUSH_INT         1
.Lpc229:                CALL_FN          .Lstr_19, 3 # fname="IDX"
...
.Lpc265:                CALL_FN          .Lstr_19, 2 # fname="IDX"
.Lpc266:                CALL_FN          .Lstr_29, 1 # fname="SORT"
...
.Lpc283:                PUSH_INT         1
.Lpc284:                CALL_FN          .Lstr_19, 3 # fname="IDX"
...
.Lpc292:                CALL_FN          .Lstr_19, 2 # fname="IDX"
.Lpc293:                PUSH_VAR         .Lstr_22 # var=tag
.Lpc294:                CALL_FN          .Lstr_19, 2 # fname="IDX"
...
.Lpc338:                PUSH_INT         0
.Lpc339:                CALL_FN          .Lstr_68, 2 # fname="GT"
.Lpc340:                VOID_POP         
...
.Lpc449:                PAT_SPAN         
.Lpc450:                PAT_CAPTURE      0, .Lstr_9 # var=num kind=0
.Lpc451:                PAT_LIT          .Lstr_87 # arg="_CRD :_PUN"
.Lpc452:                PUSH_VAR         .Lstr_88 # var=epsilon
.Lpc453:                PAT_DEREF        
.Lpc454:                PAT_CAPTURE_FN   0, .Lstr_8 # fname=new_sent namelist=(NULL)
.Lpc455:                PAT_CAT          
.Lpc456:                PAT_CAT          
...
.Lpc460:                PAT_BREAK        
.Lpc461:                PAT_CAT          
.Lpc462:                PAT_CAPTURE      0, .Lstr_20 # var=wrd kind=0
...
.Lpc469:                PAT_SPAN         
.Lpc470:                PAT_CAT          
.Lpc471:                PAT_CAPTURE      0, .Lstr_22 # var=tag kind=0
.Lpc472:                PUSH_VAR         .Lstr_88 # var=epsilon
.Lpc473:                PAT_DEREF        
.Lpc474:                PAT_CAPTURE_FN   0, .Lstr_18 # fname=add_tok namelist=(NULL)
.Lpc475:                PAT_CAT          
.Lpc476:                PAT_CAT          
.Lpc477:                PAT_CAT          
.Lpc478:                PAT_ALT          
