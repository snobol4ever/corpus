...
.Lx692_20:
                        ...
                        call             rt_arg_stage@PLT
.Lx692_21:
                        mov              rdi, qword ptr [rip + .Lx692_0]                # name
                        mov              esi, 1                                         # nargs
                        call             rt_proc_call_open@PLT
                        test             rax, rax
                                                                                        je    .Lx692_1
...
.Lx754_20:
                        ...
                        call             rt_arg_stage@PLT
.Lx754_21:
                        mov              rdi, qword ptr [rip + .Lx754_0]                # name
                        mov              esi, 1                                         # nargs
                        call             rt_proc_call_open@PLT
                        test             rax, rax
                                                                                        je    .Lx754_1
...
.Lx766_20:
                        ...
                        call             rt_arg_stage@PLT
.Lx766_21:
                        mov              rdi, qword ptr [rip + .Lx766_0]                # name
                        mov              esi, 1                                         # nargs
                        call             rt_proc_call_open@PLT
                        test             rax, rax
                                                                                        je    .Lx766_1
...
.Lx782_20:
                        ...
                        call             rt_arg_stage@PLT
.Lx782_21:
                        mov              rdi, qword ptr [rip + .Lx782_0]                # name
                        mov              esi, 1                                         # nargs
                        call             rt_proc_call_open@PLT
                        test             rax, rax
                                                                                        je    .Lx782_1
...
.Lx790_20:
                        ...
                        call             rt_arg_stage@PLT
.Lx790_21:
                        mov              rdi, qword ptr [rip + .Lx790_0]                # name
                        mov              esi, 1                                         # nargs
                        call             rt_proc_call_open@PLT
                        test             rax, rax
                                                                                        je    .Lx790_1
