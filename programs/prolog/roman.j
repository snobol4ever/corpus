...
; Source: /home/claude/corpus/programs/prolog/roman.pl
...
call0_alpha:
    ...
    aload 7
    iload 8
    invokestatic roman/p_member_2([Ljava/lang/Object;[Ljava/lang/Object;I)[Ljava/lang/Object;
    dup
    astore 9
    ifnull call0_omega
    aload 9
...
call3_alpha:
    ...
    aload 7
    iload 8
    invokestatic roman/p_memberchk_2([Ljava/lang/Object;[Ljava/lang/Object;I)[Ljava/lang/Object;
    dup
    astore 9
    ifnull call3_omega
    aload 9
...
; Predicate method: p_FUNCTOR_ARITY(args..., cs) -> Object[]|null
; cs = continuation state: 0=first try, N=retry from clause N
.method static p_roman_2([Ljava/lang/Object;[Ljava/lang/Object;I)[Ljava/lang/Object;
    .limit stack 512
    .limit locals 73
    iconst_0
    istore 71
    iload 2 ; cs == 0x7fffffff (cutgamma sentinel)? -> omega
    ldc 2147483647
    if_icmpeq p_roman_2_omega
    iload 2
    istore 4
    iload 2 ; cs >= 13? → clause13
    ldc 13
    if_icmpge p_roman_2_clause13
    iload 2 ; cs >= 12? → clause12
    ldc 12
    if_icmpge p_roman_2_clause12
    iload 2 ; cs >= 11? → clause11
    ldc 11
    if_icmpge p_roman_2_clause11
    iload 2 ; cs >= 10? → clause10
    ldc 10
    if_icmpge p_roman_2_clause10
    iload 2 ; cs >= 9? → clause9
    ldc 9
    if_icmpge p_roman_2_clause9
    iload 2 ; cs >= 8? → clause8
    ldc 8
    if_icmpge p_roman_2_clause8
    iload 2 ; cs >= 7? → clause7
    ldc 7
    if_icmpge p_roman_2_clause7
    iload 2 ; cs >= 6? → clause6
    ldc 6
    if_icmpge p_roman_2_clause6
    iload 2 ; cs >= 5? → clause5
    ldc 5
    if_icmpge p_roman_2_clause5
    iload 2 ; cs >= 4? → clause4
    ldc 4
    if_icmpge p_roman_2_clause4
    iload 2 ; cs >= 3? → clause3
    ldc 3
    if_icmpge p_roman_2_clause3
    iload 2 ; cs >= 2? → clause2
    ldc 2
    if_icmpge p_roman_2_clause2
    iload 2 ; cs >= 1? → clause1
    ldc 1
    if_icmpge p_roman_2_clause1
    iload 2 ; cs >= 0? → clause0
    ldc 0
    if_icmpge p_roman_2_clause0
...
p_roman_2_clause0:
    ...
    isub
    dup
    ifge p_roman_2_initcs_clamp_0
    pop
    iconst_0
p_roman_2_initcs_clamp_0:
    istore 4
    iconst_0
    istore 5
    invokestatic roman/pj_trail_mark()I
...
p_roman_2_clause1:
    ...
    isub
    dup
    ifge p_roman_2_initcs_clamp_1
    pop
    iconst_0
p_roman_2_initcs_clamp_1:
    istore 4
    iconst_0
    istore 5
    invokestatic roman/pj_trail_mark()I
...
p_roman_2_clause2:
    ...
    isub
    dup
    ifge p_roman_2_initcs_clamp_2
    pop
    iconst_0
p_roman_2_initcs_clamp_2:
    istore 4
    iconst_0
    istore 5
    invokestatic roman/pj_trail_mark()I
...
p_roman_2_clause3:
    ...
    isub
    dup
    ifge p_roman_2_initcs_clamp_3
    pop
    iconst_0
p_roman_2_initcs_clamp_3:
    istore 4
    iconst_0
    istore 5
    invokestatic roman/pj_trail_mark()I
...
p_roman_2_clause4:
    ...
    isub
    dup
    ifge p_roman_2_initcs_clamp_4
    pop
    iconst_0
p_roman_2_initcs_clamp_4:
    istore 4
    iconst_0
    istore 5
    invokestatic roman/pj_trail_mark()I
...
p_roman_2_clause5:
    ...
    isub
    dup
    ifge p_roman_2_initcs_clamp_5
    pop
    iconst_0
p_roman_2_initcs_clamp_5:
    istore 4
    iconst_0
    istore 5
    invokestatic roman/pj_trail_mark()I
...
p_roman_2_clause6:
    ...
    isub
    dup
    ifge p_roman_2_initcs_clamp_6
    pop
    iconst_0
p_roman_2_initcs_clamp_6:
    istore 4
    iconst_0
    istore 5
    invokestatic roman/pj_trail_mark()I
...
p_roman_2_clause7:
    ...
    isub
    dup
    ifge p_roman_2_initcs_clamp_7
    pop
    iconst_0
p_roman_2_initcs_clamp_7:
    istore 4
    iconst_0
    istore 5
    invokestatic roman/pj_trail_mark()I
...
p_roman_2_clause8:
    ...
    isub
    dup
    ifge p_roman_2_initcs_clamp_8
    pop
    iconst_0
p_roman_2_initcs_clamp_8:
    istore 4
    iconst_0
    istore 5
    invokestatic roman/pj_trail_mark()I
...
p_roman_2_clause9:
    ...
    isub
    dup
    ifge p_roman_2_initcs_clamp_9
    pop
    iconst_0
p_roman_2_initcs_clamp_9:
    istore 4
    iconst_0
    istore 5
    invokestatic roman/pj_trail_mark()I
...
p_roman_2_clause10:
    ...
    isub
    dup
    ifge p_roman_2_initcs_clamp_10
    pop
    iconst_0
p_roman_2_initcs_clamp_10:
    istore 4
    iconst_0
    istore 5
    invokestatic roman/pj_trail_mark()I
...
p_roman_2_clause11:
    ...
    isub
    dup
    ifge p_roman_2_initcs_clamp_11
    pop
    iconst_0
p_roman_2_initcs_clamp_11:
    istore 4
    iconst_0
    istore 5
    invokestatic roman/pj_trail_mark()I
...
p_roman_2_clause12:
    ...
    isub
    dup
    ifge p_roman_2_initcs_clamp_12
    pop
    iconst_0
p_roman_2_initcs_clamp_12:
    istore 4
    iconst_0
    istore 5
    invokestatic roman/pj_trail_mark()I
...
p_roman_2_clause13:
    ...
    isub
    dup
    ifge p_roman_2_initcs_clamp_13
    pop
    iconst_0
p_roman_2_initcs_clamp_13:
    istore 4
    iconst_0
    istore 5
    invokestatic roman/pj_trail_mark()I
...
.method public static main([Ljava/lang/String;)V
    ...
    .limit locals 4
    iconst_0
    invokestatic roman/p_main_0(I)[Ljava/lang/Object;
    pop
    return
.end method
