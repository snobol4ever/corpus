...
plseq2_g1_α:
 bb35504_α:
# BOX PL_CALL cat/1 (WAM-CP-5, n_args=1)
 mov edi, 56
 mov rsi, 0
 xor edx, edx
 xorps xmm0, xmm0
...
bb35504_α_fail5: 
 ...
 call pl_bb_env_install@PLT
 jmp xite3_then_α
bb35504_α_nosol: jmp xite3_else_α
xite3_then_α:
 bb35280_α:
...
plseq2_g3_α:
 bb34720_α:
# BOX PL_CALL bird/1 (WAM-CP-5, n_args=1)
 mov edi, 56
 mov rsi, 1
 xor edx, edx
 xorps xmm0, xmm0
...
.Lplent0_done: 
 jmp .Lplcallees4_end
# PL CALLEE BLOCK bird/1/1
.intel_syntax noprefix
.Lplpred_bird_1: 
# env push/pop handled by caller (bb_pl_call site)
# redo entry: .Lplpred_bird_1_redo
 bb23040_α:
# BOX PL_CHOICE n=2 (WAM-CP-5 heap cursor, WAM-CP-9 cut)
 call rt_pl_env_current@PLT
 mov rdx, rax
...
.Lplpb5_ω: 
 ...
 call rt_set_last_ok@PLT
 ret
.Lplpred_bird_1_redo: jmp .Lplpb5_β
# PL CALLEE BLOCK cat/1/1
.intel_syntax noprefix
.Lplpred_cat_1: 
# env push/pop handled by caller (bb_pl_call site)
# redo entry: .Lplpred_cat_1_redo
 bb27872_α:
# BOX PL_CHOICE n=2 (WAM-CP-5 heap cursor, WAM-CP-9 cut)
 call rt_pl_env_current@PLT
 mov rdx, rax
...
.Lplpb7_ω: 
 ...
 call rt_set_last_ok@PLT
 ret
.Lplpred_cat_1_redo: jmp .Lplpb7_β
.Lplcallees4_end: 
 HALT
