...
.Lx22_101:              mov              qword ptr [rsp + 32], rax
                        ...
                        mov              r8,  qword ptr [rip + rtccb+40]
                        mov              r9,  qword ptr [rip + rtccb+48];     jmp   n1_lit_real_α
n0_call_builtin_prolog_β:
                                                                              jmp   main_ω
#-----------------------------------------------------------------------------------------------------------------------
n1_lit_real_α:          mov              qword ptr [rsp + 512], 5             # result
                        mov              rax, qword ptr [rip + .Lx23_0]
                        mov              qword ptr [rsp + 520], rax;          jmp   n2_lit_real_α
.Lx23_0:                .quad            4612811918334230528
#-----------------------------------------------------------------------------------------------------------------------
n2_lit_real_α:          mov              qword ptr [rsp + 528], 5             # result
...
.Lrkfn34:               .string          "$write"
                        ...
                        cmp              eax, 104;                            je    n21_call_builtin_prolog_α
                        mov              r8,  qword ptr [rip + rtccb+40]
                        mov              r9,  qword ptr [rip + rtccb+48];     jmp   n10_lit_real_α
n9_call_builtin_prolog_β:
                                                                              jmp   n21_call_builtin_prolog_α
#-----------------------------------------------------------------------------------------------------------------------
n10_lit_real_α:         mov              qword ptr [rsp + 288], 5             # result
                        mov              rax, qword ptr [rip + .Lx35_0]
                        mov              qword ptr [rsp + 296], rax;          jmp   n11_lit_real_α
.Lx35_0:                .quad            4609434218613702656
#-----------------------------------------------------------------------------------------------------------------------
n11_lit_real_α:         mov              qword ptr [rsp + 304], 5             # result
