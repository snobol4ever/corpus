...
n19_move_label_α:       lea              rax, [rip + n21_call_builtin_prolog_α]
                        mov              qword ptr [rsp + 64], rax;           jmp   proc_ab$2F2_γ
#-----------------------------------------------------------------------------------------------------------------------
n20_disjunction_α:      mov              qword ptr [rip + rtccb+40], r8
                        ...
                        mov              r10, qword ptr [rip + rtccb+56]
                        mov              r11, qword ptr [rip + rtccb+64]
                        test             rax, rax;                            je    proc_ab$2F2_ω
                                                                              jmp   rax
n20_disjunction_β:                                                            jmp   proc_ab$2F2_ω
#-----------------------------------------------------------------------------------------------------------------------
n21_call_builtin_prolog_α:
                        ...
                        mov              r9,  qword ptr [rip + rtccb+48]
                        mov              r10, qword ptr [rip + rtccb+56]
                        mov              r11, qword ptr [rip + rtccb+64];     jmp   proc_ab$2F2_ω
...
proc_ab$2F2_dcα:
                        ...
                        add              rsp, 16
                        lea              rcx, [rip + .Lx54_2]
                        lea              rdx, [rip + .Lx54_3];                jmp   proc_ab$2F2_α
.Lx54_2:                pop              r11
                        pop              r11;                                 jmp   r11
.Lx54_3:                pop              r11
                        pop              r11
...
n70_call_proc_staged_α: lea              rsi, [rsp + 624]
                        lea              rdx, [rsp + 720]
                        call             proc_ab$2F2_dcα;                     jmp   .Lx95_2
.Lx95_2:                mov              rcx, qword ptr [rip + rt_g_ret_by_name@GOTPCREL] # NRETURN by-name consult wn=0
