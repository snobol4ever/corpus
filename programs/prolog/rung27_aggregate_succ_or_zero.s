...
.Lx28_101:              mov              qword ptr [rsp + 80], rax
                        ...
                        cmp              al, 104;                             je    succ_or_zero$2F2_ω
                        mov              r8,  qword ptr [rip + rtccb+40]
                        mov              r9,  qword ptr [rip + rtccb+48];     jmp   n1_var_ref_α
n0_call_builtin_prolog_β:
                        mov              r11, 1;                              jmp   succ_or_zero$2F2_ω
#-----------------------------------------------------------------------------------------------------------------------
...
n13_call_builtin_prolog_β:
                        mov              r11, 14;                             jmp   succ_or_zero$2F2_ω
#-----------------------------------------------------------------------------------------------------------------------
...
n26_disjunction_α:      mov              r11, 27
                        ...
                        test             rax, rax;                            je    succ_or_zero$2F2_ω
                                                                              jmp   rax
n26_disjunction_β:      mov              r11, 27;                             jmp   succ_or_zero$2F2_ω
#-----------------------------------------------------------------------------------------------------------------------
n27_call_builtin_prolog_α:
                        ...
                        cmp              al, 104;                             je    succ_or_zero$2F2_ω
                        mov              r8,  qword ptr [rip + rtccb+40]
                        mov              r9,  qword ptr [rip + rtccb+48];     jmp   succ_or_zero$2F2_ω
n27_call_builtin_prolog_β:
                        mov              r11, 28;                             jmp   succ_or_zero$2F2_ω
#-----------------------------------------------------------------------------------------------------------------------
...
.Lx95_0:                .quad            3
#-----------------------------------------------------------------------------------------------------------------------
n71_var_ref_α:          mov              r11, 31
                        mov              rax, 4294967336
                        lea              rdx, [rsp + 704]
                        mov              qword ptr [rsp + 656], rax
                        mov              qword ptr [rsp + 664], rdx;          jmp   n72_call_proc_staged_α
#-----------------------------------------------------------------------------------------------------------------------
n72_call_proc_staged_α: mov              r11, 32
                        lea              rsi, [rsp + 640]
                        lea              rdx, [rsp + 656]
...
.Lx99_29:               mov              qword ptr [rsp + 576], rax
                        ...
                        cmp              al, 104;                             je    n93_call_builtin_prolog_α
                                                                              jmp   n73_var_α
n72_call_proc_staged_β: mov              r11, 32;                             jmp   n93_call_builtin_prolog_α
.Lx99_0:                .quad            .Lx99_0_s
.Lx99_0_s:              .string          "succ_or_zero/2"
#-----------------------------------------------------------------------------------------------------------------------
n73_var_α:              mov              r11, 33
...
.Lrkfn103:              .string          "$write"
                        ...
                        cmp              al, 104;                             je    n72_call_proc_staged_β
                        mov              r8,  qword ptr [rip + rtccb+40]
                        mov              r9,  qword ptr [rip + rtccb+48];     jmp   n75_lit_string_α
n74_call_builtin_prolog_β:
                        mov              r11, 34;                             jmp   n72_call_proc_staged_β
#-----------------------------------------------------------------------------------------------------------------------
n75_lit_string_α:       mov              r11, 35
...
.Lrkfn106:              .string          "$nl0"
                        ...
                        cmp              al, 104;                             je    n72_call_proc_staged_β
                        mov              r8,  qword ptr [rip + rtccb+40]
                        mov              r9,  qword ptr [rip + rtccb+48];     jmp   n77_lit_integer_α
n76_call_builtin_prolog_β:
                        mov              r11, 36;                             jmp   n72_call_proc_staged_β
#-----------------------------------------------------------------------------------------------------------------------
n77_lit_integer_α:      mov              r11, 37
                        mov              qword ptr [rsp + 448], 3             # result
                        mov              rax, qword ptr [rip + .Lx107_0]
                        mov              qword ptr [rsp + 456], rax;          jmp   n78_var_ref_α
.Lx107_0:               .quad            1
#-----------------------------------------------------------------------------------------------------------------------
n78_var_ref_α:          mov              r11, 38
                        mov              rax, 4294967336
                        lea              rdx, [rsp + 688]
                        mov              qword ptr [rsp + 464], rax
                        mov              qword ptr [rsp + 472], rdx;          jmp   n79_call_proc_staged_α
#-----------------------------------------------------------------------------------------------------------------------
n79_call_proc_staged_α: mov              r11, 39
                        lea              rsi, [rsp + 448]
                        lea              rdx, [rsp + 464]
...
.Lx111_29:              mov              qword ptr [rsp + 384], rax
                        ...
                        cmp              al, 104;                             je    n72_call_proc_staged_β
                                                                              jmp   n80_var_α
n79_call_proc_staged_β: mov              r11, 39;                             jmp   n72_call_proc_staged_β
.Lx111_0:               .quad            .Lx111_0_s
.Lx111_0_s:             .string          "succ_or_zero/2"
#-----------------------------------------------------------------------------------------------------------------------
n80_var_α:              mov              r11, 40
...
n81_call_builtin_prolog_β:
                        mov              r11, 41;                             jmp   n79_call_proc_staged_β
#-----------------------------------------------------------------------------------------------------------------------
n82_lit_string_α:       mov              r11, 42
...
.Lx123_29:              mov              qword ptr [rsp + 192], rax
                        ...
                        cmp              al, 104;                             je    n79_call_proc_staged_β
                                                                              jmp   n87_var_α
n86_call_proc_staged_β: mov              r11, 46;                             jmp   n79_call_proc_staged_β
.Lx123_0:               .quad            .Lx123_0_s
.Lx123_0_s:             .string          "succ_or_zero/2"
#-----------------------------------------------------------------------------------------------------------------------
n87_var_α:              mov              r11, 47
...
n88_call_builtin_prolog_β:
                        mov              r11, 48;                             jmp   n86_call_proc_staged_β
#-----------------------------------------------------------------------------------------------------------------------
n89_lit_string_α:       mov              r11, 49
...
.Lrkfn130:              .string          "$nl0"
                        ...
                        cmp              al, 104;                             je    n86_call_proc_staged_β
                        mov              r8,  qword ptr [rip + rtccb+40]
                        mov              r9,  qword ptr [rip + rtccb+48];     jmp   n91_move_label_α
n90_call_builtin_prolog_β:
                        mov              r11, 50;                             jmp   n86_call_proc_staged_β
#-----------------------------------------------------------------------------------------------------------------------
n91_move_label_α:       mov              r11, 51
                        lea              rax, [rip + n86_call_proc_staged_β]
                        mov              qword ptr [rsp + 16], rax;           jmp   main_γ
#-----------------------------------------------------------------------------------------------------------------------
n92_disjunction_α:      mov              r11, 52
                        mov              qword ptr [rip + rtccb+40], r8
                        call             rt_pl_cp_pop@PLT
                        mov              r8,  qword ptr [rip + rtccb+40]
                        mov              r9,  qword ptr [rip + rtccb+48]
                        test             rax, rax;                            je    main_ω
                                                                              jmp   rax
n92_disjunction_β:      mov              r11, 52;                             jmp   main_ω
#-----------------------------------------------------------------------------------------------------------------------
