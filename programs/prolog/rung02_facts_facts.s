...
.Lpl_pred_table:
  .quad .Lpl_pname_0
  .quad 1
  .quad .Lplpred_person_1
  .quad .Lplpred_person_1_redo
  .section .rodata
.Lpl_pname_0:
  .asciz "person"
  .text
...
# BOX RESOLVE_CHOICE n=3 (WAM-CP-5 heap cursor, WAM-CP-9 cut)
 ...
 call rt_choice_cut_enter@PLT
 jmp .Lplch0_dispatch
.Lplch0_β_nosol: jmp .Lplpred_person_1_ω
.Lplch0_c0_body:
 bb20528_α:
# BOX RESOLVE_UNIFY (WAM-CP-7 var-const)  [x86() self-encoding]
 ...
 test eax, eax
 je .Lplpred_person_1_β
 jmp .Lplch0_exit_γ
 .Lplch0_c0_beta:
 jmp .Lplpred_person_1_β
.Lplch0_c1_body:
 bb23600_α:
# BOX RESOLVE_UNIFY (WAM-CP-7 var-const)  [x86() self-encoding]
 mov edi, 0
...
plseq2_g0_α:
 bb16992_α:
# BOX RESOLVE_CALL person/1 (WAM-CP-5, n_args=1)
 mov edi, 56
 mov rsi, 0
 xor edx, edx
 xorps xmm0, xmm0
...
bb16992_α_fail5: 
 ...
 call resolve_bb_env_install@PLT
 jmp plseq2_g1_α
bb16992_α_nosol: jmp .Lplch1_c1_pre
plseq2_g1_α:
 bb16768_α:
