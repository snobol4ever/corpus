...
n3_call_builtin_prolog_α:
                        ...
                        .section         .rodata
.Lrkfn30:               .string          "$aop_atom_number"
                        .section         .text
                        .intel_syntax    noprefix
                        lea              rdi, [rip + .Lrkfn30]
                        lea              rsi, [rsp + 560]
...
n10_call_builtin_prolog_α:
                        ...
                        .section         .rodata
.Lrkfn42:               .string          "$aop_atom_number"
                        .section         .text
                        .intel_syntax    noprefix
                        lea              rdi, [rip + .Lrkfn42]
                        lea              rsi, [rsp + 384]
...
n15_var_ref_α:          mov              rax, 4294967336
                        ...
                        mov              qword ptr [rsp + 248], rdx;          jmp   n16_lit_integer_α
#-----------------------------------------------------------------------------------------------------------------------
n16_lit_integer_α:      mov              qword ptr [rsp + 256], 3             # result
                        mov              rax, qword ptr [rip + .Lx52_0]
                        mov              qword ptr [rsp + 264], rax;          jmp   n17_call_builtin_prolog_α
.Lx52_0:                .quad            7
#-----------------------------------------------------------------------------------------------------------------------
n17_call_builtin_prolog_α:
                        ...
                        .section         .rodata
.Lrkfn54:               .string          "$aop_atom_number"
                        .section         .text
                        .intel_syntax    noprefix
                        lea              rdi, [rip + .Lrkfn54]
                        lea              rsi, [rsp + 208]
