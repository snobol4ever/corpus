...
bb1408_α_fail5: 
 ...
 call pl_bb_env_install@PLT
 jmp xite2_then_α
bb1408_α_nosol: jmp xite2_else_α
xite2_then_α:
 bb1184_α:
...
bb99728_α_fail5: 
 ...
 call pl_bb_env_install@PLT
 jmp xite3_then_α
bb99728_α_nosol: jmp xite3_else_α
xite3_then_α:
 bb99504_α:
 # BOX PL_BUILTIN(write/1)
 lea rcx, [rip + .S23]
...
bb98272_α_fail5: 
 ...
 call pl_bb_env_install@PLT
 jmp xite4_then_α
bb98272_α_nosol: jmp xite4_else_α
xite4_then_α:
 bb98048_α:
 # BOX PL_BUILTIN(write/1)
 lea rcx, [rip + .S23]
...
bb69168_α_fail5: 
 ...
 call pl_bb_env_install@PLT
 jmp .Lplpb6_γ
bb69168_α_nosol: jmp plseq7_g2_β
.Lplpb6_β:
 jmp plseq7_g3_β
.Lplpb6_γ: 
 mov rdi, 1
...
bb82528_α_fail5: 
 ...
 call pl_bb_env_install@PLT
 jmp .Lplch14_exit_γ
bb82528_α_nosol: jmp plseq15_g2_β
.Lplch14_c0_beta:
 jmp plseq15_g3_β
.Lplch14_c1_body:
plseq16_g0_α:
