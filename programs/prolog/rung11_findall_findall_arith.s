...
#-----------------------------------------------------------------------------------------------------------------------
n5_call_proc_staged_α:  mov              qword ptr [rsp + 288], 0
...
#-----------------------------------------------------------------------------------------------------------------------
n7_var_α:               mov              rax, qword ptr [rsp + 448]
                        mov              qword ptr [rsp + 224], rax
                        mov              rax, qword ptr [rsp + 456]
                        mov              qword ptr [rsp + 232], rax;          jmp   n8_var_α
#-----------------------------------------------------------------------------------------------------------------------
n8_var_α:               mov              rax, qword ptr [rsp + 448]
...
n11_suspend_β:                                                                jmp   n5_call_proc_staged_β
#-----------------------------------------------------------------------------------------------------------------------
...
.Lx67_112:              cmp              esi, 2;                              jne   .Lx67_111
                        ...
                        test             rax, rax;                            je    .Lx67_111
                        mov              r8, rax;                             jmp   .Lx67_110
.Lx67_113:              cmp              eax, 72;                             jne   .Lx67_111
                        mov              rax, qword ptr [r8 + 8]
                        test             rax, rax;                            je    .Lx67_111
                        cmp              rax, r8;                             je    .Lx67_111
                        mov              r8, rax;                             jmp   .Lx67_110
.Lx67_111:              mov              eax, dword ptr [r8 + 0]
                        cmp              eax, 0;                              je    .Lx67_114
                        cmp              eax, 104;                            je    .Lx67_114
                        cmp              eax, 72;                             jne   .Lx67_118
                        mov              rax, qword ptr [r8 + 8]
                        cmp              rax, r8;                             je    .Lx67_114
                                                                              jmp   .Lx67_118
.Lx67_118:              mov              eax, dword ptr [r8 + 0]
                        cmp              eax, 80;                             je    .Lx67_115
                        cmp              eax, 3;                              jne   .Lx67_114
                        mov              esi, dword ptr [r8 + 4]
...
#-----------------------------------------------------------------------------------------------------------------------
n40_lit_integer_α:      mov              qword ptr [rsp + 656], 3             # result
...
n42_suspend_β:                                                                jmp   n43_call_builtin_prolog_α
#-----------------------------------------------------------------------------------------------------------------------
...
#-----------------------------------------------------------------------------------------------------------------------
n45_lit_integer_α:      mov              qword ptr [rsp + 512], 3             # result
                        mov              rax, qword ptr [rip + .Lx77_0]
                        mov              qword ptr [rsp + 520], rax;          jmp   n46_lit_integer_α
.Lx77_0:                .quad            1
#-----------------------------------------------------------------------------------------------------------------------
n46_lit_integer_α:      mov              qword ptr [rsp + 528], 3             # result
...
.Lx79_112:              cmp              esi, 2;                              jne   .Lx79_111
                        ...
                        test             rax, rax;                            je    .Lx79_111
                        mov              r8, rax;                             jmp   .Lx79_110
.Lx79_113:              cmp              eax, 72;                             jne   .Lx79_111
                        mov              rax, qword ptr [r8 + 8]
                        test             rax, rax;                            je    .Lx79_111
                        cmp              rax, r8;                             je    .Lx79_111
                        mov              r8, rax;                             jmp   .Lx79_110
.Lx79_111:              mov              eax, dword ptr [r8 + 0]
                        cmp              eax, 0;                              je    .Lx79_114
                        cmp              eax, 104;                            je    .Lx79_114
                        cmp              eax, 72;                             jne   .Lx79_118
                        mov              rax, qword ptr [r8 + 8]
                        cmp              rax, r8;                             je    .Lx79_114
                                                                              jmp   .Lx79_118
.Lx79_118:              mov              eax, dword ptr [r8 + 0]
                        cmp              eax, 80;                             je    .Lx79_115
                        cmp              eax, 3;                              jne   .Lx79_114
                        mov              esi, dword ptr [r8 + 4]
...
#-----------------------------------------------------------------------------------------------------------------------
n49_lit_integer_α:      mov              qword ptr [rsp + 416], 3             # result
...
.Lx91_112:              cmp              esi, 2;                              jne   .Lx91_111
                        ...
                        test             rax, rax;                            je    .Lx91_111
                        mov              r8, rax;                             jmp   .Lx91_110
.Lx91_113:              cmp              eax, 72;                             jne   .Lx91_111
                        mov              rax, qword ptr [r8 + 8]
                        test             rax, rax;                            je    .Lx91_111
                        cmp              rax, r8;                             je    .Lx91_111
                        mov              r8, rax;                             jmp   .Lx91_110
.Lx91_111:              mov              eax, dword ptr [r8 + 0]
                        cmp              eax, 0;                              je    .Lx91_114
                        cmp              eax, 104;                            je    .Lx91_114
                        cmp              eax, 72;                             jne   .Lx91_118
                        mov              rax, qword ptr [r8 + 8]
                        cmp              rax, r8;                             je    .Lx91_114
                                                                              jmp   .Lx91_118
.Lx91_118:              mov              eax, dword ptr [r8 + 0]
                        cmp              eax, 80;                             je    .Lx91_115
                        cmp              eax, 3;                              jne   .Lx91_114
                        mov              esi, dword ptr [r8 + 4]
...
#-----------------------------------------------------------------------------------------------------------------------
n58_lit_integer_α:      mov              qword ptr [rsp + 176], 3             # result
...
.Lx97_61:               mov              rdi, qword ptr [rsp + 32]
                        ...
                        mov              rax, qword ptr [rsp + 40]
                        mov              qword ptr [rsp + 8], rax;            jmp   proc_num$2F1_γ
n60_suspend_β:                                                                jmp   n61_call_builtin_prolog_α
#-----------------------------------------------------------------------------------------------------------------------
...
.Lx121_2:               mov              rcx, qword ptr [rip + rt_g_ret_by_name@GOTPCREL] # NRETURN by-name consult wn=0
                        mov              ecx, dword ptr [rcx + 0]
...
#-----------------------------------------------------------------------------------------------------------------------
n103_var_α:             mov              rax, qword ptr [rsp + 496]
                        mov              qword ptr [rsp + 384], rax
                        mov              rax, qword ptr [rsp + 504]
...
n107_call_builtin_prolog_β:
                                                                              jmp   n114_call_builtin_prolog_α
#-----------------------------------------------------------------------------------------------------------------------
n108_var_α:             mov              rax, qword ptr [rsp + 480]
                        mov              qword ptr [rsp + 176], rax
...
n109_call_builtin_prolog_β:
                                                                              jmp   n114_call_builtin_prolog_α
#-----------------------------------------------------------------------------------------------------------------------
n110_lit_string_α:      mov              qword ptr [rsp + 128], 2             # result
...
n111_call_builtin_prolog_β:
                                                                              jmp   n114_call_builtin_prolog_α
#-----------------------------------------------------------------------------------------------------------------------
n112_move_label_α:      lea              rax, [rip + n114_call_builtin_prolog_α]
                        mov              qword ptr [rsp + 16], rax;           jmp   main_γ
#-----------------------------------------------------------------------------------------------------------------------
n113_disjunction_α:     mov              qword ptr [rip + rtccb+40], r8
                        mov              qword ptr [rip + rtccb+56], r10
                        mov              qword ptr [rip + rtccb+64], r11
