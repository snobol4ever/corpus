...
bb71440_α_fail5: 
 ...
 call pl_bb_env_install@PLT
 jmp plseq1_g4_α
bb71440_α_nosol: jmp plseq1_g0_β
plseq1_g4_α:
 bb71216_α:
 # BOX PL_BUILTIN(write/1)
 mov edi, 1
...
bb69872_α_fail5: 
 ...
 call pl_bb_env_install@PLT
 jmp plseq1_g7_α
bb69872_α_nosol: jmp plseq1_g3_β
plseq1_g7_α:
 bb69648_α:
 # BOX PL_BUILTIN(write/1)
 mov edi, 2
...
bb52176_α_fail5: 
 ...
 call pl_bb_env_install@PLT
 jmp .Lplch4_exit_γ
bb52176_α_nosol: jmp plseq6_g2_β
.Lplch4_c1_beta:
 jmp plseq6_g3_β
.Lplpb3_γ: 
 mov rdi, 1
