...
bb4496_α_fail5: 
 ...
 call pl_bb_env_install@PLT
 jmp .Lplent0_γ
bb4496_α_nosol: jmp .Lplch1_c1_pre
.Lplch1_c1_body:
 bb4384_α:
# BOX SUCCEED()
 jmp .Lplent0_γ
...
# PL CALLEE BLOCK score/2/2
.intel_syntax noprefix
.Lplpred_score_2: 
# env push/pop handled by caller (bb_pl_call site)
# redo entry: .Lplpred_score_2_redo
 bb61104_α:
# BOX PL_CHOICE n=4 (WAM-CP-5 heap cursor, WAM-CP-9 cut)
 call rt_pl_env_current@PLT
 mov rdx, rax
...
.Lplpb9_ω: 
 ...
 call rt_set_last_ok@PLT
 ret
.Lplpred_score_2_redo: jmp .Lplpb9_β
...
bb78256_α_fail5: 
 ...
 call pl_bb_env_install@PLT
 jmp plseq16_g2_α
bb78256_α_nosol: jmp plseq16_g0_β
plseq16_g2_α:
 bb78032_α:
# BOX PL_CALL wife/1 (WAM-CP-5, n_args=1)
 mov edi, 56
...
bb78032_α_fail5: 
 ...
 call pl_bb_env_install@PLT
 jmp plseq16_g3_α
bb78032_α_nosol: jmp plseq16_g1_β
plseq16_g3_α:
 bb77584_α:
...
bb77584_α_fail5: 
 ...
 call pl_bb_env_install@PLT
 jmp plseq16_g4_α
bb77584_α_nosol: jmp plseq16_g2_β
plseq16_g4_α:
 bb76800_α:
...
bb76800_α_fail5: 
 ...
 call pl_bb_env_install@PLT
 jmp plseq16_g5_α
bb76800_α_nosol: jmp plseq16_g3_β
plseq16_g5_α:
 bb76240_α:
 # BOX PL_BUILTIN(is/2)
 mov edi, 4
 ...
 je plseq16_g4_β
 jmp plseq16_g6_α
plseq16_g5_β: jmp plseq16_g4_β
plseq16_g6_α:
 bb75904_α:
# BOX PL_CALL score/2 (WAM-CP-5, n_args=2)
 mov edi, 56
 mov rsi, 0
 xor edx, edx
 xorps xmm0, xmm0
...
bb75904_α_fail5: 
 ...
 call pl_bb_env_install@PLT
 jmp plseq16_g7_α
bb75904_α_nosol: jmp plseq16_g4_β
plseq16_g7_α:
 bb75344_α:
 # BOX PL_BUILTIN(is/2)
 mov edi, 6
...
bb75008_α_fail5: 
 ...
 call pl_bb_env_install@PLT
 jmp plseq16_g9_α
bb75008_α_nosol: jmp plseq16_g6_β
plseq16_g9_α:
 bb74448_α:
 # BOX PL_BUILTIN(is/2)
 mov edi, 8
...
bb74112_α_fail5: 
 ...
 call pl_bb_env_install@PLT
 jmp plseq16_g11_α
bb74112_α_nosol: jmp plseq16_g8_β
plseq16_g11_α:
 bb73552_α:
 # BOX PL_BUILTIN(is/2)
 mov edi, 10
 ...
 je plseq16_g10_β
 jmp plseq16_g12_α
plseq16_g11_β: jmp plseq16_g10_β
plseq16_g12_α:
 bb73104_α:
# BOX PL_CALL same_total/3 (WAM-CP-5, n_args=3)
 mov edi, 56
 mov rsi, 6
 xor edx, edx
 xorps xmm0, xmm0
...
bb73104_α_fail5: 
 ...
 mov rdi, [rax + 24]
 call pl_bb_env_install@PLT
 call .Lplpred_same_total_3_redo
 call rt_last_ok@PLT
 test eax, eax
 je bb73104_α_nosol
 call pl_cp_current@PLT
 ...
 call pl_bb_env_install@PLT
 jmp plseq16_g13_α
bb73104_α_nosol: jmp plseq16_g10_β
plseq16_g13_α:
 bb72768_α:
 # BOX PL_BUILTIN(</2)
 sub rsp, 16
 ...
 je plseq16_g12_β
 jmp plseq16_g14_α
plseq16_g13_β: jmp plseq16_g12_β
plseq16_g14_α:
 bb72096_α:
...
bb72096_α_fail5: 
 ...
 call pl_bb_env_install@PLT
 jmp plseq16_g15_α
bb72096_α_nosol: jmp plseq16_g12_β
plseq16_g15_α:
 bb71984_α:
# BOX FAIL()
 jmp plseq16_g14_β
plseq16_g15_β: jmp plseq16_g14_β
.Lplpb15_β:
 jmp plseq16_g14_β
.Lplpb15_γ: 
 mov rdi, 1
...
# PL CALLEE BLOCK same_total/3/3
.intel_syntax noprefix
.Lplpred_same_total_3: 
# env push/pop handled by caller (bb_pl_call site)
# redo entry: .Lplpred_same_total_3_redo
 bb85760_α:
# BOX PL_CHOICE n=3 (WAM-CP-5 heap cursor, WAM-CP-9 cut)
 ...
 mov rdi, rax
 call rt_pl_choice_cut_enter@PLT
 jmp .Lplch22_dispatch
.Lplch22_β_nosol: jmp .Lplpb21_ω
.Lplch22_c0_body:
plseq23_g0_α:
 bb88192_α:
# BOX PL_UNIFY
...
.Lplpb21_ω: 
 ...
 call rt_set_last_ok@PLT
 ret
.Lplpred_same_total_3_redo: jmp .Lplpb21_β
...
.Lplpb26_ω: 
 ...
 call rt_set_last_ok@PLT
 ret
.Lplpred_wife_1_redo: jmp .Lplpb26_β
...
plseq29_g9_α:
 ...
 call rt_pl_write_atom@PLT
 jmp plseq29_g10_α
plseq29_g9_β: jmp plseq29_g10_α
plseq29_g10_α:
 bb99824_α:
 # BOX PL_BUILTIN(write/1)
 mov edi, 3
 call rt_pl_write_var@PLT
 jmp plseq29_g11_α
plseq29_g10_β: jmp plseq29_g11_α
plseq29_g11_α:
 bb99600_α:
 # BOX PL_BUILTIN(write/1)
 lea rcx, [rip + .S10]
 ...
 call rt_pl_write_atom@PLT
 jmp plseq29_g12_α
plseq29_g11_β: jmp plseq29_g12_α
plseq29_g12_α:
 bb99376_α:
 # BOX PL_BUILTIN(write/1)
 lea rcx, [rip + .S29]
 ...
 call rt_pl_write_atom@PLT
 jmp plseq29_g13_α
plseq29_g12_β: jmp plseq29_g13_α
plseq29_g13_α:
 bb99152_α:
 # BOX PL_BUILTIN(write/1)
 mov edi, 2
 call rt_pl_write_var@PLT
 jmp plseq29_g14_α
plseq29_g13_β: jmp plseq29_g14_α
plseq29_g14_α:
 bb98928_α:
 # BOX PL_BUILTIN(write/1)
 lea rcx, [rip + .S8]
 ...
 call rt_pl_write_atom@PLT
 jmp plseq29_g15_α
plseq29_g14_β: jmp plseq29_g15_α
plseq29_g15_α:
 bb98704_α:
 # BOX PL_BUILTIN(write/1)
 mov edi, 4
 call rt_pl_write_var@PLT
 jmp plseq29_g16_α
plseq29_g15_β: jmp plseq29_g16_α
plseq29_g16_α:
 bb98480_α:
 # BOX PL_BUILTIN(write/1)
 lea rcx, [rip + .S10]
 ...
 call rt_pl_write_atom@PLT
 jmp plseq29_g17_α
plseq29_g16_β: jmp plseq29_g17_α
plseq29_g17_α:
 bb98256_α:
 # BOX PL_BUILTIN(write/1)
 lea rcx, [rip + .S28]
...
.Lplpb28_ω: 
 ...
 call rt_set_last_ok@PLT
 ret
.Lplpred_display_5_redo: jmp .Lplpb28_β
.Lplcallees2_end: 
#=======================================================================================================================
# stmt 0
#=======================================================================================================================
