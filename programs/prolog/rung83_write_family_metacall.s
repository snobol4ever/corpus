...
.Lx92_102:              lea              r10, [rip + g_plw_cellws_on]
...
n8_call_builtin_prolog_β:
                                                                              jmp   main_ω
#-----------------------------------------------------------------------------------------------------------------------
n9_lit_string_α:        mov              qword ptr [rsp + 2416], 2            # result
...
#-----------------------------------------------------------------------------------------------------------------------
n10_lit_string_α:       mov              qword ptr [rsp + 2432], 2            # result
...
n14_call_builtin_prolog_β:
                                                                              jmp   n84_call_builtin_prolog_α
#-----------------------------------------------------------------------------------------------------------------------
n15_lit_string_α:       mov              qword ptr [rsp + 2256], 2            # result
...
#-----------------------------------------------------------------------------------------------------------------------
n16_lit_string_α:       mov              qword ptr [rsp + 2272], 2            # result
...
#-----------------------------------------------------------------------------------------------------------------------
n20_lit_string_α:       mov              qword ptr [rsp + 2176], 2            # result
...
#-----------------------------------------------------------------------------------------------------------------------
n22_lit_string_α:       mov              qword ptr [rsp + 2080], 2            # result
...
n24_call_builtin_prolog_β:
                                                                              jmp   n84_call_builtin_prolog_α
#-----------------------------------------------------------------------------------------------------------------------
n25_lit_string_α:       mov              qword ptr [rsp + 1824], 2            # result
...
#-----------------------------------------------------------------------------------------------------------------------
n26_lit_string_α:       mov              qword ptr [rsp + 1712], 2            # result
...
#-----------------------------------------------------------------------------------------------------------------------
n35_call_proc_staged_α: mov              qword ptr [rsp + 1952], 0
...
.Lx133_3:               mov              qword ptr [rsp + 1960], rsp
                        add              rsp, 8
...
.Lx133_4:               mov              rax, qword ptr [rsp + 1952]
...
n36_call_builtin_prolog_β:
                                                                              jmp   n44_lit_string_α
#-----------------------------------------------------------------------------------------------------------------------
n37_lit_string_α:       mov              qword ptr [rsp + 1456], 2            # result
...
n41_call_builtin_prolog_β:
                                                                              jmp   n84_call_builtin_prolog_α
#-----------------------------------------------------------------------------------------------------------------------
n42_lit_string_α:       mov              qword ptr [rsp + 1296], 2            # result
...
n43_call_builtin_prolog_β:
                                                                              jmp   n84_call_builtin_prolog_α
#-----------------------------------------------------------------------------------------------------------------------
n44_lit_string_α:       mov              qword ptr [rsp + 1552], 2            # result
...
n45_call_builtin_prolog_β:
                                                                              jmp   n84_call_builtin_prolog_α
#-----------------------------------------------------------------------------------------------------------------------
n46_lit_string_α:       mov              qword ptr [rsp + 1504], 2            # result
...
#-----------------------------------------------------------------------------------------------------------------------
n51_lit_string_α:       mov              qword ptr [rsp + 1200], 2            # result
...
.Lx159_0_s:             .string          "nl"
#-----------------------------------------------------------------------------------------------------------------------
n52_lit_string_α:       mov              qword ptr [rsp + 1120], 2            # result
...
.Lx162_55:              cmp              esi, 2;                              jne   .Lx162_41
                        ...
                        test             rax, rax;                            je    .Lx162_41
                        mov              r8, rax;                             jmp   .Lx162_40
.Lx162_56:              cmp              eax, 72;                             jne   .Lx162_41
                        mov              rax, qword ptr [r8 + 8]
                        test             rax, rax;                            je    .Lx162_41
...
.Lx162_57:              cmp              esi, 2;                              jne   .Lx162_43
                        ...
                        test             rax, rax;                            je    .Lx162_43
                        mov              r9, rax;                             jmp   .Lx162_42
.Lx162_58:              cmp              eax, 72;                             jne   .Lx162_43
                        mov              rax, qword ptr [r9 + 8]
                        test             rax, rax;                            je    .Lx162_43
...
.Lx162_43:              cmp              r8, r9;                              je    .Lx162_51
                        mov              eax, dword ptr [r8 + 0]
                        cmp              eax, 0;                              je    .Lx162_44
                        cmp              eax, 104;                            je    .Lx162_44
                        cmp              eax, 72;                             jne   .Lx162_45
                        mov              rax, qword ptr [r8 + 8]
                        cmp              rax, r8;                             je    .Lx162_44
                                                                              jmp   .Lx162_45
.Lx162_44:              mov              eax, dword ptr [r9 + 0]
                        cmp              eax, 0;                              je    .Lx162_53
                        cmp              eax, 104;                            je    .Lx162_53
                        cmp              eax, 72;                             jne   .Lx162_46
                        mov              rax, qword ptr [r9 + 8]
                        cmp              rax, r9;                             je    .Lx162_53
                                                                              jmp   .Lx162_46
.Lx162_46:              lea              r10, [rip + g_pl_trail]
                        mov              r11, qword ptr [r10 + 0]
                        test             r11, r11;                            je    .Lx162_53
                        mov              eax, dword ptr [r10 + 32]
                        mov              esi, 24
                        imul             rsi, rax
                        mov              rax, qword ptr [r10 + 24]
...
.Lx162_45:              mov              eax, dword ptr [r9 + 0]
                        cmp              eax, 0;                              je    .Lx162_47
                        cmp              eax, 104;                            je    .Lx162_47
                        cmp              eax, 72;                             jne   .Lx162_48
                        mov              rax, qword ptr [r9 + 8]
                        cmp              rax, r9;                             je    .Lx162_47
                                                                              jmp   .Lx162_48
.Lx162_47:              lea              r10, [rip + g_pl_trail]
                        mov              r11, qword ptr [r10 + 0]
                        test             r11, r11;                            je    .Lx162_53
                        mov              eax, dword ptr [r10 + 32]
                        mov              esi, 24
...
.Lx162_48:              mov              ecx, dword ptr [r8 + 0]
                        mov              edx, dword ptr [r9 + 0]
                        cmp              ecx, 80;                             jne   .Lx162_49
                        cmp              edx, 80;                             je    .Lx162_53
                                                                              jmp   .Lx162_52
.Lx162_49:              cmp              edx, 80;                             je    .Lx162_52
                        cmp              ecx, 5;                              je    .Lx162_53
                        cmp              edx, 5;                              je    .Lx162_53
                        cmp              ecx, 3;                              jne   .Lx162_50
                        cmp              edx, 3;                              jne   .Lx162_50
                        mov              rax, qword ptr [r8 + 0]
...
#-----------------------------------------------------------------------------------------------------------------------
n58_call_proc_staged_α: mov              qword ptr [rsp + 1008], 0
                        lea              r8, [rip + g_gc_pending]
                        mov              eax, dword ptr [r8 + 0]
                        test             eax, eax;                            jne   .Lx169_20
                        mov              rax, qword ptr [rsp + 1040]
                        mov              rdx, qword ptr [rsp + 1048]
                        lea              r8, [rip + g_call_args]
                        mov              qword ptr [r8 + 0], rax
                        mov              qword ptr [r8 + 8], rdx;             jmp   .Lx169_21
.Lx169_20:              mov              edi, 0
...
.Lx169_3:               mov              qword ptr [rsp + 1016], rsp
                        add              rsp, 8
...
.Lx169_4:               mov              rax, qword ptr [rsp + 1008]
...
.Lx169_2:               mov              rcx, qword ptr [rip + rt_g_ret_by_name@GOTPCREL] # NRETURN by-name consult wn=0
                        mov              ecx, dword ptr [rcx + 0]
...
#-----------------------------------------------------------------------------------------------------------------------
n59_lit_string_α:       mov              qword ptr [rsp + 816], 2             # result
...
n61_call_builtin_prolog_β:
                                                                              jmp   n62_lit_string_α
#-----------------------------------------------------------------------------------------------------------------------
n62_lit_string_α:       mov              qword ptr [rsp + 864], 2             # result
...
n63_call_builtin_prolog_β:
                                                                              jmp   n84_call_builtin_prolog_α
#-----------------------------------------------------------------------------------------------------------------------
n64_lit_string_α:       mov              qword ptr [rsp + 768], 2             # result
...
#-----------------------------------------------------------------------------------------------------------------------
n67_lit_string_α:       mov              qword ptr [rsp + 720], 2             # result
...
#-----------------------------------------------------------------------------------------------------------------------
n68_lit_string_α:       mov              qword ptr [rsp + 608], 2             # result
...
#-----------------------------------------------------------------------------------------------------------------------
n69_lit_string_α:       mov              qword ptr [rsp + 624], 2             # result
...
.Lx187_55:              cmp              esi, 2;                              jne   .Lx187_41
                        ...
                        test             rax, rax;                            je    .Lx187_41
                        mov              r8, rax;                             jmp   .Lx187_40
.Lx187_56:              cmp              eax, 72;                             jne   .Lx187_41
                        mov              rax, qword ptr [r8 + 8]
                        test             rax, rax;                            je    .Lx187_41
...
.Lx187_57:              cmp              esi, 2;                              jne   .Lx187_43
                        ...
                        test             rax, rax;                            je    .Lx187_43
                        mov              r9, rax;                             jmp   .Lx187_42
.Lx187_58:              cmp              eax, 72;                             jne   .Lx187_43
                        mov              rax, qword ptr [r9 + 8]
                        test             rax, rax;                            je    .Lx187_43
...
.Lx187_43:              cmp              r8, r9;                              je    .Lx187_51
                        mov              eax, dword ptr [r8 + 0]
                        cmp              eax, 0;                              je    .Lx187_44
                        cmp              eax, 104;                            je    .Lx187_44
                        cmp              eax, 72;                             jne   .Lx187_45
                        mov              rax, qword ptr [r8 + 8]
                        cmp              rax, r8;                             je    .Lx187_44
                                                                              jmp   .Lx187_45
.Lx187_44:              mov              eax, dword ptr [r9 + 0]
                        cmp              eax, 0;                              je    .Lx187_53
                        cmp              eax, 104;                            je    .Lx187_53
                        cmp              eax, 72;                             jne   .Lx187_46
                        mov              rax, qword ptr [r9 + 8]
...
.Lx187_45:              mov              eax, dword ptr [r9 + 0]
                        cmp              eax, 0;                              je    .Lx187_47
                        cmp              eax, 104;                            je    .Lx187_47
                        cmp              eax, 72;                             jne   .Lx187_48
                        mov              rax, qword ptr [r9 + 8]
...
.Lx187_48:              mov              ecx, dword ptr [r8 + 0]
                        mov              edx, dword ptr [r9 + 0]
                        cmp              ecx, 80;                             jne   .Lx187_49
                        cmp              edx, 80;                             je    .Lx187_53
                                                                              jmp   .Lx187_52
.Lx187_49:              cmp              edx, 80;                             je    .Lx187_52
                        cmp              ecx, 5;                              je    .Lx187_53
                        cmp              edx, 5;                              je    .Lx187_53
                        cmp              ecx, 3;                              jne   .Lx187_50
                        cmp              edx, 3;                              jne   .Lx187_50
                        mov              rax, qword ptr [r8 + 0]
...
.Lx190_102:             lea              r10, [rip + g_plw_cellws_on]
                        mov              eax, dword ptr [r10 + 0]
...
#-----------------------------------------------------------------------------------------------------------------------
n75_call_proc_staged_α: mov              qword ptr [rsp + 496], 0
                        lea              r8, [rip + g_gc_pending]
                        mov              eax, dword ptr [r8 + 0]
...
.Lx194_3:               mov              qword ptr [rsp + 504], rsp
                        add              rsp, 8
...
.Lx194_4:               mov              rax, qword ptr [rsp + 496]
...
.Lx194_2:               mov              rcx, qword ptr [rip + rt_g_ret_by_name@GOTPCREL] # NRETURN by-name consult wn=0
                        mov              ecx, dword ptr [rcx + 0]
...
#-----------------------------------------------------------------------------------------------------------------------
n76_lit_string_α:       mov              qword ptr [rsp + 304], 2             # result
...
n78_call_builtin_prolog_β:
                                                                              jmp   n79_lit_string_α
#-----------------------------------------------------------------------------------------------------------------------
n79_lit_string_α:       mov              qword ptr [rsp + 352], 2             # result
...
n80_call_builtin_prolog_β:
                                                                              jmp   n84_call_builtin_prolog_α
#-----------------------------------------------------------------------------------------------------------------------
n81_lit_string_α:       mov              qword ptr [rsp + 256], 2             # result
...
n82_call_builtin_prolog_β:
                                                                              jmp   n84_call_builtin_prolog_α
#-----------------------------------------------------------------------------------------------------------------------
n83_move_label_α:       lea              rax, [rip + n84_call_builtin_prolog_α]
...
n84_call_builtin_prolog_β:
                                                                              jmp   main_ω
#-----------------------------------------------------------------------------------------------------------------------
n85_lit_string_α:       mov              qword ptr [rsp + 176], 2             # result
...
#-----------------------------------------------------------------------------------------------------------------------
n87_lit_string_α:       mov              qword ptr [rsp + 128], 2             # result
...
n88_call_builtin_prolog_β:
                                                                              jmp   n91_call_builtin_prolog_α
#-----------------------------------------------------------------------------------------------------------------------
n89_move_label_α:       lea              rax, [rip + n91_call_builtin_prolog_α]
                        mov              qword ptr [rsp + 16], rax;           jmp   main_γ
#-----------------------------------------------------------------------------------------------------------------------
n90_disjunction_α:      mov              qword ptr [rip + rtccb+40], r8
                        mov              qword ptr [rip + rtccb+56], r10
                        mov              qword ptr [rip + rtccb+64], r11
