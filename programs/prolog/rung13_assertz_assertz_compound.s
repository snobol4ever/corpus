...
plseq2_g0_α:
 bb81952_α:
# BOX PL_CALL person/2 (WAM-CP-5, n_args=2)
 mov edi, 56
 mov rsi, 0
 xor edx, edx
 xorps xmm0, xmm0
...
.Lplent0_done: 
 jmp .Lplcallees3_end
# PL CALLEE BLOCK person/2/2
.intel_syntax noprefix
.Lplpred_person_2: 
# env push/pop handled by caller (bb_pl_call site)
# redo entry: .Lplpred_person_2_redo
 bb71648_α:
...
.Lplpb4_ω: 
 ...
 call rt_set_last_ok@PLT
 ret
.Lplpred_person_2_redo: jmp .Lplpb4_β
.Lplcallees3_end: 
 HALT
