...
#-----------------------------------------------------------------------------------------------------------------------
n4_var_α:               mov              rax, qword ptr [rsp + 1024]
...
n9_lit_string_α:        mov              qword ptr [rsp + 816], 2             # result
                        ...
                        mov              qword ptr [rsp + 824], rax;          jmp   n10_lit_integer_α
.Lx48_0:                .quad            .Lx48_0_s
.Lx48_0_s:              .string          "."
#-----------------------------------------------------------------------------------------------------------------------
n10_lit_integer_α:      mov              qword ptr [rsp + 720], 3             # result
                        mov              rax, qword ptr [rip + .Lx49_0]
                        mov              qword ptr [rsp + 728], rax;          jmp   n11_lit_string_α
.Lx49_0:                .quad            104
#-----------------------------------------------------------------------------------------------------------------------
n11_lit_string_α:       mov              qword ptr [rsp + 704], 2             # result
                        mov              dword ptr [rsp + 708], 1
                        mov              rax, qword ptr [rip + .Lx50_0]
                        mov              qword ptr [rsp + 712], rax;          jmp   n12_lit_integer_α
.Lx50_0:                .quad            .Lx50_0_s
.Lx50_0_s:              .string          "."
#-----------------------------------------------------------------------------------------------------------------------
n12_lit_integer_α:      mov              qword ptr [rsp + 608], 3             # result
                        mov              rax, qword ptr [rip + .Lx51_0]
                        mov              qword ptr [rsp + 616], rax;          jmp   n13_lit_string_α
.Lx51_0:                .quad            101
#-----------------------------------------------------------------------------------------------------------------------
n13_lit_string_α:       mov              qword ptr [rsp + 592], 2             # result
                        mov              dword ptr [rsp + 596], 1
                        mov              rax, qword ptr [rip + .Lx52_0]
                        mov              qword ptr [rsp + 600], rax;          jmp   n14_lit_integer_α
...
n15_lit_string_α:       mov              qword ptr [rsp + 480], 2             # result
                        ...
                        mov              qword ptr [rsp + 488], rax;          jmp   n16_lit_integer_α
.Lx54_0:                .quad            .Lx54_0_s
.Lx54_0_s:              .string          "."
#-----------------------------------------------------------------------------------------------------------------------
n16_lit_integer_α:      mov              qword ptr [rsp + 384], 3             # result
                        mov              rax, qword ptr [rip + .Lx55_0]
                        mov              qword ptr [rsp + 392], rax;          jmp   n17_lit_string_α
.Lx55_0:                .quad            108
#-----------------------------------------------------------------------------------------------------------------------
n17_lit_string_α:       mov              qword ptr [rsp + 368], 2             # result
                        mov              dword ptr [rsp + 372], 1
                        mov              rax, qword ptr [rip + .Lx56_0]
                        mov              qword ptr [rsp + 376], rax;          jmp   n18_lit_integer_α
.Lx56_0:                .quad            .Lx56_0_s
.Lx56_0_s:              .string          "."
#-----------------------------------------------------------------------------------------------------------------------
n18_lit_integer_α:      mov              qword ptr [rsp + 272], 3             # result
                        mov              rax, qword ptr [rip + .Lx57_0]
                        mov              qword ptr [rsp + 280], rax;          jmp   n19_lit_string_α
.Lx57_0:                .quad            111
#-----------------------------------------------------------------------------------------------------------------------
n19_lit_string_α:       mov              qword ptr [rsp + 256], 2             # result
