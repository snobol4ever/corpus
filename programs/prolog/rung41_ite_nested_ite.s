...
.Lx21_55:               cmp              esi, 2;                              jne   .Lx21_41
                        ...
                        test             rax, rax;                            je    .Lx21_41
                        mov              r8, rax;                             jmp   .Lx21_40
.Lx21_56:               cmp              eax, 72;                             jne   .Lx21_41
                        mov              rax, qword ptr [r8 + 8]
                        test             rax, rax;                            je    .Lx21_41
...
.Lx21_57:               cmp              esi, 2;                              jne   .Lx21_43
                        ...
                        test             rax, rax;                            je    .Lx21_43
                        mov              r9, rax;                             jmp   .Lx21_42
.Lx21_58:               cmp              eax, 72;                             jne   .Lx21_43
                        mov              rax, qword ptr [r9 + 8]
                        test             rax, rax;                            je    .Lx21_43
...
.Lx21_43:               cmp              r8, r9;                              je    .Lx21_51
                        ...
                        cmp              eax, 0;                              je    .Lx21_44
                        cmp              eax, 104;                            je    .Lx21_44
                        cmp              eax, 72;                             jne   .Lx21_45
                        mov              rax, qword ptr [r8 + 8]
                        cmp              rax, r8;                             je    .Lx21_44
                                                                              jmp   .Lx21_45
.Lx21_44:               mov              eax, dword ptr [r9 + 0]
                        cmp              eax, 0;                              je    .Lx21_53
                        cmp              eax, 104;                            je    .Lx21_53
                        cmp              eax, 72;                             jne   .Lx21_46
                        mov              rax, qword ptr [r9 + 8]
...
.Lx21_45:               mov              eax, dword ptr [r9 + 0]
                        cmp              eax, 0;                              je    .Lx21_47
                        cmp              eax, 104;                            je    .Lx21_47
                        cmp              eax, 72;                             jne   .Lx21_48
                        mov              rax, qword ptr [r9 + 8]
...
.Lx21_48:               mov              ecx, dword ptr [r8 + 0]
                        ...
                        cmp              ecx, 80;                             jne   .Lx21_49
                        cmp              edx, 80;                             je    .Lx21_53
                                                                              jmp   .Lx21_52
.Lx21_49:               cmp              edx, 80;                             je    .Lx21_52
                        cmp              ecx, 5;                              je    .Lx21_53
                        cmp              edx, 5;                              je    .Lx21_53
                        cmp              ecx, 3;                              jne   .Lx21_50
                        cmp              edx, 3;                              jne   .Lx21_50
                        mov              rax, qword ptr [r8 + 0]
...
#-----------------------------------------------------------------------------------------------------------------------
n5_call_proc_staged_α:  mov              qword ptr [rsp + 368], 0
...
.Lx25_3:                mov              qword ptr [rsp + 376], rsp
                        add              rsp, 8
...
.Lx25_4:                mov              rax, qword ptr [rsp + 368]
...
.Lx25_2:                mov              rcx, qword ptr [rip + rt_g_ret_by_name@GOTPCREL] # NRETURN by-name consult wn=0
...
.Lx25_0_s:              .string          "a/1"
#-----------------------------------------------------------------------------------------------------------------------
n6_var_α:               mov              rax, qword ptr [rsp + 512]
...
n7_call_builtin_prolog_β:
                                                                              jmp   n10_call_builtin_prolog_α
#-----------------------------------------------------------------------------------------------------------------------
n8_lit_string_α:        mov              qword ptr [rsp + 272], 2             # result
...
#-----------------------------------------------------------------------------------------------------------------------
n44_lit_integer_α:      mov              qword ptr [rsp + 752], 3             # result
                        mov              rax, qword ptr [rip + .Lx73_0]
                        mov              qword ptr [rsp + 760], rax;          jmp   n45_lit_integer_α
.Lx73_0:                .quad            1
#-----------------------------------------------------------------------------------------------------------------------
n45_lit_integer_α:      mov              qword ptr [rsp + 768], 3             # result
...
#-----------------------------------------------------------------------------------------------------------------------
n48_lit_integer_α:      mov              qword ptr [rsp + 656], 3             # result
...
#-----------------------------------------------------------------------------------------------------------------------
n53_lit_integer_α:      mov              qword ptr [rsp + 512], 3             # result
                        mov              rax, qword ptr [rip + .Lx85_0]
                        mov              qword ptr [rsp + 520], rax;          jmp   n54_lit_integer_α
.Lx85_0:                .quad            1
#-----------------------------------------------------------------------------------------------------------------------
n54_lit_integer_α:      mov              qword ptr [rsp + 528], 3             # result
...
#-----------------------------------------------------------------------------------------------------------------------
n57_lit_integer_α:      mov              qword ptr [rsp + 416], 3             # result
...
#-----------------------------------------------------------------------------------------------------------------------
n62_lit_integer_α:      mov              qword ptr [rsp + 272], 3             # result
                        mov              rax, qword ptr [rip + .Lx97_0]
                        mov              qword ptr [rsp + 280], rax;          jmp   n63_lit_integer_α
.Lx97_0:                .quad            1
#-----------------------------------------------------------------------------------------------------------------------
n63_lit_integer_α:      mov              qword ptr [rsp + 288], 3             # result
...
#-----------------------------------------------------------------------------------------------------------------------
n66_lit_integer_α:      mov              qword ptr [rsp + 176], 3             # result
...
n69_call_builtin_prolog_α:
                        ...
                        mov              r9,  qword ptr [rip + rtccb+48]
                        mov              r10, qword ptr [rip + rtccb+56]
                        mov              r11, qword ptr [rip + rtccb+64];     jmp   proc_a$2F1_ω
...
.Lx133_3:               mov              qword ptr [rsp + 552], rsp
                        add              rsp, 8
...
.Lx133_4:               mov              rax, qword ptr [rsp + 544]
...
.Lx137_3:               mov              qword ptr [rsp + 472], rsp
                        add              rsp, 8
                        mov              rax, qword ptr [rsp + 464]
...
.Lx137_4:               mov              rax, qword ptr [rsp + 464]
...
.Lx137_29:              mov              qword ptr [rsp + 432], rax
                        mov              qword ptr [rsp + 440], rdx
                        cmp              eax, 104;                            je    n114_lit_string_α
                                                                              jmp   n112_var_α
...
#-----------------------------------------------------------------------------------------------------------------------
n112_var_α:             mov              rax, qword ptr [rsp + 592]
                        mov              qword ptr [rsp + 368], rax
...
.Lrkfn141:              .string          "$write"
                        ...
                        mov              qword ptr [rsp + 336], rax
                        mov              qword ptr [rsp + 344], rdx
                        cmp              eax, 104;                            je    n109_call_proc_staged_β
                        mov              r8,  qword ptr [rip + rtccb+40]
                        mov              r9,  qword ptr [rip + rtccb+48]
                        mov              r10, qword ptr [rip + rtccb+56]
...
#-----------------------------------------------------------------------------------------------------------------------
n114_lit_string_α:      mov              qword ptr [rsp + 416], 2             # result
...
n115_call_builtin_prolog_β:
                                                                              jmp   n109_call_proc_staged_β
#-----------------------------------------------------------------------------------------------------------------------
n116_lit_string_α:      mov              qword ptr [rsp + 320], 2             # result
...
n119_call_builtin_prolog_β:
                                                                              jmp   n109_call_proc_staged_β
#-----------------------------------------------------------------------------------------------------------------------
n120_lit_string_α:      mov              qword ptr [rsp + 224], 2             # result
...
n125_call_builtin_prolog_β:
                                                                              jmp   n109_call_proc_staged_β
#-----------------------------------------------------------------------------------------------------------------------
n126_move_label_α:      lea              rax, [rip + n109_call_proc_staged_β]
