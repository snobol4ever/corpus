...
plseq1_g0_α:
 bb34048_α:
 # BOX PL_BUILTIN(findall/1555283904)
...
.Lplent0_done: 
 jmp .Lplcallees2_end
# PL CALLEE BLOCK num/1/1
.intel_syntax noprefix
.Lplpred_num_1: 
# env push/pop handled by caller (bb_pl_call site)
# redo entry: .Lplpred_num_1_redo
 bb20192_α:
...
.Lplpb3_ω: 
 ...
 call rt_set_last_ok@PLT
 ret
.Lplpred_num_1_redo: jmp .Lplpb3_β
# PL CALLEE BLOCK even/1/1
.intel_syntax noprefix
.Lplpred_even_1: 
# env push/pop handled by caller (bb_pl_call site)
# redo entry: .Lplpred_even_1_redo
plseq6_g0_α:
 bb32064_α:
# BOX PL_UNIFY
 sub rsp, 16
...
plseq6_g1_α:
 bb31616_α:
# BOX PL_CALL num/1 (WAM-CP-5, n_args=1)
 mov edi, 56
 mov rsi, 0
 xor edx, edx
 xorps xmm0, xmm0
...
bb31616_α_fail5: 
 ...
 call pl_bb_env_install@PLT
 jmp plseq6_g2_α
bb31616_α_nosol: jmp .Lplpb5_ω
plseq6_g2_α:
 bb31056_α:
 # BOX PL_BUILTIN(is/2)
 # PL_BUILTIN: unknown 'is' — stub
 jmp .Lplpb5_γ
plseq6_g2_β: jmp .Lplpb5_γ
.Lplpb5_β:
 jmp plseq6_g1_β
.Lplpb5_γ: 
 mov rdi, 1
...
.Lplpb5_ω: 
 ...
 call rt_set_last_ok@PLT
 ret
.Lplpred_even_1_redo: jmp .Lplpb5_β
.Lplcallees2_end: 
#=======================================================================================================================
# stmt 0
#=======================================================================================================================
