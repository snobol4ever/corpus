...
n0_call_builtin_prolog_β:
                        mov              r11, 1;                              jmp   inner$2F0_ω
#-----------------------------------------------------------------------------------------------------------------------
n1_lit_string_α:        mov              r11, 2
                        mov              qword ptr [rsp + 96], 2              # result
                        mov              dword ptr [rsp + 100], 5
                        mov              rax, qword ptr [rip + .Lx11_0]
                        mov              qword ptr [rsp + 104], rax;          jmp   n2_call_builtin_prolog_α
.Lx11_0:                .quad            .Lx11_0_s
.Lx11_0_s:              .string          "other"
#-----------------------------------------------------------------------------------------------------------------------
n2_call_builtin_prolog_α:
                        ...
                        mov              rdx, qword ptr [rsp + 120];          jmp   .Lx12_101
...
n6_lit_string_α:        mov              r11, 7
                        ...
                        mov              qword ptr [rsp + 232], rax;          jmp   n7_call_builtin_prolog_α
.Lx18_0:                .quad            .Lx18_0_s
.Lx18_0_s:              .string          "wrong"
#-----------------------------------------------------------------------------------------------------------------------
...
#-----------------------------------------------------------------------------------------------------------------------
n27_call_proc_staged_α: mov              r11, 14
...
n27_call_proc_staged_β: mov              r11, 14
...
#-----------------------------------------------------------------------------------------------------------------------
n37_move_label_α:       mov              r11, 24
                        lea              rax, [rip + n39_call_builtin_prolog_α]
                        mov              qword ptr [rsp + 16], rax;           jmp   main_γ
#-----------------------------------------------------------------------------------------------------------------------
n38_disjunction_α:      mov              r11, 25
                        mov              qword ptr [rip + rtccb+40], r8
                        ...
                        test             rax, rax;                            je    main_ω
                                                                              jmp   rax
n38_disjunction_β:      mov              r11, 25;                             jmp   main_ω
#-----------------------------------------------------------------------------------------------------------------------
...
module_init:
                        sub              rsp, 8
                        .section         .rodata
.Lstartup_pname0:       .string          "inner/0"
                        .align           8
.Lstartup_prec0:
