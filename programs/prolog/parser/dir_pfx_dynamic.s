...
#-----------------------------------------------------------------------------------------------------------------------
n18_lit_string_α:       mov              qword ptr [rsp + 96], 2              # result
                        mov              dword ptr [rsp + 100], 3
                        mov              rax, qword ptr [rip + .Lx22_0]
                        mov              qword ptr [rsp + 104], rax;          jmp   n19_var_ref_α
...
n19_var_ref_α:          mov              rax, 4294967336
                        ...
                        mov              qword ptr [rsp + 120], rdx;          jmp   n20_call_builtin_gen_α
#-----------------------------------------------------------------------------------------------------------------------
n20_call_builtin_gen_α: mov              rax, qword ptr [rsp + 112]
                        mov              qword ptr [rsp + 64], rax
...
.Lx25_60:               .section         .rodata
.Lbynamegenfn11:        .string          "$dyn_iter"
                        .section         .text
                        .intel_syntax    noprefix
                        ...
                        cmp              eax, 104;                            je    foo$2F1_ω
                        mov              r8,  qword ptr [rip + rtccb+40]
                        mov              r9,  qword ptr [rip + rtccb+48]
                        mov              r10, qword ptr [rip + rtccb+56]
                        mov              r11, qword ptr [rip + rtccb+64];     jmp   n21_suspend_α
n20_call_builtin_gen_β:                                                       jmp   .Lx25_60
#-----------------------------------------------------------------------------------------------------------------------
...
.Lx27_61:               mov              rdi, qword ptr [rsp + 32]
                        ...
                        mov              qword ptr [rsp + 8], rax;            jmp   foo$2F1_γ
n21_suspend_β:                                                                jmp   n20_call_builtin_gen_β
#-----------------------------------------------------------------------------------------------------------------------
foo$2F1_res:
                        add              rsp, 8
                        pop              rsp
...
main_α_body:
#-----------------------------------------------------------------------------------------------------------------------
n28_lit_string_α:       mov              qword ptr [rsp + 160], 2             # result
                        mov              dword ptr [rsp + 164], 1
                        mov              rax, qword ptr [rip + .Lx33_0]
                        mov              qword ptr [rsp + 168], rax;          jmp   n29_lit_string_α
.Lx33_0:                .quad            .Lx33_0_s
.Lx33_0_s:              .string          "/"
#-----------------------------------------------------------------------------------------------------------------------
n29_lit_string_α:       mov              qword ptr [rsp + 48], 2              # result
                        mov              dword ptr [rsp + 52], 3
                        mov              rax, qword ptr [rip + .Lx34_0]
                        mov              qword ptr [rsp + 56], rax;           jmp   n30_lit_integer_α
.Lx34_0:                .quad            .Lx34_0_s
.Lx34_0_s:              .string          "foo"
#-----------------------------------------------------------------------------------------------------------------------
n30_lit_integer_α:      mov              qword ptr [rsp + 64], 3              # result
                        mov              rax, qword ptr [rip + .Lx35_0]
                        mov              qword ptr [rsp + 72], rax;           jmp   n31_call_builtin_prolog_α
.Lx35_0:                .quad            1
#-----------------------------------------------------------------------------------------------------------------------
n31_call_builtin_prolog_α:
                        ...
                        mov              r9,  qword ptr [rip + rtccb+48]
                        mov              r10, qword ptr [rip + rtccb+56]
                        mov              r11, qword ptr [rip + rtccb+64];     jmp   n32_call_proc_staged_α
n31_call_builtin_prolog_β:
                                                                              jmp   main_ω
#-----------------------------------------------------------------------------------------------------------------------
n32_call_proc_staged_α: lea              r8, [rip + g_gc_pending]
                        mov              eax, dword ptr [r8 + 0]
...
.Lx38_20:               mov              edi, 0
                        ...
                        mov              r10, qword ptr [rip + rtccb+56]
                        mov              r11, qword ptr [rip + rtccb+64]
.Lx38_21:               mov              rdi, qword ptr [rip + .Lx38_0]
                        mov              esi, 1
                        mov              qword ptr [rip + rtccb+40], r8
                        mov              qword ptr [rip + rtccb+56], r10
                        mov              qword ptr [rip + rtccb+64], r11
                        ...
                        mov              r10, qword ptr [rip + rtccb+56]
                        mov              r11, qword ptr [rip + rtccb+64]
                        lea              rcx, [rip + .Lx38_4]                 # s111 floater pair (LEGACY flat-glue arm): the THIRD non-TINY arm, the one GVA-off actually takes (MONITOR_BIN forces n_gva_m3=0 so the SCC gate and the role-4 TINY shim both decline and the site falls HERE, to rt_proc_call_open + flat rcx/rdx wires).  s110 patched only the two open_slim tails, so this arm still pushed NOTHING and :(RETURN) popped enclosing-frame bytes.  Push omega then gamma = [rsp+0]=gamma [rsp+8]=omega; the fnrbp2 floater consumes 16 so L(3)/L(4) arrive at today's depth.  SCRIP_SLIM_PAIR=0 restores prior bytes.
                        push             rcx
                        lea              rcx, [rip + .Lx38_3]
                        push             rcx
                        lea              rcx, [rip + .Lx38_3]
...
.Lx38_29:               mov              qword ptr [rsp + 0], rax
                        mov              qword ptr [rsp + 8], rdx
                        cmp              eax, 104;                            je    main_ω
                                                                              jmp   main_γ
n32_call_proc_staged_β:                                                       jmp   main_ω
.Lx38_0:                .quad            .Lx38_0_s
.Lx38_0_s:              .string          "dynamic/1"
#-----------------------------------------------------------------------------------------------------------------------
main_β:
                                                                              jmp   main_ω
#-----------------------------------------------------------------------------------------------------------------------
