...
.Lplent0_done: 
 jmp .Lplcallees3_end
# PL CALLEE BLOCK animal/1/1
.intel_syntax noprefix
.Lplpred_animal_1: 
# env push/pop handled by caller (bb_pl_call site)
 bb55760_α:
# BOX PL_CHOICE n=4 (mode-4 first-solution)
 jmp .Lplch5_c0_pre
 .Lplch5_c0_pre:
 call rt_pl_trail_mark_push@PLT
 jmp .Lplch5_c0_body
...
# BOX PL_UNIFY
 ...
 je .Lplch5_c3_pre
 jmp .Lplpb4_γ
.Lplch5_c2_beta: jmp .Lplch5_c3_pre
.Lplch5_c3_body:
 bb63232_α:
# BOX PL_UNIFY
 mov edi, 57
