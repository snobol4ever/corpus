...
n0_call_builtin_prolog_β:
                                                                              jmp   main_ω
#-----------------------------------------------------------------------------------------------------------------------
n1_lit_string_α:        mov              qword ptr [rsp + 288], 2             # result
                        mov              dword ptr [rsp + 292], 1
                        mov              rax, qword ptr [rip + .Lx12_0]
                        mov              qword ptr [rsp + 296], rax;          jmp   n2_lit_integer_α
.Lx12_0:                .quad            .Lx12_0_s
.Lx12_0_s:              .string          "+"
#-----------------------------------------------------------------------------------------------------------------------
n2_lit_integer_α:       mov              qword ptr [rsp + 176], 3             # result
...
n3_lit_integer_α:       mov              qword ptr [rsp + 192], 3             # result
                        ...
                        mov              qword ptr [rsp + 200], rax;          jmp   n4_call_builtin_prolog_α
.Lx14_0:                .quad            2
#-----------------------------------------------------------------------------------------------------------------------
...
n5_call_builtin_prolog_α:
                        ...
                        .section         .rodata
.Lrkfn17:               .string          "$write_canonical"
                        .section         .text
                        .intel_syntax    noprefix
                        lea              rdi, [rip + .Lrkfn17]
                        lea              rsi, [rsp + 160]
