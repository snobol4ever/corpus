...
.Lx28_101:              mov              qword ptr [rsp + 32], rax
                        ...
                        cmp              al, 104;                             je    score$2F1_ω
                        mov              r8,  qword ptr [rip + rtccb+40]
                        mov              r9,  qword ptr [rip + rtccb+48];     jmp   n1_var_ref_α
n0_call_builtin_prolog_β:
                        mov              r11, 1;                              jmp   score$2F1_ω
#-----------------------------------------------------------------------------------------------------------------------
...
.Lx33_112:              cmp              esi, 2;                              jne   .Lx33_111
                        ...
                        test             rax, rax;                            je    .Lx33_111
                        mov              r8, rax;                             jmp   .Lx33_110
.Lx33_113:              cmp              al, 72;                              jne   .Lx33_111
                        mov              rax, qword ptr [r8 + 8]
                        test             rax, rax;                            je    .Lx33_111
                        cmp              rax, r8;                             je    .Lx33_111
                        mov              r8, rax;                             jmp   .Lx33_110
.Lx33_111:              mov              eax, dword ptr [r8 + 0]
                        cmp              al, 0;                               je    .Lx33_114
                        cmp              al, 104;                             je    .Lx33_114
                        cmp              al, 72;                              jne   .Lx33_118
                        mov              rax, qword ptr [r8 + 8]
                        cmp              rax, r8;                             je    .Lx33_114
                                                                              jmp   .Lx33_118
.Lx33_118:              mov              eax, dword ptr [r8 + 0]
                        cmp              al, 80;                              je    .Lx33_115
                        cmp              al, 3;                               jne   .Lx33_114
                        mov              esi, dword ptr [r8 + 4]
...
.Lx45_112:              cmp              esi, 2;                              jne   .Lx45_111
                        ...
                        test             rax, rax;                            je    .Lx45_111
                        mov              r8, rax;                             jmp   .Lx45_110
.Lx45_113:              cmp              al, 72;                              jne   .Lx45_111
                        mov              rax, qword ptr [r8 + 8]
                        test             rax, rax;                            je    .Lx45_111
                        cmp              rax, r8;                             je    .Lx45_111
                        mov              r8, rax;                             jmp   .Lx45_110
.Lx45_111:              mov              eax, dword ptr [r8 + 0]
                        cmp              al, 0;                               je    .Lx45_114
                        cmp              al, 104;                             je    .Lx45_114
                        cmp              al, 72;                              jne   .Lx45_118
                        mov              rax, qword ptr [r8 + 8]
                        cmp              rax, r8;                             je    .Lx45_114
                                                                              jmp   .Lx45_118
.Lx45_118:              mov              eax, dword ptr [r8 + 0]
                        cmp              al, 80;                              je    .Lx45_115
                        cmp              al, 3;                               jne   .Lx45_114
                        mov              esi, dword ptr [r8 + 4]
...
.Lx57_118:              mov              eax, dword ptr [r8 + 0]
                        cmp              al, 80;                              je    .Lx57_115
                        cmp              al, 3;                               jne   .Lx57_114
                        mov              esi, dword ptr [r8 + 4]
...
n27_call_builtin_prolog_α:
                        ...
                        cmp              al, 104;                             je    score$2F1_ω
                        mov              r8,  qword ptr [rip + rtccb+40]
                        mov              r9,  qword ptr [rip + rtccb+48];     jmp   score$2F1_ω
n27_call_builtin_prolog_β:
                        mov              r11, 28;                             jmp   score$2F1_ω
#-----------------------------------------------------------------------------------------------------------------------
score$2F1_res:
                        add              rsp, 8
                        pop              rsp
...
.Lx80_102:              lea              r12, [rip + g_plw_cellws_on]
                        mov              eax, dword ptr [r10 + 0]
...
.Lrkfn82:               .string          "$findall_new"
                        ...
                        mov              qword ptr [rsp + 200], rdx
                        cmp              al, 104;                             je    n79_call_builtin_prolog_α
                        mov              r8,  qword ptr [rip + rtccb+40]
                        mov              r9,  qword ptr [rip + rtccb+48];     jmp   n67_var_ref_α
n66_call_builtin_prolog_β:
                        mov              r11, 30;                             jmp   n79_call_builtin_prolog_α
#-----------------------------------------------------------------------------------------------------------------------
n67_var_ref_α:          mov              r11, 31
                        mov              rax, 4294967336
                        lea              rdx, [rsp + 448]
                        mov              qword ptr [rsp + 416], rax
                        mov              qword ptr [rsp + 424], rdx;          jmp   n68_call_proc_staged_α
#-----------------------------------------------------------------------------------------------------------------------
n68_call_proc_staged_α: mov              r11, 32
...
.Lx86_3:                mov              qword ptr [rsp + 392], rsp
                        ...
                        mov              r8,  qword ptr [rip + rtccb+40]
                        mov              r9,  qword ptr [rip + rtccb+48];     jmp   .Lx86_2
...
.Lx86_29:               mov              qword ptr [rsp + 352], rax
                        mov              qword ptr [rsp + 360], rdx
                        cmp              al, 104;                             je    n71_var_ref_α
                                                                              jmp   n69_var_α
n68_call_proc_staged_β: mov              r11, 32
...
.Lrkfn90:               .string          "$findall_add"
                        ...
                        cmp              al, 104;                             je    n79_call_builtin_prolog_α
                        mov              r8,  qword ptr [rip + rtccb+40]
                        mov              r9,  qword ptr [rip + rtccb+48];     jmp   n68_call_proc_staged_β
n70_call_builtin_prolog_β:
                        mov              r11, 34;                             jmp   n79_call_builtin_prolog_α
#-----------------------------------------------------------------------------------------------------------------------
n71_var_ref_α:          mov              r11, 35
                        mov              rax, 4294967336
                        lea              rdx, [rsp + 432]
...
n72_call_builtin_prolog_β:
                        mov              r11, 36;                             jmp   n79_call_builtin_prolog_α
#-----------------------------------------------------------------------------------------------------------------------
n73_var_α:              mov              r11, 37
...
n74_call_builtin_prolog_β:
                        mov              r11, 38;                             jmp   n79_call_builtin_prolog_α
#-----------------------------------------------------------------------------------------------------------------------
...
.Lrkfn101:              .string          "$nl0"
                        ...
                        cmp              al, 104;                             je    n79_call_builtin_prolog_α
                        mov              r8,  qword ptr [rip + rtccb+40]
                        mov              r9,  qword ptr [rip + rtccb+48];     jmp   n77_move_label_α
n76_call_builtin_prolog_β:
                        mov              r11, 40;                             jmp   n79_call_builtin_prolog_α
#-----------------------------------------------------------------------------------------------------------------------
n77_move_label_α:       mov              r11, 41
                        lea              rax, [rip + n79_call_builtin_prolog_α]
                        mov              qword ptr [rsp + 16], rax;           jmp   main_γ
#-----------------------------------------------------------------------------------------------------------------------
n78_disjunction_α:      mov              r11, 42
                        mov              qword ptr [rip + rtccb+40], r8
                        ...
                        test             rax, rax;                            je    main_ω
                                                                              jmp   rax
n78_disjunction_β:      mov              r11, 42;                             jmp   main_ω
#-----------------------------------------------------------------------------------------------------------------------
