...
.Lx16_44:               mov              eax, dword ptr [r9 + 0]
                        ...
                        cmp              rax, r9;                             je    .Lx16_53
                                                                              jmp   .Lx16_46
.Lx16_46:               lea              r12, [rip + g_pl_trail]
                        mov              rdi, qword ptr [r10 + 0]
                        test             rdi, rdi;                            je    .Lx16_53
                        mov              eax, dword ptr [r10 + 32]
                        mov              esi, 24
                        imul             rsi, rax
...
.Lx16_45:               mov              eax, dword ptr [r9 + 0]
                        ...
                        cmp              rax, r9;                             je    .Lx16_47
                                                                              jmp   .Lx16_48
.Lx16_47:               lea              r12, [rip + g_pl_trail]
                        mov              rdi, qword ptr [r10 + 0]
                        test             rdi, rdi;                            je    .Lx16_53
                        mov              eax, dword ptr [r10 + 32]
                        mov              esi, 24
...
n5_call_proc_staged_α:  mov              r11, 6
                        ...
                        mov              eax, dword ptr [r8 + 0]
                        test             eax, eax;                            jne   .Lx20_200
                        mov              rax, qword ptr [rsp + 240]
                        mov              rdx, qword ptr [rsp + 248]
                        lea              r8, [rip + g_call_args]
                        mov              qword ptr [r8 + 0], rax
                        mov              qword ptr [r8 + 8], rdx;             jmp   .Lx20_201
.Lx20_200:              mov              edi, 0
...
.Lx47_102:              lea              r12, [rip + g_plw_cellws_on]
                        mov              eax, dword ptr [r10 + 0]
...
.Lx194_44:              mov              eax, dword ptr [r9 + 0]
                        ...
                        cmp              rax, r9;                             je    .Lx194_53
                                                                              jmp   .Lx194_46
.Lx194_46:              lea              r12, [rip + g_pl_trail]
                        mov              rdi, qword ptr [r10 + 0]
                        test             rdi, rdi;                            je    .Lx194_53
                        mov              eax, dword ptr [r10 + 32]
                        mov              esi, 24
                        imul             rsi, rax
                        mov              rax, qword ptr [r10 + 24]
...
.Lx194_45:              mov              eax, dword ptr [r9 + 0]
                        ...
                        cmp              rax, r9;                             je    .Lx194_47
                                                                              jmp   .Lx194_48
.Lx194_47:              lea              r12, [rip + g_pl_trail]
                        mov              rdi, qword ptr [r10 + 0]
                        test             rdi, rdi;                            je    .Lx194_53
                        mov              eax, dword ptr [r10 + 32]
                        mov              esi, 24
