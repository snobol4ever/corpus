...
.Lx24_101:              mov              qword ptr [rsp + 32], rax
                        mov              qword ptr [rsp + 40], rdx
                        cmp              eax, 104;                            je    proc_item$2F1_ω
                        mov              r8,  qword ptr [rip + rtccb+40]
                        mov              r9,  qword ptr [rip + rtccb+48]
                        mov              r10, qword ptr [rip + rtccb+56]
...
.Lx30_61:               mov              rdi, qword ptr [rsp + 32]
                        ...
                        mov              qword ptr [rsp + 0], rax
                        mov              rax, qword ptr [rsp + 40]
                        mov              qword ptr [rsp + 8], rax;            jmp   proc_item$2F1_γ
...
#-----------------------------------------------------------------------------------------------------------------------
n20_lit_string_α:       mov              qword ptr [rsp + 176], 2             # result
...
.Lx44_61:               mov              rdi, qword ptr [rsp + 32]
                        ...
                        mov              rax, qword ptr [rsp + 40]
                        mov              qword ptr [rsp + 8], rax;            jmp   proc_item$2F1_γ
n22_suspend_β:                                                                jmp   n23_call_builtin_prolog_α
#-----------------------------------------------------------------------------------------------------------------------
n23_call_builtin_prolog_α:
                        ...
                        mov              r9,  qword ptr [rip + rtccb+48]
                        mov              r10, qword ptr [rip + rtccb+56]
                        mov              r11, qword ptr [rip + rtccb+64];     jmp   proc_item$2F1_ω
...
#-----------------------------------------------------------------------------------------------------------------------
n48_lit_string_α:       mov              qword ptr [rsp + 624], 2             # result
...
.Lx74_55:               cmp              esi, 2;                              jne   .Lx74_41
                        ...
                        test             rax, rax;                            je    .Lx74_41
                        mov              r8, rax;                             jmp   .Lx74_40
.Lx74_56:               cmp              eax, 72;                             jne   .Lx74_41
                        mov              rax, qword ptr [r8 + 8]
                        test             rax, rax;                            je    .Lx74_41
...
.Lx74_57:               cmp              esi, 2;                              jne   .Lx74_43
                        ...
                        test             rax, rax;                            je    .Lx74_43
                        mov              r9, rax;                             jmp   .Lx74_42
.Lx74_58:               cmp              eax, 72;                             jne   .Lx74_43
                        mov              rax, qword ptr [r9 + 8]
                        test             rax, rax;                            je    .Lx74_43
...
.Lx74_43:               cmp              r8, r9;                              je    .Lx74_51
                        ...
                        cmp              eax, 0;                              je    .Lx74_44
                        cmp              eax, 104;                            je    .Lx74_44
                        cmp              eax, 72;                             jne   .Lx74_45
                        mov              rax, qword ptr [r8 + 8]
                        cmp              rax, r8;                             je    .Lx74_44
                                                                              jmp   .Lx74_45
.Lx74_44:               mov              eax, dword ptr [r9 + 0]
                        cmp              eax, 0;                              je    .Lx74_53
                        cmp              eax, 104;                            je    .Lx74_53
                        cmp              eax, 72;                             jne   .Lx74_46
                        mov              rax, qword ptr [r9 + 8]
...
.Lx74_45:               mov              eax, dword ptr [r9 + 0]
                        cmp              eax, 0;                              je    .Lx74_47
                        cmp              eax, 104;                            je    .Lx74_47
                        cmp              eax, 72;                             jne   .Lx74_48
                        mov              rax, qword ptr [r9 + 8]
...
.Lx74_48:               mov              ecx, dword ptr [r8 + 0]
                        ...
                        cmp              ecx, 80;                             jne   .Lx74_49
                        cmp              edx, 80;                             je    .Lx74_53
                                                                              jmp   .Lx74_52
.Lx74_49:               cmp              edx, 80;                             je    .Lx74_52
                        cmp              ecx, 5;                              je    .Lx74_53
                        cmp              edx, 5;                              je    .Lx74_53
                        cmp              ecx, 3;                              jne   .Lx74_50
                        cmp              edx, 3;                              jne   .Lx74_50
                        mov              rax, qword ptr [r8 + 0]
...
#-----------------------------------------------------------------------------------------------------------------------
n54_call_proc_staged_α: mov              qword ptr [rsp + 432], 0
...
.Lx80_2:                mov              rcx, qword ptr [rip + rt_g_ret_by_name@GOTPCREL] # NRETURN by-name consult wn=0
...
.Lx80_29:               mov              qword ptr [rsp + 400], rax
                        mov              qword ptr [rsp + 408], rdx
                        cmp              eax, 104;                            je    n57_call_builtin_prolog_α
                                                                              jmp   n55_var_α
n54_call_proc_staged_β: call             rt_gen_spine_resume_enter@PLT
...
#-----------------------------------------------------------------------------------------------------------------------
n55_var_α:              mov              rax, qword ptr [rsp + 656]
                        mov              qword ptr [rsp + 384], rax
...
n59_call_builtin_prolog_β:
                                                                              jmp   n66_call_builtin_prolog_α
#-----------------------------------------------------------------------------------------------------------------------
n60_var_α:              mov              rax, qword ptr [rsp + 640]
