...
plseq1_g0_α:
 bb3456_α:
 # BOX PL_BUILTIN(findall/1320677248)
...
plseq1_g3_α:
 bb752_α:
 # BOX PL_BUILTIN(findall/1320677312)
 # PL_BUILTIN: unknown 'findall' — stub
 jmp plseq1_g4_α
...
.Lplent0_done: 
 jmp .Lplcallees2_end
# PL CALLEE BLOCK item/3/3
.intel_syntax noprefix
.Lplpred_item_3: 
# env push/pop handled by caller (bb_pl_call site)
# redo entry: .Lplpred_item_3_redo
plseq4_g0_α:
 bb98512_α:
# BOX PL_UNIFY
 sub rsp, 16
...
.Lplpb3_ω: 
 ...
 call rt_set_last_ok@PLT
 ret
.Lplpred_item_3_redo: jmp .Lplpb3_β
.Lplcallees2_end: 
#=======================================================================================================================
# stmt 0
#=======================================================================================================================
