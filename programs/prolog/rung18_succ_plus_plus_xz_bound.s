...
n0_call_builtin_prolog_β:
                                                                              jmp   main_ω
#-----------------------------------------------------------------------------------------------------------------------
n1_lit_integer_α:       mov              qword ptr [rsp + 496], 3             # result
                        mov              rax, qword ptr [rip + .Lx23_0]
                        mov              qword ptr [rsp + 504], rax;          jmp   n2_var_ref_α
.Lx23_0:                .quad            3
#-----------------------------------------------------------------------------------------------------------------------
n2_var_ref_α:           mov              rax, 4294967336
                        lea              rdx, [rsp + 560]
                        mov              qword ptr [rsp + 512], rax
                        mov              qword ptr [rsp + 520], rdx;          jmp   n3_lit_integer_α
#-----------------------------------------------------------------------------------------------------------------------
n3_lit_integer_α:       mov              qword ptr [rsp + 528], 3             # result
                        mov              rax, qword ptr [rip + .Lx26_0]
                        mov              qword ptr [rsp + 536], rax;          jmp   n4_call_builtin_prolog_α
.Lx26_0:                .quad            10
#-----------------------------------------------------------------------------------------------------------------------
...
#-----------------------------------------------------------------------------------------------------------------------
n5_var_α:               mov              rax, qword ptr [rsp + 560]
                        mov              qword ptr [rsp + 416], rax
                        mov              rax, qword ptr [rsp + 568]
                        mov              qword ptr [rsp + 424], rax;          jmp   n6_call_builtin_prolog_α
#-----------------------------------------------------------------------------------------------------------------------
...
n6_call_builtin_prolog_β:
                                                                              jmp   n18_call_builtin_prolog_α
#-----------------------------------------------------------------------------------------------------------------------
n7_lit_string_α:        mov              qword ptr [rsp + 368], 2             # result
                        mov              dword ptr [rsp + 372], 0
                        mov              rax, qword ptr [rip + .Lx33_0]
                        mov              qword ptr [rsp + 376], rax;          jmp   n8_call_builtin_prolog_α
...
n8_call_builtin_prolog_β:
                                                                              jmp   n18_call_builtin_prolog_α
#-----------------------------------------------------------------------------------------------------------------------
n9_lit_integer_α:       mov              qword ptr [rsp + 288], 3             # result
                        mov              rax, qword ptr [rip + .Lx36_0]
                        mov              qword ptr [rsp + 296], rax;          jmp   n10_var_ref_α
.Lx36_0:                .quad            0
#-----------------------------------------------------------------------------------------------------------------------
n10_var_ref_α:          mov              rax, 4294967336
                        lea              rdx, [rsp + 544]
                        mov              qword ptr [rsp + 304], rax
                        mov              qword ptr [rsp + 312], rdx;          jmp   n11_lit_integer_α
#-----------------------------------------------------------------------------------------------------------------------
n11_lit_integer_α:      mov              qword ptr [rsp + 320], 3             # result
                        mov              rax, qword ptr [rip + .Lx39_0]
                        mov              qword ptr [rsp + 328], rax;          jmp   n12_call_builtin_prolog_α
.Lx39_0:                .quad            5
#-----------------------------------------------------------------------------------------------------------------------
...
n12_call_builtin_prolog_β:
                                                                              jmp   n18_call_builtin_prolog_α
#-----------------------------------------------------------------------------------------------------------------------
n13_var_α:              mov              rax, qword ptr [rsp + 544]
...
n15_lit_string_α:       mov              qword ptr [rsp + 160], 2             # result
                        ...
                        mov              qword ptr [rsp + 168], rax;          jmp   n16_call_builtin_prolog_α
...
n16_call_builtin_prolog_β:
                                                                              jmp   n18_call_builtin_prolog_α
#-----------------------------------------------------------------------------------------------------------------------
n17_move_label_α:       lea              rax, [rip + n18_call_builtin_prolog_α]
