...
#-----------------------------------------------------------------------------------------------------------------------
n10_lit_string_α:       mov              qword ptr [rsp + 544], 2             # result
                        mov              dword ptr [rsp + 548], 1
                        mov              rax, qword ptr [rip + .Lx30_0]
                        mov              qword ptr [rsp + 552], rax;          jmp   n11_var_ref_α
...
n11_var_ref_α:          mov              rax, 4294967336
                        ...
                        mov              qword ptr [rsp + 440], rdx;          jmp   n12_lit_integer_α
#-----------------------------------------------------------------------------------------------------------------------
n12_lit_integer_α:      mov              qword ptr [rsp + 448], 3             # result
                        mov              rax, qword ptr [rip + .Lx33_0]
                        mov              qword ptr [rsp + 456], rax;          jmp   n13_call_builtin_prolog_α
.Lx33_0:                .quad            5
#-----------------------------------------------------------------------------------------------------------------------
...
.Lx35_53:               mov              esi, 2
                        ...
                        mov              r10, qword ptr [rip + rtccb+56]
                        mov              r11, qword ptr [rip + rtccb+64]
.Lx35_54:               mov              qword ptr [rsp + 368], rax
...
n15_var_ref_α:          mov              rax, 4294967336
                        ...
                        mov              qword ptr [rsp + 200], rdx;          jmp   n16_call_builtin_prolog_α
#-----------------------------------------------------------------------------------------------------------------------
n16_call_builtin_prolog_α:
                        ...
                        mov              rdx, qword ptr [rsp + 216];          jmp   .Lx38_101
.Lx38_102:              lea              r10, [rip + g_plw_cellws_on]
                        mov              eax, dword ptr [r10 + 0]
...
.Lx38_100:              lea              rdi, [rsp + 224]
                        ...
                        mov              r10, qword ptr [rip + rtccb+56]
                        mov              r11, qword ptr [rip + rtccb+64]
.Lx38_101:              mov              qword ptr [rsp + 208], rax
...
n17_var_ref_α:          mov              rax, 4294967336
                        ...
                        mov              qword ptr [rsp + 360], rdx;          jmp   n18_call_proc_staged_α
#-----------------------------------------------------------------------------------------------------------------------
n18_call_proc_staged_α: mov              qword ptr [rsp + 320], 0
...
.Lx42_3:                mov              qword ptr [rsp + 328], rsp
                        add              rsp, 8
...
.Lx42_4:                mov              rax, qword ptr [rsp + 320]
...
.Lx42_29:               mov              qword ptr [rsp + 288], rax
                        mov              qword ptr [rsp + 296], rdx
...
n18_call_proc_staged_β: call             rt_gen_spine_resume_enter@PLT
                        ...
                        mov              r10, qword ptr [rip + rtccb+56]
                        mov              r11, qword ptr [rip + rtccb+64]
                        test             rax, rax;                            je    n25_call_builtin_prolog_α
                        mov              rdi, rax
...
#-----------------------------------------------------------------------------------------------------------------------
n19_var_α:              mov              rax, qword ptr [rsp + 560]
...
.Lrkfn49:               .string          "$nl0"
                        ...
                        mov              r9,  qword ptr [rip + rtccb+48]
                        mov              r10, qword ptr [rip + rtccb+56]
                        mov              r11, qword ptr [rip + rtccb+64];     jmp   n23_move_label_α
n22_call_builtin_prolog_β:
                                                                              jmp   n26_call_builtin_prolog_α
#-----------------------------------------------------------------------------------------------------------------------
n23_move_label_α:       lea              rax, [rip + n26_call_builtin_prolog_α]
