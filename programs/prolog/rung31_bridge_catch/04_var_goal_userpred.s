...
.Lx23_101:              mov              qword ptr [rsp + 80], rax
                        ...
                        cmp              eax, 104;                            je    proc_double$2F2_ω
                        mov              r8,  qword ptr [rip + rtccb+40]
                        mov              r9,  qword ptr [rip + rtccb+48]
                        mov              r10, qword ptr [rip + rtccb+56]
...
.Lx33_55:               cmp              esi, 2;                              jne   .Lx33_41
                        ...
                        test             rax, rax;                            je    .Lx33_41
                        mov              r8, rax;                             jmp   .Lx33_40
.Lx33_56:               cmp              eax, 72;                             jne   .Lx33_41
                        mov              rax, qword ptr [r8 + 8]
                        test             rax, rax;                            je    .Lx33_41
...
.Lx33_57:               cmp              esi, 2;                              jne   .Lx33_43
                        ...
                        test             rax, rax;                            je    .Lx33_43
                        mov              r9, rax;                             jmp   .Lx33_42
.Lx33_58:               cmp              eax, 72;                             jne   .Lx33_43
                        mov              rax, qword ptr [r9 + 8]
                        test             rax, rax;                            je    .Lx33_43
...
.Lx33_43:               cmp              r8, r9;                              je    .Lx33_51
                        mov              eax, dword ptr [r8 + 0]
                        cmp              eax, 0;                              je    .Lx33_44
                        cmp              eax, 104;                            je    .Lx33_44
                        cmp              eax, 72;                             jne   .Lx33_45
                        mov              rax, qword ptr [r8 + 8]
                        cmp              rax, r8;                             je    .Lx33_44
                                                                              jmp   .Lx33_45
.Lx33_44:               mov              eax, dword ptr [r9 + 0]
                        cmp              eax, 0;                              je    .Lx33_53
                        cmp              eax, 104;                            je    .Lx33_53
                        cmp              eax, 72;                             jne   .Lx33_46
                        mov              rax, qword ptr [r9 + 8]
...
.Lx33_45:               mov              eax, dword ptr [r9 + 0]
                        cmp              eax, 0;                              je    .Lx33_47
                        cmp              eax, 104;                            je    .Lx33_47
                        cmp              eax, 72;                             jne   .Lx33_48
                        mov              rax, qword ptr [r9 + 8]
...
.Lx33_48:               mov              ecx, dword ptr [r8 + 0]
                        mov              edx, dword ptr [r9 + 0]
                        cmp              ecx, 80;                             jne   .Lx33_49
                        cmp              edx, 80;                             je    .Lx33_53
                                                                              jmp   .Lx33_52
.Lx33_49:               cmp              edx, 80;                             je    .Lx33_52
                        cmp              ecx, 5;                              je    .Lx33_53
                        cmp              edx, 5;                              je    .Lx33_53
                        cmp              ecx, 3;                              jne   .Lx33_50
                        cmp              edx, 3;                              jne   .Lx33_50
                        mov              rax, qword ptr [r8 + 0]
...
#-----------------------------------------------------------------------------------------------------------------------
n16_var_α:              mov              rax, qword ptr [rsp + 480]
...
n20_move_label_α:       lea              rax, [rip + n22_call_builtin_prolog_α]
                        mov              qword ptr [rsp + 64], rax;           jmp   proc_double$2F2_γ
#-----------------------------------------------------------------------------------------------------------------------
n21_disjunction_α:      mov              qword ptr [rip + rtccb+40], r8
                        ...
                        mov              r10, qword ptr [rip + rtccb+56]
                        mov              r11, qword ptr [rip + rtccb+64]
                        test             rax, rax;                            je    proc_double$2F2_ω
                                                                              jmp   rax
n21_disjunction_β:                                                            jmp   proc_double$2F2_ω
#-----------------------------------------------------------------------------------------------------------------------
n22_call_builtin_prolog_α:
                        ...
                        mov              r9,  qword ptr [rip + rtccb+48]
                        mov              r10, qword ptr [rip + rtccb+56]
                        mov              r11, qword ptr [rip + rtccb+64];     jmp   proc_double$2F2_ω
...
proc_double$2F2_dcα:
                        ...
                        add              rsp, 16
                        lea              rcx, [rip + .Lx46_2]
                        lea              rdx, [rip + .Lx46_3];                jmp   proc_double$2F2_α
.Lx46_2:                pop              r11
                        pop              r11;                                 jmp   r11
.Lx46_3:                pop              r11
                        pop              r11
...
#-----------------------------------------------------------------------------------------------------------------------
n49_lit_string_α:       mov              qword ptr [rsp + 544], 2             # result
...
#-----------------------------------------------------------------------------------------------------------------------
n50_lit_integer_α:      mov              qword ptr [rsp + 432], 3             # result
...
.Lx77_102:              lea              r10, [rip + g_plw_cellws_on]
                        mov              eax, dword ptr [r10 + 0]
...
#-----------------------------------------------------------------------------------------------------------------------
n57_call_proc_staged_α: mov              qword ptr [rsp + 320], 0
...
.Lx81_3:                mov              qword ptr [rsp + 328], rsp
                        add              rsp, 8
...
.Lx81_4:                mov              rax, qword ptr [rsp + 320]
...
.Lx81_2:                mov              rcx, qword ptr [rip + rt_g_ret_by_name@GOTPCREL] # NRETURN by-name consult wn=0
...
#-----------------------------------------------------------------------------------------------------------------------
n58_var_α:              mov              rax, qword ptr [rsp + 560]
                        mov              qword ptr [rsp + 176], rax
...
n61_call_builtin_prolog_β:
                                                                              jmp   n65_call_builtin_prolog_α
#-----------------------------------------------------------------------------------------------------------------------
n62_move_label_α:       lea              rax, [rip + n65_call_builtin_prolog_α]
