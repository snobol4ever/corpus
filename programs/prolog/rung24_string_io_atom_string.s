...
n3_call_builtin_prolog_α:
                        ...
                        .section         .rodata
.Lrkfn30:               .string          "$aop_atom_string"
                        .section         .text
                        .intel_syntax    noprefix
                        lea              rdi, [rip + .Lrkfn30]
                        lea              rsi, [rsp + 560]
...
n8_var_ref_α:           mov              rax, 4294967336
                        ...
                        mov              qword ptr [rsp + 424], rdx;          jmp   n9_lit_string_α
#-----------------------------------------------------------------------------------------------------------------------
n9_lit_string_α:        mov              qword ptr [rsp + 432], 2             # result
                        mov              dword ptr [rsp + 436], 5
                        mov              rax, qword ptr [rip + .Lx40_0]
                        mov              qword ptr [rsp + 440], rax;          jmp   n10_call_builtin_prolog_α
...
n10_call_builtin_prolog_α:
                        ...
                        .section         .rodata
.Lrkfn42:               .string          "$aop_atom_string"
                        .section         .text
                        .intel_syntax    noprefix
                        lea              rdi, [rip + .Lrkfn42]
                        lea              rsi, [rsp + 384]
...
n14_call_builtin_prolog_β:
                                                                              jmp   n24_call_builtin_prolog_α
#-----------------------------------------------------------------------------------------------------------------------
n15_lit_integer_α:      mov              qword ptr [rsp + 240], 3             # result
...
n17_call_builtin_prolog_α:
                        ...
                        .section         .rodata
.Lrkfn54:               .string          "$aop_atom_string"
                        .section         .text
                        .intel_syntax    noprefix
                        lea              rdi, [rip + .Lrkfn54]
                        lea              rsi, [rsp + 208]
