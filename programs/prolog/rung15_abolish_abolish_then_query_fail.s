...
plseq2_g1_α:
 bb40624_α:
# BOX PL_CALL dog/1 (WAM-CP-5, n_args=1)
 mov edi, 57
 mov rsi, 0
 lea rdx, [rip + .S5]
 xorps xmm0, xmm0
...
bb40624_α_fail5: 
 ...
 call pl_bb_env_install@PLT
 jmp xite3_then_α
bb40624_α_nosol: jmp xite3_else_α
xite3_then_α:
 bb40400_α:
...
.Lplent0_done: 
 jmp .Lplcallees4_end
# PL CALLEE BLOCK dog/1/1
.intel_syntax noprefix
.Lplpred_dog_1: 
# env push/pop handled by caller (bb_pl_call site)
# redo entry: .Lplpred_dog_1_redo
 bb33664_α:
# BOX PL_CHOICE n=2 (WAM-CP-5 heap cursor, WAM-CP-9 cut)
 call rt_pl_env_current@PLT
 mov rdx, rax
...
.Lplpb5_ω: 
 ...
 call rt_set_last_ok@PLT
 ret
.Lplpred_dog_1_redo: jmp .Lplpb5_β
.Lplcallees4_end: 
 HALT
