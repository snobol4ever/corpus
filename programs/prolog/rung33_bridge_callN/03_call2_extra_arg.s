...
#-----------------------------------------------------------------------------------------------------------------------
n13_lit_string_α:       mov              qword ptr [rsp + 320], 2             # result
...
#-----------------------------------------------------------------------------------------------------------------------
n16_lit_string_α:       mov              qword ptr [rsp + 240], 2             # result
...
#-----------------------------------------------------------------------------------------------------------------------
n17_call_proc_staged_α: mov              qword ptr [rsp + 192], 0
                        lea              r8, [rip + g_gc_pending]
                        mov              eax, dword ptr [r8 + 0]
                        test             eax, eax;                            jne   .Lx32_20
                        mov              rax, qword ptr [rsp + 224]
                        mov              rdx, qword ptr [rsp + 232]
                        lea              r8, [rip + g_call_args]
                        mov              qword ptr [r8 + 0], rax
                        mov              qword ptr [r8 + 8], rdx;             jmp   .Lx32_21
.Lx32_20:               mov              edi, 0
                        ...
                        mov              r8,  qword ptr [rip + rtccb+40]
                        mov              r9,  qword ptr [rip + rtccb+48]
.Lx32_21:               lea              r8, [rip + g_gc_pending]
                        mov              eax, dword ptr [r8 + 0]
                        test             eax, eax;                            jne   .Lx32_22
                        mov              rax, qword ptr [rsp + 240]
                        mov              rdx, qword ptr [rsp + 248]
                        lea              r8, [rip + g_call_args]
                        mov              qword ptr [r8 + 16], rax
                        mov              qword ptr [r8 + 24], rdx;            jmp   .Lx32_23
.Lx32_22:               mov              edi, 1
...
.Lx32_3:                mov              qword ptr [rsp + 200], rsp
                        add              rsp, 8
                        ...
                        mov              r8,  qword ptr [rip + rtccb+40]
                        mov              r9,  qword ptr [rip + rtccb+48];     jmp   .Lx32_2
.Lx32_5:                call             rt_gen_spine_pass_γ@PLT;             jmp   .Lx32_2
.Lx32_4:                mov              rax, qword ptr [rsp + 192]
...
#-----------------------------------------------------------------------------------------------------------------------
n20_move_label_α:       lea              rax, [rip + n17_call_proc_staged_β]
