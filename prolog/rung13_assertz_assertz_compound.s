...
#-----------------------------------------------------------------------------------------------------------------------
n62_call_proc_staged_α: mov              r11, 29
...
.Lx81_200:              mov              edi, 0
                        ...
                        mov              r10, qword ptr [rip + rtccb+56]
                        mov              r11, qword ptr [rip + rtccb+64]
.Lx81_201:              lea              r8, [rip + g_gc_pending]
                        mov              eax, dword ptr [r8 + 0]
                        test             eax, eax;                            jne   .Lx81_202
                        mov              rax, qword ptr [rsp + 416]
                        mov              rdx, qword ptr [rsp + 424]
                        lea              r8, [rip + g_call_args]
                        mov              qword ptr [r8 + 16], rax
                        mov              qword ptr [r8 + 24], rdx;            jmp   .Lx81_203
.Lx81_202:              mov              edi, 1
...
.Lx81_29:               mov              qword ptr [rsp + 320], rax
                        ...
                        cmp              al, 104;                             je    n71_call_builtin_prolog_α
                                                                              jmp   n63_var_α
n62_call_proc_staged_β: mov              r11, 29
...
n64_call_builtin_prolog_β:
                        mov              r11, 31;                             jmp   n62_call_proc_staged_β
#-----------------------------------------------------------------------------------------------------------------------
...
n66_call_builtin_prolog_β:
                        mov              r11, 33;                             jmp   n62_call_proc_staged_β
#-----------------------------------------------------------------------------------------------------------------------
n67_var_α:              mov              r11, 34
...
n68_call_builtin_prolog_β:
                        mov              r11, 35;                             jmp   n62_call_proc_staged_β
#-----------------------------------------------------------------------------------------------------------------------
...
n70_call_builtin_prolog_β:
                        mov              r11, 37;                             jmp   n62_call_proc_staged_β
#-----------------------------------------------------------------------------------------------------------------------
...
#-----------------------------------------------------------------------------------------------------------------------
n72_move_label_α:       mov              r11, 39
                        lea              rax, [rip + n74_call_builtin_prolog_α]
                        mov              qword ptr [rsp + 16], rax;           jmp   main_γ
#-----------------------------------------------------------------------------------------------------------------------
n73_disjunction_α:      mov              r11, 40
                        mov              qword ptr [rip + rtccb+40], r8
                        mov              qword ptr [rip + rtccb+56], r10
                        mov              qword ptr [rip + rtccb+64], r11
                        ...
                        test             rax, rax;                            je    main_ω
                                                                              jmp   rax
n73_disjunction_β:      mov              r11, 40;                             jmp   main_ω
#-----------------------------------------------------------------------------------------------------------------------
