...
n24_call_builtin_prolog_α:
                        ...
                        mov              r9,  qword ptr [rip + rtccb+48]
                        mov              r10, qword ptr [rip + rtccb+56]
                        mov              r11, qword ptr [rip + rtccb+64];     jmp   pair$2F2_ω
n24_call_builtin_prolog_β:
                        mov              r11, 25;                             jmp   pair$2F2_ω
#-----------------------------------------------------------------------------------------------------------------------
pair$2F2_res:
                        add              rsp, 8
                        pop              rsp
...
.Lx87_200:              mov              edi, 0
                        ...
                        mov              r10, qword ptr [rip + rtccb+56]
                        mov              r11, qword ptr [rip + rtccb+64]
.Lx87_201:              lea              r8, [rip + g_gc_pending]
                        mov              eax, dword ptr [r8 + 0]
                        test             eax, eax;                            jne   .Lx87_202
                        mov              rax, qword ptr [rsp + 608]
                        mov              rdx, qword ptr [rsp + 616]
                        lea              r8, [rip + g_call_args]
                        mov              qword ptr [r8 + 16], rax
                        mov              qword ptr [r8 + 24], rdx;            jmp   .Lx87_203
.Lx87_202:              mov              edi, 1
...
n63_call_proc_staged_β: mov              r11, 30
...
n68_call_builtin_prolog_β:
                        mov              r11, 35;                             jmp   n78_call_builtin_prolog_α
#-----------------------------------------------------------------------------------------------------------------------
...
.Lx100_55:              cmp              esi, 2;                              jne   .Lx100_41
                        ...
                        test             rax, rax;                            je    .Lx100_41
                        mov              r8, rax;                             jmp   .Lx100_40
.Lx100_56:              cmp              al, 72;                              jne   .Lx100_41
                        mov              rax, qword ptr [r8 + 8]
                        test             rax, rax;                            je    .Lx100_41
...
.Lx100_57:              cmp              esi, 2;                              jne   .Lx100_43
                        ...
                        test             rax, rax;                            je    .Lx100_43
                        mov              r9, rax;                             jmp   .Lx100_42
.Lx100_58:              cmp              al, 72;                              jne   .Lx100_43
                        mov              rax, qword ptr [r9 + 8]
                        test             rax, rax;                            je    .Lx100_43
...
.Lx100_43:              cmp              r8, r9;                              je    .Lx100_51
                        mov              eax, dword ptr [r8 + 0]
                        cmp              al, 0;                               je    .Lx100_44
                        cmp              al, 104;                             je    .Lx100_44
                        cmp              al, 72;                              jne   .Lx100_45
                        mov              rax, qword ptr [r8 + 8]
                        cmp              rax, r8;                             je    .Lx100_44
                                                                              jmp   .Lx100_45
.Lx100_44:              mov              eax, dword ptr [r9 + 0]
                        cmp              al, 0;                               je    .Lx100_53
                        cmp              al, 104;                             je    .Lx100_53
                        cmp              al, 72;                              jne   .Lx100_46
                        mov              rax, qword ptr [r9 + 8]
                        cmp              rax, r9;                             je    .Lx100_53
                                                                              jmp   .Lx100_46
.Lx100_46:              lea              r12, [rip + g_pl_trail]
                        mov              rdi, qword ptr [r12 + 0]
                        test             rdi, rdi;                            je    .Lx100_53
                        mov              eax, dword ptr [r12 + 32]
                        mov              esi, 24
                        imul             rsi, rax
...
.Lx100_45:              mov              eax, dword ptr [r9 + 0]
                        cmp              al, 0;                               je    .Lx100_47
                        cmp              al, 104;                             je    .Lx100_47
                        cmp              al, 72;                              jne   .Lx100_48
                        mov              rax, qword ptr [r9 + 8]
                        cmp              rax, r9;                             je    .Lx100_47
                                                                              jmp   .Lx100_48
.Lx100_47:              lea              r12, [rip + g_pl_trail]
                        mov              rdi, qword ptr [r12 + 0]
                        test             rdi, rdi;                            je    .Lx100_53
                        mov              eax, dword ptr [r12 + 32]
                        mov              esi, 24
...
.Lx100_48:              mov              ecx, dword ptr [r8 + 0]
                        ...
                        cmp              cl, 80;                              jne   .Lx100_49
                        cmp              dl, 80;                              je    .Lx100_53
                                                                              jmp   .Lx100_52
.Lx100_49:              cmp              dl, 80;                              je    .Lx100_52
                        cmp              cl, 5;                               je    .Lx100_53
                        cmp              dl, 5;                               je    .Lx100_53
                        cmp              cl, 3;                               jne   .Lx100_50
                        cmp              dl, 3;                               jne   .Lx100_50
                        mov              rax, qword ptr [r8 + 0]
...
n75_call_builtin_prolog_β:
                        mov              r11, 42;                             jmp   n78_call_builtin_prolog_α
#-----------------------------------------------------------------------------------------------------------------------
n76_move_label_α:       mov              r11, 43
                        lea              rax, [rip + n78_call_builtin_prolog_α]
                        mov              qword ptr [rsp + 16], rax;           jmp   main_γ
#-----------------------------------------------------------------------------------------------------------------------
n77_disjunction_α:      mov              r11, 44
                        mov              qword ptr [rip + rtccb+40], r8
                        mov              qword ptr [rip + rtccb+56], r10
                        mov              qword ptr [rip + rtccb+64], r11
                        ...
                        test             rax, rax;                            je    main_ω
                                                                              jmp   rax
n77_disjunction_β:      mov              r11, 44;                             jmp   main_ω
#-----------------------------------------------------------------------------------------------------------------------
